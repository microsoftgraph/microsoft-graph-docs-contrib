...
### Common Setup: Determine author and ms.subservice values for front matter
...
In addition to the [base quality checklist](#base-quality-checklist-applies-to-all-scenarios), verify:
...
- **Note:** DO NOT create these files from scratch; copy them from the stubs folder
- **Target locations:**
...
- All objects (e.g., resources, properties, methods) MUST be referred to in the documentation using the exact same name and casing as defined in the CSDL file
...
5. **Properties section:**
   ...
   - Type references: Apply [namespace qualification rules](#reference-standards-namespace-qualification)
...
7. **Request body section:**
   - Type references in all request body tables: Apply [namespace qualification rules](#reference-standards-namespace-qualification)
   - **For GET/LIST files:**
     - No updates required
   - **For POST files:**
...
8. **Response section:**
   ...
   - Return types: Apply [namespace qualification rules](#reference-standards-namespace-qualification)
...
## Base quality checklist (applies to ALL scenarios)

The following checks apply to every documentation scenario. Scenario-specific checklists below add additional items.
...
- [ ] Type references follow [namespace qualification rules](#reference-standards-namespace-qualification)
...
## Quality checklist — Scenario 1 additions
...
Before completing Scenario 4 tasks, verify the [base quality checklist](#base-quality-checklist-applies-to-all-scenarios) and these additional items:
