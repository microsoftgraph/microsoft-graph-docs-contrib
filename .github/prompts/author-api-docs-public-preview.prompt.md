...
**See [Common Setup: temp-docstubs Folder](author-api-docs-common.md#temp-docstubs-folder)** for instructions on setting up the temp-docstubs folder.
...
2. **Apply general rules:**
   - Fill in front matter as described in [Front matter rules](author-api-docs-common.md#front-matter-rules)
   - Update description as described in [File body rules](author-api-docs-common.md#file-body-rules)
...
5. **Properties section:**
   ...
   - Type references: Apply [namespace qualification rules](author-api-docs-common.md#namespace-qualification)
...
4. **HTTP request section:**
   ...
   - **For actions/functions in subnamespaces:** See [namespace qualification rules](author-api-docs-common.md#namespace-qualification) for fully qualifying actions/functions
...
7. **Request body section:**
   - Type references in all request body tables: Apply [namespace qualification rules](author-api-docs-common.md#namespace-qualification)
   - **For GET/LIST files:**
     - No updates required
   - **For POST files:**
...
8. **Response section:**
   ...
   - Return types: Apply [namespace qualification rules](author-api-docs-common.md#namespace-qualification)
...
9. **Examples section:**
   - Follow HTTP-only example formatting (see [Handling Code Snippets](author-api-docs-common.md#handling-code-snippets-in-examples))
...
See the shared processes in [`author-api-docs-common.md`](.github/prompts/author-api-docs-common.md) for complete instructions on each of these processes.
...
- [ ] Examples section: SDK snippets NOT manually added (see [Handling Code Snippets](author-api-docs-common.md#handling-code-snippets-in-examples))
