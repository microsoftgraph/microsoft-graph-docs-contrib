...
For example, suppose your local branch X was successfully merged into the microsoftgraph/microsoft-graph-docs main branch and you want to make additional updates to the content that was merged.
