...
|Addition|Beta|Added support for [restoring and permanently deleting groups](https://graph.microsoft.io/en-us/docs/api-reference/beta/resources/deleteditem).<br/>New entity: directory with deleteditems navigation property. |
