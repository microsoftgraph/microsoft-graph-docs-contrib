...
|Addition|Beta|Added the [getMobileAppCount](o:getMobileAppCount:Collection(microsoft.graph.mobileApp)) function on [mobileApp](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/resources/intune_apps_mobileapp) collection |
|Addition|Beta|Added the [getTopMobileApps](o:getTopMobileApps:Collection(microsoft.graph.mobileApp)) function on [mobileApp](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/resources/intune_apps_mobileapp) collection |
