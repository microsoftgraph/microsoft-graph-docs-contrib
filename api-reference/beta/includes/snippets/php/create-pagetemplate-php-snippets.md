...
$requestBody = new PageTemplate();
$requestBody->setOdataType('#microsoft.graph.pageTemplate');
...
$result = $graphServiceClient->sites()->bySiteId('site-id')->pagetemplates()->post($requestBody)->wait();
