...
$queryParameters = new RunRequestBuilderGetQueryParameters();
...
$requestResult = $graphServiceClient->identityGovernance()->lifecycleWorkflows()->workflowsById('workflow-id')->runsById('run-id')->get($requestConfiguration);
