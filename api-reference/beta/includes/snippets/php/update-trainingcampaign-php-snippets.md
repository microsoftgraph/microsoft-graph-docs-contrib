...
$campaignSchedule->setStatus(new CampaignStatus('cancelled'));
$requestBody->setCampaignSchedule($campaignSchedule);

$result = $graphServiceClient->security()->attackSimulation()->trainingCampaigns()->byTrainingCampaignId('trainingCampaign-id')->patch($requestBody)->wait();
