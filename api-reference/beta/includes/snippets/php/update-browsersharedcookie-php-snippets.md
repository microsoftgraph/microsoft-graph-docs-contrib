...
$result = $graphServiceClient->admin()->edge()->internetExplorerMode()->siteLists()->bySiteListId('browserSiteList-id')->sharedCookies()->bySharedCookieId('browserSharedCookie-id')->patch($requestBody);
