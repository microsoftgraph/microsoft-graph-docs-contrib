...
$callbackConfiguration = new AccessPackageRequestApprovalStageCallbackConfiguration();
$callbackConfiguration->setOdataType('microsoft.graph.accessPackageRequestApprovalStageCallbackConfiguration');
$additionalData = [
