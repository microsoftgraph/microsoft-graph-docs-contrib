...
rules_unified_role_management_policy_rule1setting.is_approval_required = False
...
approval_stages_approval_stage1.PrimaryApprovers([])
...
rules_unified_role_management_policy_rule4.is_expiration_required = False
