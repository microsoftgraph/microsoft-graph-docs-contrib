...
result = await graph_client.role_management.device_management.role_assignments.by_role_assignment_id('unifiedRoleAssignmentMultiple-id').get(request_configuration = request_configuration)
