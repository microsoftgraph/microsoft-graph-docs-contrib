...
request_body = PageTemplate(
	odata_type = "#microsoft.graph.pageTemplate",
	name = "test.aspx",
	title = "test",
...
result = await graph_client.sites.by_site_id('site-id').pagetemplates.post(body = request_body)
