...
request_body.display_name = 'Woodgrove User Flow 2'
...
identity_providers_identity_provider_base2 = IdentityProviderBase()
identity_providers_identity_provider_base2.id = 'Google-OAUTH'


identityProvidersArray []= identityProvidersIdentityProviderBase2;
identity_providers_identity_provider_base3 = IdentityProviderBase()
identity_providers_identity_provider_base3.id = 'Facebook-OAUTH'
...
attributes_identity_user_flow_attribute3 = IdentityUserFlowAttribute()
attributes_identity_user_flow_attribute3.id = 'extension_6ea3bc85aec24b1c92ff4a117afb6621_Favoritecolor'

attributes_identity_user_flow_attribute3.display_name = 'Favorite color'

attributes_identity_user_flow_attribute3.description = 'what is your favorite color'

attributes_identity_user_flow_attribute3.userflowattributetype(IdentityUserFlowAttributeType.Custom('identityuserflowattributetype.custom'))

attributes_identity_user_flow_attribute3.datatype(IdentityUserFlowAttributeDataType.String('identityuserflowattributedatatype.string'))
