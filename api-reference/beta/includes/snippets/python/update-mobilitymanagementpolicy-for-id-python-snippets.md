...
result = await graph_client.policies.mobile_app_management_policies.by_mobile_app_management_policie_id('mobilityManagementPolicy-id').patch(request_body = request_body)
