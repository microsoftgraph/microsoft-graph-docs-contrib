...
request_body.action(ScheduleRequestActions.AdminAssign('schedulerequestactions.adminassign'))
...
schedule_infoexpiration.endDateTime = DateTime('2023-02-07T19:56:00.000Z')


schedule_info.expiration = schedule_infoexpiration

request_body.schedule_info = schedule_info
request_body.justification = 'Assign eligible request.'
