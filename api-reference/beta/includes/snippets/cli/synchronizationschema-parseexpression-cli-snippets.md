...
mgc-beta service-principals synchronization jobs schema parse-expression post --service-principal-id {servicePrincipal-id} --synchronization-job-id {synchronizationJob-id} --body '{\
