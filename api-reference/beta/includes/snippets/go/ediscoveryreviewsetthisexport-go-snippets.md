...
graphClient.Security().Cases().EdiscoveryCasesById("ediscoveryCase-id").ReviewSetsById("ediscoveryReviewSet-id").Export(ediscoveryCase-id, ediscoveryReviewSet-id).Post(requestBody)
