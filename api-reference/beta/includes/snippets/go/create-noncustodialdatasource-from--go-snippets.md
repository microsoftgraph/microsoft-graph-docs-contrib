...
graphClient.Compliance().Ediscovery().CasesById("case-id").SourceCollectionsById("sourceCollection-id").NoncustodialSourcesById("noncustodialDataSource-id").Post(requestBody)
