...
activities, err := graphClient.Security().CaseManagement().Cases().ByCaseId("case-id").Activities().ByActivityId("activity-id").Patch(context.Background(), requestBody, nil)
