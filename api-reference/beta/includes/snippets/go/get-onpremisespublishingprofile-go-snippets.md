...
result, err := graphClient.OnPremisesPublishingProfilesById("onPremisesPublishingProfile-id").GetWithRequestConfigurationAndResponseHandler(configuration, nil)
