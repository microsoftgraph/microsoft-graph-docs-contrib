...
LinkedList<RuleCondition> conditionsList = new LinkedList<RuleCondition>();
RuleCondition conditions = new RuleCondition();
conditions.relationshipType = RelationshipType.OR;
conditions.conditionCategory = ConditionCategory.AZURE_NETWORK_CONNECTION_CHECK_FAILURES;
conditions.aggregation = AggregationType.COUNT;
conditions.operator = OperatorType.GREATER_OR_EQUAL;
conditions.thresholdValue = "90";
conditionsList.add(conditions);
alertRule.conditions = conditionsList;
