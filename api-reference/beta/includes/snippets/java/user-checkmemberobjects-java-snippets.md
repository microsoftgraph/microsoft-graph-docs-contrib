...
com.microsoft.graph.beta.users.item.checkmemberobjects.CheckMemberObjectsPostRequestBody checkMemberObjectsPostRequestBody = new com.microsoft.graph.beta.users.item.checkmemberobjects.CheckMemberObjectsPostRequestBody();
