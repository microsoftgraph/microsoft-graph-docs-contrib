...
com.microsoft.graph.models.tenantgovernanceservices.GovernancePolicyTemplate result = graphClient.directory().tenantGovernance().governancePolicyTemplates().byGovernancePolicyTemplateId("{governancePolicyTemplate-id}").patch(governancePolicyTemplate);
