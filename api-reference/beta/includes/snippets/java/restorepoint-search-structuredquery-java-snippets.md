...
RestoreSearchArtifactQueryExpression structuredQueryExpression = new RestoreSearchArtifactQueryExpression();
...
LinkedList<GranularRestoreItems> items = new LinkedList<GranularRestoreItems>();
items.add(GranularRestoreItems.Email);
