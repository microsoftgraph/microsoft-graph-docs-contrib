...
com.microsoft.graph.beta.users.item.calendar.getschedule.GetSchedulePostRequestBody getSchedulePostRequestBody = new com.microsoft.graph.beta.users.item.calendar.getschedule.GetSchedulePostRequestBody();
