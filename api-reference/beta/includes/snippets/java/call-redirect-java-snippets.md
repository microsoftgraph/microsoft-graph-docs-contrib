...
com.microsoft.graph.beta.communications.calls.item.redirect.RedirectPostRequestBody redirectPostRequestBody = new com.microsoft.graph.beta.communications.calls.item.redirect.RedirectPostRequestBody();
