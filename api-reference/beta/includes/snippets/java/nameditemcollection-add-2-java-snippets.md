...
com.microsoft.graph.beta.drives.item.items.item.workbook.names.addformulalocal.AddFormulaLocalPostRequestBody addFormulaLocalPostRequestBody = new com.microsoft.graph.beta.drives.item.items.item.workbook.names.addformulalocal.AddFormulaLocalPostRequestBody();
