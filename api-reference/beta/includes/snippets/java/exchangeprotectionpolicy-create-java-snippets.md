...
additionalData.put("userId", "cdd3a849-dcaf-4a85-af82-7e39fc14019a");
...
mailboxProtectionUnit1.setAdditionalData(additionalData1);
...
mailboxProtectionUnit2.setAdditionalData(additionalData2);
