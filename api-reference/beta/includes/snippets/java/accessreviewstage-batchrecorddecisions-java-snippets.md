...
com.microsoft.graph.beta.identitygovernance.accessreviews.definitions.item.instances.item.stages.item.batchrecorddecisions.BatchRecordDecisionsPostRequestBody batchRecordDecisionsPostRequestBody = new com.microsoft.graph.beta.identitygovernance.accessreviews.definitions.item.instances.item.stages.item.batchrecorddecisions.BatchRecordDecisionsPostRequestBody();
