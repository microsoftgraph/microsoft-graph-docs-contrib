...
learningContent.contentWebUrl = "https://docs.microsoft.com/en-us/learn/modules/manage-classes-resources-assessment-planning-beedle/";
...
learningContent.createdDateTime = OffsetDateTimeSerializer.deserialize("2018-01-01T00:00:00");
learningContent.lastModifiedDateTime = OffsetDateTimeSerializer.deserialize("2021-04-01T04:26:06.1995367Z");
learningContent.contributor = "Scott Simpson";
...
graphClient.employeeExperience().learningProviders("13727311-e7bb-470d-8b20-6a23d9030d70").learningContents("LP4471")
	.buildRequest()
