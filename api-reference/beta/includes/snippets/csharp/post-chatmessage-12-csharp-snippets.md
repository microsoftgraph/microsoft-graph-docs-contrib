...
var requestBody = new ChatMessage
{
	...
	HostedContents = new List<ChatMessageHostedContent>
	{
		...
		{
			ContentBytes = Convert.FromBase64String("iVBORw0KGgoAAAANSUhEUgAABWMAAAEMCAYAAAChuaTsAAAAAXNSR0IArs4c6QAAAARnQU1BA"),
		...
		new ChatMessageHostedContent
		{
			ContentBytes = Convert.FromBase64String("iVBORw0KGgoAAAANSUhEUgAAA5YAAAB4CAYAAACJrW0RAAAAAXNSR0IArs4c6QAAIABJREFUe"),
			ContentType = "image/png",
			AdditionalData = new Dictionary<string, object>
			{
				{
