...
### Response
If successful, this method returns `200, OK` response code and [group](./resources/group.md) collection object in the response body. The response will also include a nextLink URL or a deltaLink URL. 
