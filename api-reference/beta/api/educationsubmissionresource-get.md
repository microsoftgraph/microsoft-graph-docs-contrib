...
Retrieve the properties of a specific resource associated with a [submission](../resources/educationsubmissionresource.md). This operation can be performed by teacher, student and system.
