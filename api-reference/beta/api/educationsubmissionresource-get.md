...
The following example shows how to get the dependent [educationSubmissionResources](../resources/educationsubmissionresource.md) for a given submission resource.
