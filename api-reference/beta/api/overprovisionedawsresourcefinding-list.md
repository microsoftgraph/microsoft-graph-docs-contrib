...
-->
``` http
GET ** Collection URI for microsoft.graph.overprovisionedAwsResourceFinding not found
```
...
-->
``` http
GET https://graph.microsoft.com/beta** Collection URI for microsoft.graph.overprovisionedAwsResourceFinding not found
```
