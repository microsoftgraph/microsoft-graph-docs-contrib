...
-->
``` http
GET /users/{usersId}/employeeExperience/assignedRoles/{engagementRoleId}/members
```
...
-->
``` http
GET https://graph.microsoft.com/beta/me/employeeExperience/assignedRoles/{engagementRoleId}/members
```
