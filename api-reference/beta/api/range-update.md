...
<!-- { "blockType": "ignored" } -->
```http
PATCH /me/drive/root/workbook/names/{name}/range
PATCH /me/drive/root/workbook/worksheets/{id|name}/range(address='<address>')
PATCH /me/drive/root/workbook/tables/{id|name}/columns/{id|name}/range
```
