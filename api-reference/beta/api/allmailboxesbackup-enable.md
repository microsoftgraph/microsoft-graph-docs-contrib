...
<!-- {
  ...
  "name": "allmailboxesbackup-enable-permissions"
}
-->
[!INCLUDE [permissions-table](../includes/permissions/allmailboxesbackup-enable-permissions.md)]
...
<!-- {
  "blockType": "request",
  "name": "allmailboxesbackupthis.enable"
}
-->
``` http
