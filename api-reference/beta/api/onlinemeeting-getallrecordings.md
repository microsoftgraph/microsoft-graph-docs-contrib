...
description: "Get recordings from all online meetings that a user is a participant in."
author: "jacobsatora"
...
Get all recordings from private, scheduled [online meetings](../resources/onlinemeeting.md) that a user is an organizer of.
...
<!-- { "blockType": "ignored" } -->
```http
GET /users/{id}/online/getAllRecordings?$filter=MeetingOrganizerId%20eq%20'{id}'
```
...
If successful, this method returns a `200 OK` response code and a list of [callRecordings](../resources/callrecording.md) in the response body.
