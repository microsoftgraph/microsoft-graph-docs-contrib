---
title: "Update inactiveAwsResourceFinding"
description: "Update the properties of an inactiveAwsResourceFinding object."
...
# Update inactiveAwsResourceFinding
Namespace: microsoft.graph

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

Update the properties of an [inactiveAwsResourceFinding](../resources/inactiveawsresourcefinding.md) object.
...
If successful, this method returns a `200 OK` response code and an updated [inactiveAwsResourceFinding](../resources/inactiveawsresourcefinding.md) object in the response body.
...
<!-- {
  "blockType": "request",
  "name": "update_inactiveawsresourcefinding"
}
-->
``` http
