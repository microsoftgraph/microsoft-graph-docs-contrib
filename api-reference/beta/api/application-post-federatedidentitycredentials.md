...
|name|String|The unique identifier for the federated identity. Has a character limit of 120 characters and must be URL friendly (for example, not include spaces). Read-only after creation.|
