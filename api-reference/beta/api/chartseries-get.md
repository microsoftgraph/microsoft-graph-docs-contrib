...
```msgraph-interactive
GET https://graph.microsoft.com/beta/me/drive/items/{id}/workbook/worksheets/{id|name}/charts/{name}/series/{series-id}
```
...
# [CLI](#tab/cli)
[!INCLUDE [sample-code](../includes/snippets/cli/get-chartseries-cli-snippets.md)]
[!INCLUDE [sdk-documentation](../includes/snippets/snippets-sdk-documentation-link.md)]
...
# [Python](#tab/python)
[!INCLUDE [sample-code](../includes/snippets/python/get-chartseries-python-snippets.md)]
[!INCLUDE [sdk-documentation](../includes/snippets/snippets-sdk-documentation-link.md)]
