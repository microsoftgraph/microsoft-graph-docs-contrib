...
<!-- { "blockType": "permissions", "name": "mailsearchfolder_post_userconfigurations" } -->
...
[!INCLUDE [sample-code](../includes/snippets/javascript/create-userconfiguration-from--javascript-snippets.md)]
