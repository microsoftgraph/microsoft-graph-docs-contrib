---
title: "Update superAzureServicePrincipalFinding"
description: "Update the properties of a superAzureServicePrincipalFinding object."
...
# Update superAzureServicePrincipalFinding
Namespace: microsoft.graph

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

Update the properties of a [superAzureServicePrincipalFinding](../resources/superazureserviceprincipalfinding.md) object.
...
If successful, this method returns a `200 OK` response code and an updated [superAzureServicePrincipalFinding](../resources/superazureserviceprincipalfinding.md) object in the response body.
...
<!-- {
  "blockType": "request",
  "name": "update_superazureserviceprincipalfinding"
}
-->
``` http
