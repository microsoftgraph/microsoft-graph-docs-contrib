...
## Request body
In the request body, supply a JSON representation for the eBookGroupAssignment object.

The following table shows the properties that are required when you create the eBookGroupAssignment.
