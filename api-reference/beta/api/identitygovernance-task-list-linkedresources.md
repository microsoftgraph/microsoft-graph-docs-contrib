...
-->
``` http
GET /users/{usersId}/tasks/lists/{baseTaskListId}/tasks/{baseTaskId}/linkedResources
```
...
-->
``` http
GET https://graph.microsoft.com/beta/users/{usersId}/tasks/lists/{baseTaskListId}/tasks/{baseTaskId}/linkedResources
```
