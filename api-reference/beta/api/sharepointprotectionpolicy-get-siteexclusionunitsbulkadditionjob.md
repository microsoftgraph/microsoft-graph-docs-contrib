...
Get a [siteExclusionUnitsBulkAdditionJob](../resources/siteexclusionunitsbulkadditionjob.md) object associated with a [sharePointProtectionPolicy](../resources/sharepointprotectionpolicy.md).
...
<!-- { "blockType": "permissions", "name": "sharepointprotectionpolicy_get_siteexclusionunitsbulkadditionjob" } -->
[!INCLUDE [permissions-table](../includes/permissions/sharepointprotectionpolicy-get-siteexclusionunitsbulkadditionjob-permissions.md)]
...
<!-- {
  "blockType": "request",
  "name": "sharepointprotectionpolicy_get_siteexclusionunitsbulkadditionjob"
}
-->
```http
