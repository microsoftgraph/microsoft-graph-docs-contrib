...
|style|string|Constant value that represents the Table style. Possible values are: TableStyleLight1 thru TableStyleLight21, TableStyleMedium1 thru TableStyleMedium28, TableStyleDark1 thru TableStyleDark11. A custom user-defined style present in the workbook can also be specified.|
