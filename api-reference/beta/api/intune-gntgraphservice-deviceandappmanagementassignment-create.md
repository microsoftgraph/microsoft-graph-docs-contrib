---
title: "Create deviceAndAppManagementAssignment"
description: "Create a new deviceAndAppManagementAssignment object."
author: "jaiprakashmb"
...
# Create deviceAndAppManagementAssignment
...
Create a new [deviceAndAppManagementAssignment](../resources/intune-gntgraphservice-deviceandappmanagementassignment.md) object.
...
-->
```http
POST /deviceManagement/targetPayloadAssignments
```
...
## Request body
In the request body, supply a JSON representation for the deviceAndAppManagementAssignment object.

The following table shows the properties that are required when you create the deviceAndAppManagementAssignment.
...
## Response
If successful, this method returns a `201 Created` response code and a [deviceAndAppManagementAssignment](../resources/intune-gntgraphservice-deviceandappmanagementassignment.md) object in the response body.
...
```http
POST https://graph.microsoft.com/beta/deviceManagement/targetPayloadAssignments
