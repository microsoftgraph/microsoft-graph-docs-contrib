...
Update the properties of a [sharedPCConfiguration](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_deviceconfig_sharedpcconfiguration.md) object.
## Prerequisites
...
## Request body
In the request body, supply a JSON representation of a [sharedPCConfiguration](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_deviceconfig_sharedpcconfiguration.md) object.
The following table shows the properties that are required when you create a [sharedPCConfiguration](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_deviceconfig_sharedpcconfiguration.md).
...
## Response
If successful, this method returns a `200 OK` response code and an updated [sharedPCConfiguration](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_deviceconfig_sharedpcconfiguration.md) object in the response body.
