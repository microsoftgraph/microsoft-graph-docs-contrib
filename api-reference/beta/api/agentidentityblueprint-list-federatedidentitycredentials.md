---
title: "List agentIdentityBlueprint federatedIdentityCredentials"
description: "Get a list of the federatedIdentityCredential objects and their properties for agentIdentityBlueprints."
author: "nickludwig"
...
# List agentIdentityBlueprint federatedIdentityCredentials
Namespace: microsoft.graph

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

Get a list of the [federatedIdentityCredential](../resources/federatedidentitycredential.md) objects and their properties for an [agentIdentityBlueprint](../resources/agentidentityblueprint.md).
...
<!-- { "blockType": "permissions", "name": "agentidentityblueprint_list_federatedidentitycredentials" } -->
...
This method supports the `$filter` (`eq`) and `$select` [OData query parameters](/graph/query-parameters) to help customize the response. For example, `/applications/{id}/microsoft.graph.agentIdentityBlueprint/federatedIdentityCredentials?$filter=subject eq 'value'`.
...
<!-- {
  "blockType": "request",
  "name": "list_agentidentityblueprint_federatedidentitycredential"
}
-->
``` http
...
[!INCLUDE [sample-code](../includes/snippets/javascript/list-agentidentityblueprint-federatedidentitycredential-javascript-snippets.md)]
