...
description: "Offboards the specified managed tenant from the multi-tenant management platform."
...
Offboards the specified managed tenant from the multi-tenant management platform.
