---
title: "Post update policy approval"
description: "Create a new policy approval object."
author: "andredm7"
ms.date: 10/08/2025
...
|:---|:---|:---|
|catalogEntryId|String| The unique identifier for the catalog entry. Required.|
...
|lastModifiedDateTime|DateTimeOffset| The date and time the policy approval was last modified. The Timestamp type represents date and time information using ISO 8601 format and is always in UTC time. For example, midnight UTC on Jan 1, `2014 is 2014-01-01T00:00:00Z`. Optional.|
