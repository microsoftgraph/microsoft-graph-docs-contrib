...
If successful, this method returns a `200 OK` response code and the requested [microsoft.graph.externalConnectors.schema](../resources/schema.md) object in the response body.
