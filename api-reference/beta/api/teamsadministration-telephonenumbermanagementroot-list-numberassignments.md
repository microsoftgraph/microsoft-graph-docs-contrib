...
If successful, this method returns a `200 OK` response code and a collection of [numberAssignment](../resources/numberassignment.md) objects in the response body.
