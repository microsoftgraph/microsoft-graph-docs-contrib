...
<!-- { "blockType": "ignored" } -->
```http
POST /me/drive/root/workbook/names/{name}/range/clear
POST /me/drive/root/workbook/worksheets/{id|name}/range(address='<address>')/clear
POST /me/drive/root/workbook/tables/{id|name}/columns/{id|name}/range/clear
