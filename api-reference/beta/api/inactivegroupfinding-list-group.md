...
description: "Get the authorizationSystemIdentity resources from the group navigation property."
author: "ashyasingh"
...
Get the authorizationSystemIdentity resources from the group navigation property.
...
-->
``` http
GET /inactiveGroupFinding/group
```
...
-->
``` http
GET https://graph.microsoft.com/beta/inactiveGroupFinding/group
```
