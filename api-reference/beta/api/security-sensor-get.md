...
This method supports the following OData query parameters to help customize the response: select, expand. For general information, see [OData query parameters](/graph/query-parameters).
