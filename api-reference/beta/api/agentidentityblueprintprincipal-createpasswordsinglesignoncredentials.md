...
```http
POST /servicePrincipals/{id}/Microsoft.Graph.AgentIdentityBlueprintPrincipal/createPasswordSingleSignOnCredentials
POST /servicePrincipals(appId='{appId}')/Microsoft.Graph.AgentIdentityBlueprintPrincipal/createPasswordSingleSignOnCredentials
```
...
```http
POST https://graph.microsoft.com/beta/servicePrincipals/{id}/Microsoft.Graph.AgentIdentityBlueprintPrincipal/createPasswordSingleSignOnCredentials
