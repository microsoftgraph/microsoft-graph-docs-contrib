...
| isAllDay|Boolean|Set to true if the event lasts all day. If true, irrespective of whether single day or multi-day event, start and end time must be set to mid-night and in same   time-zone.|
