...
List properties and relationships of the [windowsManagedDevice](../resources/intune_devicefe_windowsmanageddevice.md) objects.
## Prerequisites
...
## Response
If successful, this method returns a `200 OK` response code and a collection of [windowsManagedDevice](../resources/intune_devicefe_windowsmanageddevice.md) objects in the response body.
