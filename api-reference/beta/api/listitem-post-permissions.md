---
title: "Create listitem permission"
...
>**Note:** You can only use this method to create a new application permission; you can't use it to create a new user list item permission.
...
-->
``` http
POST https://graph.microsoft.com/beta/sites/f2d90359-865b-4b6c-8848-d2722dd630e5/lists/1d702d60-503c-4924-cbfd-028c65fc89ed/items/3/permissions
