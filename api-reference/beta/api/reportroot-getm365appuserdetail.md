...
description: "Get details about which apps and flatforms users have used."
...
Get details about which apps and flatforms users have used.
...
GET /reports/getM365AppUserDetail(date='{period_value}')
```
