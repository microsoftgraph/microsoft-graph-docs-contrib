...
description: "Read the properties and relationships of a microsoft.graph.security.hostTracker object."
...
Read the properties and relationships of a [microsoft.graph.security.hostTracker](../resources/security-hosttracker.md) object.
...
-->
``` http
GET https://graph.microsoft.com/beta/security/threatIntelligence/hostTrackers/{hostTrackerId}
```
