...
If successful, this method returns a `200 OK` response code and a collection of [categoryTemplate](../resources/categorytemplate.md) objects in the response body.
