---
title: "Update superGcpServiceAccountFinding"
description: "Update the properties of a superGcpServiceAccountFinding object."
...
# Update superGcpServiceAccountFinding
Namespace: microsoft.graph

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

Update the properties of a [superGcpServiceAccountFinding](../resources/supergcpserviceaccountfinding.md) object.
...
If successful, this method returns a `200 OK` response code and an updated [superGcpServiceAccountFinding](../resources/supergcpserviceaccountfinding.md) object in the response body.
...
<!-- {
  "blockType": "request",
  "name": "update_supergcpserviceaccountfinding"
}
-->
``` http
