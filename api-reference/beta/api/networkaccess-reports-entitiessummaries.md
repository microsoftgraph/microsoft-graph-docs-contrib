...
description: "Get the number of users, devices, and workloads counts per traffic type in a specified time period."
author: Moti-ba
...
Get the number of users, devices, and workloads counts per traffic type in a specified time period.
