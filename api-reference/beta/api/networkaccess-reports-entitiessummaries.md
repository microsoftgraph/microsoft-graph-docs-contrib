...
description: "Get a summary on the unique count of the entities that are calculated per traffic type."
author: Moti-ba
...
Get a summary on the unique count of the entities that are calculated per traffic type.
