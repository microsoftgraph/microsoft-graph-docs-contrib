...
<!-- {
  ...
  "name": "videonewslinkpage-list-createdbyuser-permissions"
}
-->
[!INCLUDE [permissions-table](../includes/permissions/videonewslinkpage-list-createdbyuser-permissions.md)]
...
-->
``` http
GET /videoNewsLinkPage/createdByUser
```
...
-->
``` http
GET https://graph.microsoft.com/beta/videoNewsLinkPage/createdByUser
```
