---
title: "Update gcpAuthorizationSystemTypeAction"
description: "Update the properties of a gcpAuthorizationSystemTypeAction object."
...
# Update gcpAuthorizationSystemTypeAction
Namespace: microsoft.graph

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

Update the properties of a [gcpAuthorizationSystemTypeAction](../resources/gcpauthorizationsystemtypeaction.md) object.
...
-->
``` http
PATCH /gcpAuthorizationSystemTypeAction
```
...
If successful, this method returns a `200 OK` response code and an updated [gcpAuthorizationSystemTypeAction](../resources/gcpauthorizationsystemtypeaction.md) object in the response body.
...
<!-- {
  "blockType": "request",
  "name": "update_gcpauthorizationsystemtypeaction"
}
-->
``` http
PATCH https://graph.microsoft.com/beta/gcpAuthorizationSystemTypeAction
