...
Create a new [iosEnterpriseWiFiConfiguration](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_deviceconfig_iosenterprisewificonfiguration.md) object.
## Prerequisites
...
## Response
If successful, this method returns a `201 Created` response code and a [iosEnterpriseWiFiConfiguration](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_deviceconfig_iosenterprisewificonfiguration.md) object in the response body.
