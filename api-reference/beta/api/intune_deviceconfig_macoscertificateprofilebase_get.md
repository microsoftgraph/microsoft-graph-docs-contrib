...
Read properties and relationships of the [macOSCertificateProfileBase](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_deviceconfig_macoscertificateprofilebase.md) object.
## Prerequisites
...
## Response
If successful, this method returns a `200 OK` response code and [macOSCertificateProfileBase](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_deviceconfig_macoscertificateprofilebase.md) object in the response body.
