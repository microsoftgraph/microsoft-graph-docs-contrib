...
-->
```http
GET /iosMobileAppConfigurations/{iosMobileAppConfigurationsId}/deviceStatuses/
...
```http
GET https://graph.microsoft.com/beta/iosMobileAppConfigurations/{iosMobileAppConfigurationsId}/deviceStatuses/
```
