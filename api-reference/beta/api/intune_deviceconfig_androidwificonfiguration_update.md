...
Update the properties of a [androidWiFiConfiguration](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_deviceconfig_androidwificonfiguration.md) object.
## Prerequisites
...
## Request body
In the request body, supply a JSON representation of a [androidWiFiConfiguration](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_deviceconfig_androidwificonfiguration.md) object.
The following table shows the properties that are required when you create a [androidWiFiConfiguration](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_deviceconfig_androidwificonfiguration.md).
...
## Response
If successful, this method returns a `200 OK` response code and an updated [androidWiFiConfiguration](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_deviceconfig_androidwificonfiguration.md) object in the response body.
