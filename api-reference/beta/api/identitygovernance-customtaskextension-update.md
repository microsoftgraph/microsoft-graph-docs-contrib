...
### Example 1- Update a custom task extension using the AzureADTokenAuthentication configuration type
...
### Example 2 - Update a custom task extension using the azureADPopTokenAuthentication configuration type
...
<!-- {
  "blockType": "request",
  "name": "lifecycleworkflows_update_customtaskextension_azureADPopTokenAuthentication"
}
-->
``` http
PATCH https://graph.microsoft.com/beta/identityGovernance/lifecycleWorkflows/customTaskExtensions/ffcc4c85-5a14-448e-a390-77abf2700369
