...
Create a new [androidDeviceOwnerWiFiConfiguration](../resources/intune_deviceconfig_androiddeviceownerwificonfiguration.md) object.
## Prerequisites
...
## Response
If successful, this method returns a `201 Created` response code and a [androidDeviceOwnerWiFiConfiguration](../resources/intune_deviceconfig_androiddeviceownerwificonfiguration.md) object in the response body.
