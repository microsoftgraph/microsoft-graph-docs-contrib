...
description: "Update the properties of an exchangeRestoreSession object."
...
Update the properties of an [exchangeRestoreSession](../resources/exchangerestoresession.md) object.
...
<!-- {
  "blockType": "request",
  "name": "update_exchangerestoresession"
}
-->
``` http
