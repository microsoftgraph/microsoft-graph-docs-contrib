---
title: "Update fileContentThreatSubmission"
description: "Update the properties of a fileContentThreatSubmission object."
...
# Update fileContentThreatSubmission
Namespace: microsoft.graph.security

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

Update the properties of a [fileContentThreatSubmission](../resources/security-filecontentthreatsubmission.md) object.
...
-->
``` http
PATCH /fileContentThreatSubmission
```
...
If successful, this method returns a `200 OK` response code and an updated [fileContentThreatSubmission](../resources/security-filecontentthreatsubmission.md) object in the response body.
...
<!-- {
  "blockType": "request",
  "name": "update_filecontentthreatsubmission"
}
-->
``` http
PATCH https://graph.microsoft.com/beta/fileContentThreatSubmission
