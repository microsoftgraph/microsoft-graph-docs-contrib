...
|Get a known resource instance expanded with a specific extension.|Administrative unit, base task, base task list, device, drive item, event, group, group event, group post, message, organization, personal contact, to-do task, to-do task list, and user. |A resource instance expanded with the open extension.|
