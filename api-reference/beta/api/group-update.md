...
| welcomeMessageEnabled   | Boolean | Default is `false`. Indicates whether a welcome message is sent to new members when they are added to the group.                                                                                                                                                                                                                                                                                    |
...
> [!IMPORTANT]
> - To update these properties (**allowExternalSenders**, **autoSubscribeNewMembers**, **hideFromAddressLists**, **hideFromOutlookClients**, **welcomeMessageEnabled**, **isSubscribedByMail**, **unseenCount**), you must:
...
If successful, this method returns a `204 No Content` response code—except a `200 OK` response code when updating the following properties: **allowExternalSenders**, **autoSubscribeNewMembers**, **hideFromAddressLists**, **hideFromOutlookClients**, **welcomeMessageEnabled**, **isSubscribedByMail**, **unseenCount**.
