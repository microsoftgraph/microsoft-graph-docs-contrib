---
title: "Get levelMap"
description: "Get a levelMap object in IMDF format."
...
Get a [levelMap](../resources/levelmap.md) object in IMDF format.
...
-->
``` http
GET places/151e85a7-c0b8-4519-997e-1a0858255704/microsoft.graph.building/map/levels
```
