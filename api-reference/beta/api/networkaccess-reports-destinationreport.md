...
Retrieve a report containing information about all [outgoing network connections](../resources/networkaccess-destination.md) within a specified time frame, as logged in Global Secure Access.
