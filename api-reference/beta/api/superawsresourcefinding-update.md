---
title: "Update superAwsResourceFinding"
description: "Update the properties of a superAwsResourceFinding object."
...
# Update superAwsResourceFinding
Namespace: microsoft.graph

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

Update the properties of a [superAwsResourceFinding](../resources/superawsresourcefinding.md) object.
...
If successful, this method returns a `200 OK` response code and an updated [superAwsResourceFinding](../resources/superawsresourcefinding.md) object in the response body.
...
<!-- {
  "blockType": "request",
  "name": "update_superawsresourcefinding"
}
-->
``` http
