...
|channel|[microsoftEdgeChannel](../resources/intune-apps-microsoftedgechannel.md)|The channel to install on target devices. The possible values are: `dev`, `beta`, `stable`, `unknownFutureValue`.|
