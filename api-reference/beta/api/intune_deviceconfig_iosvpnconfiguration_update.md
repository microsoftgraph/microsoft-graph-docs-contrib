...
Update the properties of a [iosVpnConfiguration](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_deviceconfig_iosvpnconfiguration.md) object.
## Prerequisites
...
## Request body
In the request body, supply a JSON representation of a [iosVpnConfiguration](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_deviceconfig_iosvpnconfiguration.md) object.
The following table shows the properties that are required when you create a [iosVpnConfiguration](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_deviceconfig_iosvpnconfiguration.md).
...
## Response
If successful, this method returns a `200 OK` response code and an updated [iosVpnConfiguration](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_deviceconfig_iosvpnconfiguration.md) object in the response body.
