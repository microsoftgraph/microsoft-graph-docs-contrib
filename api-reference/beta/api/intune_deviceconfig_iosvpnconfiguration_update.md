...
## Request body
In the request body, supply a JSON representation of a [iosVpnConfiguration](../resources/intune_deviceconfig_iosvpnconfiguration.md) object.
The following table shows the properties that are required when you create a [iosVpnConfiguration](../resources/intune_deviceconfig_iosvpnconfiguration.md).
