...
|customerTimeZone|String|The customer's timezone. The format/value of time zone would be the standard followed in graph as mentioned: [dateTimeTimeZone](../resources/datetimetimezone.md).|
