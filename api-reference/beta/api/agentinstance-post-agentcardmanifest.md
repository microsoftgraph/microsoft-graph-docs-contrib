---
title: "Add agentCardManifest"
description: "Add agentCardManifest by posting to the agentCardManifest collection."
author: "jasondou"
ms.date: 11/06/2025
...
Add agentCardManifest by posting to the agentCardManifest collection.
...
<!-- {
  ...
  "name": "agentinstance-post-agentcardmanifest-permissions"
}
-->
[!INCLUDE [permissions-table](../includes/permissions/agentinstance-post-agentcardmanifest-permissions.md)]
...
-->
``` http
POST /agentRegistry/agentInstances/{agentInstanceId}/agentCardManifest/$ref
```
...
If successful, this method returns a `204 No Content` response code and an [agentCardManifest](../resources/agentcardmanifest.md) object in the response body.
...
-->
``` http
POST https://graph.microsoft.com/beta/agentRegistry/agentInstances/{agentInstanceId}/agentCardManifest/$ref
