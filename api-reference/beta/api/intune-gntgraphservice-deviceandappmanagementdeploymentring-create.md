---
title: "Create deviceAndAppManagementDeploymentRing"
description: "Create a new deviceAndAppManagementDeploymentRing object."
author: "jaiprakashmb"
...
Create a new [deviceAndAppManagementDeploymentRing](../resources/intune-gntgraphservice-deviceandappmanagementdeploymentring.md) object.
...
-->
```http
POST /deviceManagement/deployments/{deviceAndAppManagementDeploymentId}/rings
```
...
## Request body
In the request body, supply a JSON representation for the deviceAndAppManagementDeploymentRing object.

The following table shows the properties that are required when you create the deviceAndAppManagementDeploymentRing.
...
## Response
If successful, this method returns a `201 Created` response code and a [deviceAndAppManagementDeploymentRing](../resources/intune-gntgraphservice-deviceandappmanagementdeploymentring.md) object in the response body.
...
```http
POST https://graph.microsoft.com/beta/deviceManagement/deployments/{deviceAndAppManagementDeploymentId}/rings
