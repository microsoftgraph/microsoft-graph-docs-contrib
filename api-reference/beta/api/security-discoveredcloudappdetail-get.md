...
> **Note:** The **period** parameter is of type Duration. It provides the time frame in which you want to query the data. The supported time frames are the last 7, 30, or 90 days.
