...
Create a new [windowsRestoreDeviceEnrollmentConfiguration](../resources/intune-onboarding-windowsrestoredeviceenrollmentconfiguration.md) object.
...
## Response
If successful, this method returns a `201 Created` response code and a [windowsRestoreDeviceEnrollmentConfiguration](../resources/intune-onboarding-windowsrestoredeviceenrollmentconfiguration.md) object in the response body.
