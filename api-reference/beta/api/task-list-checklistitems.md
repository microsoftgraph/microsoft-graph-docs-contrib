...
-->
``` http
GET /user/tasks/lists/{baseTaskListId}/tasks/{baseTaskId}/checklistItems
```
...
-->
``` http
GET https://graph.microsoft.com/beta/user/tasks/lists/{baseTaskListId}/tasks/{baseTaskId}/checklistItems
```
