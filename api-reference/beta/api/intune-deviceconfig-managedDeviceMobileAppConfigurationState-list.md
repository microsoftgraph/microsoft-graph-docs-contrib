...
List properties and relationships of the managedDeviceMobileAppConfigurationState objects.
...
## Response
If successful, this method returns a `200 OK` response code and a collection of managedDeviceMobileAppConfigurationState objects in the response body.
