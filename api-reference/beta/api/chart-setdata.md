...
|seriesBy|string|Optional. Specifies the way columns or rows are used as data series on the chart, which can be one of the following values: `Auto`, `Columns`, `Rows`.|
