...
-->
``` http
DELETE /identityGovernance/lifecycleWorkflows/workflows/{workflowId}/$ref
DELETE /identityGovernance/lifecycleWorkflows/deletedItems/workflows/{workflowId}/$ref
```
