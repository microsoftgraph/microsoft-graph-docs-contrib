...
> [!IMPORTANT]
> The support for application permissions in this API ends on January 1, 2026. To confirm a timeCard with application permissions, use [/confirmForUser](timecard-confirmForUser.md) instead.
