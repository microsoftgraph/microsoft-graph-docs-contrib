...
If successful, this method returns a `200 OK` response code and a collection of [branchSite](../resources/networkaccess-branchsite.md) objects in the response body.
