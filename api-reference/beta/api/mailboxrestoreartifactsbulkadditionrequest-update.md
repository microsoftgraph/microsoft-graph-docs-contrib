---
title: "Update mailboxRestoreArtifactsBulkAdditionRequest"
description: "Update the properties of a mailboxRestoreArtifactsBulkAdditionRequest object."
...
# Update mailboxRestoreArtifactsBulkAdditionRequest

Namespace: microsoft.graph

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

Update the properties of a [mailboxRestoreArtifactsBulkAdditionRequest](../resources/mailboxrestoreartifactsbulkadditionrequest.md) object.
...
<!-- {
  ...
  "name": "mailboxrestoreartifactsbulkadditionrequest-update-permissions"
}
-->
[!INCLUDE [permissions-table](../includes/permissions/mailboxrestoreartifactsbulkadditionrequest-update-permissions.md)]
...
-->
``` http
PATCH /solutions/backupRestore/exchangeRestoreSessions/{exchangeRestoreSessionId}/mailboxRestoreArtifactsBulkAdditionRequests/{mailboxRestoreArtifactsBulkAdditionRequestId}
```
...
If successful, this method returns a `200 OK` response code and an updated [mailboxRestoreArtifactsBulkAdditionRequest](../resources/mailboxrestoreartifactsbulkadditionrequest.md) object in the response body.
...
<!-- {
  "blockType": "request",
  "name": "update_mailboxrestoreartifactsbulkadditionrequest"
}
-->
``` http
PATCH https://graph.microsoft.com/beta/solutions/backupRestore/exchangeRestoreSessions/{exchangeRestoreSessionId}/mailboxRestoreArtifactsBulkAdditionRequests/{mailboxRestoreArtifactsBulkAdditionRequestId}
