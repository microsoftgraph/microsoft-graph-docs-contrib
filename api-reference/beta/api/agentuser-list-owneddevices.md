...
description: "Get the list of devices that are owned by the agent user."
author: "yyuank"
ms.reviewer: "iamut"
ms.date: 11/06/2025
...
<!-- {
  ...
  "name": "agentuser-list-owneddevices-permissions"
}
-->
[!INCLUDE [permissions-table](../includes/permissions/agentuser-list-owneddevices-permissions.md)]
