...
-->
``` http
GET https://graph.microsoft.com/identityGovernance/permissionsAnalytics/aws/findings/graph.superAwsRoleFinding/aggregatedSummary
```
...
-->
``` http
GET https://graph.microsoft.com/identityGovernance/permissionsAnalytics/aws/findings/graph.superAwsRoleFinding/aggregatedSummary(authorizationSystemIds=[
  "String"
])
```
