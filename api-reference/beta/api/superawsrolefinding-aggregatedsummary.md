...
-->
``` http
GET https://graph.microsoft.com/identityGovernance/permissionsAnalytics/aws/findings/graph.superAwsRoleFinding/aggregatedSummary(authorizationSystemIds=['377596131774'])
```
