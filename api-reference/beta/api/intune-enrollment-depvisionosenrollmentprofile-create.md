...
# Create depVisionOSEnrollmentProfile
...
Create a new [depVisionOSEnrollmentProfile](../resources/intune-enrollment-depvisionosenrollmentprofile.md) object.
...
## Request body
In the request body, supply a JSON representation for the depVisionOSEnrollmentProfile object.

The following table shows the properties that are required when you create the depVisionOSEnrollmentProfile.
...
## Response
If successful, this method returns a `201 Created` response code and a [depVisionOSEnrollmentProfile](../resources/intune-enrollment-depvisionosenrollmentprofile.md) object in the response body.
