...
Update the properties of a [iosEduDeviceConfiguration](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_deviceconfig_iosedudeviceconfiguration.md) object.
## Prerequisites
...
## Request body
In the request body, supply a JSON representation of a [iosEduDeviceConfiguration](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_deviceconfig_iosedudeviceconfiguration.md) object.
The following table shows the properties that are required when you create a [iosEduDeviceConfiguration](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_deviceconfig_iosedudeviceconfiguration.md).
...
## Response
If successful, this method returns a `200 OK` response code and an updated [iosEduDeviceConfiguration](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_deviceconfig_iosedudeviceconfiguration.md) object in the response body.
