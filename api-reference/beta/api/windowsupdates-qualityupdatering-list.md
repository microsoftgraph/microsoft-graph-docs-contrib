...
If successful, this method returns a `200 OK` response code and a collection of [qualityUpdateRing](../resources/qualityupdatering.md) objects in the response body.
