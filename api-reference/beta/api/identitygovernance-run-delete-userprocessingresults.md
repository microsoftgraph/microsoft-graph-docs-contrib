...
-->
``` http
DELETE /workflowBase/userProcessingResults/{userProcessingResultId}/$ref
```
...
-->
``` http
DELETE https://graph.microsoft.com/beta/workflowBase/userProcessingResults/{userProcessingResultId}
```
