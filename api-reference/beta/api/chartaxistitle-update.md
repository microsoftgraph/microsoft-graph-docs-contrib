...
<!-- { "blockType": "ignored" } -->
```http
PATCH /me/drive/root/workbook/worksheets/{id|name}/charts/{name}/axes/valueaxis/title
PATCH /me/drive/root/workbook/worksheets/{id|name}/charts/{name}/axes/seriesaxis/title
PATCH /me/drive/root/workbook/worksheets/{id|name}/charts/{name}/axes/categoryaxis/title
```
