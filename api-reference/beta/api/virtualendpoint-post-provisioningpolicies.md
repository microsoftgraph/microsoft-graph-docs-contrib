...
|userSettingsPersistenceConfiguration|[cloudPcUserSettingsPersistenceConfiguration](../resources/cloudpcusersettingspersistenceconfiguration.md)|Indicates specific settings which enable persisting user application settings between Cloud PC sessions. The default value is `null`, this feature is only available for Cloud PC provisioning policies of type `sharedByEntraGroup`. Optional.|
