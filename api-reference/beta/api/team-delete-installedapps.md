...
> **Note:** The Group.ReadWrite.All and Directory.ReadWrite.All permission are supported only for backward compatibility. We recommend that you update your solutions to use an alternative permission listed in the previous table and avoid using these permissions going forward.
...
# [Python](#tab/python)
[!INCLUDE [sample-code](../includes/snippets/python/uninstall-teamsapp-in-team-python-snippets.md)]
[!INCLUDE [sdk-documentation](../includes/snippets/snippets-sdk-documentation-link.md)]
