...
description: "Read the properties and relationships of a microsoft.graph.security.hostCookie object."
...
Read the properties and relationships of a [microsoft.graph.security.hostCookie](../resources/security-hostcookie.md) object.
...
-->
``` http
GET https://graph.microsoft.com/beta/security/threatIntelligence/hostCookies/{hostCookieId}
```
