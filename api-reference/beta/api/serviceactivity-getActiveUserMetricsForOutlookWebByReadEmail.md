...
description: "This operation gets all the active usage based on the number of users that successfully read emails using Outlook for the web."
author: "mkuninty"
...
This operation gets all the active usage based on the number of users that successfully read emails using Outlook for the web.
