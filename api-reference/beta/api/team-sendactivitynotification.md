...
Sends an activity feed notification in scope of a team. For more details about sending notifications and the requirements for the same, refer to the documentation
