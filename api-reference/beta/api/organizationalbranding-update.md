...
| contentCustomization | [contentCustomization](../resources/contentCustomization.md) | Represents the various content options to be customized throughout authentication for a tenant. <br/><br/>**NOTE:** Supported by 'Azure Active Directory for customers' tenants only. |
