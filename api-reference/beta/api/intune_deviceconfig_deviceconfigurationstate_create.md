...
-->
``` http
POST /deviceManagement/managedDevices/{managedDeviceId}/deviceConfigurationStates
```
...
``` http
POST https://graph.microsoft.com/beta/deviceManagement/managedDevices/{managedDeviceId}/deviceConfigurationStates
