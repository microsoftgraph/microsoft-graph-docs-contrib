...
Update the properties of a [androidLobApp](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_apps_androidlobapp.md) object.
## Prerequisites
...
## Request body
In the request body, supply a JSON representation of a [androidLobApp](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_apps_androidlobapp.md) object.
The following table shows the properties that are required when you create a [androidLobApp](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_apps_androidlobapp.md).
...
## Response
If successful, this method returns a `200 OK` response code and an updated [androidLobApp](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_apps_androidlobapp.md) object in the response body.
