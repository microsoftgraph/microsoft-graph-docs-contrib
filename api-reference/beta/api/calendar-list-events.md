...
GET https://graph.microsoft.com/beta/me/calendar/events?$filter=startsWith(subject,'All')&messages?$filter=from/emailAddress/address eq 'Michael.Fanning@microsoft.com'
```
## Optional query parameters
