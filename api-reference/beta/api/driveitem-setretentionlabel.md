...
Microsoft SharePoint and OneDrive APIs that perform advanced premium administrative functions are considered [Premium metered APIs](/graph/metered-api-overview). These APIs will monetized through Azure commerce meters and require you to have a valid Azure subscription. Proposed pricing at general availability (GA) is to be determined.
