...
Create a new [sharedPCConfiguration](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_deviceconfig_sharedpcconfiguration.md) object.
## Prerequisites
...
|accountManagerPolicy|[sharedPCAccountManagerPolicy](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_deviceconfig_sharedpcaccountmanagerpolicy.md)|Specifies how accounts are managed on a shared PC. Only applies when disableAccountManager is false.|
...
## Response
If successful, this method returns a `201 Created` response code and a [sharedPCConfiguration](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_deviceconfig_sharedpcconfiguration.md) object in the response body.
