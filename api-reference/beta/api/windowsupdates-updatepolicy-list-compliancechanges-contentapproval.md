...
If successful, this method returns a `200 OK` response code and a collection of [contentApproval](../resources/windowsupdates-contentapproval.md) objects in the response body.
