...
-->
```http
GET /managedAppPolicies/{managedAppPoliciesId}/mobileAppIdentifierDeployments/
```
...
```http
GET https://graph.microsoft.com/beta/managedAppPolicies/{managedAppPoliciesId}/mobileAppIdentifierDeployments/
```
