...
Update the properties of a [iosUpdateConfiguration](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_deviceconfig_iosupdateconfiguration.md) object.
## Prerequisites
...
## Request body
In the request body, supply a JSON representation of a [iosUpdateConfiguration](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_deviceconfig_iosupdateconfiguration.md) object.
The following table shows the properties that are required when you create a [iosUpdateConfiguration](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_deviceconfig_iosupdateconfiguration.md).
...
## Response
If successful, this method returns a `200 OK` response code and an updated [iosUpdateConfiguration](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_deviceconfig_iosupdateconfiguration.md) object in the response body.
