...
<!-- {
  ...
  "name": "engagementrolemember-list-user-permissions"
}
-->
[!INCLUDE [permissions-table](../includes/permissions/engagementrolemember-list-user-permissions.md)]
...
-->
``` http
GET /users/{usersId}/employeeExperience/assignedRoles/{engagementRoleId}/members/{engagementRoleMemberId}/user
```
...
-->
``` http
GET https://graph.microsoft.com/beta/users/{usersId}/employeeExperience/assignedRoles/{engagementRoleId}/members/{engagementRoleMemberId}/user
```
