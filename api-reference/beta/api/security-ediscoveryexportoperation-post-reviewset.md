...
-->
``` http
POST /ediscoveryExportOperation/reviewSet/$ref
```
...
If successful, this method returns a `204 No Content` response code and an [ediscoveryReviewSet](../resources/security-ediscoveryreviewset.md) object in the response body.
...
-->
``` http
POST https://graph.microsoft.com/beta/ediscoveryExportOperation/reviewSet/$ref
