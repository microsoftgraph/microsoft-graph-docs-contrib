---
title: "Create userAttributeAssignments in b2cIdentityUserFlow"
...
# Create userAttributeAssignments in b2cIdentityUserFlow
...
Content-Type: application/json
Location /identity/b2cUserFlows('B2C_1_Consumer')/assignments('extension_guid_shoeSize')
