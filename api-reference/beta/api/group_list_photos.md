...
<!-- { "blockType": "ignored" } -->
```http
GET /groups/users/<id | userPrincipalName>/photos
GET /users/<id | userPrincipalName>/joinedGroups/users/<id | userPrincipalName>/photos
GET /drive/root/createdByUser/joinedGroups/users/<id | userPrincipalName>/photos
```
