...
> - If you want to use the Microsoft Graph reports API to get usage data for unlicensed Copilot users, see [Programmatically export unlicensed Copilot Chat usage](../resources/report.md#programmatically-export-unlicensed-copilot-chat-usage)
