---
title: "retrieveManagedDevicesWithAppInstallationIssues function"
...
# retrieveManagedDevicesWithAppInstallationIssues function
...
-->
```http
GET /users/{usersId}/retrieveManagedDevicesWithAppInstallationIssues
```
...
```http
GET https://graph.microsoft.com/beta/users/{usersId}/retrieveManagedDevicesWithAppInstallationIssues
```
