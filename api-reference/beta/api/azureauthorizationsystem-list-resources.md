...
-->
``` http
GET /external/authorizationSystems/{id}/graph.azureAuthorizationSystem/resources
```
...
-->
``` http
GET https://graph.microsoft.com/beta/external/authorizationSystems/{id}/graph.azureAuthorizationSystem/resources
```
