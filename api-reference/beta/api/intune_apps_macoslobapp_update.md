...
Update the properties of a [macOSLobApp](../resources/intune_apps_macoslobapp.md) object.
## Prerequisites
...
## Request body
In the request body, supply a JSON representation for the [macOSLobApp](../resources/intune_apps_macoslobapp.md) object.

The following table shows the properties that are required when you create the [macOSLobApp](../resources/intune_apps_macoslobapp.md).
...
## Response
If successful, this method returns a `200 OK` response code and an updated [macOSLobApp](../resources/intune_apps_macoslobapp.md) object in the response body.
