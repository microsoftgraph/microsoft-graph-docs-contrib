---
title: "Update secretInformationAccessAwsUserFinding"
description: "Update the properties of a secretInformationAccessAwsUserFinding object."
...
Update the properties of a [secretInformationAccessAwsUserFinding](../resources/secretinformationaccessawsuserfinding.md) object.
...
If successful, this method returns a `200 OK` response code and an updated [secretInformationAccessAwsUserFinding](../resources/secretinformationaccessawsuserfinding.md) object in the response body.
...
<!-- {
  "blockType": "request",
  "name": "update_secretinformationaccessawsuserfinding"
}
-->
``` http
