...
> **Important:** When you use Schedule.ReadWrite.All application permission, you must include the `MS-APP-ACTS-AS` header in the request.
...
# [CLI](#tab/cli)
[!INCLUDE [sample-code](../includes/snippets/cli/timecard-startbreak-cli-snippets.md)]
[!INCLUDE [sdk-documentation](../includes/snippets/snippets-sdk-documentation-link.md)]
