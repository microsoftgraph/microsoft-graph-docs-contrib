...
# agentIdentityBlueprintPrincipal: addTokenSigningCertificate
...
<!-- {
  ...
  "name": "agentidentityblueprintprincipal-addtokensigningcertificate-permissions"
}
-->
[!INCLUDE [permissions-table](../includes/permissions/agentidentityblueprintprincipal-addtokensigningcertificate-permissions.md)]
