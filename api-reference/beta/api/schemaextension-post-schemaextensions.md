...
[state](/graph/api/resources/schemaextension#3-schema-extensions-lifecycle) of the extension, the owner app, and only the owner app, may update or delete the extension. 
