...
description: "Restore a Cloud PC device to a previous state from a snapshot with an Intune managed device ID."
author: "rongting"
...
Restore a Cloud PC device to a previous state from a snapshot with an Intune [managed device](../resources/cloudpc.md) ID.
