...
Create a new [androidWorkProfileScepCertificateProfile](../resources/intune_deviceconfig_androidworkprofilescepcertificateprofile.md) object.
## Prerequisites
...
## Response
If successful, this method returns a `201 Created` response code and a [androidWorkProfileScepCertificateProfile](../resources/intune_deviceconfig_androidworkprofilescepcertificateprofile.md) object in the response body.
