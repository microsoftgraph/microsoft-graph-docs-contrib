...
Create a new [androidStoreApp](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_apps_androidstoreapp.md) object.
## Prerequisites
...
## Request body
In the request body, supply a JSON representation of a androidStoreApp object.
The following table shows the properties that are required when you create a androidStoreApp.
...
## Response
If successful, this method returns a `201 Created` response code and a [androidStoreApp](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_apps_androidstoreapp.md) object in the response body.
