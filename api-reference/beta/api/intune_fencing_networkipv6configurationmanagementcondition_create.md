...
Create a new [networkIPv6ConfigurationManagementCondition](../resources/intune_fencing_networkipv6configurationmanagementcondition.md) object.
## Prerequisites
...
## Response
If successful, this method returns a `201 Created` response code and a [networkIPv6ConfigurationManagementCondition](../resources/intune_fencing_networkipv6configurationmanagementcondition.md) object in the response body.
