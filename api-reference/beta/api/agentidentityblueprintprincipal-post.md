...
> [!IMPORTANT]
> Adding [**passwordCredential**](../resources/passwordcredential.md) when creating agentIdentityBlueprintPrincipals is not supported. Use the [addPassword](agentidentityblueprintprincipal-addpassword.md) method to add passwords or secrets for a agentIdentityBlueprintPrincipal.
