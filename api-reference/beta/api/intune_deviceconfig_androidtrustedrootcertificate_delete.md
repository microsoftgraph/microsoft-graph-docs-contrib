...
Deletes a [androidTrustedRootCertificate](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_deviceconfig_androidtrustedrootcertificate.md).
## Prerequisites
