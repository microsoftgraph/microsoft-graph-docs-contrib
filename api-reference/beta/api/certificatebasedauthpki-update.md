...
|:---|:---|:---|
|deletedDateTime|DateTimeOffset| The date time when the object was soft deleted. Inherited from base class. `null` for objects that are not deleted. Inherited from [directoryObject](../resources/directoryobject.md). Optional.|
|displayName|String|The name of the **certificateBasedAuthPki** entity. Optional.|
|status|String|The status of any asynchronous jobs run on the **certificateBasedAuthPki** entity which can be uploaded or deleted. Optional.|
|statusDetails|String|Property that provides additional information of the upload/delete operation of the PKI. Optional.|
|lastModifiedDateTime|DateTimeOffset|The date time the **certificateBasedAuthPki** object of its related certificate authorities were modified. Required.|
