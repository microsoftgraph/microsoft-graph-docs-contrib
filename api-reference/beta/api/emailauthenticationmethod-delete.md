...
<!-- { "blockType": "permissions", "name": "emailauthenticationmethod-delete-permissions", "requestUrls": ["DELETE /users/{id | userPrincipalName}/authentication/emailMethods/{emailMethods-id}"] } -->
