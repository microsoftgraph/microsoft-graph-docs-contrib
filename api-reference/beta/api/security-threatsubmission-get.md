...
Read the properties and relationships of a [threatSubmission](../resources/security-threatsubmission.md) object.
...
If successful, this method returns a `200 OK` response code and a [threatSubmission](../resources/security-threatsubmission.md) object in the response body.
