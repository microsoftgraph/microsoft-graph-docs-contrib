...
# Get Known Issues by Time Range 
...
If successful, this method returns a `200 OK` response code and a list of [known Issues](../resources/windowsupdates-knownissues.md) per the given time range in the response body.
