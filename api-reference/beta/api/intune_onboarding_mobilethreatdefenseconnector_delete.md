...
Deletes a [mobileThreatDefenseConnector](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_onboarding_mobilethreatdefenseconnector.md).
## Prerequisites
