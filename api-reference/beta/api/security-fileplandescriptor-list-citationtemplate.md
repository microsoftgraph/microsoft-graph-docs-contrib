...
If successful, this method returns a `200 OK` response code and a collection of [citationTemplate](../resources/citationtemplate.md) objects in the response body.
