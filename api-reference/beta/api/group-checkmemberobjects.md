...
|:---------------------------------------|:--------------------------------------------|
| Delegated (work or school account)     | Group.Read.All, Group.ReadWrite.All<br>And:<br>If checking for membership in administrative units, one or more of these permissions are also needed: AdministrativeUnit.Read.All, AdministrativeUnit.ReadWrite.All<br>Directory.Read.All, Directory.ReadWrite.All, Directory.AccessAsUser.All |
| Delegated (personal Microsoft account) | Not supported. |
| Application                            | Group.Read.All, Group.ReadWrite.All<br>And:<br>If checking for membership in administrative units, one or more of these permissions are also needed: AdministrativeUnit.Read.All, AdministrativeUnit.ReadWrite.All<br>Directory.Read.All, Directory.ReadWrite.All |
