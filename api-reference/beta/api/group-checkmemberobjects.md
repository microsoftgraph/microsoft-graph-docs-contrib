...
|:---------------------------------------|:--------------------------------------------|
| Delegated (work or school account)     | Group.Read.All, Group.ReadWrite.All<br>And:<ul><li>If checking for membership in administrative units, one or more of these permissions are also needed: AdministrativeUnit.Read.All, AdministrativeUnit.ReadWrite.All</li></ul>Directory.Read.All, Directory.ReadWrite.All, Directory.AccessAsUser.All |
| Delegated (personal Microsoft account) | Not supported. |
| Application                            | Group.Read.All, Group.ReadWrite.All<br>And:<ul><li>If checking for membership in administrative units, one or more of these permissions are also needed: AdministrativeUnit.Read.All, AdministrativeUnit.ReadWrite.All<ul><li>Directory.Read.All, Directory.ReadWrite.All |
