...
For successful responses, channel messages in the response will be sorted in order of last modified reply chain, which includes both root channel messagee and its replies.
