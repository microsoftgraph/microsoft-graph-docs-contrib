---
title: "Update overprovisionedGcpServiceAccountFinding"
description: "Update the properties of an overprovisionedGcpServiceAccountFinding object."
...
Update the properties of an [overprovisionedGcpServiceAccountFinding](../resources/overprovisionedgcpserviceaccountfinding.md) object.
...
If successful, this method returns a `200 OK` response code and an updated [overprovisionedGcpServiceAccountFinding](../resources/overprovisionedgcpserviceaccountfinding.md) object in the response body.
...
<!-- {
  "blockType": "request",
  "name": "update_overprovisionedgcpserviceaccountfinding"
}
-->
``` http
