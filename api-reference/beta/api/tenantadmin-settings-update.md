...
| tenantDefaultTimezone                              | String                       | The default timezone of a tenant for newly created sites. Possible values can be found at this [reference](https://learn.microsoft.com/en-us/dotnet/api/microsoft.sharepoint.spregionalsettings.timezones).    |
