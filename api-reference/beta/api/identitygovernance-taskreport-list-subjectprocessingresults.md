...
description: "Get a list of subjectProcessingResult objects associated with a task report."
author: "masonwolff"
ms.date: 05/26/2026
...
Get a list of the [subjectProcessingResult](../resources/identitygovernance-subjectprocessingresult.md) objects associated with a [taskReport](../resources/identitygovernance-taskreport.md).
...
<!-- {
  ...
  "name": "identitygovernance-taskreport-list-subjectprocessingresults-permissions"
}
-->
[!INCLUDE [permissions-table](../includes/permissions/identitygovernance-taskreport-list-subjectprocessingresults-permissions.md)]
...
<!-- {
  "blockType": "request",
  "name": "lifecycleworkflows_list_taskreport_subjectprocessingresults"
}
-->
``` http
