...
|driveExclusionUnits@delta|Collection([driveExclusionUnit](../resources/driveexclusionunit.md))|Collection of [driveExclusionUnit](../resources/driveexclusionunit.md) objects to be added to or removed from the [oneDriveForBusinessProtectionPolicy](../resources/onedriveforbusinessprotectionpolicy.md). Use this property for policies configured with `protectionMode` set to `fullServiceBackup`. Required for full workload backup policies.|
