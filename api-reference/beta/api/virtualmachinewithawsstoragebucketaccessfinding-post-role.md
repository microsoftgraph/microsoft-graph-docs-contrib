...
-->
``` http
POST /virtualMachineWithAwsStorageBucketAccessFinding/role/$ref
```
...
-->
``` http
POST https://graph.microsoft.com/beta/virtualMachineWithAwsStorageBucketAccessFinding/role/$ref
