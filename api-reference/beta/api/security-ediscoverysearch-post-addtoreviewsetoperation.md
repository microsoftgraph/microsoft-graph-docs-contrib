---
title: "Create ediscoveryAddToReviewSetOperation"
description: "Create a new ediscoveryAddToReviewSetOperation object."
...
# Create ediscoveryAddToReviewSetOperation
Namespace: microsoft.graph.security

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

Create a new [ediscoveryAddToReviewSetOperation](../resources/security-ediscoveryaddtoreviewsetoperation.md) object.
...
-->
``` http
POST ** Collection URI for microsoft.graph.security.ediscoveryAddToReviewSetOperation not found
```
...
## Request body
In the request body, supply a JSON representation of the [ediscoveryAddToReviewSetOperation](../resources/security-ediscoveryaddtoreviewsetoperation.md) object.

You can specify the following properties when creating an **ediscoveryAddToReviewSetOperation**.
...
If successful, this method returns a `201 Created` response code and an [ediscoveryAddToReviewSetOperation](../resources/security-ediscoveryaddtoreviewsetoperation.md) object in the response body.
...
<!-- {
  "blockType": "request",
  "name": "create_ediscoveryaddtoreviewsetoperation_from_"
}
-->
``` http
POST https://graph.microsoft.com/beta** Collection URI for microsoft.graph.security.ediscoveryAddToReviewSetOperation not found
