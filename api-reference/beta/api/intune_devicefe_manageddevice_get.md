...
GET /managedDevices/{managedDevicesId}/detectedApps/{detectedAppId}/managedDevices/{managedDeviceId}
```
...
## Response
If successful, this method returns a `200 OK` response code and [managedDevice](../resources/intune_devicefe_manageddevice.md) object in the response body.
