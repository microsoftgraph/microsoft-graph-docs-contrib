...
If successful, this method returns a `200 OK` response code and a collection of [filteringProfile](../resources/filteringprofile.md) objects in the response body.
