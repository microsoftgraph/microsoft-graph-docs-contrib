...
description: "Retrieve information about a specific forwarding rule within a forwarding policy."
author: Moti-ba
...
Retrieve information about a specific forwarding rule within a forwarding policy
...
-->
``` http
GET /networkaccess/forwardingPolicies/{policyId}/policyRules/{ruleId}
```
