...
<!-- { "blockType": "ignored" } -->
```http
GET /me/drive/root/workbook/names/{name}/range/format
GET /me/drive/root/workbook/worksheets/{id|name}/range(address='<address>')/format
GET /me/drive/root/workbook/tables/{id|name}/columns/{id|name}/range/format
```
