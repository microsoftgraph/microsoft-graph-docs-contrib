...
> [!CAUTION]
> The `extractLabel` API is deprecated and will stop returning data on August 30, 2022. Please use the new [extractLabel API](./security-informationprotection-sensitivitylabel-extractlabel.md).
