...
Update the properties of a [windowsUniversalAppX](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_apps_windowsuniversalappx.md) object.
## Prerequisites
...
## Request body
In the request body, supply a JSON representation of a [windowsUniversalAppX](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_apps_windowsuniversalappx.md) object.
The following table shows the properties that are required when you create a [windowsUniversalAppX](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_apps_windowsuniversalappx.md).
...
## Response
If successful, this method returns a `200 OK` response code and an updated [windowsUniversalAppX](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_apps_windowsuniversalappx.md) object in the response body.
