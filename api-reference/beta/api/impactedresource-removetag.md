---
title: "impactedResource: removeTag"
...
Remove a user-defined [tag](../resources/recommendationtag.md) from an [impactedResource](../resources/impactedresource.md) object. To remove the same tag from multiple impacted resources in a single request, use the [removeTag](../api/impactedresource-removetag-collection.md) action on the impactedResources collection.
...
<!-- { "blockType": "permissions", "name": "impactedresource_removetag" } -->
[!INCLUDE [permissions-table](../includes/permissions/impactedresource-removetag-permissions.md)]
...
|:---|:---|:---|
|tagId|String|The unique identifier of the [recommendationTag](../resources/recommendationtag.md) to remove from the impacted resource. Required.|
...
<!-- {
  "blockType": "request",
  "name": "impactedresourcethis.removeTag",
