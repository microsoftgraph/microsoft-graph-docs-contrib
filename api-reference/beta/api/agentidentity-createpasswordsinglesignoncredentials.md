...
# agentIdentity: createPasswordSingleSignOnCredentials
...
<!-- {
  ...
  "name": "agentidentity-createpasswordsinglesignoncredentials-permissions"
}
-->
[!INCLUDE [permissions-table](../includes/permissions/agentidentity-createpasswordsinglesignoncredentials-permissions.md)]
