...
POST /users/<id | userPrincipalName>/notes/sections/<id>/Microsoft.Graph.copyToSectionGroup
POST /groups/users/<id | userPrincipalName>/notes/sections/<id>/Microsoft.Graph.copyToSectionGroup
```
### Request headers
