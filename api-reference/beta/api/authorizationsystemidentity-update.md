...
-->
``` http
PATCH /identityFinding/identity
PATCH /inactiveGroupFinding/group
PATCH /authorizationSystemIdentity
PATCH /privilegeEscalationFinding/identity
PATCH /awsSecretInformationAccessFinding/identity
PATCH /awsSecurityToolAdministrationFinding/identity
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/identityFinding/identity
