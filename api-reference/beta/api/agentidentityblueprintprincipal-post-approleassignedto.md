...
description: "Grant an app role assignment for a agent identity blueprint principal."
author: "zallison22"
ms.date: 10/27/2025
...
# Grant an appRoleAssignment for a agent identity blueprint principal

Namespace: microsoft.graph

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

Assign an app role for a resource agent identity blueprint principal, to a user, group, or client agent identity blueprint principal.
...
- `principalId`: The `id` of the **user**, **group** or client **agent identity blueprint principal** to which you are assigning the app role.
...
<!-- {
  ...
  "name": "agentidentityblueprintprincipal-post-approleassignedto-permissions"
}
-->
...
POST /servicePrincipals(appId='{appId}')/Microsoft.Graph.AgentIdentityBlueprintPrincipal/appRoleAssignedTo
