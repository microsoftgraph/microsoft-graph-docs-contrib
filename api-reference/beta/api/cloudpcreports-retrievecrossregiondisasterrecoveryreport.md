...
| reportName | [cloudPcDisasterRecoveryReportName](#cloudpcdisasterrecoveryreportname-values) | Indicates the name of the Cloud PC disaster recovery report. The possible value are: `crossRegionDisasterRecoveryReport`, `disasterRecoveryReport`, `unknownFutureValue`. When **reportName** isn't initialized, `crossRegionDisasterRecoveryReport` is the default value. |
