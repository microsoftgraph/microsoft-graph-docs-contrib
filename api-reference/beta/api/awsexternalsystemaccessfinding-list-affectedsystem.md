...
description: "Get the authorizationSystem resources from the affectedSystem navigation property."
...
Get the authorizationSystem resources from the affectedSystem navigation property.
...
-->
``` http
GET /awsExternalSystemAccessFinding/affectedSystem
```
...
-->
``` http
GET https://graph.microsoft.com/beta/awsExternalSystemAccessFinding/affectedSystem
```
