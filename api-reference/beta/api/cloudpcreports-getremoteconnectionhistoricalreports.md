...
Get a Cloud PC's remote connection historical report. This report is generated by totaling raw event data hourly by activity ID. For example, you can aggregate signInDateTime, signOutDateTime, usageInHour, remoteSignInTimeInSec, roundTripTimeInMsP50 hourly in a given period (such as last seven days)
