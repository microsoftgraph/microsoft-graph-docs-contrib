...
[!INCLUDE [teams-premium-apis](../../includes/teams-premium-apis.md)]
...
>**Note:** If no `model` is specified, [evaluation mode](/graph/teams-licenses#evaluation-mode-default-requirements) will be used.
