...
|[health monitoring alert](../resources/healthmonitoring-alert.md) <br />`reports/healthmonitoring/alerts`| HealthMonitoringAlertConfig.Read.All | Not supported. | HealthMonitoringAlertConfig.Read.All |
