...
|[chat](../resources/chat.md) (/appCatalogs/teamsApps/{id}/installedToChats) -- all chats in an organization where a particular Teams app is installed | Not supported | Not supported | Chat.ReadBasic.WhereInstalled, Chat.Read.WhereInstalled, Chat.ReadWrite.WhereInstalled |
...
|[chatMessage](../resources/chatmessage.md) (/appCatalogs/teamsApps/{id}/installedToChats/getAllMessages -- chat messages for all chats in an organization where a particular Teams app is installed) | Not supported. | Not supported. | Chat.Read.WhereInstalled, Chat.ReadWrite.WhereInstalled |
...
|[conversationMember](../resources/conversationmember.md) (/appCatalogs/teamsApps/{id}/installedToChats/getAllMembers) -- chat members for all chats in an organization where a particular Teams app is installed | Not supported | Not supported | ChatMember.Read.WhereInstalled, ChatMember.ReadWrite.WhereInstalled, Chat.ReadBasic.WhereInstalled, Chat.Read.WhereInstalled, Chat.ReadWrite.WhereInstalled |
