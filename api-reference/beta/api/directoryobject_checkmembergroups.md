...
POST /directoryObjects/users/<id | userPrincipalName>/Microsoft.Graph.checkMemberGroups
POST /contacts/users/<id | userPrincipalName>/manager/Microsoft.Graph.checkMemberGroups
