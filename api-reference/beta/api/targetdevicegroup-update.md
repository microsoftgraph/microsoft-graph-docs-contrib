...
description: "Update the properties of a targetDeviceGroup object."
author: "SanDeo-MSFT"
...
Update the properties of a [targetDeviceGroup](../resources/targetdevicegroup.md) object.
...
-->
``` http
PATCH https://graph.microsoft.com/beta/servicePrincipals/{servicePrincipalsId}/remoteDesktopSecurityConfiguration/targetDeviceGroups/{targetDeviceGroupId}
