---
title: "Update iosWiredNetworkConfiguration"
description: "Update the properties of a iosWiredNetworkConfiguration object."
author: "jaiprakashmb"
...
# Update iosWiredNetworkConfiguration
...
Update the properties of a [iosWiredNetworkConfiguration](../resources/intune-deviceconfig-ioswirednetworkconfiguration.md) object.
...
## Request body
In the request body, supply a JSON representation for the [iosWiredNetworkConfiguration](../resources/intune-deviceconfig-ioswirednetworkconfiguration.md) object.

The following table shows the properties that are required when you create the [iosWiredNetworkConfiguration](../resources/intune-deviceconfig-ioswirednetworkconfiguration.md).
...
## Response
If successful, this method returns a `200 OK` response code and an updated [iosWiredNetworkConfiguration](../resources/intune-deviceconfig-ioswirednetworkconfiguration.md) object in the response body.
