...
Read the properties and relationships of a [dataSourceContainer](../resources/security-datasourcecontainer.md) object.
...
If successful, this method returns a `200 OK` response code and a [dataSourceContainer](../resources/security-datasourcecontainer.md) object in the response body.
