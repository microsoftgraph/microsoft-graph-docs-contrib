---
title: "sharePointMigrationTask: getBySourceGroupMailNickname"
description: "Get sharepointMigrationTask by source group mail nickname"
author: "Joey-King"
ms.date: 11/12/2025
...
# sharePointMigrationTask: getBySourceGroupMailNickname
...
<!-- { "blockType": "permissions", "name": "sharepointmigrationtask_getbysourcegroupmailnickname" } -->
[!INCLUDE [permissions-table](../includes/permissions/sharepointmigrationtask-getbysourcegroupmailnickname-permissions.md)]
...
<!-- {
  "blockType": "request",
  "name": "sharepointmigrationtaskthis.getbysourcegroupmailnickname"
}
-->
``` http
GET https://graph.microsoft.com/beta/solutions/sharePoint/migrations/crossOrganizationMigrationTasks/getBySourceGroupMailNickname(sourceGroupMailNickname='contoso')
```

# [C#](#tab/csharp)
[!INCLUDE [sample-code](../includes/snippets/csharp/sharepointmigrationtaskthisgetbysourcegroupmailnickname-csharp-snippets.md)]
[!INCLUDE [sdk-documentation](../includes/snippets/snippets-sdk-documentation-link.md)]

# [Go](#tab/go)
[!INCLUDE [sample-code](../includes/snippets/go/sharepointmigrationtaskthisgetbysourcegroupmailnickname-go-snippets.md)]
[!INCLUDE [sdk-documentation](../includes/snippets/snippets-sdk-documentation-link.md)]

# [Java](#tab/java)
[!INCLUDE [sample-code](../includes/snippets/java/sharepointmigrationtaskthisgetbysourcegroupmailnickname-java-snippets.md)]
[!INCLUDE [sdk-documentation](../includes/snippets/snippets-sdk-documentation-link.md)]

# [JavaScript](#tab/javascript)
[!INCLUDE [sample-code](../includes/snippets/javascript/sharepointmigrationtaskthisgetbysourcegroupmailnickname-javascript-snippets.md)]
[!INCLUDE [sdk-documentation](../includes/snippets/snippets-sdk-documentation-link.md)]

# [PHP](#tab/php)
[!INCLUDE [sample-code](../includes/snippets/php/sharepointmigrationtaskthisgetbysourcegroupmailnickname-php-snippets.md)]
[!INCLUDE [sdk-documentation](../includes/snippets/snippets-sdk-documentation-link.md)]

# [Python](#tab/python)
[!INCLUDE [sample-code](../includes/snippets/python/sharepointmigrationtaskthisgetbysourcegroupmailnickname-python-snippets.md)]
[!INCLUDE [sdk-documentation](../includes/snippets/snippets-sdk-documentation-link.md)]
