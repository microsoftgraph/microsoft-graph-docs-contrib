---
title: "Delete onTokenIssuanceStartCustomExtension"
description: "Deletes an onTokenIssuanceStartCustomExtension object."
author: "soneff"
...
# Delete onTokenIssuanceStartCustomExtension
Namespace: microsoft.graph

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

Deletes an [onTokenIssuanceStartCustomExtension](../resources/ontokenissuancestartcustomextension.md) object.
...
<!-- {
  "blockType": "request",
  "name": "delete_ontokenissuancestartcustomextension"
}
-->
``` http
DELETE https://graph.microsoft.com/beta/onTokenIssuanceStartCustomExtension
```
