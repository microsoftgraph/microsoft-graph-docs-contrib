...
# recommendation: addTag
Namespace: microsoft.graph

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

Add a user-defined [tag](../resources/recommendationtag.md) to a [recommendation](../resources/recommendation.md) object. Tags help you organize, group, and filter recommendations in the Microsoft Entra admin center.
...
<!-- { "blockType": "permissions", "name": "recommendation_addtag" } -->
[!INCLUDE [permissions-table](../includes/permissions/recommendation-addtag-permissions.md)]
...
<!-- {
  "blockType": "request",
  "name": "recommendationthis.addTag",
