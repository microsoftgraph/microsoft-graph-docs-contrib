...
description: "This operation gets all the active usage based on the number of users that successfully read emails using iOS or Android mail apps."
author: "mkuninty"
...
This operation gets all the active usage based on the number of users that successfully read emails using iOS or Android mail apps.
