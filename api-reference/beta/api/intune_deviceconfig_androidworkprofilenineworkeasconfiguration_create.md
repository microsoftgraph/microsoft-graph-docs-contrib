...
Create a new [androidWorkProfileNineWorkEasConfiguration](../resources/intune_deviceconfig_androidworkprofilenineworkeasconfiguration.md) object.
## Prerequisites
...
## Response
If successful, this method returns a `201 Created` response code and a [androidWorkProfileNineWorkEasConfiguration](../resources/intune_deviceconfig_androidworkprofilenineworkeasconfiguration.md) object in the response body.
