...
-->
``` http
PATCH /awsExternalSystemAccessRoleFinding/role
PATCH /virtualMachineWithAwsStorageBucketAccessFinding/role
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/awsExternalSystemAccessRoleFinding/role
