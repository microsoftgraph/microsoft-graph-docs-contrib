...
> [!CAUTION]
> This API is deprecated and will stop returning data on August 31, 2024. Going forward, use the [cloudPC: setReviewStatus](../api/cloudpc-setreviewstatus.md) API.
