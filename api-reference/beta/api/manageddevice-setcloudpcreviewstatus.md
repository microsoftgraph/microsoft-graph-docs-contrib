...
> [!CAUTION]
> This API is deprecated and stopped returning data on February 28, 2025. Going forward, use the [cloudPC: setReviewStatus](../api/cloudpc-setreviewstatus.md) API.
