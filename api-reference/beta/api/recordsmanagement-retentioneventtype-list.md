...
If successful, this method returns a `200 OK` response code and a collection of [retentionEventType](api-reference/beta/resources/recordsmanagement-retentioneventtype.md) objects in the response body.
