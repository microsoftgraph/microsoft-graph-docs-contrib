...
If successful, this method returns a `200 OK` response code and a collection of [retentionEventType](../resources/retentioneventtype) objects in the response body.
