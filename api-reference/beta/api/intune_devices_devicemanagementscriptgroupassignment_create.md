...
Create a new [deviceManagementScriptGroupAssignment](../resources/intune_shared_devicemanagementscriptgroupassignment.md) object.
## Prerequisites
...
## Response
If successful, this method returns a `201 Created` response code and a [deviceManagementScriptGroupAssignment](../resources/intune_shared_devicemanagementscriptgroupassignment.md) object in the response body.
