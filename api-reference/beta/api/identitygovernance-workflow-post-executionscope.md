---
title: "Add user"
description: "Add executionScope by posting to the executionScope collection."
author: "AlexFilipin"
...
Add executionScope by posting to the executionScope collection.
...
-->
``` http
POST /identityGovernance/lifecycleWorkflows/deletedItems/workflows/{workflowId}/executionScope/$ref
```
...
-->
``` http
POST https://graph.microsoft.com/beta/identityGovernance/lifecycleWorkflows/deletedItems/workflows/{workflowId}/executionScope/$ref
