...
POST /directoryObjects/users/<id | userPrincipalName>/Microsoft.Graph.getMemberGroups
POST /contacts/users/<id | userPrincipalName>/manager/Microsoft.Graph.getMemberGroups
