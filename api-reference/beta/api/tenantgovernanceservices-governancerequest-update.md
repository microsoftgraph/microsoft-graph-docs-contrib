...
<!-- { "blockType": "permissions", "name": "tenantgovernanceservices_governancerequest_update" } -->
[!INCLUDE [permissions-table](../includes/permissions/tenantgovernanceservices-governancerequest-update-permissions.md)]
