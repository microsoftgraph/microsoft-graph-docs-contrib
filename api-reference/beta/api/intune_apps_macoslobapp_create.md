...
Create a new [macOSLobApp](../resources/intune_apps_macoslobapp.md) object.
## Prerequisites
...
## Response
If successful, this method returns a `201 Created` response code and a [macOSLobApp](../resources/intune_apps_macoslobapp.md) object in the response body.
