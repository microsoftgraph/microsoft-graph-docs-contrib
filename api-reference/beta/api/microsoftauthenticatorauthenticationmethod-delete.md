...
<!-- { "blockType": "permissions", "name": "authentication-list-emailmethods-permissions", "requestUrls": ["DELETE /users/{id | userPrincipalName}/authentication/microsoftAuthenticatorMethods/{microsoftAuthenticatorAuthenticationMethodId}"] } -->
