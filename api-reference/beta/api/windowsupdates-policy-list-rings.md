...
If successful, this method returns a `200 OK` response code and a collection of [microsoft.graph.windowsUpdates.ring](../resources/windowsupdates-ring.md) objects or objects of a derived type in the response body.
