...
Admins with *User Administrator*, *Helpdesk Administrator*, or *Password Administrator* roles can also reset passwords for non-admin users and a limited set of admin roles as defined in [Who can reset passwords](https://learn.microsoft.com/azure/active-directory/roles/privileged-roles-permissions?tabs=admin-center#who-can-reset-passwords).
