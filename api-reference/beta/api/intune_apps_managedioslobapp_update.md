...
Update the properties of a [managedIOSLobApp](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_apps_managedioslobapp.md) object.
## Prerequisites
...
## Request body
In the request body, supply a JSON representation of a [managedIOSLobApp](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_apps_managedioslobapp.md) object.
The following table shows the properties that are required when you create a [managedIOSLobApp](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_apps_managedioslobapp.md).
...
## Response
If successful, this method returns a `200 OK` response code and an updated [managedIOSLobApp](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_apps_managedioslobapp.md) object in the response body.
