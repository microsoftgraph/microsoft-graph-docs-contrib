...
-->
``` http
DELETE /applications/{applicationsId}/owners/{id}/$ref
```
...
<!-- {
  "blockType": "request",
  "name": "delete_owners_from_agentidentityblueprint"
}
-->
``` http
DELETE https://graph.microsoft.com/beta/applications/{applicationsId}/owners/{id}/$ref
```
