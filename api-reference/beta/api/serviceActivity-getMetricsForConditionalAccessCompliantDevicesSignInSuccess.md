...
description: "Get the number of user authentication requests that successfully satisfy a Conditional Access policy that requires devices compliance. Compliant devices are managed by Microsoft Intune and can be mobile iOS/Android devices, tablets, or cloud Microsoft Entra joined computers (not hybrid)."
author: zachpeng
...
Get the number of user authentication requests that successfully satisfy a Conditional Access policy that requires devices compliance. Compliant devices are managed by Microsoft Intune and can be mobile iOS/Android devices, tablets, or cloud Microsoft Entra joined computers (not hybrid).
...
<!-- {
  "blockType": "request",
  "name": "reportsthis.getMetricsForConditionalAccessCompliantDevicesSignInSuccess"
}
-->
``` http
