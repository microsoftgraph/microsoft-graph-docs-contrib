...
description: "This operation gets all the active usage based on the number of active users opening or saving Visio for the web."
author: "mkuninty"
...
This operation gets all the active usage based on the number of active users opening or saving Visio for the web.
