...
<!-- { "blockType": "permissions", "name": "security_securitycopilot_workspace_post_sessions" } -->
...
[!INCLUDE [sample-code](../includes/snippets/powershell/create-session-from--powershell-snippets.md)]
[!INCLUDE [sdk-documentation](../includes/snippets/snippets-sdk-documentation-link.md)]
