...
>[!CAUTION] 
> This API is deprecated and will stop returning data on March 31, 2025. Going forward, use the [retrieveCloudPcTenantMetricsReport](cloudpcreports-retrieveCloudPcTenantMetricsReport.md) API.
