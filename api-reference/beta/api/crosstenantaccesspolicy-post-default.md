...
Create a new crossTenantAccessPolicyConfigurationDefault object.
...
-->
``` http
POST /policyRoot/crossTenantAccessPolicy/default
```
...
-->
``` http
POST https://graph.microsoft.com/beta/policyRoot/crossTenantAccessPolicy/default
