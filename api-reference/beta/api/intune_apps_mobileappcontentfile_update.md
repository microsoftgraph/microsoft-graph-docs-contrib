...
-->
```http
PATCH /deviceAppManagement/mobileApps/{id}/contentVersions/{id}/files/{id}
```
...
```http
PATCH https://graph.microsoft.com/beta/deviceAppManagement/mobileApps/{id}/contentVersions/{id}/files/{id}
