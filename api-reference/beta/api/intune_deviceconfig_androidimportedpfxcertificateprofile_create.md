...
Create a new [androidImportedPFXCertificateProfile](../resources/intune_deviceconfig_androidimportedpfxcertificateprofile.md) object.
## Prerequisites
...
## Response
If successful, this method returns a `201 Created` response code and a [androidImportedPFXCertificateProfile](../resources/intune_deviceconfig_androidimportedpfxcertificateprofile.md) object in the response body.
