...
If successful, this method returns a `200 OK` response code and a collection of [retentionEvent](api-reference\beta\resources\recordsmanagement-retentionevent.md) objects in the response body.
