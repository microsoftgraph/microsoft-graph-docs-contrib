...
Deletes a [macOSTrustedRootCertificate](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_deviceconfig_macostrustedrootcertificate.md).
## Prerequisites
