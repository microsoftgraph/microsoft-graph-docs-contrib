...
Get the availability information for a collection of users, distributions lists, or resources, for the specified time period.
...
{        
    "Schedules": ["admin@contoso.onmicrosoft.com", "AlexW@contoso.OnMicrosoft.com"],
    "StartTime": {
...

{
    ...
    "value":[
        {
            "scheduleId":"admin@contoso.onmicrosoft.com",
