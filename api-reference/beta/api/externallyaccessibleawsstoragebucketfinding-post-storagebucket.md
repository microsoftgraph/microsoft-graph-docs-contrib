...
-->
``` http
POST /externallyAccessibleAwsStorageBucketFinding/storageBucket/$ref
```
...
-->
``` http
POST https://graph.microsoft.com/beta/externallyAccessibleAwsStorageBucketFinding/storageBucket/$ref
