---
title: "Update inactiveServerlessFunctionFinding"
description: "Update the properties of an inactiveServerlessFunctionFinding object."
...
# Update inactiveServerlessFunctionFinding
Namespace: microsoft.graph

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

Update the properties of an [inactiveServerlessFunctionFinding](../resources/inactiveserverlessfunctionfinding.md) object.
...
If successful, this method returns a `200 OK` response code and an updated [inactiveServerlessFunctionFinding](../resources/inactiveserverlessfunctionfinding.md) object in the response body.
...
<!-- {
  "blockType": "request",
  "name": "update_inactiveserverlessfunctionfinding"
}
-->
``` http
