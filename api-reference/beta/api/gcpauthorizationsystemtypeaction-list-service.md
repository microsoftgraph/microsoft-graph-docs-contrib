---
title: "List authorizationSystemTypeService"
description: "Get the authorizationSystemTypeService resources from the service navigation property."
...
# List authorizationSystemTypeService
Namespace: microsoft.graph

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

Get the authorizationSystemTypeService resources from the service navigation property.
...
-->
``` http
GET /gcpAuthorizationSystemTypeAction/service
```
...
-->
``` http
GET https://graph.microsoft.com/beta/gcpAuthorizationSystemTypeAction/service
```
