...
> [!CAUTION]
> The `evaluateApplication` API is deprecated and will stop returning data on August 30, 2022. Please use the new [evaluateApplication API](./security-sensitivitylabel-evaluateapplication.md).
