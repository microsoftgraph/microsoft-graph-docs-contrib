...
description: "Retrieve the forwarding options for the tenant, with a specific focus on the "skipDnsLookupState" flag. This flag determines whether DNS lookup will be skipped, allowing Microsoft 365 (M365) traffic to be forwarded directly to the Front Door using the client-resolved destination."
author: Moti-ba
...
Retrieve the forwarding options for the tenant, with a specific focus on the "skipDnsLookupState" flag. This flag determines whether DNS lookup will be skipped, allowing Microsoft 365 (M365) traffic to be forwarded directly to the Front Door using the client-resolved destination.
