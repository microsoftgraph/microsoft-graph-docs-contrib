...
description: "Add virtualMachines by posting to the virtualMachines collection."
...
Add virtualMachines by posting to the virtualMachines collection.
...
-->
``` http
POST /openNetworkAzureSecurityGroupFinding/virtualMachines/$ref
```
...
-->
``` http
POST https://graph.microsoft.com/beta/openNetworkAzureSecurityGroupFinding/virtualMachines/$ref
