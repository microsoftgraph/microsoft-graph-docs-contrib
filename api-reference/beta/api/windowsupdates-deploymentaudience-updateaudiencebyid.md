...
Update the members and exclusions collections of a [deploymentAudience](../resources/deploymentaudience.md) with [updatableAsset](../resources/windowsupdates-updatableasset.md) resources of the same type.
