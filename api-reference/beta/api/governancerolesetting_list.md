...
Retrieve a collection of [governanceRoleSetting](../resources/governancerolesetting.md) on a resource.
...
## Example
An administrator lists role settings for resource "Wingtip Toys - Prod" 
<!-- {
  "blockType": "request",
