...
## Request body
In the request body, supply a JSON representation of a [windowsPhoneXAP](../resources/intune_apps_windowsphonexap.md) object.
The following table shows the properties that are required when you create a [windowsPhoneXAP](../resources/intune_apps_windowsphonexap.md).
