---
title: "List appRoleAssignments granted to a agent identity"
description: "Retrieve the list of app role assignments granted to an agent identity."
author: "zallison22"
ms.date: 10/27/2025
...
# List appRoleAssignments granted to an agent identity

Namespace: microsoft.graph

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

Retrieve the list of [appRoleAssignment](../resources/approleassignment.md) that have been granted to an agent identity.
...
<!-- { "blockType": "permissions", "name": "agentidentity_list_approleassignments" } -->
...
<!-- {
  "blockType": "request",
  "name": "agentidentity_get_approleassignments"
}-->
