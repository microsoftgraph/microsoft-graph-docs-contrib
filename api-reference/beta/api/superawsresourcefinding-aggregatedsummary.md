...
-->
``` http
GET https://graph.microsoft.com/beta/identityGovernance/permissionsAnalytics/aws/findings/graph.superAwsResourceFinding/aggregatedSummary(authorizationSystemIds=['377596131774'])
```
