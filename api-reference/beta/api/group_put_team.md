...
Create a new Team in a Group, as specified in the request body.
...
If successful, this method returns `201, Created` response code and [team](../resources/channel.md) object in the response body.
