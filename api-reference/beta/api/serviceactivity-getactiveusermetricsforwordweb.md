...
description: "Get all the active usage based on the number of active users opening or saving Word for the web."
author: "mkuninty"
...
Get all the active usage based on the number of active users opening or saving Word for the web.
