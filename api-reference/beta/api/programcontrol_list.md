...
In the Azure AD [access reviews](../resources/accessreviews_root.md) feature, list all the [programControl](../resources/programcontrol.md) objects, across all programs in the tenant.
## Permissions
