---
title: "List secretInformationAccessAwsUserFindings"
...
# List secretInformationAccessAwsUserFindings
...
-->
``` http
GET /identityGovernance/permissionsAnalytics/aws/findings/graph.secretInformationAccessAwsUserFinding
```
...
-->
``` http
GET https://graph.microsoft.com/beta/identityGovernance/permissionsAnalytics/aws/findings/graph.secretInformationAccessAwsUserFinding
```
...
{
  "@odata.context": "https://graph.microsoft.com/beta/identityGovernance/$metadata#permissionsAnalytics/aws/findings/graph.secretInformationAccessAwsUserFinding",
  "value": [
      {
