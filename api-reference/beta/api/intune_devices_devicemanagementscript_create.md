...
Create a new [deviceManagementScript](../resources/intune_shared_devicemanagementscript.md) object.
## Prerequisites
...
## Response
If successful, this method returns a `201 Created` response code and a [deviceManagementScript](../resources/intune_shared_devicemanagementscript.md) object in the response body.
