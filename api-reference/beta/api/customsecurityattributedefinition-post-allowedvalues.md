...
|:---|:---|:---|
|id|String|Case sensitive identifier for the allowed value. Can be up to 64 characters long and include Unicode characters. Can include spaces, but some special characters are not allowed. Cannot be changed later. Required.|
