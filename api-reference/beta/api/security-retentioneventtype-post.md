...
If successful, this method returns a `201 Created` response code and a [retentionEventType](../resources/security-retentioneventtype.md) object in the response body.
