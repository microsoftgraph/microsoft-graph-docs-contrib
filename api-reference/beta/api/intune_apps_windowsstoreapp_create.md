...
Create a new [windowsStoreApp](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_apps_windowsstoreapp.md) object.
## Prerequisites
...
## Request body
In the request body, supply a JSON representation of a windowsStoreApp object.
The following table shows the properties that are required when you create a windowsStoreApp.
...
## Response
If successful, this method returns a `201 Created` response code and a [windowsStoreApp](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_apps_windowsstoreapp.md) object in the response body.
