...
<!-- { "blockType": "permissions", "name": "virtualmachinewithawsstoragebucketaccessfinding_list" } -->
[!INCLUDE [permissions-table](../includes/permissions/virtualmachinewithawsstoragebucketaccessfinding-list-permissions.md)]
