...
```http
POST /external/connections/{id}/items
```
...
If successful, this method returns `201 Created` response code and a new [externalItem](../resources/externalitem.md) object in the response body.
...
```http
POST https://graph.microsoft.com/beta/connections/contosohr/items
...
```http
POST https://graph.microsoft.com/beta/connections/contosofiles/items
Content-type: application/json
