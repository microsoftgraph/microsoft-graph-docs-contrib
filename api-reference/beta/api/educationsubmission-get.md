...
You can use `$orderby` with the the following properties of the [submission](../resources/educationsubmission.md) resource: **status**, **submittedDateTime**, **unsubmittedDateTime**, **returnedDateTime**, **reassignedDateTime**, and **excusedDateTime**.
