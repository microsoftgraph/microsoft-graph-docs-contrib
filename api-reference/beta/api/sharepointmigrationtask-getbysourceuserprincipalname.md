...
Gets the sharepointMigrationTask that was previously created for a user, gigiven the source userPrincipalNamee. The returned sharepointMigrationTask contains source and target site url, the status of the migration, optional properties like the startedDateTime and finishedDateTime of the task, and also errors that give detailed information about the issues encountered during the execution of the sharepointMigrationTask.
