...
Create a new [macOSImportedPFXCertificateProfile](../resources/intune_deviceconfig_macosimportedpfxcertificateprofile.md) object.
## Prerequisites
...
## Response
If successful, this method returns a `201 Created` response code and a [macOSImportedPFXCertificateProfile](../resources/intune_deviceconfig_macosimportedpfxcertificateprofile.md) object in the response body.
