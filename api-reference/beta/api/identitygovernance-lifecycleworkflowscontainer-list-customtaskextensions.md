...
If successful, this method returns a `200 OK` response code and a collection of [customTaskExtension](../resources/customtaskextension.md) objects in the response body.
