...
-->
``` http
GET /networkAccess/connectivity/webCategories
```
...
If successful, this method returns a `200 OK` response code and a collection of [WebCategory](../resources/networkaccess-webcategory.md) objects in the response body.
...
-->
``` http
GET /networkAccess/settings/connectivity/webCategories
```
