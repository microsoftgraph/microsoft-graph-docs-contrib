---
title: "List secretInformationAccessAwsResourceFindings"
...
# List secretInformationAccessAwsResourceFindings
...
-->
``` http
GET /identityGovernance/permissionsAnalytics/aws/findings/graph.secretInformationAccessAwsResourceFinding
```
...
-->
``` http
GET https://graph.microsoft.com/beta/identityGovernance/permissionsAnalytics/aws/findings/graph.secretInformationAccessAwsResourceFinding
```
