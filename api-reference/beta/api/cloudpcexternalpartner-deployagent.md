...
Trigger agent deployment for a set of Windows 365 Cloud PCs which have provisioned. This API is supported when the connection is enabled and the agent setting has been configured. Currently, only support Windows 365 business Cloud PC.
