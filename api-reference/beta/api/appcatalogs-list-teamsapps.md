...
```
### Example 8: List the details of only those apps in the catalog that contain dashboard cards

The following example lists only those apps in the catalog that contain a dashboard card.
