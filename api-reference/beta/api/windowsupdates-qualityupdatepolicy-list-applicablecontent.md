...
Get a list of the applicableContent objects and their properties.
...
<!-- {
  ...
  "name": "windowsupdates-qualityupdatepolicy-list-applicablecontent-permissions"
}
-->
[!INCLUDE [permissions-table](../includes/permissions/windowsupdates-qualityupdatepolicy-list-applicablecontent-permissions.md)]
