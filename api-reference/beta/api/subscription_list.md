...
|:---------------- |:-------------------------------------------- |
| [Delegated](../../../concepts/auth_v2_user.md) (work or school account) | Permission required to [create subscription](subscription_post_subscriptions.md) or Subscriptions.Read.All (see below). |
