...
```http
GET /reports/OneDriveUsage(view=view-value, period=period-value, date=date-value)/content
```
...
```http
GET https://graph.microsoft.com/beta/reports/OneDriveUsage(view='Detail',date='2017-02-02')/content
GET https://graph.microsoft.com/beta/reports/OneDriveUsage(view='Account',period='D7')/content
GET https://graph.microsoft.com/beta/reports/OneDriveUsage(view='Files',period='D7')/content
GET https://graph.microsoft.com/beta/reports/OneDriveUsage(view='Storage',period='D7')/content
```
