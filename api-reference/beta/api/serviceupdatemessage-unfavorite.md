...
description: "Remove the favorite status of serviceUpdateMessage for the login user."
author: "payiAzure"
...
Remove the favorite status of [serviceUpdateMessage](../resources/serviceupdatemessage.md)s for the login user.
