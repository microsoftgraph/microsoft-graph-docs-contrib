...
Retrieve a list of eDiscovery review set queries.
...
If successful, this method returns a `200 OK` response code and a collection of [reviewSetQuery](../resources/ediscovery-reviewset-query.md) objects in the response body.
