...
<!-- { "blockType": "ignored" } -->
```http
GET /me/drive/root/workbook/names/{name}/range/Cell
GET /me/drive/root/workbook/worksheets/{id|name}/range(address='<address>')/Cell
GET /me/drive/root/workbook/tables/{id|name}/columns/{id|name}/range/Cell
