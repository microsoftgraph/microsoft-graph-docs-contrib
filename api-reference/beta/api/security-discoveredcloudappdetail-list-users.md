...
If successful, this method returns a `200 OK` response code and a collection of [discoveredCloudAppUser](../resources/discoveredcloudappuser.md) objects in the response body.
