...
If successful, this method returns a `200 OK` response code and a collection of [dataDiscoveryReport](../resources/datadiscoveryreport.md) objects in the response body.
