...
If successful, this method returns a `200 OK` response code and a collection of [siteSource](../resources/ediscovery-sitesource.md) objects in the response body.
