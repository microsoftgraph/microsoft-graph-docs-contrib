...
* Resolve IDs returned by functions (that return collections of IDs) such as [getMemberObjects](./directoryobject-getmemberobjects.md?view=graph-rest-beta) or [getMemberGroups](./directoryobject-getmembergroups.md?view=graph-rest-beta)  to their backing directory objects.
