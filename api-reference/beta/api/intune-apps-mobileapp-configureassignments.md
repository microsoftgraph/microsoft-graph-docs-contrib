---
title: "configureAssignments action"
description: "Intune Apps Mobileapp Configureassignments Api ."
author: "jaiprakashmb"
...
-->
```http
POST /deviceAppManagement/mobileApps/{mobileAppId}/configureAssignments
```
...
|:---|:---|:---|
|assignments|[deviceAndAppManagementPayloadAssignment](../resources/intune-apps-deviceandappmanagementpayloadassignment.md) collection||
...
```http
POST https://graph.microsoft.com/beta/deviceAppManagement/mobileApps/{mobileAppId}/configureAssignments
