...
Get the userProcessingResult resources from the userProcessingResults navigation property.
...
-->
``` http
GET /workflowBase/userProcessingResults
```
...
If successful, this method returns a `200 OK` response code and a collection of [userProcessingResult](../resources/userprocessingresult.md) objects in the response body.
...
-->
``` http
GET https://graph.microsoft.com/beta/workflowBase/userProcessingResults
```
