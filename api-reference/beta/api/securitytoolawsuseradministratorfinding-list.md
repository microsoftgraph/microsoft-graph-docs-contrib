...
<!-- { "blockType": "permissions", "name": "securitytoolawsuseradministratorfinding_list" } -->
[!INCLUDE [permissions-table](../includes/permissions/securitytoolawsuseradministratorfinding-list-permissions.md)]
