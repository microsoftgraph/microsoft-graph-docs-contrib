...
Get a collection of [cloud application reports](../resources/networkaccess-cloudapplicationreport.md) based on aggregated traffic logs for a specified time period in Global Secure Access.
...
[!INCLUDE [sample-code](../includes/snippets/powershell/reportsthisgetcloudapplicationreport-powershell-snippets.md)]
[!INCLUDE [sdk-documentation](../includes/snippets/snippets-sdk-documentation-link.md)]
