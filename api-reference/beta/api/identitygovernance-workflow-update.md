...
> [!NOTE]
> Task name and description are also able to be updated within a workflow without creating a new version. For more information on these properties, see: [task resource type (lifecycle workflow tasks)](../resources/identitygovernance-task.md).
