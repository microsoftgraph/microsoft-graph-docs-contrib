...
<!-- { "blockType": "ignored" } -->
```http
GET /me/drive/root/workbook/tables/{id|name}/columns/{id|name}/DataBodyRange
GET /me/drive/root/workbook/worksheets/{id|name}/tables/{id|name}/columns/{id|name}/DataBodyRange
