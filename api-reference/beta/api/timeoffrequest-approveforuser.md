---
title: "timeOffRequest: approveForUser"
description: "Approve a timeoffrequest object for a user."
author: lemikeshifts
ms.date: 03/31/2025
...
# timeOffRequest: approveForUser

Namespace: microsoft.graph

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

Approve a [timeoffrequest](../resources/timeoffrequest.md) object for a user.
...
|userId|String|ID of the user that approved the request. Must be a team owner (manager). Required.|
