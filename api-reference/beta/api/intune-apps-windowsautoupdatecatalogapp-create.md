...
# Create windowsAutoUpdateCatalogApp
...
Create a new [windowsAutoUpdateCatalogApp](../resources/intune-apps-windowsautoupdatecatalogapp.md) object.
...
## Request body
In the request body, supply a JSON representation for the windowsAutoUpdateCatalogApp object.

The following table shows the properties that are required when you create the windowsAutoUpdateCatalogApp.
...
## Response
If successful, this method returns a `201 Created` response code and a [windowsAutoUpdateCatalogApp](../resources/intune-apps-windowsautoupdatecatalogapp.md) object in the response body.
