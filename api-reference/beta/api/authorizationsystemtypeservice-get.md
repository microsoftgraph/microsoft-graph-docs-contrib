...
``` http
GET /authorizationSystemTypeService
GET /awsAuthorizationSystemTypeAction/service
GET /gcpAuthorizationSystemTypeAction/service
GET /azureAuthorizationSystemTypeAction/service
```
...
-->
``` http
GET https://graph.microsoft.com/beta/authorizationSystemTypeService
```
