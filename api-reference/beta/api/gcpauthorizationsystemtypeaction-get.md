...
-->
``` http
GET /external/authorizationSystems/{id}/graph.gcpAuthorizationSystem/actions/{gcpAuthorizationSystemTypeActionId}
GET /external/authorizationSystems/{id}/graph.gcpAuthorizationSystem/actions(externalId='{externalId}')
```
...
-->
``` http
GET https://graph.microsoft.com/beta/external/authorizationSystems/{id}/graph.gcpAuthorizationSystem/actions/Y29tcHV0ZS5hZGRyZXNzZXMuY3JlYXRl
```
...
{
  "@odata.context": "https://graph.microsoft.com/beta/$metadata#external/authorizationSystems/{id}/graph.gcpAuthorizationSystem/actions/Y29tcHV0ZS5hZGRyZXNzZXMuY3JlYXRl",
  "value": [
    {
