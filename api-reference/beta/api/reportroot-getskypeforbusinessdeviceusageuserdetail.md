...
<!-- { "blockType": "permissions", "name": "reportroot_getskypeforbusinessdeviceusageuserdetail" } -->
[!INCLUDE [permissions-table](../includes/permissions/reportroot-getskypeforbusinessdeviceusageuserdetail-permissions.md)]
