...
| `additionalNotificationRecipients`   |[accessReviewNotificationRecipientItem](../resources/accessReviewNotificationRecipientItem.md) collection| Define the list of additional notification recipients, that is not involved in access review functioning lifecycle, but need to be notified when review progress. one can specify a list of notification recipients to send notification emails at specific review stage. The recipients can be any AAD user or AAD group members in tenant.|
