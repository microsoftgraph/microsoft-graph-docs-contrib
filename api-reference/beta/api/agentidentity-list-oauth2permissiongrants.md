---
title: "List an agent identity's oauth2PermissionGrants"
description: "Retrieve a list of oAuth2PermissionGrant objects, representing delegated permission grants, granted to an agent identity."
author: "zallison22"
ms.date: 10/27/2025
...
# List oauth2PermissionGrants granted to an agent identity

Namespace: microsoft.graph

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

Retrieve a list of [oAuth2PermissionGrant](../resources/oAuth2PermissionGrant.md) entities, representing delegated permissions granted to the agent identity to access an API on behalf of a user.
...
<!-- { "blockType": "permissions", "name": "agentidentity_list_oauth2permissiongrants" } -->
...
<!-- {
  "blockType": "request",
  "name": "get_agentidentity_oAuth2PermissionGrants"
}-->
