...
## Response
If successful, this method returns a `200 OK` response code and collection of [audioRoutingGroup](../resources/audioRoutingGroup.md) objects in the response body.
