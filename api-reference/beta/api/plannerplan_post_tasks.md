...
POST /me/planner/plans/<id>/tasks
POST /users/<id>/planner/plans/<id>/tasks
...
<!-- {
  "blockType": "request",
  "name": "create_plannertask_from_plannerplan"
}-->
```http
POST https://graph.microsoft.com/beta/planner/plans/<id>/tasks
