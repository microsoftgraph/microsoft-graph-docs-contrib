---
title: "Add driveProtectionRule"
description: "Add driveInclusionRules by posting to the driveInclusionRules collection."
...
# Add driveProtectionRule

Namespace: microsoft.graph

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

Add driveInclusionRules by posting to the driveInclusionRules collection.
...
<!-- {
  ...
  "name": "onedriveforbusinessprotectionpolicy-post-driveinclusionrules-permissions"
}
-->
[!INCLUDE [permissions-table](../includes/permissions/onedriveforbusinessprotectionpolicy-post-driveinclusionrules-permissions.md)]
...
-->
``` http
POST /solutions/backupRestore/oneDriveForBusinessProtectionPolicies/{oneDriveForBusinessProtectionPolicyId}/driveInclusionRules/$ref
```
...
In the request body, supply a JSON representation of the [driveProtectionRule](../resources/driveprotectionrule.md) object.

You can specify the following properties when creating a **driveProtectionRule**.
...
|driveExpression|String|**TODO: Add Description** Optional.|



## Response

If successful, this method returns a `204 No Content` response code and a [driveProtectionRule](../resources/driveprotectionrule.md) object in the response body.
...
<!-- {
  "blockType": "request",
  "name": "create_driveprotectionrule_from_"
}
-->
``` http
POST https://graph.microsoft.com/beta/solutions/backupRestore/oneDriveForBusinessProtectionPolicies/{oneDriveForBusinessProtectionPolicyId}/driveInclusionRules/$ref
...
{
  "@odata.type": "#microsoft.graph.driveProtectionRule",
  "id": "c26f320f-42b7-4728-3b37-8640bb254609",
  "status": "String",
