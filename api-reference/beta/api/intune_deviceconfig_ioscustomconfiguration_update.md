...
Update the properties of a [iosCustomConfiguration](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_deviceconfig_ioscustomconfiguration.md) object.
## Prerequisites
...
## Request body
In the request body, supply a JSON representation of a [iosCustomConfiguration](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_deviceconfig_ioscustomconfiguration.md) object.
The following table shows the properties that are required when you create a [iosCustomConfiguration](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_deviceconfig_ioscustomconfiguration.md).
...
## Response
If successful, this method returns a `200 OK` response code and an updated [iosCustomConfiguration](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_deviceconfig_ioscustomconfiguration.md) object in the response body.
