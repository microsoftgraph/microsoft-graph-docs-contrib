...
-->
``` http
POST /externallyAccessibleGcpStorageBucketFinding/storageBucket/$ref
```
...
-->
``` http
POST https://graph.microsoft.com/beta/externallyAccessibleGcpStorageBucketFinding/storageBucket/$ref
