...
description: "This operation gets usage metrics based on the number of times users opened the Teams app without error."
author: "mkuninty"
...
This operation gets usage metrics based on the number of times users opened the Teams app without error.
