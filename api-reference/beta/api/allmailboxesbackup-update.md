---
title: "Update allMailboxesBackup"
description: "Update the properties of an allMailboxesBackup object."
...
# Update allMailboxesBackup

Namespace: microsoft.graph

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

Update the properties of an allMailboxesBackup object.
...
<!-- {
  ...
  "name": "allmailboxesbackup-update-permissions"
}
-->
[!INCLUDE [permissions-table](../includes/permissions/allmailboxesbackup-update-permissions.md)]
...
If successful, this method returns a `200 OK` response code and an updated [allMailboxesBackup](../resources/allmailboxesbackup.md) object in the response body.
...
<!-- {
  "blockType": "request",
  "name": "update_allmailboxesbackup"
}
-->
``` http
PATCH https://graph.microsoft.com/beta/allMailboxesBackup
