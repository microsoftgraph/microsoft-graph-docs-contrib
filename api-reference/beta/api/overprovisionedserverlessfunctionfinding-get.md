...
-->
``` http
GET https://graph.microsoft.com/identityGovernance/permissionsAnalytics/aws/findings('MSxPdmVycHJvdmlzaW9uZWRTZXJ2ZXJsZXNzRnVuY3Rpb25GaW5kaW5nLDQ3MDQ')/graph.overprovisionedServerlessFunctionFinding
```
