...
<!-- { "blockType": "ignored" } -->
```http
GET /groups/users/<id | userPrincipalName>
GET /users/<id | userPrincipalName>/joinedGroups/users/<id | userPrincipalName>
GET /drive/root/createdByUser/joinedGroups/users/<id | userPrincipalName>
```
