...
description: "This operation gets all the active usage based on the number of users who signed in with modern authentication across all email apps."
author: "mkuninty"
...
This operation gets all the active usage based on the number of users who signed in with modern authentication across all email apps.
