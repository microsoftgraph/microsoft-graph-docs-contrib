...
<!-- { "blockType": "ignored" } -->
```http
PATCH /groups/users/<id | userPrincipalName>
PATCH /users/<id | userPrincipalName>/joinedGroups/users/<id | userPrincipalName>
PATCH /drive/root/createdByUser/joinedGroups/users/<id | userPrincipalName>
```
### Request headers
