...
-->
``` http
DELETE /emailThreatSubmissionPolicies/{emailThreatSubmissionPoliciesId}/$ref
```
...
-->
``` http
DELETE https://graph.microsoft.com/beta/emailThreatSubmissionPolicies/{emailThreatSubmissionPoliciesId}
```
