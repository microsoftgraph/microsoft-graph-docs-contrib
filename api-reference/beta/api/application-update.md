...
| windows                     | [windowsApplication](../resources/windowsapplication.md)                            | Specifies settings for a Windows application, including package SID and redirect URIs for authorization codes and access tokens. |
