...
description: "Get all Shift objects across all teams a user is a direct member of."
author: "shanemalone"
...
Get all [shift](../resources/shift.md) objects across all teams a user is a direct member of.
