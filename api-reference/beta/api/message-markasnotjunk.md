...
description: "Mark a message as not junk. This removes the sender from the list of blocked senders. When MoveToInbox is true, the message is moved to inbox folder."
author: "kagunase"
...
Mark a message as not junk. This removes the sender to the list of blocked senders. When MoveToInbox is true, the message is moved to inbox folder.
...
|:---------------|:--------|:----------|
|MoveToInbox|Boolean|The value of MoveToInbox indicates if the message has to be moved to inbox. 
