...
Get a report that summarizes [access from external IDs](../resources/networkaccess-crosstenantaccess.md) to the tenant through Microsoft Entra External ID, as logged in Global Secure Access.
