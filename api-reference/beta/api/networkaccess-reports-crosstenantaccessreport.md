...
Get a report that summarizes access from external IDs to the tenant through Microsoft Entra External ID, as logged in [Global Secure Access](../resources/networkaccess-global-secure-access-api-overview.md).
