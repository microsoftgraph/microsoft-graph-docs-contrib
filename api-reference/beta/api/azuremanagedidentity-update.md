---
title: "Update azureManagedIdentity"
description: "Update the properties of an azureManagedIdentity object."
...
Update the properties of an [azureManagedIdentity](../resources/azuremanagedidentity.md) object.
...
If successful, this method returns a `200 OK` response code and an updated [azureManagedIdentity](../resources/azuremanagedidentity.md) object in the response body.
...
<!-- {
  "blockType": "request",
  "name": "update_azuremanagedidentity"
}
-->
``` http
