...
description: "Get all the active usage based on the number of users that successfully read emails using iOS or Android mail apps."
author: "mkuninty"
...
Get all the active usage based on the number of users that successfully read emails using iOS or Android mail apps.
