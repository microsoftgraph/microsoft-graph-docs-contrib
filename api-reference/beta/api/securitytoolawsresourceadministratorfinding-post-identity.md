...
description: "Add identity by posting to the identity collection."
...
Add identity by posting to the identity collection.
...
-->
``` http
POST /awsSecurityToolAdministrationFinding/identity/$ref
```
...
-->
``` http
POST https://graph.microsoft.com/beta/awsSecurityToolAdministrationFinding/identity/$ref
