...
Get a list of the [configurationApplication](../resources/configurationapplication.md) objects and their properties.
...
<!-- {
  "blockType": "response",
  "truncated": true,
  "@odata.type": "Collection(microsoft.graph.configurationApplication)"
}
-->
``` http
HTTP/1.1 200 OK
