...
<!-- { "blockType": "ignored" } -->
```http
POST /me/drive/root/workbook/worksheets/{id|name}/charts/{name}/format/fill/setSolidColor
POST /me/drive/root/workbook/worksheets/{id|name}/charts/{name}/title/format/fill/setSolidColor
POST /me/drive/root/workbook/worksheets/{id|name}/charts/{name}/legend/format/fill/setSolidColor
