---
title: "revokeCloudCertificationAuthorityCertificate action"
description: "Intune Cloudpkigraphservice Cloudcertificationauthority Revokecloudcertificationauthoritycertificate Api ."
author: "jaiprakashmb"
...
# revokeCloudCertificationAuthorityCertificate action
...
-->
``` http
POST /deviceManagement/cloudCertificationAuthority/{cloudCertificationAuthorityId}/revokeCloudCertificationAuthorityCertificate
```
...
|:---|:---|:---|
|certificationAuthorityVersion|Int32|The CloudCertificationAuthority entity instance version of the certificate to revoke.|
...
``` http
POST https://graph.microsoft.com/beta/deviceManagement/cloudCertificationAuthority/{cloudCertificationAuthorityId}/revokeCloudCertificationAuthorityCertificate
