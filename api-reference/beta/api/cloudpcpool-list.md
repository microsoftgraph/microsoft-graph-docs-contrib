...
[!INCLUDE [permissions-table](../includes/permissions/cloudpcpool-list-permissions.md)]
...
This method supports the `$select`, `$filter`, `$top`, `$skip`, `$orderby`, and `$count` OData query parameters to help customize the response. For general information, see [OData query parameters](/graph/query-parameters).
