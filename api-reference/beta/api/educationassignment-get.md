...
Get the properties and relationships of an [assignment](../resources/educationassignment.md). This operation can be performed with both the roles in the class either teacher or student.
