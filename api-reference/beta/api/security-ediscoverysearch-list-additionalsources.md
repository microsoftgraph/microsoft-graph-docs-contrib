...
If successful, this method returns a `200 OK` response code and a collection of [ediscoveryNoncustodialDataSource](../resources/ediscoverynoncustodialdatasource.md) objects in the response body.
