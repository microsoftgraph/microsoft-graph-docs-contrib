...
> [!IMPORTANT]
> The support for application permissions in this API ends on January 1, 2026. To decline a request with application permissions, use [/declineForUser](https://learn.microsoft.com/graph/api/schedulechangerequest-declineforuser) instead.
