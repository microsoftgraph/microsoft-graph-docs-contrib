...
Update the properties of a [iosLobApp](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_apps_ioslobapp.md) object.
## Prerequisites
...
## Request body
In the request body, supply a JSON representation of a [iosLobApp](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_apps_ioslobapp.md) object.
The following table shows the properties that are required when you create a [iosLobApp](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_apps_ioslobapp.md).
...
## Response
If successful, this method returns a `200 OK` response code and an updated [iosLobApp](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_apps_ioslobapp.md) object in the response body.
