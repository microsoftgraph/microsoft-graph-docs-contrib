...
description: "Get the number of user authentication requests, over a given time range, that successfully satisfy a Conditional Access policy requiring devices to be managed. Managed devices are computers joined to and managed by your on-premises directory and hybrid devices joined to Microsoft Entra."
author: "Zacharypeng"
...
Get the number of user authentication requests, over a given time range, that successfully satisfy a Conditional Access policy requiring devices to be managed. Managed devices are computers joined to and managed by your on-premises directory and hybrid devices joined to Microsoft Entra.
