...
<!-- { "blockType": "permissions", "name": "reportroot_getteamsuseractivitydistributionusercounts" } -->
[!INCLUDE [permissions-table](../includes/permissions/reportroot-getteamsuseractivitydistributionusercounts-permissions.md)]
