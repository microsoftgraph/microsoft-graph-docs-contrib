...
Create a new [importedDeviceIdentityResult](../resources/intune_shared_importeddeviceidentityresult.md) object.
## Prerequisites
...
## Response
If successful, this method returns a `201 Created` response code and a [importedDeviceIdentityResult](../resources/intune_shared_importeddeviceidentityresult.md) object in the response body.
