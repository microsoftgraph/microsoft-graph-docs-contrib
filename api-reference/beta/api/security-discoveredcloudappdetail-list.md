...
If successful, this method returns a `200 OK` response code and a collection of [discoveredCloudAppDetail](../resources/security-discoveredcloudappdetail.md) objects in the response body.
