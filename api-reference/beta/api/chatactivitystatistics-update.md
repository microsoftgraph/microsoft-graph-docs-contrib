...
description: "Updates the properties of the chatActivityStatistics object."
...
Updates the properties of the chatActivityStatistics object.
...
```http
PATCH /chatactivitystatistics/{id}
```
...
```http
PATCH https://graph.microsoft.com/beta/me/analytics/chatactivitystatistics/{id}
...
<!-- {
  ...
  "description": "Update chatactivitystatistics",
  "keywords": "",
