...
Create a new license [assignment](../resources/cloudlicensing-assignment.md) by posting to the **assignments** collection of an [allotment](../resources/cloudlicensing-allotment.md).
...
<!-- {
  ...
  "name": "cloudlicensing-allotment-post-assignments-permissions"
}
-->
[!INCLUDE [permissions-table](../includes/permissions/cloudlicensing-allotment-post-assignments-permissions.md)]
...
-->
``` http
POST https://graph.microsoft.com/beta/admin/cloudLicensing/allotments/rkocgef3dgjhnu3gmu2mqhbdbmwcymnf6fk3k6a7zbui5e7gfpmi/assignments
...
[!INCLUDE [sample-code](../includes/snippets/javascript/create-assignment-from-allotment-javascript-snippets.md)]
