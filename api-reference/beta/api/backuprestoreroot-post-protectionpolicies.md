---
title: "Create protectionPolicyBase"
description: "Create a new protectionPolicyBase object."
...
# Create protectionPolicyBase

Namespace: microsoft.graph

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

Create a new protectionPolicyBase object.
...
<!-- {
  ...
  "name": "backuprestoreroot-post-protectionpolicies-permissions"
}
-->
[!INCLUDE [permissions-table](../includes/permissions/backuprestoreroot-post-protectionpolicies-permissions.md)]
...
In the request body, supply a JSON representation of the [protectionPolicyBase](../resources/protectionpolicybase.md) object.

You can specify the following properties when creating a **protectionPolicyBase**.
...
If successful, this method returns a `201 Created` response code and a [protectionPolicyBase](../resources/protectionpolicybase.md) object in the response body.
...
<!-- {
  "blockType": "request",
  "name": "create_protectionpolicybase_from_"
}
-->
``` http
POST https://graph.microsoft.com/beta/solutions/backupRestore/protectionPolicies
