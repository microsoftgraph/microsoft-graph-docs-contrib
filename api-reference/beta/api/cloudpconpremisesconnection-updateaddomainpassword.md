...
description: "Update the Active Directory (AD) domain password for a successful on-premises connection. This API is supported when the onPremisesConnection's type is hybridAzureADJoin."
author: "AshleyYangSZ"
...
Update the Active Directory (AD) domain password for an [onPremisesConnection](../resources/cloudpconpremisesconnection.md). This API is supported when the **onPremisesConnection**'s type is `hybridAzureADJoin`.
