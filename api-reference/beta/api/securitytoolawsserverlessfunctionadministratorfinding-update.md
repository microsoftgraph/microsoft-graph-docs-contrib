---
title: "Update securityToolAwsServerlessFunctionAdministratorFinding"
description: "Update the properties of a securityToolAwsServerlessFunctionAdministratorFinding object."
...
# Update securityToolAwsServerlessFunctionAdministratorFinding
Namespace: microsoft.graph

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

Update the properties of a [securityToolAwsServerlessFunctionAdministratorFinding](../resources/securitytoolawsserverlessfunctionadministratorfinding.md) object.
...
If successful, this method returns a `200 OK` response code and an updated [securityToolAwsServerlessFunctionAdministratorFinding](../resources/securitytoolawsserverlessfunctionadministratorfinding.md) object in the response body.
...
<!-- {
  "blockType": "request",
  "name": "update_securitytoolawsserverlessfunctionadministratorfinding"
}
-->
``` http
