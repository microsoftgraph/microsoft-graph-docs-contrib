---
title: "Get onTokenIssuanceStartCustomExtension"
description: "Read the properties and relationships of an onTokenIssuanceStartCustomExtension object."
author: "soneff"
...
Read the properties and relationships of an [onTokenIssuanceStartCustomExtension](../resources/ontokenissuancestartcustomextension.md) object.
...
If successful, this method returns a `200 OK` response code and an [onTokenIssuanceStartCustomExtension](../resources/ontokenissuancestartcustomextension.md) object in the response body.
...
<!-- {
  "blockType": "request",
  "name": "get_ontokenissuancestartcustomextension"
}
-->
``` http
GET https://graph.microsoft.com/beta/onTokenIssuanceStartCustomExtension
```
