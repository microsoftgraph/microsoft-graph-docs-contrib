...
Create a new [managedIOSLobApp](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_apps_managedioslobapp.md) object.
## Prerequisites
...
## Response
If successful, this method returns a `201 Created` response code and a [managedIOSLobApp](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_apps_managedioslobapp.md) object in the response body.
