...
-->
```http
GET /deviceManagement/roleAssignments/{id}
GET /deviceManagement/roleDefinitions/{id}/roleAssignments/{id}
```
...
```http
GET https://graph.microsoft.com/beta/deviceManagement/roleAssignments/{id}
```
