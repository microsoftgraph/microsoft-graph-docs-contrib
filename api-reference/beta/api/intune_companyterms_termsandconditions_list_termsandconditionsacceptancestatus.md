...
-->
```http
GET /termsAndConditions/{termsAndConditionsId}/acceptanceStatuses/
```
...
```http
GET https://graph.microsoft.com/beta/termsAndConditions/{termsAndConditionsId}/acceptanceStatuses/
```
