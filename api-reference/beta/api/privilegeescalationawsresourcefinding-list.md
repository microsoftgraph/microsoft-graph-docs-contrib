---
title: "List privilegeEscalationAwsResourceFindings"
...
# List privilegeEscalationAwsResourceFindings
...
-->
``` http
GET ** Collection URI for microsoft.graph.privilegeEscalationAwsResourceFinding not found
```
...
-->
``` http
GET https://graph.microsoft.com/beta** Collection URI for microsoft.graph.privilegeEscalationAwsResourceFinding not found
```
