...
|Application                            | `ProgramControl.Read.All`, `ProgramControl.ReadWrite.All`.  The service principal must also be in a directory role which permits them to read a program. |
