---
title: "Update ediscoveryIndexOperation"
description: "Update the properties of an ediscoveryIndexOperation object."
...
# Update ediscoveryIndexOperation
Namespace: microsoft.graph.security

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

Update the properties of an [ediscoveryIndexOperation](../resources/security-ediscoveryindexoperation.md) object.
...
-->
``` http
PATCH /security/cases/ediscoveryCases/{ediscoveryCaseId}/reviewSets/{ediscoveryReviewSetId}/files/{ediscoveryFileId}/custodian/lastIndexOperation
PATCH /security/cases/ediscoveryCases/{ediscoveryCaseId}/searches/{ediscoverySearchId}/noncustodialSources/{ediscoveryNoncustodialDataSourceId}/lastIndexOperation
```
...
If successful, this method returns a `200 OK` response code and an updated [ediscoveryIndexOperation](../resources/security-ediscoveryindexoperation.md) object in the response body.
...
<!-- {
  "blockType": "request",
  "name": "update_ediscoveryindexoperation"
}
-->
``` http
PATCH https://graph.microsoft.com/beta/security/cases/ediscoveryCases/{ediscoveryCaseId}/reviewSets/{ediscoveryReviewSetId}/files/{ediscoveryFileId}/custodian/lastIndexOperation
