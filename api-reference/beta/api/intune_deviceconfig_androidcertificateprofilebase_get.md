...
Read properties and relationships of the [androidCertificateProfileBase](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_deviceconfig_androidcertificateprofilebase.md) object.
## Prerequisites
...
## Response
If successful, this method returns a `200 OK` response code and [androidCertificateProfileBase](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_deviceconfig_androidcertificateprofilebase.md) object in the response body.
