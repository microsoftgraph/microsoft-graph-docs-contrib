---
title: "Update superAwsRoleFinding"
description: "Update the properties of a superAwsRoleFinding object."
...
# Update superAwsRoleFinding
Namespace: microsoft.graph

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

Update the properties of a [superAwsRoleFinding](../resources/superawsrolefinding.md) object.
...
If successful, this method returns a `200 OK` response code and an updated [superAwsRoleFinding](../resources/superawsrolefinding.md) object in the response body.
...
<!-- {
  "blockType": "request",
  "name": "update_superawsrolefinding"
}
-->
``` http
