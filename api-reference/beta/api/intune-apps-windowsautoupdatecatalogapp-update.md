...
# Update windowsAutoUpdateCatalogApp
...
Update the properties of a [windowsAutoUpdateCatalogApp](../resources/intune-apps-windowsautoupdatecatalogapp.md) object.
...
## Request body
In the request body, supply a JSON representation for the [windowsAutoUpdateCatalogApp](../resources/intune-apps-windowsautoupdatecatalogapp.md) object.

The following table shows the properties that are required when you create the [windowsAutoUpdateCatalogApp](../resources/intune-apps-windowsautoupdatecatalogapp.md).
...
## Response
If successful, this method returns a `200 OK` response code and an updated [windowsAutoUpdateCatalogApp](../resources/intune-apps-windowsautoupdatecatalogapp.md) object in the response body.
...

{
  ...
  "mobileAppCatalogPackageBranchId": "Mobile App Catalog Package Branch Id value"
}
```
...
{
  "@odata.type": "#microsoft.graph.windowsAutoUpdateCatalogApp",
  "id": "34e941fa-41fa-34e9-fa41-e934fa41e934",
  "displayName": "Display Name value",
  "description": "Description value",
  "publisher": "Publisher value",
  "largeIcon": {
