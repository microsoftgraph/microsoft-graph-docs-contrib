...
description: "Check for membership in a list of groups, directory roles, or administrative units for the specified directory object."
...
Check for membership in a list of groups, directory roles, or administrative units for the specified directory object. This function is transitive.
...
POST /me/memberOf/{id}/checkMemberObjects
POST /users/{id}/manager/checkMemberObjects
```
