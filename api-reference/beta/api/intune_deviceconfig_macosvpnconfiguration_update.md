...
Update the properties of a [macOSVpnConfiguration](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_deviceconfig_macosvpnconfiguration.md) object.
## Prerequisites
...
## Request body
In the request body, supply a JSON representation of a [macOSVpnConfiguration](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_deviceconfig_macosvpnconfiguration.md) object.
The following table shows the properties that are required when you create a [macOSVpnConfiguration](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_deviceconfig_macosvpnconfiguration.md).
...
## Response
If successful, this method returns a `200 OK` response code and an updated [macOSVpnConfiguration](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_deviceconfig_macosvpnconfiguration.md) object in the response body.
