---
title: "userProcessingResult: usersSummary"
description: "userprocessingresult user summary api doc"
author: "AlexFilipin"
...
# userProcessingResult: usersSummary

Namespace: microsoft.graph.identityGovernance

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

User processing results from user summary
...
-->
``` http
GET /workflowBase/userProcessingResults/usersSummary
```
...
<!-- {
  "blockType": "request",
  "name": "userprocessingresultthis.userssummary"
}
-->
``` http
GET https://graph.microsoft.com/beta/workflowBase/userProcessingResults/usersSummary(startDateTime=String{timestamp},endDateTime=String{timestamp})
```
