...
> **Note:** With this behavior, it isn't possible to tell whether a property is changing. Also, the delta responses tend to be large because they contain all property values - as shown in the [second example](#request-2).
