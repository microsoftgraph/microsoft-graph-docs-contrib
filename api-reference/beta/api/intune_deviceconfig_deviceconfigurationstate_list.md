...
-->
``` http
GET /deviceManagement/managedDevices/{managedDeviceId}/deviceConfigurationStates
```
...
``` http
GET https://graph.microsoft.com/beta/deviceManagement/managedDevices/{managedDeviceId}/deviceConfigurationStates
```
