...
<!-- {
  ...
  "name": "windowsupdates-qualityupdatepolicy-delete-approvals-permissions"
}
-->
[!INCLUDE [permissions-table](../includes/permissions/windowsupdates-qualityupdatepolicy-delete-approvals-permissions.md)]
...
-->
``` http
DELETE /admin/windows/updates/policies/{policyId}/approvals/{policyApprovalId}/$ref
```
