...
Administrative units **cannot** be permanently deleted using the deletedItems API. Soft-deleted administrative units will be permanently deleted 30 days after initial deletion unless they are restored.
