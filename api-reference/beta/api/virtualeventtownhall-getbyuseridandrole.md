...
<!-- {
  ...
  "name": "virtualeventtownhall-getbyuseridandrole-permissions"
}
-->
...
-->
``` http
GET ** Collection URI for microsoft.graph.virtualEventTownhall not found/getByUserIdAndRole
```
...
-->
``` http
GET https://graph.microsoft.com/beta** Collection URI for microsoft.graph.virtualEventTownhall not found/getByUserIdAndRole(userId='parameterValue',role='parameterValue')
```
