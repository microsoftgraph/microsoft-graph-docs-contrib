...
If successful, this method returns a `200 OK` response code and collection of [filterOperatorSchema](../resources/synchronization_filterOperatorSchema.md) objects in the response body.
...
{
    "@odata.context": "https://graph.microsoft.com/beta/$metadata#filterOperators",
    "value": [
        {
            "name": "EQUALS",
            "arity": "Binary",
