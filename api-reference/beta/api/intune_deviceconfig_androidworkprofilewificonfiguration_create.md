...
Create a new [androidWorkProfileWiFiConfiguration](../resources/intune_deviceconfig_androidworkprofilewificonfiguration.md) object.
## Prerequisites
...
## Response
If successful, this method returns a `201 Created` response code and a [androidWorkProfileWiFiConfiguration](../resources/intune_deviceconfig_androidworkprofilewificonfiguration.md) object in the response body.
