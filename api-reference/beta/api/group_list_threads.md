...
<!-- { "blockType": "ignored" } -->
```http
GET /groups/users/<id | userPrincipalName>/threads
GET /users/<id | userPrincipalName>/joinedGroups/users/<id | userPrincipalName>/threads
GET /drive/root/createdByUser/joinedGroups/users/<id | userPrincipalName>/threads
```
