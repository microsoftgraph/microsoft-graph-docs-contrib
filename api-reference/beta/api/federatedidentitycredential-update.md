...
|:---|:---|:---|
|audiences|String collection|The list of audiences that can appear in the issued token. For Azure AD, you should set its value to `api://AzureADTokenExchange`. |
