...
Update the properties of a [federatedIdentityCredential](../resources/federatedidentitycredential.md) object assigned to an [application](../resources/application.md) or an [agentIdentityBlueprint](../resources/agentidentityblueprint.md).
...
<!-- { "blockType": "permissions", "name": "federatedidentitycredential_update_2" } -->
[!INCLUDE [permissions-table](../includes/permissions/federatedidentitycredential-update-2-permissions.md)]
