...
Create a new [macOSGeneralDeviceConfiguration](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_deviceconfig_macosgeneraldeviceconfiguration.md) object.
## Prerequisites
...
## Response
If successful, this method returns a `201 Created` response code and a [macOSGeneralDeviceConfiguration](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_deviceconfig_macosgeneraldeviceconfiguration.md) object in the response body.
