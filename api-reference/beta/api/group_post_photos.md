...
<!-- { "blockType": "ignored" } -->
```http
POST /groups/users/<id | userPrincipalName>/photos
POST /users/<id | userPrincipalName>/joinedGroups/users/<id | userPrincipalName>/photos
POST /drive/root/createdByUser/joinedGroups/users/<id | userPrincipalName>/photos
