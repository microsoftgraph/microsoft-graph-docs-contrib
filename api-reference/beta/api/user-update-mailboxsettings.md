...
**Note** that the [user purpose](../resources/userpurpose.md) setting of a user's [mailboxSettings](../resources/mailboxsettings.md) cannot be updated using this method.
