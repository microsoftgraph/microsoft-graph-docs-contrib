...
## HTTP request
Applications can be deleted with either the primary key, **id** (Object ID), or the alternate key, **appId** (Application ID).  Application ID is often referred to as Client ID.
