...
|exemptedAppPackages|[keyValuePair](../resources/intune_shared_keyvaluepair.md) collection|App packages in this list will be exempt from the policy and will be able to receive data from managed apps.|
