...
>**Note:** Permissions marked with * use [resource-specific consent](/microsoftteams/platform/graph-api/rsc/resource-specific-consent). These RSC permissions pertains to the individual recipients in the payload.
