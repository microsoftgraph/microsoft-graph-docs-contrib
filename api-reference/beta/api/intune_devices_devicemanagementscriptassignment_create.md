...
Create a new [deviceManagementScriptAssignment](../resources/intune_shared_devicemanagementscriptassignment.md) object.
## Prerequisites
...
## Response
If successful, this method returns a `201 Created` response code and a [deviceManagementScriptAssignment](../resources/intune_shared_devicemanagementscriptassignment.md) object in the response body.
