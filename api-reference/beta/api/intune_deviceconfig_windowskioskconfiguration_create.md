...
Create a new [windowsKioskConfiguration](../resources/intune_deviceconfig_windowskioskconfiguration.md) object.
## Prerequisites
...
## Response
If successful, this method returns a `201 Created` response code and a [windowsKioskConfiguration](../resources/intune_deviceconfig_windowskioskconfiguration.md) object in the response body.
