...
If successful, this method returns a `200 OK` response code and a collection of [articleIndicator](../resources/articleindicator.md) objects in the response body.
