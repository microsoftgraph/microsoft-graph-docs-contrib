...
Create a new [windowsPrivacyDataAccessControlItem](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_deviceconfig_windowsprivacydataaccesscontrolitem.md) object.
## Prerequisites
...
## Request body
In the request body, supply a JSON representation of a windowsPrivacyDataAccessControlItem object.
The following table shows the properties that are required when you create a windowsPrivacyDataAccessControlItem.
...
## Response
If successful, this method returns a `201 Created` response code and a [windowsPrivacyDataAccessControlItem](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_deviceconfig_windowsprivacydataaccesscontrolitem.md) object in the response body.
