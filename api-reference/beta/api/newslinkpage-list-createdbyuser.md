...
<!-- {
  ...
  "name": "newslinkpage-list-createdbyuser-permissions"
}
-->
[!INCLUDE [permissions-table](../includes/permissions/newslinkpage-list-createdbyuser-permissions.md)]
...
-->
``` http
GET /newsLinkPage/createdByUser
```
...
-->
``` http
GET https://graph.microsoft.com/beta/newsLinkPage/createdByUser
```
