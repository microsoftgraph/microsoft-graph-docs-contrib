...
Read properties and relationships of the managedDeviceMobileAppConfigurationState object.
...
## Response
If successful, this method returns a `200 OK` response code and managedDeviceMobileAppConfigurationState object in the response body.
