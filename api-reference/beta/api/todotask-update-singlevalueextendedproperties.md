...
To update one or more extended properties in a new task, use the same REST request as updating a task, and include the properties of the new task and extended property in the request body. 
