...
-->
```http
GET /deviceAppManagement/mobileApps/{id}/contentVersions/{id}/files/
```
...
```http
GET https://graph.microsoft.com/beta/deviceAppManagement/mobileApps/{id}/contentVersions/{id}/files/
```
