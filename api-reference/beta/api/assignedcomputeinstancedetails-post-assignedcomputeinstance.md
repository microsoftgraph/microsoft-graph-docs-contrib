...
description: "Add assignedComputeInstance by posting to the assignedComputeInstance collection."
...
Add assignedComputeInstance by posting to the assignedComputeInstance collection.
...
-->
``` http
POST /openAwsSecurityGroupFinding/assignedComputeInstancesDetails/{assignedComputeInstanceDetailsId}/assignedComputeInstance/$ref
```
...
-->
``` http
POST https://graph.microsoft.com/beta/openAwsSecurityGroupFinding/assignedComputeInstancesDetails/{assignedComputeInstanceDetailsId}/assignedComputeInstance/$ref
