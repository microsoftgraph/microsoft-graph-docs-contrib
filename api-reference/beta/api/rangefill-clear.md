...
<!-- { "blockType": "ignored" } -->
```http
POST /me/drive/root/workbook/names/{name}/range/format/fill/clear
POST /me/drive/root/workbook/worksheets/{id|name}/range(address='<address>')/format/fill/clear
POST /me/drive/root/workbook/tables/{id|name}/columns/{id|name}/range/format/fill/clear
