---
title: "Update overprovisionedAwsResourceFinding"
description: "Update the properties of an overprovisionedAwsResourceFinding object."
...
# Update overprovisionedAwsResourceFinding
Namespace: microsoft.graph

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

Update the properties of an [overprovisionedAwsResourceFinding](../resources/overprovisionedawsresourcefinding.md) object.
...
If successful, this method returns a `200 OK` response code and an updated [overprovisionedAwsResourceFinding](../resources/overprovisionedawsresourcefinding.md) object in the response body.
...
<!-- {
  "blockType": "request",
  "name": "update_overprovisionedawsresourcefinding"
}
-->
``` http
