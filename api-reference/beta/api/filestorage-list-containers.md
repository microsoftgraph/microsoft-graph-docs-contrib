...
Note: Only a limited subset of properties is returned for each fileStorageContainer. The $expand operation is not supported for drive, permissions, and customProperties properties.
