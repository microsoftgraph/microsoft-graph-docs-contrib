---
title: "Update superServerlessFunctionFinding"
description: "Update the properties of a superServerlessFunctionFinding object."
...
# Update superServerlessFunctionFinding
Namespace: microsoft.graph

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

Update the properties of a [superServerlessFunctionFinding](../resources/superserverlessfunctionfinding.md) object.
...
If successful, this method returns a `200 OK` response code and an updated [superServerlessFunctionFinding](../resources/superserverlessfunctionfinding.md) object in the response body.
...
<!-- {
  "blockType": "request",
  "name": "update_superserverlessfunctionfinding"
}
-->
``` http
