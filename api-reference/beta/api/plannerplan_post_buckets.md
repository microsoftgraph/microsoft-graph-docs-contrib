...
<!-- { "blockType": "ignored" } -->
```http
POST /planner/plans/<id>/buckets
POST /me/planner/plans/<id>/buckets
POST /users/<id>/planner/plans/<id>/buckets
...
<!-- {
  "blockType": "request",
  "name": "create_plannerbucket_from_plannerplan"
}-->
```http
POST https://graph.microsoft.com/beta/planner/plans/<id>/buckets
