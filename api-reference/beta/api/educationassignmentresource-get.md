...
The following example shows how to get the dependent [educationAssignmentResources](../resources/educationassignmentresource.md) for a given assignment resource.
