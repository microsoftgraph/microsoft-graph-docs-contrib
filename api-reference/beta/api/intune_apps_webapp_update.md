...
Update the properties of a [webApp](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_apps_webapp.md) object.
## Prerequisites
...
## Request body
In the request body, supply a JSON representation of a [webApp](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_apps_webapp.md) object.
The following table shows the properties that are required when you create a [webApp](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_apps_webapp.md).
...
## Response
If successful, this method returns a `200 OK` response code and an updated [webApp](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_apps_webapp.md) object in the response body.
