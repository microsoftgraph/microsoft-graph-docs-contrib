...
-->
``` http
GET ** Collection URI for microsoft.graph.unenforcedMfaAwsUserFinding not found/aggregatedSummary
```
...
-->
``` http
GET https://graph.microsoft.com/beta** Collection URI for microsoft.graph.unenforcedMfaAwsUserFinding not found/aggregatedSummary(authorizationSystemIds=[
  "String"
])
```
