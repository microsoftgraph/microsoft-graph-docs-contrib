...
description: "This operation gets usage metrics based on the number of times users joined Teams meeting without errors."
author: "mkuninty"
...
This operation gets usage metrics based on the number of times users joined Teams meeting without errors.
