...
> [!IMPORTANT] 
> The credential user registration details API is deprecated and will stop returning data on June 26, 2024. Use the [User registration details](../resources/userregistrationdetails.md) API instead.
