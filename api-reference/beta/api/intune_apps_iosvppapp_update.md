...
Update the properties of a [iosVppApp](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_apps_iosvppapp.md) object.
## Prerequisites
...
## Request body
In the request body, supply a JSON representation of a [iosVppApp](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_apps_iosvppapp.md) object.
The following table shows the properties that are required when you create a [iosVppApp](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_apps_iosvppapp.md).
...
## Response
If successful, this method returns a `200 OK` response code and an updated [iosVppApp](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_apps_iosvppapp.md) object in the response body.
