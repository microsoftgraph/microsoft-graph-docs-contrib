---
title: "List migrationEvent objects"
description: "Get a list of the migrationEvent objects and their properties."
author: "wenzhou"
ms.date: 06/04/2025
...
# List migrationEvent objects

Namespace: microsoft.graph

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

Get a list of the migrationEvent objects and their properties. The migration events remain valid for 4 days and can be queried as frequently as needed within validity period.
...
<!-- {
  ...
  "name": "migrationjob-list-progressevents-permissions"
}
-->
[!INCLUDE [permissions-table](../includes/permissions/migrationjob-list-progressevents-permissions.md)]
...
If successful, this method returns a `200 OK` response code and a collection of [migrationEvent](../resources/migrationevent.md) objects in the response body.
