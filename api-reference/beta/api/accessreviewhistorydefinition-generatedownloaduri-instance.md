...
Generates a URI for a [accessReviewHistoryInstance](../resources/accessReviewHistoryInstance.md) in the `done` state. Each URI can be used to retrieve the instance's review history data. Each URI is valid for 24 hours and can be retrieved by fetching the **downloadUri** property from the desired [accessReviewHistoryInstance](../resources/accessReviewHistoryInstance.md) object.
