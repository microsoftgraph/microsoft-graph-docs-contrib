---
title: "Update overprovisionedAwsRoleFinding"
description: "Update the properties of an overprovisionedAwsRoleFinding object."
...
# Update overprovisionedAwsRoleFinding
Namespace: microsoft.graph

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

Update the properties of an [overprovisionedAwsRoleFinding](../resources/overprovisionedawsrolefinding.md) object.
...
If successful, this method returns a `200 OK` response code and an updated [overprovisionedAwsRoleFinding](../resources/overprovisionedawsrolefinding.md) object in the response body.
...
<!-- {
  "blockType": "request",
  "name": "update_overprovisionedawsrolefinding"
}
-->
``` http
