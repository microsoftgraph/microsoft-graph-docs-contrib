---
title: "Delete onTokenIssuanceStartListener"
description: "Deletes an onTokenIssuanceStartListener object."
author: "soneff"
...
# Delete onTokenIssuanceStartListener
Namespace: microsoft.graph

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

Deletes an [onTokenIssuanceStartListener](../resources/ontokenissuancestartlistener.md) object.
...
<!-- {
  "blockType": "request",
  "name": "delete_ontokenissuancestartlistener"
}
-->
``` http
DELETE https://graph.microsoft.com/beta/onTokenIssuanceStartListener
```
