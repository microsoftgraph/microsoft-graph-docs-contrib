...
If successful, this method returns a `200 OK` response code and a collection of [remoteActionAudit](../resources/intune_devices_remoteactionaudit.md) objects in the response body.
