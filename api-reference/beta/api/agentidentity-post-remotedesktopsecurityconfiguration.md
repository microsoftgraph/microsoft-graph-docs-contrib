...
<!-- {
  ...
  "name": "agentidentity-post-remotedesktopsecurityconfiguration-permissions"
}
-->
[!INCLUDE [permissions-table](../includes/permissions/agentidentity-post-remotedesktopsecurityconfiguration-permissions.md)]
...
-->
``` http
POST ** Collection URI for microsoft.graph.remoteDesktopSecurityConfiguration not found
```
...
-->
``` http
POST https://graph.microsoft.com/beta** Collection URI for microsoft.graph.remoteDesktopSecurityConfiguration not found
