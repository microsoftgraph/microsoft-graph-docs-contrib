...
Create a new workPlanOccurrence object in your own work plan. Only time-off occurrences can be created directly. Other occurrences are autogenerated from recurrences.
