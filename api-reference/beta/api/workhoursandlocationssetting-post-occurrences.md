...
Create a new [workPlanOccurrence](../resources/workplanoccurrence.md) object in your own work plan. Only time-off occurrences can be created directly. Other occurrences are autogenerated from recurrences.
