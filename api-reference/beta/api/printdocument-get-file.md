...
In addition to the following permissions, the user or app's tenant must have an active Universal Print subscription and have either of _Printer.Read.All_ or _Printer.ReadWrite.All_ application permission.
