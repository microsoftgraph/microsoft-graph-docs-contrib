...
Download the binary file associated with the document. Calling this method yields a redirect response with a pre-authenticated URL that can be used to download the payload.
