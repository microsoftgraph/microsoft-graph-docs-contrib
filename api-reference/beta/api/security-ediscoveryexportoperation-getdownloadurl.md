...
[!CAUTION]
The **getDownloadUrl** method is deprecated and will stop returning data on April, 30th 2023. Please use the new **exportFileMetadata** property returned in resource [Get caseOperation](../api/security-caseoperation-get.md)
