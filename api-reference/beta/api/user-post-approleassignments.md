...
```http
POST https://graph.microsoft.com/beta/users/eabd2f81-0d6a-485b-8b72-28faaea2ce04/appRoleAssignments
...
{
  "@odata.context": "https://graph.microsoft.com/beta/$metadata#users('eabd2f81-0d6a-485b-8b72-28faaea2ce04')/appRoleAssignments/$entity",
