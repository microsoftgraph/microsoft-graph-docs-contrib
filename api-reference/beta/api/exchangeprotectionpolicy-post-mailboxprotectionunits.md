---
title: "Add mailboxProtectionUnit"
description: "Add mailboxProtectionUnits by posting to the mailboxProtectionUnits collection."
...
# Add mailboxProtectionUnit

Namespace: microsoft.graph

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

Add mailboxProtectionUnits by posting to the mailboxProtectionUnits collection.
...
<!-- {
  ...
  "name": "exchangeprotectionpolicy-post-mailboxprotectionunits-permissions"
}
-->
[!INCLUDE [permissions-table](../includes/permissions/exchangeprotectionpolicy-post-mailboxprotectionunits-permissions.md)]
...
-->
``` http
POST /solutions/backupRestore/exchangeProtectionPolicies/{exchangeProtectionPolicyId}/mailboxProtectionUnits/$ref
```
...
In the request body, supply a JSON representation of the [mailboxProtectionUnit](../resources/mailboxprotectionunit.md) object.

You can specify the following properties when creating a **mailboxProtectionUnit**.
...
|mailboxType|mailboxType|**TODO: Add Description**. The possible values are: `unknown`, `user`, `shared`, `unknownFutureValue`. Optional.|



## Response

If successful, this method returns a `204 No Content` response code and a [mailboxProtectionUnit](../resources/mailboxprotectionunit.md) object in the response body.
...
<!-- {
  "blockType": "request",
  "name": "create_mailboxprotectionunit_from_"
}
-->
``` http
POST https://graph.microsoft.com/beta/solutions/backupRestore/exchangeProtectionPolicies/{exchangeProtectionPolicyId}/mailboxProtectionUnits/$ref
