...
If successful, this method returns a `200 OK` response code and a collection of [forwardingPolicyLink](../resources/networkaccess-forwardingprofile-list-policies.md) objects in the response body.
