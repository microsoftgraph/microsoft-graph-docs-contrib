...
Update the properties of a [macOSWiFiConfiguration](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_deviceconfig_macoswificonfiguration.md) object.
## Prerequisites
...
## Request body
In the request body, supply a JSON representation of a [macOSWiFiConfiguration](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_deviceconfig_macoswificonfiguration.md) object.
The following table shows the properties that are required when you create a [macOSWiFiConfiguration](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_deviceconfig_macoswificonfiguration.md).
...
## Response
If successful, this method returns a `200 OK` response code and an updated [macOSWiFiConfiguration](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_deviceconfig_macoswificonfiguration.md) object in the response body.
