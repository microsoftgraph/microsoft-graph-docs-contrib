...
Create a new [androidWorkProfileVpnConfiguration](../resources/intune_deviceconfig_androidworkprofilevpnconfiguration.md) object.
## Prerequisites
...
## Response
If successful, this method returns a `201 Created` response code and a [androidWorkProfileVpnConfiguration](../resources/intune_deviceconfig_androidworkprofilevpnconfiguration.md) object in the response body.
