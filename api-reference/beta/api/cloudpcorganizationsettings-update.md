...
Update the properties of the [cloudPcOrganizationSettings](../resources/cloudpcorganizationsettings.md) object in a tenant, which has only one **cloudPcOrganizationSettings** object.
