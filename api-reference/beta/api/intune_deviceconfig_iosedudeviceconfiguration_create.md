...
Create a new [iosEduDeviceConfiguration](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_deviceconfig_iosedudeviceconfiguration.md) object.
## Prerequisites
...
## Response
If successful, this method returns a `201 Created` response code and a [iosEduDeviceConfiguration](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_deviceconfig_iosedudeviceconfiguration.md) object in the response body.
