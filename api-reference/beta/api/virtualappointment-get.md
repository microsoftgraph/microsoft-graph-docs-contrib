...
> [!CAUTION] 
  > The Virtual appointment resource is deprecated and will stop returning data on May 31, 2023. Existing apps that use this feature should be updated to the new [Virtual appointment API](api-reference/beta/api/virtualappointment-getvirtualappoinmentjoinweburl.md).
