...
description: "Get all the active usage based on the number of users that successfully read emails using Outlook apps for mobile."
author: "mkuninty"
...
Get all the active usage based on the number of users that successfully read emails using Outlook apps for mobile.
