...
If successful, this method returns a `200 OK` response code and a collection of [departmentTemplate](../resources/security-departmenttemplate.md) objects in the response body.
