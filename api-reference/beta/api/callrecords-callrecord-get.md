...
* Subscribe to [change notifications](/graph/api/resources/change-notifications-api-overview?view=graph-rest-1.0) to the `/communications/callRecords` endpoint.
