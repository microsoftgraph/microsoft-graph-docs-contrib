...
<!-- {
  ...
  "name": "customauthenticationextension-validateauthenticationconfiguration-permissions"
}
-->
...
-->
``` http
POST https://graph.microsoft.com/beta/identity/customAuthenticationExtensions/{customAuthenticationExtensionId}/validateAuthenticationConfiguration
```
