...
description: "Create a new virtualEvent object in draft mode."
author: "frankpeng7"
...
In the request body, supply a JSON representation of the supported derived types of [virtualEvent](../resources/virtualevent.md) object.
...
If successful, this method returns a `201 Created` response code and a [virtualEventWebinar](../resources/virtualeventwebinar.md) or [virtualEventTownhall](../resources/virtualeventtownhall.md) object in the response body.

## Examples

### Example 1: Create a webinar
