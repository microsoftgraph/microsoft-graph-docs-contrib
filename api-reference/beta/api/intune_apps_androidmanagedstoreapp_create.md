...
Create a new [androidManagedStoreApp](../resources/intune_apps_androidmanagedstoreapp.md) object.
## Prerequisites
...
## Response
If successful, this method returns a `201 Created` response code and a [androidManagedStoreApp](../resources/intune_apps_androidmanagedstoreapp.md) object in the response body.
