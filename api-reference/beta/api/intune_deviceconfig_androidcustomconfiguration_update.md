...
Update the properties of a [androidCustomConfiguration](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_deviceconfig_androidcustomconfiguration.md) object.
## Prerequisites
...
## Request body
In the request body, supply a JSON representation of a [androidCustomConfiguration](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_deviceconfig_androidcustomconfiguration.md) object.
The following table shows the properties that are required when you create a [androidCustomConfiguration](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_deviceconfig_androidcustomconfiguration.md).
...
## Response
If successful, this method returns a `200 OK` response code and an updated [androidCustomConfiguration](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_deviceconfig_androidcustomconfiguration.md) object in the response body.
