---
title: "Update inactiveAwsRoleFinding"
description: "Update the properties of an inactiveAwsRoleFinding object."
...
# Update inactiveAwsRoleFinding
Namespace: microsoft.graph

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

Update the properties of an [inactiveAwsRoleFinding](../resources/inactiveawsrolefinding.md) object.
...
If successful, this method returns a `200 OK` response code and an updated [inactiveAwsRoleFinding](../resources/inactiveawsrolefinding.md) object in the response body.
...
<!-- {
  "blockType": "request",
  "name": "update_inactiveawsrolefinding"
}
-->
``` http
