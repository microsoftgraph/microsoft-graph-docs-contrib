...
| additionalNotificationRecipients   |[accessReviewNotificationRecipientItem] (../resources/accessReviewNotificationRecipientItem.md) collection| Allows creator to specify additional AAD users or AAD groups to be notified by email when the review completes.|
