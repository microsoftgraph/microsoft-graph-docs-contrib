...
> **Known Limitation**: In the current beta release, the **layoutType** property returns `null` for the primary channel. To get the layout type, use the [Get channel](../api/channel-get.md) API with the primary channel's ID. Full support for **layoutType** is planned for a future release.
