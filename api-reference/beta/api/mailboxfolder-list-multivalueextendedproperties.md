...
<!-- {
  ...
  "name": "mailboxfolder-list-multivalueextendedproperties-permissions"
}
-->
[!INCLUDE [permissions-table](../includes/permissions/mailboxfolder-list-multivalueextendedproperties-permissions.md)]
...
-->
``` http
GET /admin/exchange/mailboxes/{mailboxId}/folders/{mailboxFolderId}/multiValueExtendedProperties
```
...
-->
``` http
GET https://graph.microsoft.com/beta/admin/exchange/mailboxes/{mailboxId}/folders/{mailboxFolderId}/multiValueExtendedProperties
```
