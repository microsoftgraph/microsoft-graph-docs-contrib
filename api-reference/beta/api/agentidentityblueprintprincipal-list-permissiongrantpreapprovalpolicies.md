...
<!-- {
  ...
  "name": "agentidentityblueprintprincipal-list-permissiongrantpreapprovalpolicies-permissions"
}
-->
[!INCLUDE [permissions-table](../includes/permissions/agentidentityblueprintprincipal-list-permissiongrantpreapprovalpolicies-permissions.md)]
...
-->
``` http
GET https://graph.microsoft.com/beta/servicePrincipals/{servicePrincipalsId}/permissionGrantPreApprovalPolicies
```
