...
If successful, this method returns a `200 OK` response code and [cloudpcpolicyscheduledapplyactiondetail](../../beta/resources/cloudpcpolicyscheduledapplyactiondetail.md) in the response body.
