...
Retrieve a list of [plannerPlans](plannerPlan.md) that are marked as favorite by a user. Plans can be marked as favorite by modifying the [plannerUser](plannerUser.md) resource.
