...
<!-- {
  ...
  "name": "videonewslinkpage-list-lastmodifiedbyuser-permissions"
}
-->
[!INCLUDE [permissions-table](../includes/permissions/videonewslinkpage-list-lastmodifiedbyuser-permissions.md)]
...
-->
``` http
GET /videoNewsLinkPage/lastModifiedByUser
```
...
-->
``` http
GET https://graph.microsoft.com/beta/videoNewsLinkPage/lastModifiedByUser
```
