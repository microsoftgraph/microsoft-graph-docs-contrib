...
Update the properties of a [intuneBrandingProfile](../resources/intune_wip_intunebrandingprofile.md) object.
## Prerequisites
...
## Request body
In the request body, supply a JSON representation for the [intuneBrandingProfile](../resources/intune_wip_intunebrandingprofile.md) object.

The following table shows the properties that are required when you create the [intuneBrandingProfile](../resources/intune_wip_intunebrandingprofile.md).
...
## Response
If successful, this method returns a `200 OK` response code and an updated [intuneBrandingProfile](../resources/intune_wip_intunebrandingprofile.md) object in the response body.
