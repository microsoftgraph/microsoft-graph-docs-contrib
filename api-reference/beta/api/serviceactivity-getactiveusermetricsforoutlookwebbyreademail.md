...
description: "Get all the active usage based on the number of users that successfully read emails using Outlook for the web."
author: "mkuninty"
...
Get all the active usage based on the number of users that successfully read emails using Outlook for the web.
