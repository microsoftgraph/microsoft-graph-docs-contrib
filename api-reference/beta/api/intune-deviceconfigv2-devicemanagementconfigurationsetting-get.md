...
-->
```http
GET /deviceManagement/auditPolicies/{deviceManagementAuditPolicyId}/settings/{deviceManagementConfigurationSettingId}
...
```http
GET https://graph.microsoft.com/beta/deviceManagement/auditPolicies/{deviceManagementAuditPolicyId}/settings/{deviceManagementConfigurationSettingId}
```
