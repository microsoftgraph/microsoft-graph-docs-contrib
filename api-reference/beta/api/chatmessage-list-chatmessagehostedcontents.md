...
|Application| For **user** or **chat** resource:<br/>Chat.Read.All, Chat.ReadWrite.All<br/><br/>For **channel** resource:<br/>ChannelMessage.Read.All, Group.Read.All, Group.ReadWrite.All |
