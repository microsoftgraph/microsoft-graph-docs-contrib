...
|:---------------------------------------|:--------------------------------------------|
|Delegated (work or school account)| For user or chat resource: Chat.Read, Chat.ReadWrite.<br/>For channel resource: ChannelMessage.Read.All, Group.Read.All, Group.Read.WriteAll |
|Delegated (personal Microsoft account)|Not supported|
|Application| For user or chat resource: Chat.Read.All, Chat.ReadWrite.All.<br/>For channel resource: ChannelMessage.Read.Group (RSC), ChannelMessage.Read.All, Group.Read.All, Group.ReadWrite.All |
