...
|Application| ChannelMessage.Read.All, Chat.Read.All, For **user** or **chat** resource:<br/>Chat.Read.All, Group.Read.All, Chat.ReadWrite.All<br/><br/>For **channel** resource:<br/>ChannelMessage.Read.Group ([RSC](aka.ms/teams-rsc)), Chat.ReadWrite.All, Group.ReadWrite.All |
