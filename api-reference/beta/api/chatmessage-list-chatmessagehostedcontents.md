...
|:---------------------------------------|:--------------------------------------------|
|Delegated (work or school account)|For **user** or **chat** resource:<br/>Chat.Read, Chat.ReadWrite<br/><br/>For **channel** resource:<br/>ChannelMessage.Read.Group, Group.Read.All, Group.ReadWrite.All|
|Delegated (personal Microsoft account)|Not supported|
|Application| For **user** or **chat** resource:<br/>Chat.Read.All, Chat.ReadWrite.All<br/><br/>For **channel** resource:<br/>ChannelMessage.Read.Group, Group.Read.All, Group.ReadWrite.All |
