---
title: "agentIdentity: addTokenSigningCertificate"
description: "Add a signing certificate to a agentIdentity."
author: "zallison22"
ms.date: 10/27/2025
...
# agentIdentity: addTokenSigningCertificate
...
<!-- {
  ...
  "name": "agentidentity-addtokensigningcertificate-permissions"
}
-->
[!INCLUDE [permissions-table](../includes/permissions/agentidentity-addtokensigningcertificate-permissions.md)]
...
```http
POST /servicePrincipals/{id}/Microsoft.Graph.AgentIdentity/addTokenSigningCertificate
POST /servicePrincipals(appId='{appId}')/Microsoft.Graph.AgentIdentity/addTokenSigningCertificate
```
...
<!-- {
  "blockType": "request",
  "name": "agentidentitythis.addtokensigningcertificate"
}
-->
``` http
POST https://graph.microsoft.com/beta/riskyAgentIdentity/agentIdentity/addTokenSigningCertificate
