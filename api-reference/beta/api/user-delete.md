...
Delete a [user](../resources/user.md) object. If the ID specified in the request URL is that of an [agentUser](../resources/agentuser.md) object, this request deletes the agent user.
