...
-->
``` http
POST /external/authorizationSystems/{authorizationSystemId}/dataCollectionInfo
```
...
-->
``` http
POST https://graph.microsoft.com/beta/external/authorizationSystems/{authorizationSystemId}/dataCollectionInfo
