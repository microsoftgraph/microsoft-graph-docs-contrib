...
-->
``` http
DELETE ** Entity URI for microsoft.graph.windowsUpdates.contentApproval not found
```
...
-->
``` http
DELETE https://graph.microsoft.com/beta** Entity URI for microsoft.graph.windowsUpdates.contentApproval not found
```
