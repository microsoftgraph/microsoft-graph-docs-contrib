...
If successful, this method returns a `200 OK` response code and a collection of [retentionLabel](api-reference/beta/resources/recordsmanagement-retentionlabel.md) objects in the response body.
