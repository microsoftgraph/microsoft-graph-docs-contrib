---
title: "Add user"
description: "Add createdBy by posting to the createdBy collection."
author: "AlexFilipin"
...
Add createdBy by posting to the createdBy collection.
...
-->
``` http
POST /identityGovernance/lifecycleWorkflows/customTaskExtensions/{customTaskExtensionId}/createdBy/$ref
```
...
-->
``` http
POST https://graph.microsoft.com/beta/identityGovernance/lifecycleWorkflows/customTaskExtensions/{customTaskExtensionId}/createdBy/$ref
