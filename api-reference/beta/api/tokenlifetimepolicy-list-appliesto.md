...
Get a list of [directoryObject](../api/directoryObject.md) objects that this policy has been applied to. The tokenLifetimePolicy can only be applied to [application](../api/application.md) and [servicePrincipal](../api/serviceprincipal.md) resources, and this operation can only be done via those resources.
