...
If successful, this method returns a `200 OK` response code and a collection of [lifecycleManagementSettings](../resources/identitygovernance-lifecyclemanagementsettings.md) objects in the response body.
