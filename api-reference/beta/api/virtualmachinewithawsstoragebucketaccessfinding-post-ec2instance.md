...
description: "Add ec2Instance by posting to the ec2Instance collection."
...
Add ec2Instance by posting to the ec2Instance collection.
...
-->
``` http
POST /virtualMachineWithAwsStorageBucketAccessFinding/ec2Instance/$ref
```
...
-->
``` http
POST https://graph.microsoft.com/beta/virtualMachineWithAwsStorageBucketAccessFinding/ec2Instance/$ref
