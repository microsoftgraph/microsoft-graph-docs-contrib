...
|comments|String collection|Analyst comments on the alert (for customer alert management). Edits made to the comments property with this method are limited to persist only the following comments:  `Closed in IPC`,  `Closed in MCAS`.|
