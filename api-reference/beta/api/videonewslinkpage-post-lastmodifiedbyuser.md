...
<!-- {
  ...
  "name": "videonewslinkpage-post-lastmodifiedbyuser-permissions"
}
-->
[!INCLUDE [permissions-table](../includes/permissions/videonewslinkpage-post-lastmodifiedbyuser-permissions.md)]
...
-->
``` http
POST /videoNewsLinkPage/lastModifiedByUser/$ref
```
...
-->
``` http
POST https://graph.microsoft.com/beta/videoNewsLinkPage/lastModifiedByUser/$ref
