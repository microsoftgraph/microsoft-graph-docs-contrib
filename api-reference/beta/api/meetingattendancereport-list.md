...
Get a list of [meetingAttendanceReport](../resources/meetingAttendanceReport.md) objects for an [online meeting](../resources/onlinemeeting.md) or a [virtual event](../resources/virtualevent.md). Each time an online meeting ends, an attendance report is generated for that session.
