...
A function to get a collection of [virtualEventWebinar](../resources/virtualeventwebinar.md) objects where the specified user is the organizer or a co-organizer.
...
|:---|:---|:---|
|userId|String|The ID of the user in Azure Active Directory.|
|role|String|User role of the webinar. Possible values are: `organizer`, `coOrganizer`.|
...
If successful, this method returns a `200 OK` response code and a list of [virtualEventWebinar](../resources/virtualeventwebinar.md) objects in the response body.
...
<!-- {
  "blockType": "request",
  "name": "virtualeventwebinar_getByUserIdAndRole"
}
-->
``` http
GET https://graph.microsoft.com/beta/solutions/virtualEvents/webinars/getByUserIdAndRole(userId='2c409337-6849-479c-a063-17591414b3b8', role='organizer')
```
