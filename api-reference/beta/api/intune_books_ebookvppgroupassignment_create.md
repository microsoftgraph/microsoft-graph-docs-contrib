...
## Request body
In the request body, supply a JSON representation for the eBookVppGroupAssignment object.

The following table shows the properties that are required when you create the eBookVppGroupAssignment.
