...
description: "Add storageAccount by posting to the storageAccount collection."
...
Add storageAccount by posting to the storageAccount collection.
...
-->
``` http
POST /externallyAccessibleAzureBlobContainerFinding/storageAccount/$ref
```
...
-->
``` http
POST https://graph.microsoft.com/beta/externallyAccessibleAzureBlobContainerFinding/storageAccount/$ref
