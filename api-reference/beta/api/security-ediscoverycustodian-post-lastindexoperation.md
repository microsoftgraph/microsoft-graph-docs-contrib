---
title: "Create ediscoveryIndexOperation"
description: "Create a new ediscoveryIndexOperation object."
...
# Create ediscoveryIndexOperation
Namespace: microsoft.graph.security

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

Create a new [ediscoveryIndexOperation](../resources/security-ediscoveryindexoperation.md) object.
...
-->
``` http
POST ** Collection URI for microsoft.graph.security.ediscoveryIndexOperation not found
```
...
## Request body
In the request body, supply a JSON representation of the [ediscoveryIndexOperation](../resources/security-ediscoveryindexoperation.md) object.

You can specify the following properties when creating an **ediscoveryIndexOperation**.
...
If successful, this method returns a `201 Created` response code and an [ediscoveryIndexOperation](../resources/security-ediscoveryindexoperation.md) object in the response body.
...
<!-- {
  "blockType": "request",
  "name": "create_ediscoveryindexoperation_from_"
}
-->
``` http
POST https://graph.microsoft.com/beta** Collection URI for microsoft.graph.security.ediscoveryIndexOperation not found
