...
<!-- {
  ...
  "name": "engagementrolemember-post-user-permissions"
}
-->
[!INCLUDE [permissions-table](../includes/permissions/engagementrolemember-post-user-permissions.md)]
...
-->
``` http
POST /users/{usersId}/employeeExperience/assignedRoles/{engagementRoleId}/members/{engagementRoleMemberId}/user/$ref
```
...
|cloudLicensing|[userCloudLicensing](../resources/cloudlicensing-usercloudlicensing.md)|**TODO: Add Description** Optional.|
...
-->
``` http
POST https://graph.microsoft.com/beta/users/{usersId}/employeeExperience/assignedRoles/{engagementRoleId}/members/{engagementRoleMemberId}/user/$ref
