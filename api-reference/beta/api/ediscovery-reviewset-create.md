...
Create a new [reviewSet](../resources/ediscoveryreviewset.md). The request body contains the display name of the review set which is the only writable property.
