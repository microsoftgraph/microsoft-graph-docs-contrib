...
Preferred presence takes effect only when there is at least one [presence session](/graph/manage-presence-state#presence-sessions) of the user. Otherwise, the user's presence stays as Offline.
