...
Create a new [permissionsAnalytics](../resources/permissionsanalytics.md) object.
...
-->
``` http
POST ** Collection URI for microsoft.graph.permissionsAnalytics not found
```
...
-->
``` http
POST https://graph.microsoft.com/beta** Collection URI for microsoft.graph.permissionsAnalytics not found
