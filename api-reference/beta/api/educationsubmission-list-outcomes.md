...
The available `$expand` option for this method is * which includes all the previous options.
...
```
### Example 3: Get outcomes with $expand options
#### Request
The following is an example of the request.
...
<!-- {
  ...
  "name": "get_outcomes_expand"
}-->
```msgraph-interactive
GET https://graph.microsoft.com/beta/education/classes/37d99af7-cfc5-4e3b-8566-f7d40e4a2070/assignments/a3cce0ba-2008-4c4d-bf62-079408562d96/submissions/2185e6d7-2924-4ed1-dde1-269f89e29184/outcomes?$expand=*
```
...
{
    "@odata.context": "https://graph.microsoft.com/beta/$metadata#education/classes('37d99af7-cfc5-4e3b-8566-f7d40e4a2070')/assignments('a3cce0ba-2008-4c4d-bf62-079408562d96')/submissions('2185e6d7-2924-4ed1-dde1-269f89e29184')/outcomes",
    "@microsoft.graph.tips": "Use $select to choose only the properties your app needs, as this can lead to performance improvements. For example: GET education/classes('<37d99af7-cfc5-4e3b-8566-f7d40e4a2070>')/assignments('<a3cce0ba-2008-4c4d-bf62-079408562d96>')/submissions('<2185e6d7-2924-4ed1-dde1-269f89e29184>')/outcomes?$select=lastModifiedBy,lastModifiedDateTime",
    "value": [
        {
            "@odata.type": "#microsoft.graph.educationFeedbackOutcome",
        ...
        },
        {
            ...
            "feedbackResource": {
                ...
                "lastModifiedDateTime": "2022-05-06T00:52:21.8011514Z",
                "fileUrl": "https://graph.microsoft.com/beta/drives/b!-Ik2sRPLDEWy_bR8l75jfeDcpXQcRKVOmcml10NQLQ1F8CNZWU38SarWxPyWM7jx/items/01VANVJQ3OHVMMZAEQPRC3LQJLBEQQY4BI",
                "createdBy": {
                    "application": null,
                    "device": null,
                    "user": {
        ...
        },
        {
            ...
            "feedbackResource": {
                ...
                "lastModifiedDateTime": "2022-05-06T00:52:26.3994863Z",
                "fileUrl": "https://graph.microsoft.com/beta/drives/b!-Ik2sRPLDEWy_bR8l75jfeDcpXQcRKVOmcml10NQLQ1F8CNZWU38SarWxPyWM7jx/items/01VANVJQ77OZHY33IMBRB2WKYKKXGM6KLV",
                "createdBy": {
                    "application": null,
                    "device": null,
                    "user": {
        ...
        },
        {
            ...
            "feedbackResource": {
                ...
                "lastModifiedDateTime": "2022-10-21T18:58:42.019513Z",
                "fileUrl": "https://graph.microsoft.com/beta/drives/b!-Ik2sRPLDEWy_bR8l75jfeDcpXQcRKVOmcml10NQLQ1F8CNZWU38SarWxPyWM7jx/items/01VANVJQ5X3ULNDOWTJJEYSIBXZIK42E5G",
                "createdBy": {
                    "application": null,
                    "device": null,
                    "user": {
