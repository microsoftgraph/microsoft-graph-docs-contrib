---
title: "List virtualEvent Attendance Reports"
description: "Get a list of attendance reports for virtual event session."
author: "awang119"
...
# List VirtualEvent Attendance Report
Namespace: microsoft.graph

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

Get a list of [meetingAttendanceReport](../resources/meetingAttendanceReport.md) objects for a [virtualEventSession](../resources/virtualeventsession.md).
...
-->
To list attendance reports for a session of a webinar:
