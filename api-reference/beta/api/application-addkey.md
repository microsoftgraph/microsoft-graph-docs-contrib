...
>
> You should only provide the public key value when adding a certificate credential to your application. Not removing the private key metadata from the certificate before adding to your application introduces a risk of compromise to your application.
