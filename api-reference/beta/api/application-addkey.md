...
>
> You should only provide the public key value when adding a certificate credential to your application. Failure to remove the private key metadata from the certificate before adding key credentials risks compromising your application.
