...
description: "Get all the active usage based on the number of users that successfully read emails using Outlook for the Mac."
author: "mkuninty"
...
Get all the active usage based on the number of users that successfully read emails using Outlook for the Mac.
