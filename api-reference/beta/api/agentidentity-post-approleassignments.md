---
title: "Grant an appRoleAssignment to an agent identity"
description: "Grant an app role assignment to an agent identity."
author: "zallison22"
ms.date: 10/27/2025
...
# Grant an appRoleAssignment to an agent identity
...
App roles that are assigned to agent identity are also known as [application permissions](/azure/active-directory/develop/v2-permissions-and-consent#permission-types). Application permissions can be granted directly with app role assignments, or through a [consent experience](/azure/active-directory/develop/application-consent-experience).
...
<!-- {
  "blockType": "request",
  "name": "agentidentity_create_approleassignment"
}-->
...
In this example, note that the value used as the agentIdentity  **id** in the request URL (`9028d19c-26a9-4809-8e3f-20ff73e2d75e`) is the same as the **principalId** property in the body. The **resourceId** value is the **id** of the resource service principal (the API).
