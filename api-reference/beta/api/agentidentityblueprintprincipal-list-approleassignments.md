...
<!-- {
  ...
  "name": "agentidentityblueprintprincipal-list-approleassignments-permissions"
}
-->
...
-->
``` http
GET /servicePrincipals/{servicePrincipalsId}/Microsoft.Graph.AgentIdentityBlueprintPrincipal/appRoleAssignments
```
