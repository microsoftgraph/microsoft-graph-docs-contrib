...
|listItemUniqueId|String|The unique ID of the file or folder to process. It's one of the sharepointIds. Check the [driveItem](../resources/driveitem.md) resource to get listItemUniqueId. For more information, see [sharepointids](../resources/sharepointids.md).|
