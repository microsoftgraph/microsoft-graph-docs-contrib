...
|Application                            | `AccessReview.Read.All`, `AccessReview.ReadWrite.All`.  The service principal must also be in a directory role which permits them to read an access review. |
