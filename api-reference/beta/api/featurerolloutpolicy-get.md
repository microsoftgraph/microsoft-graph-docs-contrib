...
This method supports some of the OData query parameters like $select to help customize the response. For general information, see [OData query parameters](/graph/query-parameters).
