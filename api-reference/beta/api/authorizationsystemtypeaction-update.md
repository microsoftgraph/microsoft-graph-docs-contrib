...
-->
``` http
PATCH /privilegeEscalation/actions/{authorizationSystemTypeActionId}
...
-->
``` http
PATCH https://graph.microsoft.com/beta/privilegeEscalation/actions/{authorizationSystemTypeActionId}
