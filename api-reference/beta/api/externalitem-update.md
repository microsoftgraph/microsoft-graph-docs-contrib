...
| content    | [externalItemContent](externalitemcontent.md) | A plain-text or HTML representation of the contents of the item. The text in this property is full-text indexed. |
