...
<ul><li>`unknown` – Default or unspecified booking behavior</li>
<li>`standard` - Available for general booking</li>
<li>`reserved` – Reserved for specific users or purposes</li></ul> |
