...
| sensorMigration                        | [microsoft.graph.security.sensorMigration](security-sensormigration.md) collection                                               | Represents Microsoft Defender for Identity sensors that can be migrated to the unified security portal.                                        |
