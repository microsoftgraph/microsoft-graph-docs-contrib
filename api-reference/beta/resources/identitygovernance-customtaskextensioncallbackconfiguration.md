...
|authorizedApps|microsoft.graph.application collection| A collection of unique identifiers `appId` of the applications that are allowed to [resume](../api/identitygovernance-taskprocessingresult-resume.md) a task processing result.|
