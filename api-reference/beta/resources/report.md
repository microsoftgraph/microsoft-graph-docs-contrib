...
| :---------------------- | :--------------------------------------- |
| AttackSimulation        | <ul><li>[getAttackSimulationRepeatOffenders](../api/reportroot-getattacksimulationrepeatoffenders.md)</li><li>[getAttackSimulationSimulationUserCoverage](../api/reportroot-getattacksimulationsimulationusercoverage.md)</li><li>[getAttackSimulationTrainingUserCoverage](../api/reportroot-getattacksimulationtrainingusercoverage.md)</li></ul> |
