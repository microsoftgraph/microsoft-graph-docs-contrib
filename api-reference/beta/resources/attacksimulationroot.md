...
|[List payloads](../api/attacksimulationroot-lists-payloads.md)|[payload](../resources/payload.md) collection|Get the payload resources from the payloads navigation property.|
