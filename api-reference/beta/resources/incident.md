...
|comments|[m365AlertComment](../resources/m365alertcomment.md) collection|Array of comments created by secops when managing the incident.|
|createdDateTime|DateTimeOffset|Time when incident was first created.|
...
|incidentWebUrl|String|URL for the incident page in M365Defender portal.|
|lastUpdateDateTime|DateTimeOffset|Time when the incident was last updated.|
|redirectIncidentId|String|Only populated in case an incident is being grouped together with another incident, as part of the incident processing logic.|
