...
Represents the identity information (**sourceIdentity** and **targetIdentity** properties) used in a [correlatedIdentity](../resources/correlatedidentity.md) object in [identity correlation reports](../resources/identitycorrelation.md). Contains the anchor property, matching property, identity type, and additional details for a source or target identity.
