...
|dueDateTime|**dateTimeTimeZone**|The date and time that the follow up is to be finished. **Note**: in order to set the due date, you must also specify the `startDateTime`; otherwise, you will get a `400 "InvalidRequest"` response.|
