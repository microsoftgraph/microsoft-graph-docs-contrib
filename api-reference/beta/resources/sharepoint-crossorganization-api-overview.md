...
2. Gets the sharePointMigrationTask that was previously created, given the task's ID, sourceUserPrincipalName, sourceSiteUrl, or sourceGroupObjectId
...
| :--- | :--- |
|To migrate a specific **user** in a source tenant to a target tenant|[sharePointUserMigrationTaskParameters](sharepointusermigrationtaskparameters.md)|
|To migrate a specific **regular site** in a source tenant to a target tenant|[sharePointSiteMigrationTaskParameters](sharepointsitemigrationtaskparameters.md)|
|To migrate a specific **group-connected site** in a source tenant to a target tenant|[sharePointGroupMigrationTaskParameters](sharepointgroupmigrationtaskparameters.md)|

## Next steps

Use the Microsoft Graph API to manage the tasks during tenant-to-tenant migrations. To learn more:
