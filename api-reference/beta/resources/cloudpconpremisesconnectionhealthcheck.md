...
|additionalDetails (deprecated)|String|Additional details about the health check or the recommended action. Read-only. Starting from January 31, 2024, this property will no longer be supported and will be marked as deprecated. Please use additionalDetail instead. |
