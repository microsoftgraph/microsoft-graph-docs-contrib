...
|resourceAvailabilityCheckNoIntuneReaderRoleError|The cloudPC service principal doesn't have sufficient permissions to check the Intune platform restriction settings. Please make sure that the cloudPC service principal has the *Reader* permissions on the subscription.|
