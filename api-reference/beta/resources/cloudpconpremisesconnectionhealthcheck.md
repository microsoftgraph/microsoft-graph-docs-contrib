...
|endpointConnectivityCheckLocaleUrlNotAllowListed|During provisioning, one or more required language package URLs couldn’t be contacted. Please make sure that all of the required URLs are allowed through the firewalls and proxies.|
