...
|azureAdDeviceSyncCheckTransientServiceError|The Azure Active Directory (Azure AD) device sync check failed due to a transient error. Please retry it again. If the issue persists, please contact Customer Support.|
...
|resourceAvailabilityCheckTransientServiceError|The resource availability check failed due to a transient error. Please retry it again. If the issue persists, please contact Customer Support.|
...
|permissionCheckTransientServiceError|The first-party app permission check failed due to a transient error. Please retry it again. If the issue persists, please contact Customer Support.|
