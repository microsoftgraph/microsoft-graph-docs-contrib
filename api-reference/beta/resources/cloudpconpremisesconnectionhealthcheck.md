...
|adJoinCheckCredentialsExpired|The domain join check failed because the password of the domain join user has expired. Please update the password then update the on-premises network connection with the new credentials.|
