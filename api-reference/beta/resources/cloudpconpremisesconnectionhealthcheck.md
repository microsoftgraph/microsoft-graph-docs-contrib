...
|azureAdDeviceSyncCheckConnectDisabled|The Azure AD device sync check failed because the Azure AD Connect is disabled. Please make sure Azure AD Connect is enabled and syncing frequently. If Azure AD connect doesn't sync the computer within 60 minutes, then check will fail.|
|azureAdDeviceSyncCheckDurationExceeded|The Azure AD device sync check failed because the Azure AD sync doesn't sync in 60 minutes. Please make sure Azure AD Connect is enabled and syncing frequently. If Azure AD connect doesn't sync the computer within 60 minutes, then check will fail.|
|azureAdDeviceSyncCheckTransientServiceError|A transient error occurred while checking Azure AD device sync. Please retry it again. If the issue persists, please contact Customer Support.|
...
|resourceAvailabilityCheckTransientServiceError|A transient error occurred while checking resource availability. Please retry it again. If the issue persists, please contact Customer Support.|
...
|permissionCheckTransientServiceError|A transient error occurred while checking first party app permissions. Please retry it again. If the issue persists, please contact Customer Support.|
