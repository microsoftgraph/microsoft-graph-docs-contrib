...
|resourceAvailabilityCheckMissingRegistrationForLocation| Missing registration for location. The issue can be fixed by registering the resource provider (Azure Network provider) for your account.|
