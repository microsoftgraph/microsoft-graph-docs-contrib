---
title: "appConfigurationSchemaItemMultiselectType resource type"
description: "Multiselect configuration item inside an Android application's custom configuration schema."
author: "jaiprakashmb"
...
# appConfigurationSchemaItemMultiselectType resource type
...
|defaultValue|String collection|Default value, if specified by the app developer|
...
<!-- {
  "blockType": "resource",
  "@odata.type": "microsoft.graph.appConfigurationSchemaItemMultiselectType"
}
-->
``` json
{
