...
|[permanentDelete](../api/outlooktask-permanentdelete.md)|None|Permanent delete outlook tasks and places it in the Purges folder of the dumpster in user's mailbox|
|**Attachments**| | |
