...
|[permanentDelete](../api/outlooktask-permanentdelete.md)|None|Permanently delete outlook tasks and places it in the Purges folder in the Recoverable Items folder in the user's mailbox.|
|**Attachments**| | |
