...
| :--------------- | :----------------------------------------- | :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
|accessedResources|String collection|Deprecated. Identifiers of resources accessed during the conversation. Use accessedResources_v2 instead.|
|accessedResources_v2|[resourceAccessDetail](../resources/resourceaccessdetail.md) collection|Provides detailed information about resources accessed during the conversation, including identifiers, access type, and status.|
|agents|[aiAgentInfo](../resources/aiagentinfo.md) collection|Information about AI agents that participated in preparing the message.|
...
|parentMessageId|String|Identifier of the parent message in the conversation thread.|
|plugins|[aiInteractionPlugin](../resources/aiinteractionplugin.md) collection|Information about AI interaction plugins used during the conversation.|
