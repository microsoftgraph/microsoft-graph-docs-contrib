...
|---|---|---|
|[List androidCustomConfigurations](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/api/intune_deviceconfig_androidcustomconfiguration_list.md)|[androidCustomConfiguration](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_deviceconfig_androidcustomconfiguration.md) collection|List properties and relationships of the [androidCustomConfiguration](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_deviceconfig_androidcustomconfiguration.md) objects.|
|[Get androidCustomConfiguration](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/api/intune_deviceconfig_androidcustomconfiguration_get.md)|[androidCustomConfiguration](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_deviceconfig_androidcustomconfiguration.md)|Read properties and relationships of the [androidCustomConfiguration](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_deviceconfig_androidcustomconfiguration.md) object.|
|[Create androidCustomConfiguration](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/api/intune_deviceconfig_androidcustomconfiguration_create.md)|[androidCustomConfiguration](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_deviceconfig_androidcustomconfiguration.md)|Create a new [androidCustomConfiguration](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_deviceconfig_androidcustomconfiguration.md) object.|
|[Delete androidCustomConfiguration](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/api/intune_deviceconfig_androidcustomconfiguration_delete.md)|None|Deletes a [androidCustomConfiguration](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_deviceconfig_androidcustomconfiguration.md).|
|[Update androidCustomConfiguration](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/api/intune_deviceconfig_androidcustomconfiguration_update.md)|[androidCustomConfiguration](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_deviceconfig_androidcustomconfiguration.md)|Update the properties of a [androidCustomConfiguration](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_deviceconfig_androidcustomconfiguration.md) object.|
