...
|---|---|---|
|[List windowsPhone81AppXs](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/api/intune_apps_windowsphone81appx_list.md)|[windowsPhone81AppX](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_apps_windowsphone81appx.md) collection|List properties and relationships of the [windowsPhone81AppX](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_apps_windowsphone81appx.md) objects.|
|[Get windowsPhone81AppX](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/api/intune_apps_windowsphone81appx_get.md)|[windowsPhone81AppX](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_apps_windowsphone81appx.md)|Read properties and relationships of the [windowsPhone81AppX](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_apps_windowsphone81appx.md) object.|
|[Create windowsPhone81AppX](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/api/intune_apps_windowsphone81appx_create.md)|[windowsPhone81AppX](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_apps_windowsphone81appx.md)|Create a new [windowsPhone81AppX](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_apps_windowsphone81appx.md) object.|
|[Delete windowsPhone81AppX](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/api/intune_apps_windowsphone81appx_delete.md)|None|Deletes a [windowsPhone81AppX](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_apps_windowsphone81appx.md).|
|[Update windowsPhone81AppX](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/api/intune_apps_windowsphone81appx_update.md)|[windowsPhone81AppX](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_apps_windowsphone81appx.md)|Update the properties of a [windowsPhone81AppX](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_apps_windowsphone81appx.md) object.|
