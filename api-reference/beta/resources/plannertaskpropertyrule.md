...
Represents specific restrictions that apply to editing a [plannerTask](../resources/plannertask.md). For more details, see [Planner task rules overview](planner-task-rules-overview.md).
