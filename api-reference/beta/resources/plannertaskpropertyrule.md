...
Represents specific restrictions that apply to editing a [plannerTask](../resources/plannertask.md). For more details, see [Planner Task Rules](planner-task-rules-overview.md).
