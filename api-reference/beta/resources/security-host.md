...
| [Get WHOIS for a host](../api/security-host-get-whois.md)                           | [microsoft.graph.security.whoisRecord](../resources/security-whoisrecord.md)                      | Get the current [microsoft.graph.security.whoisRecord](../resources/security-whoisrecord.md) resource for a [microsoft.graph.security.host](../resources/security-host.md).                                                 |
