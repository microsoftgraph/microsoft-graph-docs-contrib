...
| [List operations](../api/industrydata-longrunningoperation-list.md)                       | [microsoft.graph.longRunningOperation](indusydata-longrunningoperation.md) collection                        | Get a list of [long-running operations](longrunningoperation.md) and their statuses.                                    |
