...
| [List operations](../api/industrydata-longrunningoperation-list.md)                       | [microsoft.graph.longRunningOperation](industrydata-longrunningoperation.md) collection                      | Get a list of [long-running operations](industrydata-longrunningoperation.md) and their statuses.                       |
...
| operations           | [microsoft.graph.longRunningOperation](industrydata-longrunningoperation.md) collection                      | Set of ephemeral operations that the system is currently running. Read-only.                                                  |
