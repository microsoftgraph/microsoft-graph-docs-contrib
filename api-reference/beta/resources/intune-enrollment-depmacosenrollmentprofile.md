...
|supervisedModeEnabled|Boolean|Supervised mode, True to enable, false otherwise. For more information, see [What is device enrollment in Intune?](/mem/intune/enrollment/device-enrollment). Inherited from [depEnrollmentBaseProfile](../resources/intune-enrollment-depenrollmentbaseprofile.md)|
