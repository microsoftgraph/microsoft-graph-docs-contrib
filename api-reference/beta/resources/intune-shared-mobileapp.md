...
|[getRelatedAppStates function](../api/intune-shared-mobileapp-getrelatedappstates.md)|[mobileAppRelationshipState](../resources/intune-shared-mobileapprelationshipstate.md) collection|Not yet documented|
|**Policy Set**|
...
|publishingState|[mobileAppPublishingState](../resources/intune-shared-mobileapppublishingstate.md)|The publishing state for the app. The app cannot be assigned unless the app is published. Possible values are: `notPublished`, `processing`, `published`.|
...
|:---|:---|:---|
|**Apps**|
|categories|[mobileAppCategory](../resources/intune-shared-mobileappcategory.md) collection|The list of categories for this app.|
|assignments|[mobileAppAssignment](../resources/intune-shared-mobileappassignment.md) collection|The list of group assignments for this mobile app.|
|installSummary|[mobileAppInstallSummary](../resources/intune-shared-mobileappinstallsummary.md)|Mobile App Install Summary.|
|deviceStatuses|[mobileAppInstallStatus](../resources/intune-shared-mobileappinstallstatus.md) collection|The list of installation states for this mobile app.|
...
|relationships|[mobileAppRelationship](../resources/intune-shared-mobileapprelationship.md) collection|List of relationships for this mobile app.|
