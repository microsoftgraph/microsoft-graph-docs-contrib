...
For more information on configuration options using accessReviewQueryScope, see [configure the scope of your access review definition](/graph/accessreviews-scope-concept).
