...
| mobileDeviceManagementPolicies            | [mobileDeviceManagementPolicies](mobilitymanagementpolicy.md) collection                                  | The policy that defines auto-enrollment configuration for a mobility management (MDM or MAM) application.                                                            |
