...
| [List sensitivity labels](../api/tenantdatasecurityandgovernance-list-sensitivitylabels.md)                                   | [[microsoft.graph.security.sensitivityLabel](../resources/security-sensitivitylabel.md) collection                                                         | Get a list of the sensitivityLabel objects and their properties using the data security and governance API.                                                                                          |
| [Get a sensitivity label](../api/sensitivitylabel-get.md)                                   | [[microsoft.graph.security.sensitivityLabel](../resources/security-sensitivitylabel.md) collection                                                         | Get a sensitivityLabel objects and it's properties using the data security and governance API.                                                                                          |
