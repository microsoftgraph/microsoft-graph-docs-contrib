...
|[retryPolicy](../api/security-ediscoveryholdpolicy-retrypolicy.md)|None|Retry policy triggers the hold process to restamp all mailboxes/sites in the policy to enforce hold.|
