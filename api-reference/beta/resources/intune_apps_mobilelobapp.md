...
|---|---|---|
|[List mobileLobApps](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/api/intune_apps_mobilelobapp_list.md)|[mobileLobApp](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_apps_mobilelobapp.md) collection|List properties and relationships of the [mobileLobApp](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_apps_mobilelobapp.md) objects.|
|[Get mobileLobApp](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/api/intune_apps_mobilelobapp_get.md)|[mobileLobApp](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_apps_mobilelobapp.md)|Read properties and relationships of the [mobileLobApp](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_apps_mobilelobapp.md) object.|
