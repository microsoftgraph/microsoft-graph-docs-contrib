...
|protectionMode|backupPolicyProtectionMode|Specifies the method used to protect artifacts within the policy. Possible values are: `standard`, `fullServiceBackup`, `unknownFutureValue`. Inherited from [protectionPolicyBase](../resources/protectionpolicybase.md).|
