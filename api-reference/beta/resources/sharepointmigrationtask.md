...
| status | [sharePointMigrationTaskStatus](../resources/enums.md#sharepointmigrationtaskstatus-values) | Enumeration value that indicates the status of the migration activity that this task represents. Omit this property during creation. The service returns it automatically. Only on OneDrive and SharePoint. |
