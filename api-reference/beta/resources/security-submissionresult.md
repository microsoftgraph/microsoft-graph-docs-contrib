...
| domainResembledYourOrganization        | The reported message comes from a domain that resembles your organization. Please re-evaluate item and, if it still appears to be clean, add the sender domain to the list of trusted domains within the Anti phish policy. |
| endUserBeingImpersonated               | This reported message was sent by someone impersonating an end user. Please re-evaluate item and, if it still appears to be clean, add the sender address to the list of trusted senders within the Anti phish policy. |
