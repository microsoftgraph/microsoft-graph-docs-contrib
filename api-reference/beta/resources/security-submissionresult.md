...
| endUserBeingImpersonated               | Someone impersonating the end user sent this reported message. Reevaluate item and, if it still appears to be clean, add the sender address to the list of trusted senders within the Anti phish policy. |
