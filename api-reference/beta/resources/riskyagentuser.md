...
Represents a Microsoft Entra [Agent User](../resources/agentuser.md) that is at risk. Microsoft Entra ID Protection continually evaluates agentic risk based various signals and machine learning.
...
|id|String|The unique identifier for the agent identity. This is equivalent to 'id' from [Agent User](../resources/agentuser.md). Inherited from [entity](../resources/entity.md). Inherits from [entity](../resources/entity.md)|
...
{
  "@odata.type": "#microsoft.graph.riskyAgentUser",
  "id": "5d715079-984a-49c5-9467-e1d6626cc321",
  "agentDisplayName": "Ask HR Agent",
  "isDeleted": false,
  "isEnabled": true,
  "isProcessing": false,
