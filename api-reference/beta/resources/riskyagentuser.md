...
|id|String|The unique identifier for the agent identity. This is equivalent to 'id' from [Agent User](../resources/agentuser.md). Inherited from [entity](../resources/entity.md). <br/><br/> Supports `$filter` (`eq`, `startsWith`).|
