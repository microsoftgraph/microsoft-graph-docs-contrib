...
|values|String collection|A collection with one or many strings. The specified string(s) is matched with the specified property using the specified operation. Required.|
