...
|---|---|---|
|[List editionUpgradeConfigurations](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/api/intune_deviceconfig_editionupgradeconfiguration_list.md)|[editionUpgradeConfiguration](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_deviceconfig_editionupgradeconfiguration.md) collection|List properties and relationships of the [editionUpgradeConfiguration](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_deviceconfig_editionupgradeconfiguration.md) objects.|
|[Get editionUpgradeConfiguration](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/api/intune_deviceconfig_editionupgradeconfiguration_get.md)|[editionUpgradeConfiguration](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_deviceconfig_editionupgradeconfiguration.md)|Read properties and relationships of the [editionUpgradeConfiguration](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_deviceconfig_editionupgradeconfiguration.md) object.|
|[Create editionUpgradeConfiguration](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/api/intune_deviceconfig_editionupgradeconfiguration_create.md)|[editionUpgradeConfiguration](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_deviceconfig_editionupgradeconfiguration.md)|Create a new [editionUpgradeConfiguration](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_deviceconfig_editionupgradeconfiguration.md) object.|
|[Delete editionUpgradeConfiguration](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/api/intune_deviceconfig_editionupgradeconfiguration_delete.md)|None|Deletes a [editionUpgradeConfiguration](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_deviceconfig_editionupgradeconfiguration.md).|
|[Update editionUpgradeConfiguration](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/api/intune_deviceconfig_editionupgradeconfiguration_update.md)|[editionUpgradeConfiguration](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_deviceconfig_editionupgradeconfiguration.md)|Update the properties of a [editionUpgradeConfiguration](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_deviceconfig_editionupgradeconfiguration.md) object.|
