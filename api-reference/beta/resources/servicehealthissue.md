...
|verifyingService|Action has been taken to mitigate the issue and we're verifying that the service is healthy.|
...
|serviceInterruption|An issue was determined to affect the ability for users to access the service. In this case, the issue is significant and can be reproduced consistently.|
