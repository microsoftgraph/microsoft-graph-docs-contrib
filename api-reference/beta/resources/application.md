...
| [List deleted applications owned by user](../api/directory-deleteditems-user-owned) | [directoryObject](directoryobject.md) collection | Retrieve the applications deleted in the tenant in the last 30 days and that are owned by a user. |
