...
| uniqueName | String | The unique identifier for the application that is assigned to an application when created through Azure Resource Manager. Immutable. Read-only. |
