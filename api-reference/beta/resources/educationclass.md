...
| [List assignments: delta](../api/educationclass-list-assignments-delta.md) | [educationAssignment]collection                | Get an **educationAssignment** object collection with delta query support.                                         |
