...
|appDetail|[cloudPcCloudAppDetail](../resources/cloudpccloudappdetail.md)|The details about the cloud app. These values come initially from the **appDetail** property of the associated discovered app. The **iconPath**, **iconIndex**, and **commandLineArguments** properties can be changed as needed when you update the cloud app. This is a polymorphic type with the following derived types: [cloudPcAutomaticDiscoveredAppDetail](../resources/cloudpcautomaticdiscoveredappdetail.md) for apps automatically discovered from the Start menu, and [cloudPcFilePathAppDetail](../resources/cloudpcfilepathappdetail.md) for apps manually created by specifying a file path. The `@odata.type` property indicates the specific type. Supports `$select`.|
