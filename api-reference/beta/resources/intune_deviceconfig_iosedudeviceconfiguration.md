...
|---|---|---|
|[List iosEduDeviceConfigurations](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/api/intune_deviceconfig_iosedudeviceconfiguration_list.md)|[iosEduDeviceConfiguration](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_deviceconfig_iosedudeviceconfiguration.md) collection|List properties and relationships of the [iosEduDeviceConfiguration](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_deviceconfig_iosedudeviceconfiguration.md) objects.|
|[Get iosEduDeviceConfiguration](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/api/intune_deviceconfig_iosedudeviceconfiguration_get.md)|[iosEduDeviceConfiguration](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_deviceconfig_iosedudeviceconfiguration.md)|Read properties and relationships of the [iosEduDeviceConfiguration](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_deviceconfig_iosedudeviceconfiguration.md) object.|
|[Create iosEduDeviceConfiguration](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/api/intune_deviceconfig_iosedudeviceconfiguration_create.md)|[iosEduDeviceConfiguration](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_deviceconfig_iosedudeviceconfiguration.md)|Create a new [iosEduDeviceConfiguration](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_deviceconfig_iosedudeviceconfiguration.md) object.|
|[Delete iosEduDeviceConfiguration](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/api/intune_deviceconfig_iosedudeviceconfiguration_delete.md)|None|Deletes a [iosEduDeviceConfiguration](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_deviceconfig_iosedudeviceconfiguration.md).|
|[Update iosEduDeviceConfiguration](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/api/intune_deviceconfig_iosedudeviceconfiguration_update.md)|[iosEduDeviceConfiguration](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_deviceconfig_iosedudeviceconfiguration.md)|Update the properties of a [iosEduDeviceConfiguration](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_deviceconfig_iosedudeviceconfiguration.md) object.|
...
|teacherCertificateSettings|[iosEduCertificateSettings](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_deviceconfig_ioseducertificatesettings.md)|The Trusted Root and PFX certificates for Teacher|
|studentCertificateSettings|[iosEduCertificateSettings](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_deviceconfig_ioseducertificatesettings.md)|The Trusted Root and PFX certificates for Student|
|deviceCertificateSettings|[iosEduCertificateSettings](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_deviceconfig_ioseducertificatesettings.md)|The Trusted Root and PFX certificates for Device|
