...
| [List incompatibleGroups](../api/accesspackage-list-incompatiblegroupss.md) | [group](group.md) collection | Retrieve a list of the incompatible **group** objects for this access package. |
