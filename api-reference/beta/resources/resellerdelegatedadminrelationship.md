...
Represents the details of the delegated administrative privileges that an Indirect Reseller Partner has in a customer tenant which is created by the Indirect Provider partner.
