...
|[permanentDelete](../api/eventmessage-permanentdelete.md)|None|Permanently delete eventmessage and places it in the Purges folder in the Recoverable Items folder in the user's mailbox.|
|**Attachments**| | |
