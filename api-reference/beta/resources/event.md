...
|:---------------|:--------|:----------|
|allowNewTimeProposals| Boolean | Use `true` if the meeting organizer allows invitees to propose a new time when responding, `false` otherwise. Optional. Default is `true`. |
