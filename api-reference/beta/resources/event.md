...
|[permanentDelete](../api/event-permanentdelete.md)|None|Permanently delete event and places it in the Purges folder in the Recoverable Items folder in the user's mailbox.|
