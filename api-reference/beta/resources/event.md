...
|isDraft|Boolean|Set to true if the meeting has changes that have not yet been sent to attendees. False if all changes have been sent, or if the event is an appointment without any attendees.|
