...
|originalStart|DateTimeOffset|The Timestamp type represents date and time information using ISO 8601 format and is always in UTC time. Only occurrences and exceptions of a series has a value for originalStart. For example, midnight UTC on Jan 1, 2014 is `2014-01-01T00:00:00Z`|
