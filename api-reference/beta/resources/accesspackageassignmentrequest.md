...
|customExtensionHandlerInstances|[customExtensionHandlerInstance](../resources/customextensionhandlerinstance.md) collection|Custom extension handler instance collection within the assignment request. Read-only. |
|id|String| Read-only.|
