...
| [Reprocess accessPackageAssignmentRequest](../api/accesspackageassignment-reprocess.md) | None | Automatically retry a user’s request for access to an access package.|
