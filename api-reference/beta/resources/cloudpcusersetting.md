...
|notificationSetting (deprecated)|[cloudPcNotificationSetting](../resources/cloudpcnotificationsetting.md)|Defines the setting of the Cloud PC notification prompts for the Cloud PC user. The **notificationSetting** property is deprecated and will stop returning data on July 14, 2026.|
