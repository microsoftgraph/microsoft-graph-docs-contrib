...
|[Get Conditional Access blocked sign-in metrics](../api/serviceactivity-getmetricsforconditionalaccessblockedsigninsuccess.md)|[serviceActivityValueMetric](../resources/serviceactivityvaluemetric.md) collection|Get the number of user authentication requests, during a specific time period, that satisfy a Conditional Access policy requiring the authentication to be blocked.|
