...
| [Get quota mailbox status counts](../api/reportroot_getmailboxusagequotamailboxstatuscounts.md) | Stream          | [mailboxUsageQuotaMailboxStatusCounts](../resources/mailboxusagequotamailboxstatuscounts.md) | Get the count of user mailboxes in each quota category. |
