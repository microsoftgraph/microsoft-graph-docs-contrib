...
|cloudPCUserSettingsPersistenceDetail|[cloudPCUserSettingsPersistenceDetail](../resources/cloudPCUserSettingsPersistenceDetail.md) |The assignment targeted user settings persistence for the provisioning policy. Allow user application data and Windows settings to be saved and applied between sessions.|
