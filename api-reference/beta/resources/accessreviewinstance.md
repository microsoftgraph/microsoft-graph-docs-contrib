...
| definition |[accessReviewScheduleDefinition](accessreviewscheduledefinition.md) | This is the parent schedule for the instance. There is exactly one **accessReviewScheduleDefinition** associated with each instance. |
