...
|[List inherited app role assignments](../api/agentidentity-list-inheritedapproleassignments.md)|[appRoleAssignment](../resources/approleassignment.md) collection|Get the app role assignments that this agent identity inherits from its parent Agent Identity Blueprint Service Principal.|
|[List inherited OAuth2 permission grants](../api/agentidentity-list-inheritedoauth2permissiongrants.md)|[oAuth2PermissionGrant](../resources/oauth2permissiongrant.md) collection|Get the delegated permission grants that this agent identity inherits from its parent Agent Identity Blueprint Service Principal.|
|**Deleted items**|||
