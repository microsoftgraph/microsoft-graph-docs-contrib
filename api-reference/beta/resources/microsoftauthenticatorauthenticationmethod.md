...
|clientAppName|microsoftAuthenticatorAuthenticationMethodClientAppName|The underlying app used by the user. The possible values are: `microsoftAuthenticator`, `outlookMobile`, `unknownFutureValue`.|
