...
|[Columnsafter](../api/workbookrange_columnsafter.md)|[workbookRange](workbookrange.md)|Gets a certain number of columns to the right of the given range.|
|[Columnsbefore](../api/workbookrange_columnsbefore.md)|[workbookRange](workbookrange.md)|Gets a certain number of columns to the left of the given range.|
...
|[Rowsabove](../api/workbookrange_rowsabove.md)|[workbookRange](workbookrange.md)|Gets a certain number of rows above a given range.|
|[Rowsbelow](../api/workbookrange_rowsbelow.md)|[workbookRange](workbookrange.md)|Gets a certain number of rows below a given range.|
...
|[Resizedrange](../api/workbookrange_resizedrange.md)|[workbookRange](workbookrange.md)|Gets a range object similar to the current range object, but with its bottom-right corner expanded (or contracted) by some number of rows and columns.|
