...
Up to 100 **allowedValue** objects can be defined per [customSecurityAttributeDefinition](customsecurityattributedefinition.md). You can't rename or delete this object, but you can be deactivate it by using the [Update allowedValue](../api/../api/allowedvalue-update.md) operation. This object is defined as a navigation property on the [customSecurityAttributeDefinition](customsecurityattributedefinition.md) resource and its value is returned only on `$expand`.
