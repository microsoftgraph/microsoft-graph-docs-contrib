...
|---|---|---|
|[List sharedPCConfigurations](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/api/intune_deviceconfig_sharedpcconfiguration_list.md)|[sharedPCConfiguration](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_deviceconfig_sharedpcconfiguration.md) collection|List properties and relationships of the [sharedPCConfiguration](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_deviceconfig_sharedpcconfiguration.md) objects.|
|[Get sharedPCConfiguration](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/api/intune_deviceconfig_sharedpcconfiguration_get.md)|[sharedPCConfiguration](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_deviceconfig_sharedpcconfiguration.md)|Read properties and relationships of the [sharedPCConfiguration](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_deviceconfig_sharedpcconfiguration.md) object.|
|[Create sharedPCConfiguration](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/api/intune_deviceconfig_sharedpcconfiguration_create.md)|[sharedPCConfiguration](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_deviceconfig_sharedpcconfiguration.md)|Create a new [sharedPCConfiguration](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_deviceconfig_sharedpcconfiguration.md) object.|
|[Delete sharedPCConfiguration](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/api/intune_deviceconfig_sharedpcconfiguration_delete.md)|None|Deletes a [sharedPCConfiguration](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_deviceconfig_sharedpcconfiguration.md).|
|[Update sharedPCConfiguration](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/api/intune_deviceconfig_sharedpcconfiguration_update.md)|[sharedPCConfiguration](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_deviceconfig_sharedpcconfiguration.md)|Update the properties of a [sharedPCConfiguration](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_deviceconfig_sharedpcconfiguration.md) object.|
