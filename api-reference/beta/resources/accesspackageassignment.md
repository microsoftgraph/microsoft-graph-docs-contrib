...
| [Reprocess accessPackageAssignment](../api/accesspackageassignment-reprocess.md) | | Automatically reevaluate and enforce a user’s assignments for a specific access package.|
