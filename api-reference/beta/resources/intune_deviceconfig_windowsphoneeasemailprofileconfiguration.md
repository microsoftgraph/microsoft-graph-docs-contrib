...
|---|---|---|
|[List windowsPhoneEASEmailProfileConfigurations](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/api/intune_deviceconfig_windowsphoneeasemailprofileconfiguration_list.md)|[windowsPhoneEASEmailProfileConfiguration](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_deviceconfig_windowsphoneeasemailprofileconfiguration.md) collection|List properties and relationships of the [windowsPhoneEASEmailProfileConfiguration](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_deviceconfig_windowsphoneeasemailprofileconfiguration.md) objects.|
|[Get windowsPhoneEASEmailProfileConfiguration](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/api/intune_deviceconfig_windowsphoneeasemailprofileconfiguration_get.md)|[windowsPhoneEASEmailProfileConfiguration](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_deviceconfig_windowsphoneeasemailprofileconfiguration.md)|Read properties and relationships of the [windowsPhoneEASEmailProfileConfiguration](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_deviceconfig_windowsphoneeasemailprofileconfiguration.md) object.|
|[Create windowsPhoneEASEmailProfileConfiguration](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/api/intune_deviceconfig_windowsphoneeasemailprofileconfiguration_create.md)|[windowsPhoneEASEmailProfileConfiguration](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_deviceconfig_windowsphoneeasemailprofileconfiguration.md)|Create a new [windowsPhoneEASEmailProfileConfiguration](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_deviceconfig_windowsphoneeasemailprofileconfiguration.md) object.|
|[Delete windowsPhoneEASEmailProfileConfiguration](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/api/intune_deviceconfig_windowsphoneeasemailprofileconfiguration_delete.md)|None|Deletes a [windowsPhoneEASEmailProfileConfiguration](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_deviceconfig_windowsphoneeasemailprofileconfiguration.md).|
|[Update windowsPhoneEASEmailProfileConfiguration](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/api/intune_deviceconfig_windowsphoneeasemailprofileconfiguration_update.md)|[windowsPhoneEASEmailProfileConfiguration](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_deviceconfig_windowsphoneeasemailprofileconfiguration.md)|Update the properties of a [windowsPhoneEASEmailProfileConfiguration](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_deviceconfig_windowsphoneeasemailprofileconfiguration.md) object.|
