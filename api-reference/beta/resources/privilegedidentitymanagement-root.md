...
>
>The Privileged Identity Management (PIM) API for **Azure resource roles** will be deprecated soon. Use the new [Azure REST API for Role Eligibility Schedule Requests](/rest/api/authorization/role-eligibility-schedule-requests).
