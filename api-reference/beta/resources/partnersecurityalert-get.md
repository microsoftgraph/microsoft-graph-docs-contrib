...
Read the properties of a [partnerSecurityAlert](../resources/partnersecurityalert.md) object.
...
<!-- { "blockType": "permissions", "name": "partnersecurityalert_get" } -->
...
-->
``` http
GET security/partner/securityalert/{id}
```
...
If successful, this method returns a `200 OK` response code and a [partnerSecurityAlert](../resources/partnersecurityalert.md) object in the response body.
...
-->
``` http
GET https://graph.microsoft.com/beta/security/partner/securityalert/5d027261-d21f-4aa9-b7db-7fa1f56fb163-8777b240-c6f0-4469-9e98-a3205431b836
```
