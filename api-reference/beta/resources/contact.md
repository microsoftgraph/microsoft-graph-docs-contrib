...
|[permanentDelete](../api/contact-permanentdelete.md)|None|	Permanently deletes the contacts and places it in the Purges folder of the dumpster in user's mailbox|
