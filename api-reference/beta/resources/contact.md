...
|[permanentDelete](../api/contact-permanentdelete.md)|None|	Permanently delete contact and places it in the Purges folder in the Recoverable Items folder in the user's mailbox.|
