...
|updatedDateTime (deprecate)|string|Datetime when the status was updated. Starting from August 31, 2024, updatedDatetime property will no longer be supported and will be marked as deprecated. Please use lastModifiedDateTime instead. Read-Only. |
