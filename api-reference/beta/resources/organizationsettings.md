...
|pronouns|[pronounsSettings](../resources/pronounssettings.md)|Contains the properties configured by an administrator as a tenant-level control on whether to display pronouns in an organization.|
