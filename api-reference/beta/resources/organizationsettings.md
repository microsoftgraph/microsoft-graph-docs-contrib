...
| [List microsoftApplicationDataAccessSetting](../api/organizationsettings-list-microsoftapplicationdataaccess.md) | [microsoftApplicationDataAccessSetting](microsoftapplicationdataaccesssetting.md) | Get the properties of an [microsoftApplicationDataAccessSetting](microsoftapplicationdataaccesssetting.md) object for invoking any M365 API using any Microsoft application (not restricted to Microsoft Office applications only). |
...
|microsoftApplicationDataAccessSetting|[microsoftApplicationDataAccessSetting](../resources/microsoftapplicationdataaccesssetting.md)| Contains the properties that are configured by an administrator for invoking any M365 API using any Microsoft application (not restricted to Microsoft Office applications only). [List microsoftApplicationDataAccessSetting](../api/organizationsettings-list-microsoftapplicationdataaccess.md) returns the _settings_ for access to M365 APIs from all Microsoft applications in an organization. |
