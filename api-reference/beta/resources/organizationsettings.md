...
|microsoftApplicationDataAccessSettings|[microsoftApplicationDataAccessSettings](../resources/microsoftapplicationdataaccesssettings.md)| Contains the properties that are configured by an administrator for the access to internal Office APIs from all Microsoft applications. [List microsoftApplicationDataAccessSettings](../api/organizationsettings-list-microsoftapplicationdataaccesssettings.md) returns the _settings_ to access internal Office APIs from all Microsoft applications. |
