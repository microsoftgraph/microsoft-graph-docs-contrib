...
For more information on configuration options using principalResourceMembershipsScope, see [configure the scope of your access review definition](/graph/acecssreviews-scope-concept.md).
