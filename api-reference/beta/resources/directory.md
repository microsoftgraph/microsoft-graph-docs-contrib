...
|federationConfigurations|[identityProviderBase](../resources/identityproviderbase.md) collection|Managing federation configurations you create with your Azure AD tenant.|
