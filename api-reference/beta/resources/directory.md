...
|[List deleted items owned by a user](../api/directory_deleteitems_user_owned.md) | [directoryObject](directoryobject.md) collection | Lists directory items owned by a user. |
