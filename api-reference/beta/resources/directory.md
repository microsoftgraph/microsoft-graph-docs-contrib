...
| inboundSharedUserProfiles          | [inboundSharedUserProfile](inboundshareduserprofile.md) collection                       | A collection of external Microsoft Entra users whose profile data has been shared with the Microsoft Entra tenant. Nullable.            |
