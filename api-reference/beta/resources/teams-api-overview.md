...
| Use tags to classify users or groups based on common attributes whitin a team | [teamworkTag](../resources/teamworkTag.md), [teamworkTagMember](../resources/teamworkTagMember.md) | [list teamworkTag](../api/teamworkTag-list.md), [create teamworkTag](../api/teamworkTag-post.md) |
