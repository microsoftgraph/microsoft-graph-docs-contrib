...
| (Preview) [chatMessage](../resources/chatmessage.md) | [list](../api/channel-list-messages.md), [send](../api/channel-post-chatmessage.md), [read](/graph/api/channel-get-message?view=graph-rest-beta) |
