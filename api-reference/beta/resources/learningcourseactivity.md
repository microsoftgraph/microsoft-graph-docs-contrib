...
|assignmentType|assignmentType|Assignment type for the course activity. The possible values are: `required`, `recommended`, `unknownFutureValue`, `peerRecommended`. Required.|
