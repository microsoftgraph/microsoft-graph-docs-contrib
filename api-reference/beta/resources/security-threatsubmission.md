...
This resource is an abstract type. It's the base type for [emailThreatSubmission](../resources/security-emailthreatsubmission.md), [fileThreatSubmission](../resources/security-filethreatsubmission.md), and [urlThreatSubmission](../resources/security-urlthreatsubmission.md).
