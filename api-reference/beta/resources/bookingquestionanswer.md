...
|answerOptions|String collection|In case the answerInputType is dropdown, this will consists of a list of possible answer values |
|isRequired|Boolean|If it is mandatory to answer the custom question |
