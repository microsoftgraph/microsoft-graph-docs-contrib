...
|authenticationStrengths|[authenticationStrengthRoot](authenticationstrengthroot.md)|Cannot be called directly, but children contain authentication strength policies, valid authentication method combinations, and authentication method mode details.|
