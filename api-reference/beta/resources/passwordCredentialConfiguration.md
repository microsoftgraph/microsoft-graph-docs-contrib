...
| :---------------------------------- | :--------------------------------------------------------------------------------- | :-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| restrictionType                     | [graph.appCredentialRestrictionType](../resources/appCredentialRestrictionType.md) | Enum values that define the type of restriction being applied. Possible values are `passwordAddition` or `passwordLifetime`. An Enum can be used only once per policy.                                                                                                                        |
