...
|[retire action](../api/intune_devices_manageddevice_retire.md)|None|Not yet documented|
|[wipe action](../api/intune_devices_manageddevice_wipe.md)|None|Not yet documented|
|[resetPasscode action](../api/intune_devices_manageddevice_resetpasscode.md)|None|Not yet documented|
|[remoteLock action](../api/intune_devices_manageddevice_remotelock.md)|None|Not yet documented|
|[enableLostMode action](../api/intune_devices_manageddevice_enablelostmode.md)|None|Not yet documented|
|[disableLostMode action](../api/intune_devices_manageddevice_disablelostmode.md)|None|Not yet documented|
|[locateDevice action](../api/intune_devices_manageddevice_locatedevice.md)|None|Not yet documented|
|[bypassActivationLock action](../api/intune_devices_manageddevice_bypassactivationlock.md)|None|Not yet documented|
|[rebootNow action](../api/intune_devices_manageddevice_rebootnow.md)|None|Not yet documented|
|[List detectedApps](../api/intune_devices_manageddevice_list_detectedapp.md)|[detectedApp](../resources/intune_devices_detectedapp.md) collection|Get the detectedApps from the detectedApps navigation property.|
