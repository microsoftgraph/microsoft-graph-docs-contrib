...
| includeUserActions | conditionalAccessUserActions collection | User actions to include. Supported values are `urn:user:registersecurityinfo` and `urn:user:registerdevice` |
