...
Azure AD provides four types of activity reports:
...
Custom security attribute audit logs provide you with the history of activities related to custom security attributes, such as adding a new definition to an attribute set. Custom security attribute audit logs are separate from other audit logs and have a different endpoint. Additional permissions are required to access these audit logs and by default a Global Administrator does not have access to these audit logs.
