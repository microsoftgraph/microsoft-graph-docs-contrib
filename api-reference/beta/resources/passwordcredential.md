...
> [!NOTE]
> Using PATCH to update **passwordCredentials** is not supported. Use the addPassword and removePassword methods to update the password for an application or a service principal.
