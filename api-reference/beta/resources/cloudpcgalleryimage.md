...
|offerName|String|The offer name of this gallery image, this value will be passed to ARM to get image resource. Read-Only.|
|offerDisplayName|String|The official display offer name of this gallery image. For example: Windows 10 Enterprise + OS Optimizations. (Starting from January 31, 2024, this property will no longer be supported and will be marked as deprecated.)|
