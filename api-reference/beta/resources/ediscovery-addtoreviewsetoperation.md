...
|:---|:---|:---|
|action|microsoft.graph.ediscovery.caseAction| The type of operation - `addToReviewSet`. Read-only. Inherited from [caseOperation](../resources/ediscovery-caseoperation.md).|
