...
|deliveryLocation|String|Location where the email was delivered. The possible values are: `Inbox`, `External`, `JunkFolder`, `Quarantine`, `Failed`, `Dropped`, `DeletedFolder`, `Forwarded`.|
