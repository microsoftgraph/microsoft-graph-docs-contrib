...
|:---|:---|:---|
|antiSpamDirection|String|Direction of the email relative to your network: Inbound, Outbound, Intra-org.|
...
|urn|String|Identifier of the automated investigation where the cluster was identified|
