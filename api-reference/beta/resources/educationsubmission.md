...
|[reassign](../api/educationsubmission-reassign.md)|[educationSubmission](educationsubmission.md)|Reassigns the submission to the student to revisit/redo its work, and in the mean time the student has the ability to return feedback and code.|
...
|status|string| Read-Only. Possible values are: `working`, `submitted`, `released`, `returned` and `reassigned`.|
