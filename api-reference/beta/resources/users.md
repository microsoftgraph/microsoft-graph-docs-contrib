...
In addition, the following scenario-specific permissions also allow apps to read the basic user profile which contains mostly identifier-related properties: *User-Mail.ReadWrite.All*, *User-PasswordProfile.ReadWrite.All*, *User-Phone.ReadWrite.All*, *User.EnableDisableAccount.All*, *User-LifeCycleInfo.Read.All*, *User-LifeCycleInfo.ReadWrite.All*.
