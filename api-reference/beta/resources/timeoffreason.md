...
|--------------|---------------|--------------------------------------------------------------------------------------------|
| code               | String                  | The code of the **timeOffReason** to represent an external identifier. This field is required to be unique within the team in Microsoft Teams and uses a alphanumeric format, with max 100 characters. |
