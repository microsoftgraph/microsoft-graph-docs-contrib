...
|collaboration|[collaborationRoot](../resources/security-collaborationroot.md)|Represents an abstract type to read and perform actions on collaborative entities in Microsoft Defender.|
