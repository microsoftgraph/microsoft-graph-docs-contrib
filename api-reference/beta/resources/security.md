...
|threatSubmission|[security.threatSubmission](../resources/security-threatsubmission.md)|Threat submission sent to Microsoft which could be suspicious email threat, url threat, file threat etc.|
