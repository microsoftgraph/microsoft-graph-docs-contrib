...
|contentSensitivityLabelAssignment|[contentSensitivityLabelAssignment](contentsensitivitylabelassignment.md)|The sensitivity label assignment for the plan. Used to classify and protect the plan content based on organizational policies. `Null` if no sensitivity label is assigned. Optional.|
