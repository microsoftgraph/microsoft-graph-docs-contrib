...
|---|---|---|
|[List iosCertificateProfileBases](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/api/intune_deviceconfig_ioscertificateprofilebase_list.md)|[iosCertificateProfileBase](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_deviceconfig_ioscertificateprofilebase.md) collection|List properties and relationships of the [iosCertificateProfileBase](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_deviceconfig_ioscertificateprofilebase.md) objects.|
