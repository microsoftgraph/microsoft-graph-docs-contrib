...
The **plannerPlanContextDetailsCollection** resource represents the collection of external contexts to which a plan is linked. This resource is an open type and is part of the [plannerPlanDetails](plannerPlanDetails.md) object. The value in the property-value pair is the [plannerPlanContextDetails](plannerPlanContextDetails.md) object.
