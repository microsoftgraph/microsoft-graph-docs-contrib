...
| contentCustomization | [contentCustomization](contentCustomization.md) | Represents the various content options to be customized throughout authentication for a tenant. Inherited from [organizationalBrandingProperties](organizationalbrandingproperties.md). |
