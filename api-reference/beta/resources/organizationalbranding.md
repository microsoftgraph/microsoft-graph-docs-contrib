...
| contentCustomization | [contentCustomization](contentCustomization.md) | Represents the various content options to be customized throughout authentication for a tenant. <br/><br/>**NOTE:** Supported by Azure AD for customer tenants only. Inherited from [organizationalBrandingProperties](organizationalbrandingproperties.md). |
