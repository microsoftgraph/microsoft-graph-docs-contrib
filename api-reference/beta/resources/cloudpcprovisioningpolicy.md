...
|domainJoinConfigurations|Collection(microsoft.graph.cloudPcDomainJoinConfiguration)|Specifies a list ordered by priority on how Cloud PCs will join Azure AD.|
