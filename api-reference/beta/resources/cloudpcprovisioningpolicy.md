...
|autopatch|[cloudPcProvisioningPolicyAutopatch](../resources/cloudPcProvisioningPolicyAutopatch.md)|The specific settings to **Autopatch** which enables Autopatch customers to get Autopatch experience for Cloud PC. Supports `$filter`, `$select`, and `$orderBy`.|
