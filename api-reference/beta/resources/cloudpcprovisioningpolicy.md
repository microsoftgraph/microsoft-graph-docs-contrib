...
|id|String|The unique identifier associated with provisioning policy. This ID is auto populated during the creation of new provisioning policy. Read-Only. Supports `$filter`, `$select`, and `$orderBy`. |
