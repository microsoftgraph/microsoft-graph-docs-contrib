...
|[Retry](../api/cloudpcprovisioningpolicy-retry.md)|None| Retry the provisioning operation for Cloud PCs that used the current policy and failed to apply the [provisioning policy](../resources/cloudpcprovisioningpolicy.md).|
