...
|autopilotConfiguration|[cloudPcAutopilotConfiguration](../resources/cloudpcautopilotconfiguration.md)|The specific settings to Windows Autopilot which enables Windows 365 customers to get Autopilot experience for Cloud PC. Supports `$select`.|
