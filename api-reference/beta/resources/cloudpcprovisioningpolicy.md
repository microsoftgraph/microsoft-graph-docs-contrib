...
|[Retry](../api/cloudpcprovisioningpolicy-retry.md)|None| Retry the provisioning operation for Cloud PCs that used the current policy for provisioning and failed to apply apply [provisioning policy](../resources/cloudpcprovisioningpolicy.md)|
