...
|segmentConfiguration|[segmentConfiguration](segmentconfiguration.md)| Represents the application segment collection for an on-premises wildcard application.|
