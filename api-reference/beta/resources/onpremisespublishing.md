...
|onPremisesApplicationSegments | [onPremisesApplicationSegments](onPremisesApplicationSegment.md) collection| Represents the application segment collection for a on-premises wildcard application. |
