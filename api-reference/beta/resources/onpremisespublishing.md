...
|onPremisesApplicationSegments (deprecated)| [onPremisesApplicationSegment](onpremisesapplicationsegment.md) collection| Represents the application segment collection for an on-premises wildcard application.  |
|segmentsConfiguration|[segmentsConfiguration](segmentsConfiguration.md)| Represents the application segment collection for an on-premises wildcard application.|
...
```json
{
  ...
  "segmentsConfiguration":[{"@odata.type":"microsoft.graph.segmentsConfiguration"}],
