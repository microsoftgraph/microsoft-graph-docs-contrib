...
| onPremisesApplicationSegments | [onPremisesApplicationSegments](onpremisesapplicationsegments.md) collection | Represents the application segment object collection for the on-premises application. |
