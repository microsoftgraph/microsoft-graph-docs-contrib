...
|trafficRoutingMethod|trafficRoutingMethod| Indicates how traffic is distributed across multiple connectors in a connector group. The possible values are `none`, `random`, and `sessionPersistence`. |
