...
|decisionsThatWillMoveToNextStage|String collection|Indicate which decisions will go to the next stage. Can be a sub-set of ["Approve", "Deny", "Recommendation", "NotReviewed"]. If not provided, all decisions will go to the next stage.|
