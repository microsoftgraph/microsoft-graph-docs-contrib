...
|---|---|---|
|[List managedAndroidLobApps](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/api/intune_apps_managedandroidlobapp_list.md)|[managedAndroidLobApp](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_apps_managedandroidlobapp.md) collection|List properties and relationships of the [managedAndroidLobApp](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_apps_managedandroidlobapp.md) objects.|
|[Get managedAndroidLobApp](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/api/intune_apps_managedandroidlobapp_get.md)|[managedAndroidLobApp](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_apps_managedandroidlobapp.md)|Read properties and relationships of the [managedAndroidLobApp](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_apps_managedandroidlobapp.md) object.|
|[Create managedAndroidLobApp](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/api/intune_apps_managedandroidlobapp_create.md)|[managedAndroidLobApp](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_apps_managedandroidlobapp.md)|Create a new [managedAndroidLobApp](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_apps_managedandroidlobapp.md) object.|
|[Delete managedAndroidLobApp](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/api/intune_apps_managedandroidlobapp_delete.md)|None|Deletes a [managedAndroidLobApp](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_apps_managedandroidlobapp.md).|
|[Update managedAndroidLobApp](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/api/intune_apps_managedandroidlobapp_update.md)|[managedAndroidLobApp](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_apps_managedandroidlobapp.md)|Update the properties of a [managedAndroidLobApp](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_apps_managedandroidlobapp.md) object.|
