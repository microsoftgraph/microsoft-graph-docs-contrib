...
|deployments|[microsoft.graph.networkaccess.deployments](../resources/networkaccess-deployment.md) collection|Represents a deployment event within the Global Secure Access services, including its configuration, status, and related data|
