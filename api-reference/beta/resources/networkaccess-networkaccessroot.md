...
|logs|[microsoft.graph.networkaccess.logs](../resources/networkaccess-logs.md)|Settings of network connections that are routed through Global Secure Access and the related auditable network activities.|
