...
| :------------------------------------------ | :------------------------------ | :-------------------------- |
| excludeAppsReceivingV2Tokens                | Boolean                         | If `true`, the restriction will not be enforced for applications that are configured to receive V2 tokens in Entra ID; else, the restriction isn't enforced for those applications.|
