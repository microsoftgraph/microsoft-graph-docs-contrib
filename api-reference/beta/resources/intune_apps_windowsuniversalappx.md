...
|---|---|---|
|[List windowsUniversalAppXs](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/api/intune_apps_windowsuniversalappx_list.md)|[windowsUniversalAppX](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_apps_windowsuniversalappx.md) collection|List properties and relationships of the [windowsUniversalAppX](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_apps_windowsuniversalappx.md) objects.|
|[Get windowsUniversalAppX](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/api/intune_apps_windowsuniversalappx_get.md)|[windowsUniversalAppX](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_apps_windowsuniversalappx.md)|Read properties and relationships of the [windowsUniversalAppX](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_apps_windowsuniversalappx.md) object.|
|[Create windowsUniversalAppX](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/api/intune_apps_windowsuniversalappx_create.md)|[windowsUniversalAppX](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_apps_windowsuniversalappx.md)|Create a new [windowsUniversalAppX](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_apps_windowsuniversalappx.md) object.|
|[Delete windowsUniversalAppX](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/api/intune_apps_windowsuniversalappx_delete.md)|None|Deletes a [windowsUniversalAppX](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_apps_windowsuniversalappx.md).|
|[Update windowsUniversalAppX](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/api/intune_apps_windowsuniversalappx_update.md)|[windowsUniversalAppX](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_apps_windowsuniversalappx.md)|Update the properties of a [windowsUniversalAppX](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_apps_windowsuniversalappx.md) object.|
