...
|:---------------|:--------|:----------|
|[List hosted images](../api/chatmessagehostedimage-list.md) | [chatMessageHostedImage](chatmessagehostedimage.md) collection | Get the list of all hosted images in a chatMessage.|
