...
|:---|:---|:---|
|frontlineCloudPcAvailability|[frontlineCloudPcAvailability](../resources/frontlinecloudpcdetail#frontlinecloudpcavailability-values)|The current availability of a frontline assigned Cloud PC. Possible values are: `notApplicable`, `available`,`notAvailable, `unknownFutureValue`. The default value is `notApplicable`. Read-only. |
