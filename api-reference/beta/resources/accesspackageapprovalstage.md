...
Used for the **stages** property of approval settings in an [access package assignment policy](../resources/accesspackageassignmentpolicy.md). Specifies the primary, fallback, and escalation approvers of each stage.
