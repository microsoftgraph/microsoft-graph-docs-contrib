...
|permissions|[permission](../resources/permission.md)|Permissions of users in the fileStorageContainer. The possible values are 'reader', 'writer', 'manager', and 'owner'. Read-write.|
