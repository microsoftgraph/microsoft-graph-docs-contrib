...
|lockState|[siteLockState](../resources/enums.md#siteLockState)|Lock state of the **fileStorageContainer**. The possible values are `unlocked` and `lockedReadOnly`. Read-only.|
