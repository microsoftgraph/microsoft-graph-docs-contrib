...
|callbackConfiguration|[microsoft.graph.customTaskExtensionCallbackConfiguration](../resources/identitygovernance-customtaskextensioncallbackconfiguration.md)|Configuration for setting up a callback from the logic app to the Custom Task Extension.|
