...
|description|String|The description of this object. Required.|
...
|isDefaultEnvironment|Boolean|Determines whether this is default environment or not. This parameter is set to true for all the static origin systems like AAD groups and APPS. Required.|
...
|originId|String|An unique id of this environment from the origin system. Required.|
|originSystem|String|Name of the origin system to which this environment belongs. Required.|
