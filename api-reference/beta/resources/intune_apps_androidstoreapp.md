...
|---|---|---|
|[List androidStoreApps](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/api/intune_apps_androidstoreapp_list.md)|[androidStoreApp](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_apps_androidstoreapp.md) collection|List properties and relationships of the [androidStoreApp](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_apps_androidstoreapp.md) objects.|
|[Get androidStoreApp](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/api/intune_apps_androidstoreapp_get.md)|[androidStoreApp](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_apps_androidstoreapp.md)|Read properties and relationships of the [androidStoreApp](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_apps_androidstoreapp.md) object.|
|[Create androidStoreApp](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/api/intune_apps_androidstoreapp_create.md)|[androidStoreApp](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_apps_androidstoreapp.md)|Create a new [androidStoreApp](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_apps_androidstoreapp.md) object.|
|[Delete androidStoreApp](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/api/intune_apps_androidstoreapp_delete.md)|None|Deletes a [androidStoreApp](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_apps_androidstoreapp.md).|
|[Update androidStoreApp](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/api/intune_apps_androidstoreapp_update.md)|[androidStoreApp](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_apps_androidstoreapp.md)|Update the properties of a [androidStoreApp](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_apps_androidstoreapp.md) object.|
