...
|requestType|string|The request operation type. Example types could be: Assign (role assignment), Activate (role activation), Unassign (remove role assignment), and Deactivate (role deactivation).|
