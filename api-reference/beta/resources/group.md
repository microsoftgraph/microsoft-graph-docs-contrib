...
|assignedLabels|[assignedLabel](assignedlabel.md) collection|Property represents the list of sensitivity label pairs (label id, label name) associated with a group. <br><br>Returned only on $select.|
