...
|assignedLabels|[assignedLabel](assignedlabel.md) collection|The list of sensitivity label pairs (label ID, label name) associated with an Office 365 group. <br><br>Returned only on $select.|
