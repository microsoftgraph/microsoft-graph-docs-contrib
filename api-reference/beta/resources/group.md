...
|createdByAppId|String|App ID of the app used to create the group. Nullable for non-Azure AD mastered groups. <br><br>Returned by default. Read-only. Supports $filter.|
