...
|assignedLabels|[assignedLabel](assignedlabel.md) collection|The list of sensitivity label pairs (label id, label name) associated with an Office 365 group. <br><br>Returned only on $select. Label name is Read-only.|
