...
|customExtensionHandlers|[customExtensionHandler](../resources/customextensionhandler.md) collection| The collection of stages when to execute which custom access package workflow extension. Supports `$expand`.| 
