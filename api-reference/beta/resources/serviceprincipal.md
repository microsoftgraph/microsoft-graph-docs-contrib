...
|customSecurityAttributes|[customSecurityAttributeValue](../resources/customsecurityattributevalue.md)|Custom security attributes assigned to the application (service principal). |
