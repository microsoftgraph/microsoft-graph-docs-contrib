---
title: "appConfigurationSchemaItemStringType resource type"
description: "String configuration item inside an Android application's custom configuration schema."
author: "jaiprakashmb"
...
# appConfigurationSchemaItemStringType resource type
...
<!-- {
  "blockType": "resource",
  "@odata.type": "microsoft.graph.appConfigurationSchemaItemStringType"
}
-->
``` json
{
