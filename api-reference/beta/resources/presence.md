...
| [Set presence](../api/presence-set.md)                                               |                                                 | Set an application's presence session for a user.           |
| [Clear presence](../api/presence-clear.md)                                           |                                                 | Clear an application's presence session for a user.         |
