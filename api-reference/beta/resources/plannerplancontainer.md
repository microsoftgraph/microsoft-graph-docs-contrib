...
|project| Plan is contained by a Project from [Microsoft Project](/project). | Microsoft Project currently doesn't have a resource path on Graph, Project details and members can be managed from https://project.microsoft.com. |
