...
|project| Plan is contained by a Project from [Microsoft Project for the web](https://learn.microsoft.com/project-for-the-web/projectforweb-admin-home). | Microsoft Project currently doesn't have a resource path on Microsoft Graph. Project details and members can be managed from https://project.microsoft.com. |
