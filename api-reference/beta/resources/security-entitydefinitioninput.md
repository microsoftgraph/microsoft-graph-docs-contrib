...
Represents an entity definition input for manual alert creation. Each entity definition specifies a security entity (such as a user, device, or IP address) associated with the alert, along with its identifier and role in the alert context.
