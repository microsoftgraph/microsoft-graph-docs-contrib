...
> [!NOTE]
> The invitation status is tracked using the **externalUserState** and the **externalUserStateChangeDateTime** properties on the external [user](user.md) resource that is created as part of the invitation request.
...
|invitedUserMessageInfo|[invitedUserMessageInfo](invitedusermessageinfo.md)|Contins configuration information for the message being sent to the invited user, including customizing message text, language, and cc recipient list.|
