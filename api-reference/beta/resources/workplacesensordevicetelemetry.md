...
Represents the data collected and reported by a sensor on physical or environmental conditions, including occupancy, headcount, inferred occupancy, temperature, and more.
...
|deviceId|String|The user-defined unique identifier of the device provided at the time of creation. Do not use the system generated device's identifier.|
