...
|[Get all channel members](../api/channel-list-allmembers.md) | [conversationMember](conversationmember.md) collection | Get the list of all members in a channel.|
...
|allMembers|[conversationMember](conversationmember.md) collection|A collection of membership records associated with the channel. This includes both direct and indirect members of shared channel as well.|
