...
|channelSummary|[channelSummary](../resources/channelSummary.md)|Contains summary information about the channel, including number of guests, members, and owners, and an indicator for members from other tenants. This property is only rendered if it is specified in the `$select` clause of the Get channel API.|
