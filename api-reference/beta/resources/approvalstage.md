...
| isApproverInformationVisible |[isApproverInformationVisible](isapproverinformationvisible.md) | Indicates whether approver information is visible to the requestor. The possible values are: `no`, `yes`, `default`, `unknownFutureValue`. |
...

{
    ...
    "isApproverInformationVisible": "String",
