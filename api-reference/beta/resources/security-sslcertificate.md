...
|[List relatedHosts](../api/security-threatintelligence-list-relatedhosts.md)|[microsoft.graph.security.host](../resources/security-host.md) collection|Get the list of [hosts](../resources/security-host.md) associated with an [sslCertificate](../resources/security-sslcertificate.md).|
