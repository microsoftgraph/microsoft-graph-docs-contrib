...
- [Device platform type](intune-fencing-deviceplatformtype.md)
...
- [Key/value pair](intune-troubleshooting-keyvaluepair.md)
...
- [Resultant app state](intune-troubleshooting-resultantappstate.md)
