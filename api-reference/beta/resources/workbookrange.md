...
|[Update range](../api/range-update.md) | [workbookRange](workbookrange.md)	|Update Range object. |
...
|[Insert range](../api/range-insert.md)|[workbookRange](workbookrange.md)|Inserts a cell or a range of cells into the worksheet in place of this range, and shifts the other cells to make space. Returns a new Range object at the now blank space.|
