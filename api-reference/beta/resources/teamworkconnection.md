...
|:---|:---|:---|
|connectionStatus|teamworkConnectionStatus|Enum indicating whether component/peripheral is connected/disconnected or its state is unknown. The possible values are: `unknown`, `connected`, `disconnected`, `unknownFutureValue`.|
