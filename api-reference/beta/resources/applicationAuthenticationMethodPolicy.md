...
| passwordLifetime | Enforce a max lifetime range for a password secret.   | Restrict all new password secrets to a maximum of 30 days for on applications created after '01/01/2015'. |
...
| symmetricKeyLifetime | Enforce a max lifetime range for a symmetric key.   | Restrict all new symmetric keys to a maximum of 30 days for on applications created after '01/01/2019'. |
| asymmetricKeyLifetime | Enforce a max lifetime range for a asymmetric key (certificate).   | Restrict all new asymmetric key secrets to a maximum of 30 days for on applications created after '01/01/2019'. |
