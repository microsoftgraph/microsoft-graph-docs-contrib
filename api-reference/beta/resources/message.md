...
|[permanentDelete](../api/message-permanentdelete.md)|None|Permanently delete mail and places it in the Purges folder in the Recoverable Items folder in the user's mailbox.|
|**Attachments**| | |
