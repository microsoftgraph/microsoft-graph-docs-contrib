...
|[Power on](../api/cloudpc-poweron.md)|None|Power on a specific [cloudPC](../resources/cloudpc.md) object. Cover Shift Work CloudPC for MEM admin scenarios.|
|[Power off](../api/cloudpc-poweroff.md)|None|Power off a specific [cloudPC](../resources/cloudpc.md) object. Cover Shift Work CloudPC for MEM admin scenarios.|
