...
|[Retrieve snapshots](../api/cloudpc-retrievesnapshots.md)|[cloudPcSnapshot](../resources/cloudpcsnappshot.md) collection|Get a list of [cloudPcSnapshot](../resources/cloudpcsnappshot.md) of a Cloud PC.|
|[Share snapshot](../api/cloudpc-createsnapshot.md)|None|Share a [cloudPcSnapshot](../resources/cloudpcsnappshot.md) for a specific Cloud PC to a storage account.|
