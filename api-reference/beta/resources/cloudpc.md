...
|statusDetails|[cloudPcStatusDetails](../resources/cloudpcstatusdetails.md)|The details of the Cloud PC status. Example: `{ "code": "internalServerError", "message": "There was an error during the Cloud PC upgrade. Please contact support.", "additionalInformation": null }`.Starting from August 31, 2024, this property will no longer be supported and will be marked as deprecated. Please use statusDetail instead.|
