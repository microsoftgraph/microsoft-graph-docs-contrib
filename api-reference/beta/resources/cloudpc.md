...
|connectionSettings (deprecated)|[cloudPcConnectionSettings](../resources/cloudpcconnectionsettings.md)|The connection settings of the Cloud PC. Possible values: `enableSingleSignOn`. Read Only. This property is deprecated and hasn't been supported since August 31, 2024. Use `connectionSetting` instead. |
