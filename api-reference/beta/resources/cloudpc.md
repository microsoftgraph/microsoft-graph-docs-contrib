...
|connectionSettings (deprecated)|[cloudPcConnectionSettings](../resources/cloudpcconnectionsettings.md)|The connection setting of the Cloud PC. Possible values: `enableSingleSignOn`. Read Only.| This property is deprecated and will no longer be supported effective August 31, 2024. Use connectionSetting instead. 
