...
|[Resize remote action](../api/manageddevice-resizecloudpc.md) (deprecate)|None|Upgrade or downgrade an existing Cloud PC to another configuration with new vCPU and storage size through Intune managed device ID.This will be deprecated and switch to use newly introduced resize instead.|
