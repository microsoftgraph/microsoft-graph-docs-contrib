...
|sharedDeviceDetail|[cloudPcFrontlineSharedDeviceDetail](../resources/cloudpcfrontlineshareddevicedetail.md)| Indicates the Cloud PC device details associated with Front line Shared service plan, including the user's UPN and session start date/time.|
