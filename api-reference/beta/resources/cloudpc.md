...
|[Retrieve snapshots](../api/cloudpc-retrievesnapshots.md)|[cloudPcSnapshot](../resources/cloudpcsnapshot.md) collection|Get a list of [cloudPcSnapshot](../resources/cloudpcsnapshot.md) of a Cloud PC.|
|[Share snapshot](../api/cloudpc-createsnapshot.md)|None|Share a [cloudPcSnapshot](../resources/cloudpcsnapshot.md) for a specific Cloud PC to a storage account.|
