...
|[Bulk reprovision remote action](../api/manageddevice-bulkreprovisioncloudpc.md) (deprecate) |None|Bulk reprovision a set of Cloud PC devices with Intune managed device IDs.This API will be deprecated on August 31, 2024. Going forward, please use [bulkReprovision](../resources/cloudpcbulkreprovision.md) API. |
...
|[Bulk restore remote action](../api/manageddevice-bulkrestorecloudpc.md) (deprecate) |[cloudPcBulkRemoteActionResult](../resources/cloudpcbulkremoteactionresult.md)|Restore multiple Cloud PC devices with a single request that includes the IDs of Intune managed devices and a restore point date and time.This API will be deprecated on August 31, 2024. Going forward, please use [bulkRestore](../resources/cloudpcbulkrestore.md) API.|
|[Set review status by managedDeviceId](../api/manageddevice-setcloudpcreviewstatus.md)(deprecate)|None|Set the review status of a specific Cloud PC device by managedDeviceId.This API will be deprecated on August 31, 2024. Please use [setReviewStatus](..\api\cloudpc-setreviewstatus.md) instead.|
|[Get review status by managedDeviceId](../api/manageddevice-getcloudpcreviewstatus.md)(deprecate)|[cloudPcReviewStatus](../resources/cloudpcreviewstatus.md)|Get the review status of a specific Cloud PC device by managedDeviceId. This API will be deprecated on Aug 31, 2024. Please use [retrieveReviewStatus](..\api\cloudpc-setreviewstatus.md) instead.|
...
|[Bulk resize](../api/cloudpc-bulkresize.md) (deprecate) |[cloudPcRemoteActionResult](../resources//cloudpcremoteactionresult.md) collection|Perform a bulk resize action to resize a group of Cloud PCs that have successfully passed validation (cloudPC: validateBulkResize). If any devices can't be resized, they're labeled as "resize failed", while the remaining devices are `provisioned` for the resize process. This API will be deprecated on August 31, 2024. Going forward, use the [bulkresize](../resources/cloudpcbulkresize.md) API.|
