...
|[Get launch info](../api/cloudpc-getcloudpclaunchinfo.md)|[cloudPcLaunchInfo](../resources/cloudpclaunchinfo.md)|Get the [cloudPCLaunchInfo](../resources/cloudpclaunchinfo.md) for a specific Cloud PC that belongs to the current signed-in user.|
...
|connectionSettings (deprecated)|[cloudPcConnectionSettings](../resources/cloudpcconnectionsettings.md)|The connection settings of the Cloud PC. Possible values: `enableSingleSignOn`. Read Only. This property is deprecated and will no longer be supported effective August 31, 2024. Use connectionSetting instead. |
