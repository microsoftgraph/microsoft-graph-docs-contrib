...
|[ChangeUserAccountType](../api/cloudpc-changeuseraccounttype.md)|None|Change the account type of the user on a specific Cloud PC.|
...
|pendingProvision|The Cloud PC is pending provisioning. This means the number of Cloud PCs in grace period is more than the number of total available license.|
