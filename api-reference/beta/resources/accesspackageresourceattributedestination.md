...
An abstract type used for the **attributeDestination** property of an [accessPackageResourceAttribute](accesspackageresouceattribute.md). The actual destination will be a subtype of this complex type.
