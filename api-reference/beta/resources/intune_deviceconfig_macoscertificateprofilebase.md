...
|subjectNameFormat|String|Certificate Subject Name Format. Possible values are: `commonName`, `commonNameAsEmail`, `custom`, `commonNameIncludingEmail`, `directoryPath`, `commonNameAsIMEI`, `commonNameAsSerialNumber`.|
