...
|---|---|---|
|[List macOSCertificateProfileBases](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/api/intune_deviceconfig_macoscertificateprofilebase_list.md)|[macOSCertificateProfileBase](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_deviceconfig_macoscertificateprofilebase.md) collection|List properties and relationships of the [macOSCertificateProfileBase](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_deviceconfig_macoscertificateprofilebase.md) objects.|
