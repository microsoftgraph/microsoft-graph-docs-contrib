...
Represents properties of a cloud app that was automatically discovered from the Start menu. Inherits from [cloudPcCloudAppDetail](../resources/cloudpccloudappdetail.md).
