...
|:------ |:----------- |:----------- |
| [List](../api/user-list.md) | [agentUser](agentuser.md) collection | Get a list of **agentUser** objects. |
| [Create](../api/user-post-users.md) | [agentUser](agentuser.md) | Create a new **agentUser** object. |
| [Get](../api/user-get.md) | [agentUser](agentuser.md) | Read properties and relationships of **agentUser** object. |
| [Update](../api/user-update.md) | [agentUser](agentuser.md) | Update **agentUser** object. |
...
|externalUserState|String|Not applicable for agent users. Inherited from [user](../resources/user.md).|
|externalUserStateChangeDateTime|String|Not applicable for agent users. Inherited from [user](../resources/user.md).|
...
|lastPasswordChangeDateTime|DateTimeOffset|Not applicable for agent users. Inherited from [user](../resources/user.md).|
|legalAgeGroupClassification|String|Not applicable for agent users. Inherited from [user](../resources/user.md).|
...
|onPremisesDistinguishedName|String|Not applicable for agent users. Inherited from [user](../resources/user.md).|
|onPremisesDomainName|String|Not applicable for agent users. Inherited from [user](../resources/user.md).|
|onPremisesExtensionAttributes|[onPremisesExtensionAttributes](../resources/onpremisesextensionattributes.md)|Not applicable for agent users. Inherited from [user](../resources/user.md).|
|onPremisesImmutableId|String|Not applicable for agent users. Inherited from [user](../resources/user.md).|
|onPremisesLastSyncDateTime|DateTimeOffset|Not applicable for agent users. Inherited from [user](../resources/user.md).|
|onPremisesProvisioningErrors|[onPremisesProvisioningError](../resources/onpremisesprovisioningerror.md) collection|Not applicable for agent users. Inherited from [user](../resources/user.md).|
|onPremisesSecurityIdentifier|String|Not applicable for agent users. Inherited from [user](../resources/user.md).|
|onPremisesSipInfo|[onPremisesSipInfo](../resources/onpremisessipinfo.md)|Not applicable for agent users. Inherited from [user](../resources/user.md).|
...
|passwordPolicies|String|Not applicable for agent users. Inherited from [user](../resources/user.md).|
|passwordProfile|[passwordProfile](../resources/passwordprofile.md)|Not applicable for agent users. Inherited from [user](../resources/user.md).|
