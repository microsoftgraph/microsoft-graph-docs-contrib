...
In Azure AD Entitlement Management, an access package subject is a user, service principal or other entity that could be configured to request or be assigned an access package.
