...
|destinationDomain|String|Destination domain portion of the destination URL. (e.g. 'www.contoso.com').|
|destinationPort|String|Destination port (of the network connection).|
|destinationUrl|String|Network connection URL/URI string - excluding parameters. (e.g. 'www.contoso.com/products/default.html')|
