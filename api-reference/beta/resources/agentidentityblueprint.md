...
|createdByAppId|String|The unique identifier of the application that created this agent identity blueprint. Inherited from [application](../resources/application.md).|
