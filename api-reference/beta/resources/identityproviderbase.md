...
|[Create](../api/identityproviderbase-post-identityproviders.md)|socialidentityprovider, openIdConnectIdentityProvider or  appleManagedIdentityProvider |Create a new social identity provider (Azure AD or Azure AD B2C),OpenID Connect identity provider(Azure AD B2C) or an Apple identity provider(Azure AD B2C)|
|[Get](../api/identityproviderbase-get.md) |socialidentityprovider, builtInIdentityProvider, openIdConnectIdentityProvider or  appleManagedIdentityProvider|Retrieve properties of a social identity provider (Azure AD or Azure AD B2C), built-in identity provider (Azure AD or Azure AD B2C),OpenID Connect identity provider(Azure AD B2C) or an Apple identity provider(Azure AD B2C)|
