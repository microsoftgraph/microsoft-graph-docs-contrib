...
| isAttendeeEmailNotificationEnabled | Boolean | Indicates whether attendees get email notification for the town hall. Inherited from [virtualEvent](../resources/virtualevent.md). |
