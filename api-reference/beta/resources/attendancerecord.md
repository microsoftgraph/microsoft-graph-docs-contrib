...
```json
{
  ...
  "registrantId": "String",
  "identity": {"@odata.type": "#microsoft.graph.communicationsUserIdentity|#microsoft.graph.azureCommunicationServicesUserIdentity"},
  "attendanceIntervals": [
    {
