...
|contextDetails|[plannerPlanContextDetailsCollection](plannerplancontextdetailscollection.md)|Read-only. Collection of additional information associated to [plannerPlanContext](plannerplancontext.md) entries defined for the containing [plannerPlan](plannerPlan.md). |
