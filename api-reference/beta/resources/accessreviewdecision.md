...
| `reviewedBy`                    |[userIdentity](useridentity.md)| The identity of the reviewer. `00000000-0000-0000-0000-000000000000` if the assigned reviewer hasn't reviewed. If the recommendation was used as the review, the userPrincipalName is empty.                                                                                      |
