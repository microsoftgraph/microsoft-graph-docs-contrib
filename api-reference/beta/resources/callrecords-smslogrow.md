...
For those countries, the three or four last digits of the phone number are replaced with asterisks (for example, +123 456789***). For an inbound SMS, the sender number may be obfuscated. For an outbound SMS, the receiver number may be obfuscated.
...
|sentDateTime|DateTimeOffset|The date and time when the SMS was sent. The Timestamp type represents date and time information using ISO 8601 format and is always in UTC time. For example, midnight UTC on Jan 1, 2014 is `2014-01-01T00:00:00Z`.|
