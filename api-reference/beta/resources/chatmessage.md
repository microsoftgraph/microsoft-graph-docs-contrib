...
|[Update chatMessage](../api/chatmessage-update.md)|[chatMessage](chatmessage.md)| Update the **policyViolation** property of a chat message.|
|[1:1 and group chat messages](../api/chat-get-allmessages.md)| [chatMessage](../resources/chatmessage.md)| Retrieve all 1:1, group chats, meeting chats and Private channel messages. |
