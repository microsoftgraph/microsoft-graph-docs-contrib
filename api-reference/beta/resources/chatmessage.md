...
|messageHistory|[chatMessageHistoryItem](../resources/chatmessagehistoryitem.md) collection|List of message edition history, including modification time, actions for the message (like reactionAdded and reactionRemoved), and reactions changed in the message.
