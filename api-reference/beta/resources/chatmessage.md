...
|[Update chatMessage](../api/chatmessage-update.md)|[chatMessage](chatmessage.md)| Update the **policyViolation** property of a chat message.|
|[Get all chats](../api/chat-get-allmessages.md)| [chatMessage](../resources/chatmessage.md)| Get all chats that a user is a participant in, including individual and group chats, meeting chats, and private channel messages. |
