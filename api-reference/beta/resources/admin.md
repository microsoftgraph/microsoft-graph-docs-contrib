...
|sharepoint|[microsoft.graph.tenantAdmin.sharepoint](../resources/tenantAdmin-sharepoint.md)|A container for administrative resources to manage a tenant's sharepoint/onedrive settings.|
