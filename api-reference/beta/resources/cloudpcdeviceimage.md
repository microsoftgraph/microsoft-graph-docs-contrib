...
|sourceImageNotGeneralized|The uploaded image hasn’t been generalized. Re-upload the image after running the sysprep/generalize command. [Learn more](https://docs.microsoft.com/en-us/azure/virtual-machines/generalize).|
