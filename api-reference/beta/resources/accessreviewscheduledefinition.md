...
|stageSettings|[accessReviewStageSettings](../resources/accessreviewstagesettings.md) collection|The stage settings of an access review series. If a review series has stages, each review instance will be broken down in to up to 3 sequential stages, where each stage can have different set of reviewer, fallback reviewers and settings. Stages will be created sequentially based on the dependsOn property. Optional.|
