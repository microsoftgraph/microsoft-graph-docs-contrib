...
|[Export report](../api/security-ediscoverysearch-exportreport.md)| Export an items report from the eDiscovery search.|
|[Export results](../api/security-ediscoverysearch-exportresult.md) Export results from the eDiscovery search.|
