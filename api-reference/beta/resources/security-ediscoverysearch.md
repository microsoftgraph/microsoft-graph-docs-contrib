...
|[exportReport](../api/security-ediscoverysearch-exportreport.md)|None|Export an item report from an [ediscoverySearch](../resources/security-ediscoverysearch.md).|
|[exportResult](../api/security-ediscoverysearch-exportresult.md)|None|Export results from an [ediscoverySearch](../resources/security-ediscoverysearch.md).|
