...
Represents a file plan descriptor that specifies the department or business unit of an organization to which a label applies. Used to supplement a [retention label](security-retentionlabel.md) for [record management purposes](security-recordsmanagement-overview.md).

To add, get, or remove an **citation** descriptor, use the [citationTemplate](security-categorytemplate.md) resource.
