...
| Delete a community | [DELETE /employeeExperience/communities/{communityId}](../api/community-delete.md) | If successful, this method deletes a [community](../resources/community.md) in Viva Engage and returns a `204 No Content` response code. All the Microsoft 365 content associated with the community is deleted. [Learn more](/viva/engage/engage-microsoft-365-groups#q-what-happens-if-i-delete-a-viva-engage-community-connected-to-microsoft-365-groups) |
