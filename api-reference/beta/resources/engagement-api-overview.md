...
| Delete a community | [DELETE /employeeExperience/communities/{communityId}](../api/community-delete.md) | If successful, this method deletes a [community](../resources/community.md) in Viva Engage and returns a `204 No Content` response code. |
