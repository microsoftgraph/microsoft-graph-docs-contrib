...
|historyStates|[alertHistoryState](alerthistorystate.md) collection| Each time an alert is patched, the change is saved in a new object of alertHistoryState, and will be returned as part of the modified alert. |
