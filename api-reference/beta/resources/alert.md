...
|historyStates|[alertHistoryState](alerthistorystate.md) collection| Collection of alertHistoryStates compromising an audit log of all updates made to an alert. |
