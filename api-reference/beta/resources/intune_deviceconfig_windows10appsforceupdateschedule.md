...
|recurrence|[windows10AppsUpdateRecurrence](../resources/intune_deviceconfig_windows10appsupdaterecurrence.md)|Recurrence schedule. Possible values are: `none`, `daily`, `weekly`, `monthly`.|
