...
|members|[directoryObject](directoryobject.md) collection|Users, groups, and devices that are members of this Adminsitrative Unit. HTTP Methods: GET (list members), POST (add members), DELETE (remove members).|
