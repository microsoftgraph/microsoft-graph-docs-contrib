...
|**Schema extensions**| | |
|[Add schema extension values](../api/extensibility-schema-groups.md) || Create a schema extension definition and then use it to add custom typed data to a resource.|
