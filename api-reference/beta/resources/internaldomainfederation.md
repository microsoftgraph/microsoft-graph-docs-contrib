...
Represents configurations of the domains in a tenant that are federated and verified with Microsoft Entra ID. Use this resource to configure federation settings when setting up federation with Microsoft Entra ID. For information on federation, see [What is federation with Microsoft Entra ID?](/azure/active-directory/hybrid/whatis-fed).
