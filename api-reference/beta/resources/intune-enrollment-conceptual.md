...
- [Deleted windows autopilot device state](intune-enrollment-deletedwindowsautopilotdevicestate.md)
...
- [Windows autopilot device deletion state](intune-enrollment-windowsautopilotdevicedeletionstate.md)
