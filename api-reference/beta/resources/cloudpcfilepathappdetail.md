...
description: "Represents properties of a cloud app that an admin manually created using a file path."
author: "niniliu"
...
Represents properties of a [cloud app](../resources/cloudpccloudapp.md) that an admin manually created using a file path.
