...
| Manage Verified ID profiles, including configuration for Face Check and verifiable credential exchange :::image type="content" source="../images/preview-label.png" alt-text="Available on beta only."::: | [verifiedIdProfile resource type](verifiedidprofile.md) and its associated APIs |
| **Other policies** | |
