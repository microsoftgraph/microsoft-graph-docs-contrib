...
|:---|:---|:---|
|displayName|String|The name of the object. SSupports `$filter` and (`eq`,`contains`). Inherited from [authorizationSystemIdentity](../resources/authorizationsystemidentity.md).|
