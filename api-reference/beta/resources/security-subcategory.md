...
Represents a unique subcategory applied to a retention label. Used to supplement a [retention label](security-retentionlabel.md) for [record management purposes](security-recordsmanagement-overview.md).

To add, get, or remove a **citation** descriptor, use the [citationTemplate](security-categorytemplate.md) resource.
