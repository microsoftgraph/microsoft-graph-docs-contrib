...
|[Hide a chat for user](../api/chat-hideforuser.md)|None|Hide a chat for a user.|
|[Unhide a chat for user](../api/chat-unhideforuser.md)|None|Unhide a chat for a user.|
| **Messages** |||
