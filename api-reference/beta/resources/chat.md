...
|migrationMode|[migrationMode](../resources/chat.md#migratiomode-values)|Setting to indicate whether a chat is in migrationMode. This will be `null` for chats that never entered migration mode.|
