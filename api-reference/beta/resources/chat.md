...
|[Get operation on chat](../api/teamsasyncoperation-get#example-get-operation-on-chat.md) | [teamsAsyncOperation](teamsAsyncOperation.md) | Get a single async operation that ran or is running on the chat.|
