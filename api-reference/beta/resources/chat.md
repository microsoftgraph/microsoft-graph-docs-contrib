...
| **Operations** |||
|[List operations on chat](../api/chat-list-operations.md) | [teamsAsyncOperation](teamsAsyncOperation.md) collection | Get the list of async operations that ran or are running on this team.|
|[Get operation on chat](../api/chat-get-operation.md) | [teamsAsyncOperation](teamsAsyncOperation.md) | Get a single async operation that ran or is running on this team.|
