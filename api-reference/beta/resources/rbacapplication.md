...
| [List transitiveRoleAssignments](../api/unifiedroleassignment-list-transitive.md) | [unifiedRoleAssignment](unifiedroleassignment.md) collection | Get direct and transitive unifiedRoleAssignments assigned to a specific principal. Specifying principalId is required. |
