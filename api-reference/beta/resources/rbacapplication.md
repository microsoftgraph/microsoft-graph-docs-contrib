...
| [List transitiveRoleAssignments](../api/rbacapplication-list-roleassignments-transitive.md) | [unifiedRoleAssignment](unifiedroleassignment.md) collection | Get direct and transitive unifiedRoleAssignments assigned to a specific principal. Specifying principalId is required. |
