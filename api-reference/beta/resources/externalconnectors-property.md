...
| isExactMatchRequired  | boolean   | Specifies if the property will be matched exactly for queries. Only non-searchable properties of type `string` or `stringCollection` can specify exact matching. Optional. |
