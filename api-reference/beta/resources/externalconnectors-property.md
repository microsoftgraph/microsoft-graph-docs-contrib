...
| description          | String            | Specifies a human-readable description that explains the property’s purpose, usage, or guidance for Copilot. This attribute enhances semantic understanding by helping Copilot interpret queries and map them accurately to properties, resulting in more relevant and precise responses.Optional attribute but highly recommended for queryable properties.Maximum length: 200 characters.|
