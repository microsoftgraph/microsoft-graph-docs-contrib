...
There can be up to 6 categories applied to a task. Category descriptions, e.g. `category0`, `category1` etc., are part of the [plan details](plannerplandetails.md) object. This is an open type.
