...
| :---------------------------- | :---------------------------- | :--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| behaviorDuringRetentionPeriod | microsoft.graph.security.behaviorDuringRetentionPeriod | Describes the item behavior during retention period. For possible values, please see: [behaviorDuringRetentionPeriod](/graph/api/resources/enums-security?view=graph-rest-beta#behaviorduringretentionperiod-values.md). Read-only. |
