...
- [Defender security center i t contact display type](intune_deviceconfig_defendersecuritycenteritcontactdisplaytype.md)
...
- [Device type](intune_deviceconfig_devicetype.md)
