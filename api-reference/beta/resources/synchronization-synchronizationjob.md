...
|[getProvisionOnDemand](../api/synchronization-synchronizationjob-get-provision-on-demand.md)|None|Poll the outcome of a provisioning request when using on-demand provisioning. |
