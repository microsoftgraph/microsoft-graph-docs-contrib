...
|status|[microsoft.graph.security.incidentStatus](#incidentstatus-values)|The status of the incident. Possible values are: `active`, `inProgress`, `resolved`, `redirected`, `unknownFutureValue`.|
