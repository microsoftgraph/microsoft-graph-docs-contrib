...
|windowsSettings|[cloudPcWindowsSettings](../resources/cloudpcwindowssettings.md)|The settings to apply to Windows while creating Cloud PCs for this organization. The default value is a WindowsSettings with default language value `en-US`.|
