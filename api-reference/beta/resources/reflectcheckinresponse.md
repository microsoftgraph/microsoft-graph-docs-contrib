...
description: "Represents a response to Reflect check-in"
author: "v-rmanda"
...
Represents a response to Reflect check-in.
...
|submitDateTime|DateTimeOffset|Date and time when the response to the Reflect check-in was submitted.|
