...
| :----------------------------- | :------------------- | :--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| accessType                     | resourceAccessType   | Indicates the type of access performed on the resource. Inherited from [resourceAccessDetail](../resources/resourceaccessdetail.md). The possible values are: `none`, `read`, `write`, `create`, `unknownFutureValue`. |
...
| status                         | resourceAccessStatus | Indicates the status of the access attempt. Inherited from [resourceAccessDetail](../resources/resourceaccessdetail.md). The possible values are: `none`, `failure`, `success`, `unknownFutureValue`.                  |
