...
| startDateTime               | `DateTimeOffset`                  | The start date and time for the `shiftItem`. Required.    |
| endDateTime               | `DateTimeOffset`                  | The end date and time for the `shiftItem`. Required.    |
