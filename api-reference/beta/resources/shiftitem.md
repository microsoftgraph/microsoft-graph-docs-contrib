...
| activities 	| `collection([shiftActivity](shiftactivity.md))`    | An incremental part of a shift which can cover details of when and where an employee is during their shift. For example, an assignment or a scheduled break or lunch. |
