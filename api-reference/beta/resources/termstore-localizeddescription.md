...
Represents the localized description used to describe a [microsoft.graph.termstore.term] in a term [microsoft.graph.termstore.store]. For more details, see [microsoft.graph.termstore.term].
