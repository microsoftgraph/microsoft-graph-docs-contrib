---
title: "appConfigurationSchemaItemHiddenType resource type"
description: "Hidden configuration item inside an Android application's custom configuration schema."
author: "jaiprakashmb"
...
# appConfigurationSchemaItemHiddenType resource type
...
<!-- {
  "blockType": "resource",
  "@odata.type": "microsoft.graph.appConfigurationSchemaItemHiddenType"
}
-->
``` json
{
