...
|---|---|---|
|[List webApps](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/api/intune_apps_webapp_list.md)|[webApp](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_apps_webapp.md) collection|List properties and relationships of the [webApp](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_apps_webapp.md) objects.|
|[Get webApp](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/api/intune_apps_webapp_get.md)|[webApp](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_apps_webapp.md)|Read properties and relationships of the [webApp](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_apps_webapp.md) object.|
|[Create webApp](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/api/intune_apps_webapp_create.md)|[webApp](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_apps_webapp.md)|Create a new [webApp](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_apps_webapp.md) object.|
|[Delete webApp](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/api/intune_apps_webapp_delete.md)|None|Deletes a [webApp](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_apps_webapp.md).|
|[Update webApp](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/api/intune_apps_webapp_update.md)|[webApp](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_apps_webapp.md)|Update the properties of a [webApp](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_apps_webapp.md) object.|
