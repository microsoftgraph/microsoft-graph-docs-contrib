...
>[!NOTE]
>For access review APIs that apply to group memberships, see [Access reviews for groups](accessreviewsv2-root.md). The access review APIs in this section apply to all other supported resource types.
