...
The **extensionAttributes** property of the [device](device.md) resource contains fifteen custom extension attribute properties. These properties may be set during creation or update of a device in Azure Active Directory (Azure AD).
