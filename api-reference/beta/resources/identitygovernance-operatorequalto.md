---
title: "operatorEqualTo resource type"
description: "Represents a time-based operator that matches a user's date attribute at an exact offset from the current date."
author: "jackschedel"
ms.date: 08/10/2026
...
Represents a [workflowTriggerTimeBasedOperator](../resources/identitygovernance-workflowtriggertimebasedoperator.md) that matches users whose date attribute is exactly **offsetInDays** days from the current date.
