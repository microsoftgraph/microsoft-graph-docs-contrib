...
description: "Represents the content sensitivity label assignment in Microsoft Planner plans."
author: "ankku"
ms.date: 10/23/2025
...
|justificationText|String|Optional. The justification text provided when changing the sensitivity label. This property is typically used during label downgrade to document the reason.|
