...
|[enableEndpointPrivilegeManagement action](../api/intune-deviceconfig-devicemanagement-enableendpointprivilegemanagement.md)|None|DEPRECATED - DO NOT USE. (Triggers onboarding of tenant to Microsoft Managed Platform - Cloud (MMP-C)).|
|[enableTenantPerPermissionsScopeTagSetting action](../api/intune-deviceconfig-devicemanagement-enabletenantperpermissionsscopetagsetting.md)|None|This action will enable per permissions scope tag on the tenant.|
|[retrieveTenantPerPermissionsScopeTagSetting action](../api/intune-deviceconfig-devicemanagement-retrievetenantperpermissionsscopetagsetting.md)|None|This function will return True if the tenant has per permission scope tags enabled or false if the tenant does not have per permission scope tags enabled.|
...
|hardwarePasswordInfo|[hardwarePasswordInfo](../resources/intune-deviceconfig-hardwarepasswordinfo.md) collection|Intune will provide customer the ability to configure BIOS configuration settings on the enrolled Windows 10 and Windows 11 Microsoft Entra joined devices. Starting from June, 2024, customers should start using hardwarePasswordDetail resource type - Microsoft Graph beta | Microsoft Learn. HardwarePasswordInfo will be marked as deprecated with Intune Release 2409|
