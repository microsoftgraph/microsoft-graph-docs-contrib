...
|resultTemplates|[resultTemplate](resultTemplate.md) collection|A dictionary which key is a **resultTemplateId** and it's value is the name and json schema of the result template.
