...
|[run](../api/protectionrulebase-run.md)|[protectionRuleBase](../resources/protectionrulebase.md)|**TODO: Add Description**|
...
|active | Upon running the protection rule the status of protection rule transitions to active. The state transition is draft to active.|
