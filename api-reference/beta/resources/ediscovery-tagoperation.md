...
|:---|:---|:---|
|action|[microsoft.graph.ediscovery.caseAction](../resources/ediscovery-caseoperation#caseAction-values.md)| The case action for this entity will always be `applyTags`. Read-only. Inherited from [caseOperation](../resources/ediscovery-caseoperation.md).|
