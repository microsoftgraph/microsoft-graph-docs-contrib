...
|:---|:---|:---|
|action|[microsoft.graph.ediscovery.caseAction](../resources/ediscovery-caseoperation#caseAction-values.md)| The type of operation - `applyTags`. Read-only. Inherited from [caseOperation](../resources/ediscovery-caseoperation.md).|
