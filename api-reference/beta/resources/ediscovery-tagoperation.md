...
|:---|:---|:---|
|action|microsoft.graph.ediscovery.caseAction| The type of operation - `applyTags`. Read-only. Inherited from [caseOperation](../resources/ediscovery-caseoperation.md).|
