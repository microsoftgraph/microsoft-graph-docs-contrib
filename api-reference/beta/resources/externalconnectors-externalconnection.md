...
| ingestedItemsCount           | Integer                            |  The number of items ingested in connection. This number is cached and has a delay for the refreshed value after 15 minutes. If the connection state is `draft`, then ingestedItemsCount will be `null`. |
