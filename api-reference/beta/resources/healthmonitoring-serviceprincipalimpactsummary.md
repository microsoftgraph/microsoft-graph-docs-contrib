...
|resourceType|String|The type of resource that was impacted. For example: `servicePrincipal`. Inherited from [microsoft.graph.healthMonitoring.resourceImpactSummary](../resources/healthmonitoring-resourceimpactsummary.md).|
