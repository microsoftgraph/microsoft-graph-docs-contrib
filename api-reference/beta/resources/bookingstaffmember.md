...
|timeZone|String|Timezone of the bookingStaffMember is operating from. The format/value of time zone would be the standard followed in graph as mentioned: [dateTimeTimeZone](datetimetimezone.md).|
