...
An entity of type `chatAttachment` is returned as part of the [Get channel messages](../api/channel_messages_list.md) API, as a part of [chatMessage](chatMessage.md) entity.
