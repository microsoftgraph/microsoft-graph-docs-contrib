...
|attributes|[accessPackageResourceAttribute](../resources/accesspackageresourceattribute.md) collection| Contains attribute information for the attributes that are required to be collected from the requestor and provided to the resource application.|
