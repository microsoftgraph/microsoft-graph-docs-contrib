...
|---|---|---|
|[List androidWiFiConfigurations](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/api/intune_deviceconfig_androidwificonfiguration_list.md)|[androidWiFiConfiguration](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_deviceconfig_androidwificonfiguration.md) collection|List properties and relationships of the [androidWiFiConfiguration](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_deviceconfig_androidwificonfiguration.md) objects.|
|[Get androidWiFiConfiguration](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/api/intune_deviceconfig_androidwificonfiguration_get.md)|[androidWiFiConfiguration](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_deviceconfig_androidwificonfiguration.md)|Read properties and relationships of the [androidWiFiConfiguration](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_deviceconfig_androidwificonfiguration.md) object.|
|[Create androidWiFiConfiguration](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/api/intune_deviceconfig_androidwificonfiguration_create.md)|[androidWiFiConfiguration](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_deviceconfig_androidwificonfiguration.md)|Create a new [androidWiFiConfiguration](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_deviceconfig_androidwificonfiguration.md) object.|
|[Delete androidWiFiConfiguration](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/api/intune_deviceconfig_androidwificonfiguration_delete.md)|None|Deletes a [androidWiFiConfiguration](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_deviceconfig_androidwificonfiguration.md).|
|[Update androidWiFiConfiguration](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/api/intune_deviceconfig_androidwificonfiguration_update.md)|[androidWiFiConfiguration](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_deviceconfig_androidwificonfiguration.md)|Update the properties of a [androidWiFiConfiguration](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_deviceconfig_androidwificonfiguration.md) object.|
