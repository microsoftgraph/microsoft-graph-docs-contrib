...
|---|---|---|
|[List windows10CertificateProfileBases](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/api/intune_deviceconfig_windows10certificateprofilebase_list.md)|[windows10CertificateProfileBase](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_deviceconfig_windows10certificateprofilebase.md) collection|List properties and relationships of the [windows10CertificateProfileBase](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_deviceconfig_windows10certificateprofilebase.md) objects.|
|[Get windows10CertificateProfileBase](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/api/intune_deviceconfig_windows10certificateprofilebase_get.md)|[windows10CertificateProfileBase](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_deviceconfig_windows10certificateprofilebase.md)|Read properties and relationships of the [windows10CertificateProfileBase](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_deviceconfig_windows10certificateprofilebase.md) object.|
