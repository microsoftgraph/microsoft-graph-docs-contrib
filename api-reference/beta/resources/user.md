...
|dataSecuityAndGovernance|[userDataSecurityAndGovernance](userDatasecurityandgovernance.md)| The data security and governance settings for the user. Read-only. Nullable.|
