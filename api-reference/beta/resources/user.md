...
| isLicenseReconciliationNeeded | Boolean | Indicates whether the user needs a license for their mailbox. <br><br> Read-only. <br><br> Supports `$filter` (`eq` where `true` only).  |
