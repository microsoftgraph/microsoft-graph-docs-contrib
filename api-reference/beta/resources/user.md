...
```json
{
  "aboutMe": "string",
  "accountEnabled": true,
  "ageGroup": [ { "@odata.type": "microsoft.graph.directoryObject" } ],
  ...
  "city": "string",
  "companyName": "string",
  "consentProvidedForMinor": [ { "@odata.type": "microsoft.graph.directoryObject" } ],
  "country": "string",
  ...
  "interests": ["string"],
  "jobTitle": "string",
  "legalAgeGroupClassification": [ { "@odata.type": "microsoft.graph.directoryObject" } ],
  "mail": "string",
