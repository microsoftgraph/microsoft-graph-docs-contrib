...
| **AI interaction**|||
| [Get all enterprise interactions]|[aiInteraction](../resources/aiinteraction.md) collection|Get all Copilot interactions data, including both a user prompt to Copilot and the Copilot response.|
