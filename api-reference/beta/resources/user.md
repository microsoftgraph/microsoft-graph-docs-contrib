...
|onPremisesSipInfo|[onPremisesSipInfo](../resources/onpremisessipinfo.md)|Contains all onPremises Session Initiation Protocol(SIP) information related to the user. Read-only.|
