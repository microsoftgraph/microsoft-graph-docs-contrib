...
|employeeOrgData|[employeeOrgData](employee-org-data.md) |Represents organization data (e.g. division and costCenter) associated with a user. <br><br>Returned only on $select.|
