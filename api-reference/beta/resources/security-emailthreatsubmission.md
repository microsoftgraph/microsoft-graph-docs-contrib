...
| attackSimulationInfo         | attackSimulationInfo         | If the email is phishing simulation, the field will not be null.                                       | ❌   | ❌        |
| tenantAllowOrBlockListAction | tenantAllowOrBlockListAction | Used to auto add urls/attachments/senders of the email threat submission into tenant allow block list. | ❌   | ❌        |
## Relationships
None.
