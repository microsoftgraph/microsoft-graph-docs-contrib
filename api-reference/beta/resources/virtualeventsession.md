...
| allowTeamworkReactions | Boolean | Indicates if Teams reactions are enabled for the virtual event session. Inherited from [onlineMeetingBase](../resources/onlineMeetingBase.md). |
