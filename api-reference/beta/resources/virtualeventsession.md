...
| videoOnDemandWebUrl | String | [URL of the video on demand (VOD)](https://learn.microsoft.com/microsoftteams/manage-vod-publishing) for Microsoft Teams events allows webinar and town hall organizers to quickly publish and share event recordings.  |
