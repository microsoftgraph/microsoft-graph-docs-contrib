...
|deliveryPlatform|[payloadDeliveryPlatform]|The payload delivery platform for a simulation. Possible values are: `unknown`, `sms`, `email`, `teams`, `unknownFutureValue`. 
...
|complexity|[payloadComplexity]|Complexity of a payload.|
...
|theme|[payloadTheme]|Theme of a payload.|
|brand|[payloadBrand]|Brand of a payload.|
|industry|[payloadIndustry]|industry of a payload.|
