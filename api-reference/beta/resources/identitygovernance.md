...
+ [Custom data](../resources/customdatacontainer.md)
...
|customData|[customDataContainer](../resources/customdatacontainer.md)|Container for custom data object definitions and objects.|
