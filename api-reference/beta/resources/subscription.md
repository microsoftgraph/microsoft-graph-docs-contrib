...
| lifecycleNotificationUrl | string | Optional. The URL of the endpoint that will receive "lifecycle notifications". If not provided, those notifications will be delivered to **notificationUrl**. [Read more](/graph/webhooks-outlook-authz.md) about how Outlook resources use lifecycle notifications.  This URL must make use of the HTTPS protocol. |
