...
An incident is a collection of correlated alerts and associated data that make up the story of an attack.
...
The incidents APIs allows you to sort through incidents to create an informed cyber security response. It exposes a collection of incidents that were flagged in your network, within the time range you specified in your environment retention policy.
