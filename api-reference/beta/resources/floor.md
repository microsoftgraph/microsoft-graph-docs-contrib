...
|:---|:---|:---|
|children|[place](../resources/place.md) collection|A collection of child places that is only used in the [Bulk upsert](../api/place-patch-places.md) API. For a **floor**, valid child types are [section](../resources/section.md) and [room](../resources/room.md). Inherited from [place](../resources/place.md).|
