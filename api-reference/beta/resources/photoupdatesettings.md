...
|enum|microsoft.peopleAdmin.photoUpdateSource| Specifies the types of photo updates permitted.The possible values are: `cloud`, `onPremises`, `unknownFutureValue`.|
