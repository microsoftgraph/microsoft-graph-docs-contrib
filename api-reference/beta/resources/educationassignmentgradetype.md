...
This superclass can not be used directly in the assignment property. It exists to allow for multiple different ways to grade assignments, it is a base class for [educationAssignmentPointsGradeType](educationassignmentpointsgradetype.md).
