...
| recommendationInsightSettings|[accessReviewRecommendationInsightSetting](../resources/accessReviewRecommendationInsightSetting.md) collection | Optional field. Describes the types of insights that aid reviewers making decisions to include in the review. There is one type that is currently supported: `userLastSignInRecommendationInsightSetting` (default) |
