...
|[List the users under the scope of the execution conditions](../api/identitygovernance-list-executionscope.md)|[microsoft.graph.user]|Get a list of users who fall under the scope of the execution conditions of a [workflow](../resources/identitygovernance-workflow.md) object.|
