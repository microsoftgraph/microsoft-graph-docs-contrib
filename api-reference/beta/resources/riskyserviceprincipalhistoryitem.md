...
| initiatedBy    | String    | The identifier of the actor that does the operation. |
| activity       | [riskyServicePrincipalActivity](riskyserviceprincipalactivity.md)| The activity related to the service principal risk. | 
