...
| allowTranscription | Boolean | Indicates if transcription is enabled for the meeting. |
| allowRecording | Boolean | Indicates if recording is enabled for the meeting. |
