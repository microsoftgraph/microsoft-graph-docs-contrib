...
| meetingTemplateId | String | The id of the [meeting template](https://learn.microsoft.com/en-us/microsoftteams/create-custom-meeting-template). Inherited from [onlineMeetingBase](../resources/onlineMeetingBase.md). |
