...
| anonymizeIdentityForRoles    | onlineMeetingRole collection | Specifies whose identity will be anonymized in meeting. Possible values are: `attendee`. The `attendee` value cannot be removed through a PATCH operation once added.|
