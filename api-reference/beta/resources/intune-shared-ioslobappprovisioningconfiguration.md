...
|assignments|[iosLobAppProvisioningConfigurationAssignment](../resources/intune-shared-ioslobappprovisioningconfigurationassignment.md) collection|The associated group assignments for IosLobAppProvisioningConfiguration.|
