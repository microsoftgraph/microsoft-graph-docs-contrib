...
|recurrence|[plannerTaskRecurrence](plannertaskrecurrence.md)|Defines active or inactive recurrence for the task; may be null if recurrence has never been defined for the task.|
