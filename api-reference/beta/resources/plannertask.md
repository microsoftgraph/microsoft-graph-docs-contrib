...
|id|String|Read-only. The unique identifier of the task. It's 28 characters long and case-sensitive. [Format validation](tasks-identifiers-disclaimer.md) is done on the service.|
