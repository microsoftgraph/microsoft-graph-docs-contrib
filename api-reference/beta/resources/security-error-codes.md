...
Bulk actions (i.e. creating, updating, and deleting) can generate two different potential error codes:  
1. A 400 error code indicates that the body provided had an error during serialization.
