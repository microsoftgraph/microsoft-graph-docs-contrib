...
|validationRegex|String|The regular expression pattern used to validate custom usernames. The pattern must be a valid regex, cannot exceed 60 characters in length, and cannot be an email-supported regex pattern.|
