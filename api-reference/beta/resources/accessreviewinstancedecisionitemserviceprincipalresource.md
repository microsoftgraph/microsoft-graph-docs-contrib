...
Every decision item in an access review represents a principal's access to a resource that is identified by an accessreviewinstancedecisionitemserviceprincipalresource object. accessreviewinstancedecisionitemserviceprincipalresource is an open type that allows for other properties to be passed in.
