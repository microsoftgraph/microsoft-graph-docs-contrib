...
|conversation|[teamworkConversationIdentity](../resources/teamworkconversationidentity.md)|If present, represents a conversation (for example, team, channel, and chat) @mentioned in a [message](../resources/chatmessage.md).|
