...
|[List recent notebooks](../api/notebook_recent.md) | [RecentNotebook](recentnotebook.md) collection | Get a collection of the most recently accessed notebooks for the user. |
