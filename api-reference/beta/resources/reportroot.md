...
|[Get apps user counts](../api/reportroot-getemailappusageappsusercounts.md)|Stream|Get The number of unique users per email app.|
|[Get user counts](../api/reportroot-getemailappusageusercounts.md)|Stream|Get The number of unique users that connected to Exchange Online using any email app.|
|[Get versions user counts](../api/reportroot-getemailappusageversionsusercounts.md)|Stream|Get The number of unique users by Outlook desktop version.|
...
|[Get quota status mailbox counts](../api/reportroot-getmailboxusagequotastatusmailboxcounts.md)|Stream|Get The number of user mailboxes in each quota category.|
...
|[Get activation counts](../api/reportroot-getoffice365activationcounts.md)|Stream|Get The number of Microsoft 365 activations on desktops and devices.|
|[Get user counts](../api/reportroot-getoffice365activationsusercounts.md)|Stream|Get The number of users that are enabled and those that have activated the Office subscription on desktop or devices.|
...
|[Get user counts](../api/reportroot-getoffice365activeusercounts.md)|Stream|Get The number of daily active users in the reporting period by product.|
|[Get services user counts](../api/reportroot-getoffice365servicesusercounts.md)|Stream|Get The number of users by activity type and service.|
...
|healthMonitoring|[microsoft.graph.healthMonitoring.healthMonitoringRoot](../resources/healthmonitoring-healthmonitoringroot.md)|Represents a container for navigation properties of resources for  Microsoft Entra Health Monitoring.|
