...
| Discover information about ports Microsoft Defender Threat Intelligence has observed on a **host**. Host ports contain information such as which ports are observable on a host, what components have been seen on those ports, number of times that port has been observed, and what the banner response contains.            | [hostPort](../resources/security-hostport.md)                               | [Methods of hostPort](../resources/security-hostport.md#methods)                               |
