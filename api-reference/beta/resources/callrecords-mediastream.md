...
|isAudioForwardErrorCorrectionUsed|Boolean|Indicates if the forward error correction (FEC) was used at some point during the session. The default value is null.|
