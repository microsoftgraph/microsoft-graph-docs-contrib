...
description: "Represents the summary of severity information regarding the vulnerabilities (CVEs) addressed by a quality update."
author: "angiechen22"
...
Represents the summary of severity information regarding the vulnerabilities (CVEs) addressed by a quality update. The National Vulnerability Database uses the Common Vulnerability Scoring System (CVSS)  to supply a qualitative measure of severity. Each CVE has a severity level which may be `moderate`, `important`, or `critical` and a CVSS base score that ranges from 0.0 to 10.0.

## Properties
|Property|Type|Description|
|:---|:---|:---|
|maxSeverityLevel|microsoft.graph.windowsUpdates.cveSeverityLevel| Highest severity level that occurs of any CVE addressed by the quality update. Read-only.|
