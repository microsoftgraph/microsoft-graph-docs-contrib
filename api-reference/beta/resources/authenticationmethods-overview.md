...
* You can retrieve details of a user's Passwordless Phone Sign-in with Microsoft Authenticator registration, and delete it if the user has lost the phone.
...
|[passwordlessmicrosoftauthenticatorauthenticationmethod](passwordlessmicrosoftauthenticatorauthenticationmethod.md)|Passwordless Phone Sign-in with Microsoft Authenticator can be used by a user to sign-in to Azure AD|Delete a Passwordless Phone Sign-in authentication method.|
