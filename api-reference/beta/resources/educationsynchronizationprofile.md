...
| expirationDate                       | Date                                                   | The date the profile should be considered expired and cease syncing. Must in [ISO 8601](https://www.iso.org/iso-8601-date-and-time-format.html) format (`YYYY-MM-DD`). Maximum value is 18 months from profile creation.  (optional)       |
