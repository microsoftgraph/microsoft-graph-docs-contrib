...
|authenticationProcessingDetails|[keyValue](keyvalue.md) collection|Extra authentication processing details, such as the agent name for PTA/PHS or Server/farm name for federated authentication.|
