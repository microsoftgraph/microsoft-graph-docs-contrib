...
|riskEventTypes_v2|String|The list of risk event types associated with the sign-in. Possible values: `unlikelyTravel`, `anonymizedIPAddress`, `maliciousIPAddress`, `unfamiliarFeatures`, `malwareInfectedIPAddress`, `suspiciousIPAddress`, `leakedCredentials`, `investigationsThreatIntelligence`,  `generic`, or `unknownFutureValue`.|
...
```json
{
  ...
  "resourceId": "String",
  "riskDetail": "string",
  "riskEventTypes": {"@odata.type": "microsoft.graph.riskEventTypes"},
