...
|conditionalAccessAudiences|String|A list that indicates the audience whom were evaluated by Conditional Access during a sign-in event. <br/><br/> Supports `$filter` (`eq`).|
