...
|authenticationRequirementPolicies|[authenticationRequirementPolicy](../resources/authenticationrequirementpolicy.md) collection|Sources of authentication requirement. It identifies what Microsoft Entra feature requires MFA, such as conditional access, per-user MFA, identity protection, and security defaults.|
