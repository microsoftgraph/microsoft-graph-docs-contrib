...
|conditionalAccessAudiences|String|full list of applications which will be evaluated by Conditional Access in the format application id : conditional access audience reasons. <br/><br/> Supports `$filter` (`eq`).|
...
|isThroughGlobalSecureAccess|Boolean|Whether or not a user came through Global Secure Access service.|
