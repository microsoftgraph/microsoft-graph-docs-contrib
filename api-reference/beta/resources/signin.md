...
|:---------------|:--------|:----------|
|agent|[microsoft.graph.agentic.agentSignIn](agentic-agentsignin.md)|Represents details about the agentic. Includes the type of agent as well as parentAppID in some cases|
