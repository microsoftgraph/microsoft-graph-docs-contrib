...
|---|---|---|
|[List iosStoreApps](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/api/intune_apps_iosstoreapp_list.md)|[iosStoreApp](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_apps_iosstoreapp.md) collection|List properties and relationships of the [iosStoreApp](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_apps_iosstoreapp.md) objects.|
|[Get iosStoreApp](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/api/intune_apps_iosstoreapp_get.md)|[iosStoreApp](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_apps_iosstoreapp.md)|Read properties and relationships of the [iosStoreApp](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_apps_iosstoreapp.md) object.|
|[Create iosStoreApp](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/api/intune_apps_iosstoreapp_create.md)|[iosStoreApp](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_apps_iosstoreapp.md)|Create a new [iosStoreApp](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_apps_iosstoreapp.md) object.|
|[Delete iosStoreApp](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/api/intune_apps_iosstoreapp_delete.md)|None|Deletes a [iosStoreApp](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_apps_iosstoreapp.md).|
|[Update iosStoreApp](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/api/intune_apps_iosstoreapp_update.md)|[iosStoreApp](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_apps_iosstoreapp.md)|Update the properties of a [iosStoreApp](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_apps_iosstoreapp.md) object.|
