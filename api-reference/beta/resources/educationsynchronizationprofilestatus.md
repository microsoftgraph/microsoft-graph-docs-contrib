...
"Extracting" and Validating statuses are only returned for opt-in clients. See more about: [evolvable enums](https://github.com/microsoftgraph/microsoft-graph-docs/blob/main/concepts/best-practices-concept.md#evolvable-enums).
