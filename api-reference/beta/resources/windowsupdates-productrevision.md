...
|isHotpatchUpdate|Boolean|`True` indicates that the content is hotpatchable; otherwise, `false`. [Deploy a hotpatch quality update](/graph/windowsupdates-hotpatch-update.md) using Windows Autopatch. Read-only.|
