...
|---|---|---|
|[List macOSWiFiConfigurations](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/api/intune_deviceconfig_macoswificonfiguration_list.md)|[macOSWiFiConfiguration](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_deviceconfig_macoswificonfiguration.md) collection|List properties and relationships of the [macOSWiFiConfiguration](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_deviceconfig_macoswificonfiguration.md) objects.|
|[Get macOSWiFiConfiguration](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/api/intune_deviceconfig_macoswificonfiguration_get.md)|[macOSWiFiConfiguration](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_deviceconfig_macoswificonfiguration.md)|Read properties and relationships of the [macOSWiFiConfiguration](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_deviceconfig_macoswificonfiguration.md) object.|
|[Create macOSWiFiConfiguration](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/api/intune_deviceconfig_macoswificonfiguration_create.md)|[macOSWiFiConfiguration](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_deviceconfig_macoswificonfiguration.md)|Create a new [macOSWiFiConfiguration](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_deviceconfig_macoswificonfiguration.md) object.|
|[Delete macOSWiFiConfiguration](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/api/intune_deviceconfig_macoswificonfiguration_delete.md)|None|Deletes a [macOSWiFiConfiguration](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_deviceconfig_macoswificonfiguration.md).|
|[Update macOSWiFiConfiguration](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/api/intune_deviceconfig_macoswificonfiguration_update.md)|[macOSWiFiConfiguration](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_deviceconfig_macoswificonfiguration.md)|Update the properties of a [macOSWiFiConfiguration](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/api/resources/intune_deviceconfig_macoswificonfiguration.md) object.|
