...
|guestUserRoleId|Guid| Represents role templateId for the role that should be granted to guest user. Refer to [List unifiedRoleDefinitions](../api/rbacapplication-list-roledefinitions.md) to find the list of available role templates. Currently following roles are supported: <ul<<li>User (a0b1b346-4d3e-4e8b-98f8-753987be4970)</li><li> Guest User (10dae51f-b6af-4016-8d66-8c2a99b929b3)</li>, and <li>Restricted Guest User (2af84b1e-32c8-42b7-82bc-daa82404023b).</li></ul> | 
