...
> **Notes:** 
>
>The exception is the `/users/{id}/chats/getAllMessages` resource which supports resource data regardless of permission type. The resource is only available in beta.
