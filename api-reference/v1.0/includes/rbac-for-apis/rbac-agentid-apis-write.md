...
>   - Agent ID Developer - Create agent identity blueprints and blueprint principals. The user with this role is automatically added as an owner of the agent identity blueprint or blueprint principal they create and can perform write operations on the resources they own.
