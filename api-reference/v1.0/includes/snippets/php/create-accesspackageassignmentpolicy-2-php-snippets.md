...
$stagesAccessPackageApprovalStage1->setDurationBeforeAutomaticDenial('P14D');
...
$stagesAccessPackageApprovalStage1->setDurationBeforeEscalation('PT0S');
...
$stagesAccessPackageApprovalStage2->setDurationBeforeAutomaticDenial('P14D');
...
$reviewSettingsScheduleExpiration->setDuration('P14D');
