...
$requestBody->set@odatatype('#microsoft.graph.iosManagedAppProtection');
...
$result = $graphServiceClient->deviceAppManagement()->iosManagedAppProtections()->post($requestBody);
