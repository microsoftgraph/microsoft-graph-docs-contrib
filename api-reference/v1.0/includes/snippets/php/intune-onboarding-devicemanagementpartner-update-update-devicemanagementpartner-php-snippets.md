...
use Microsoft\Graph\Generated\Models\PartnerAppType;
...
$result = $graphServiceClient->deviceManagement()->deviceManagementPartners()->byDeviceManagementPartnerId('deviceManagementPartner-id')->patch($requestBody)->wait();
