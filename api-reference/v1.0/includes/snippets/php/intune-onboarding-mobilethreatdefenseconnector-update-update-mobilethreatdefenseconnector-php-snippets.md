...
$result = $graphServiceClient->deviceManagement()->mobileThreatDefenseConnectors()->byMobileThreatDefenseConnectorId('mobileThreatDefenseConnector-id')->patch($requestBody)->wait();
