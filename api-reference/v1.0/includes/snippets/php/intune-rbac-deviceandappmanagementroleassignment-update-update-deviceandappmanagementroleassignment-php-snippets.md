...
$result = $graphServiceClient->deviceManagement()->roleAssignments()->byDeviceAndAppManagementRoleAssignmentId('deviceAndAppManagementRoleAssignment-id')->patch($requestBody);
