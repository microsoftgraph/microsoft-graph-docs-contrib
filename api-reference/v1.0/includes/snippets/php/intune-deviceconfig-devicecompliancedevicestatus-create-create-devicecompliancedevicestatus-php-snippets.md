...
$requestBody->set@odatatype('#microsoft.graph.deviceComplianceDeviceStatus');
...
$result = $graphServiceClient->deviceManagement()->deviceCompliancePolicies()->byDeviceCompliancePolicieId('deviceCompliancePolicy-id')->deviceStatuses()->post($requestBody);
