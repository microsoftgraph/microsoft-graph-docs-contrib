...
$requestBody->set@odatatype('#microsoft.graph.defaultManagedAppProtection');
...
$result = $graphServiceClient->deviceAppManagement()->defaultManagedAppProtections()->byDefaultManagedAppProtectionId('defaultManagedAppProtection-id')->patch($requestBody);
