...
$result = $graphServiceClient->deviceManagement()->deviceCompliancePolicies()->byDeviceCompliancePolicieId('deviceCompliancePolicy-id')->userStatuses()->byUserStatuseId('deviceComplianceUserStatus-id')->patch($requestBody);
