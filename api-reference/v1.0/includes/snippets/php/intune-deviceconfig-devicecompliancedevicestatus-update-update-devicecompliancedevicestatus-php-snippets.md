...
$result = $graphServiceClient->deviceManagement()->deviceCompliancePolicies()->byDeviceCompliancePolicyId('deviceCompliancePolicy-id')->deviceStatuses()->byDeviceComplianceDeviceStatusId('deviceComplianceDeviceStatus-id')->patch($requestBody);
