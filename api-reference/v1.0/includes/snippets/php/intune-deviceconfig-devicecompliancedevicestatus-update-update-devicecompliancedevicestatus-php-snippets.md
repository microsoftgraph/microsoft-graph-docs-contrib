...
$result = $graphServiceClient->deviceManagement()->deviceCompliancePolicies()->byDeviceCompliancePolicieId('deviceCompliancePolicy-id')->deviceStatuses()->byDeviceStatuseId('deviceComplianceDeviceStatus-id')->patch($requestBody);
