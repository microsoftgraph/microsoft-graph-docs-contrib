...
$requestBody->set@odatatype('#microsoft.graph.deviceConfigurationDeviceOverview');
...
$result = $graphServiceClient->deviceManagement()->deviceConfigurations()->byDeviceConfigurationId('deviceConfiguration-id')->deviceStatusOverview()->patch($requestBody);
