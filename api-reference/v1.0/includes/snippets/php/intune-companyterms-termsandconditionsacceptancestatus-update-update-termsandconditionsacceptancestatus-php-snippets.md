...
$result = $graphServiceClient->deviceManagement()->termsAndConditions()->byTermsAndConditionId('termsAndConditions-id')->acceptanceStatuses()->byAcceptanceStatuseId('termsAndConditionsAcceptanceStatus-id')->patch($requestBody);
