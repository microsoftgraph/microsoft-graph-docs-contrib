...
$requestBody->set@odatatype('#microsoft.graph.deviceConfigurationDeviceStatus');
...
$result = $graphServiceClient->deviceManagement()->deviceConfigurations()->byDeviceConfigurationId('deviceConfiguration-id')->deviceStatuses()->byDeviceStatuseId('deviceConfigurationDeviceStatus-id')->patch($requestBody);
