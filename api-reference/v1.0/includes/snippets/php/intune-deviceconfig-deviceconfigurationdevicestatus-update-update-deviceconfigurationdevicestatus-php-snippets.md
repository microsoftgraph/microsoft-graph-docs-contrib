...
$result = $graphServiceClient->deviceManagement()->deviceConfigurations()->byDeviceConfigurationId('deviceConfiguration-id')->deviceStatuses()->byDeviceConfigurationDeviceStatusId('deviceConfigurationDeviceStatus-id')->patch($requestBody);
