...
$result = $graphServiceClient->deviceManagement()->deviceCompliancePolicies()->byDeviceCompliancePolicyId('deviceCompliancePolicy-id')->assignments()->byDeviceCompliancePolicyAssignmentId('deviceCompliancePolicyAssignment-id')->patch($requestBody)->wait();
