...
$result = $graphServiceClient->deviceAppManagement()->managedEBooks()->byManagedEBookId('managedEBook-id')->deviceStates()->byDeviceInstallStateId('deviceInstallState-id')->patch($requestBody);
