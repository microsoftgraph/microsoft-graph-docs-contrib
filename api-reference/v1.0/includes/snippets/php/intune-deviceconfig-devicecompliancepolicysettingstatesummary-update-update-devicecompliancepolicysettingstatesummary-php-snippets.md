...
$result = $graphServiceClient->deviceManagement()->deviceCompliancePolicySettingStateSummaries()->byDeviceCompliancePolicySettingStateSummarieId('deviceCompliancePolicySettingStateSummary-id')->patch($requestBody);
