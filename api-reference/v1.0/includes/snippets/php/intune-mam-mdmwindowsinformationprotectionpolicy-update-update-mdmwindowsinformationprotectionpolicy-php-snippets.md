...
$result = $graphServiceClient->deviceAppManagement()->mdmWindowsInformationProtectionPolicies()->byMdmWindowsInformationProtectionPolicyId('mdmWindowsInformationProtectionPolicy-id')->patch($requestBody);
