...
$requestBody->set@odatatype('#microsoft.graph.deviceConfigurationUserOverview');
...
$result = $graphServiceClient->deviceManagement()->deviceConfigurations()->byDeviceConfigurationId('deviceConfiguration-id')->userStatusOverview()->patch($requestBody);
