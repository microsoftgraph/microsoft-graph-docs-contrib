...
$result = $graphServiceClient->deviceAppManagement()->enterpriseCodeSigningCertificates()->byEnterpriseCodeSigningCertificateId('enterpriseCodeSigningCertificate-id')->patch($requestBody)->wait();
