...
$result = $graphServiceClient->deviceManagement()->telecomExpenseManagementPartners()->byTelecomExpenseManagementPartnerId('telecomExpenseManagementPartner-id')->patch($requestBody);
