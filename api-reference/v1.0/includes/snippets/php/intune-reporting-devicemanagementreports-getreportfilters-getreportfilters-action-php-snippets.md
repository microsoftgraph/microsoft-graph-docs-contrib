...
use Microsoft\Graph\Generated\DeviceManagement\Reports\GetReportFilters\GetReportFiltersPostRequestBody;


$graphServiceClient = new GraphServiceClient($tokenRequestContext, $scopes);

$requestBody = new GetReportFiltersPostRequestBody();
...
$graphServiceClient->deviceManagement()->reports()->getReportFilters()->post($requestBody)->wait();
