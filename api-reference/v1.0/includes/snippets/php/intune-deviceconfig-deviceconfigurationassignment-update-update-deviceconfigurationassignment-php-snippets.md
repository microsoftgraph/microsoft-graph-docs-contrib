...
$result = $graphServiceClient->deviceManagement()->deviceConfigurations()->byDeviceConfigurationId('deviceConfiguration-id')->assignments()->byDeviceConfigurationAssignmentId('deviceConfigurationAssignment-id')->patch($requestBody);
