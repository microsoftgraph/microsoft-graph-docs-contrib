...
$result = $graphServiceClient->deviceAppManagement()->mobileAppConfigurations()->byManagedDeviceMobileAppConfigurationId('managedDeviceMobileAppConfiguration-id')->userStatuses()->byManagedDeviceMobileAppConfigurationUserStatusId('managedDeviceMobileAppConfigurationUserStatus-id')->patch($requestBody)->wait();
