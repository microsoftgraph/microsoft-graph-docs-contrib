...
$result = $graphServiceClient->deviceManagement()->windowsInformationProtectionAppLearningSummaries()->byWindowsInformationProtectionAppLearningSummarieId('windowsInformationProtectionAppLearningSummary-id')->patch($requestBody);
