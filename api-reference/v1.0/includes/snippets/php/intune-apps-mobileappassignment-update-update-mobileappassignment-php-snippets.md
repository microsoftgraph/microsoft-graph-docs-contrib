...
$result = $graphServiceClient->deviceAppManagement()->mobileApps()->byMobileAppId('mobileApp-id')->assignments()->byAssignmentId('mobileAppAssignment-id')->patch($requestBody);
