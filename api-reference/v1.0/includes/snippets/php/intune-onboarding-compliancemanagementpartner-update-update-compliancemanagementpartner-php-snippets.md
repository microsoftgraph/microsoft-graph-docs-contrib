...
$result = $graphServiceClient->deviceManagement()->complianceManagementPartners()->byComplianceManagementPartnerId('complianceManagementPartner-id')->patch($requestBody);
