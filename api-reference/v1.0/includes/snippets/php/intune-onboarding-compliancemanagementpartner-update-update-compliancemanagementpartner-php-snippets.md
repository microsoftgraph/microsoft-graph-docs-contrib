...
use Microsoft\Graph\Generated\Models\PartnerState;
...
$result = $graphServiceClient->deviceManagement()->complianceManagementPartners()->byComplianceManagementPartnerId('complianceManagementPartner-id')->patch($requestBody)->wait();
