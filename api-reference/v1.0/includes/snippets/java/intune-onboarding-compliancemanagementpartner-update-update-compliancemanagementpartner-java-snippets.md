...
ComplianceManagementPartner result = graphClient.deviceManagement().complianceManagementPartners().byComplianceManagementPartnerId("{complianceManagementPartner-id}").patch(complianceManagementPartner);
