...
PrivilegedAccessGroupEligibilityScheduleRequestCollectionResponse result = graphClient.identityGovernance().privilegedAccess().group().eligibilityScheduleRequests().get(requestConfiguration -> {
