...
bookingStaffMemberBase.displayName = "Dana Swope";
bookingStaffMemberBase.emailAddress = "danas@contoso.com";
bookingStaffMemberBase.additionalDataManager().put("role@odata.type", new JsonPrimitive("#microsoft.graph.bookingStaffRole"));
bookingStaffMemberBase.role = BookingStaffRole.EXTERNAL_GUEST;
bookingStaffMemberBase.timeZone = "America/Chicago";
bookingStaffMemberBase.useBusinessHours = true;
bookingStaffMemberBase.additionalDataManager().put("workingHours@odata.type", new JsonPrimitive("#Collection(microsoft.graph.bookingWorkHours)"));
...
timeSlots.endTime = new TimeOfDay(0, 0, 0);
timeSlots.startTime = new TimeOfDay(0, 0, 0);
...
timeSlots1.endTime = new TimeOfDay(0, 0, 0);
timeSlots1.startTime = new TimeOfDay(0, 0, 0);
...
timeSlots2.endTime = new TimeOfDay(0, 0, 0);
timeSlots2.startTime = new TimeOfDay(0, 0, 0);
...
timeSlots3.endTime = new TimeOfDay(0, 0, 0);
timeSlots3.startTime = new TimeOfDay(0, 0, 0);
...
timeSlots4.endTime = new TimeOfDay(0, 0, 0);
timeSlots4.startTime = new TimeOfDay(0, 0, 0);
timeSlotsList4.add(timeSlots4);
workingHours4.timeSlots = timeSlotsList4;
workingHoursList.add(workingHours4);
bookingStaffMemberBase.workingHours = workingHoursList;

graphClient.solutions().bookingBusinesses("{id}").staffMembers()
	.buildRequest()
