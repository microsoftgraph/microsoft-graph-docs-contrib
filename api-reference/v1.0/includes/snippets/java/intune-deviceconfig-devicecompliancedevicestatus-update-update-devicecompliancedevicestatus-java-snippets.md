...
graphClient.deviceManagement().deviceCompliancePolicies("{deviceCompliancePolicyId}").deviceStatuses("{deviceComplianceDeviceStatusId}")
	.buildRequest()
	.patch(deviceComplianceDeviceStatus);
