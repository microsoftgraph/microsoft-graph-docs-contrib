...
graphClient.deviceManagement().notificationMessageTemplates("{notificationMessageTemplateId}").localizedNotificationMessages("{localizedNotificationMessageId}")
	.buildRequest()
	.patch(localizedNotificationMessage);
