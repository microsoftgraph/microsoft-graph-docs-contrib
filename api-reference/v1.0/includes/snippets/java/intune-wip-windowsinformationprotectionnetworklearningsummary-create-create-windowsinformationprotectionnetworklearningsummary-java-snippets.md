...
WindowsInformationProtectionNetworkLearningSummary result = graphClient.deviceManagement().windowsInformationProtectionNetworkLearningSummaries().post(windowsInformationProtectionNetworkLearningSummary);
