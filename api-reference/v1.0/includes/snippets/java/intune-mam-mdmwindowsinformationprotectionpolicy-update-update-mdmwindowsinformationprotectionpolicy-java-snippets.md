...
graphClient.deviceAppManagement().mdmWindowsInformationProtectionPolicies("{mdmWindowsInformationProtectionPolicyId}")
	.buildRequest()
	.patch(mdmWindowsInformationProtectionPolicy);
