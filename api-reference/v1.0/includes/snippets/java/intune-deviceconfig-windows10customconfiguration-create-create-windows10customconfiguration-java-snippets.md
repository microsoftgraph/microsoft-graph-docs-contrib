...
Windows10CustomConfiguration deviceConfiguration = new Windows10CustomConfiguration();
deviceConfiguration.setOdataType("#microsoft.graph.windows10CustomConfiguration");
