...
com.microsoft.graph.drives.item.items.item.workbook.worksheets.item.charts.add.AddPostRequestBody addPostRequestBody = new com.microsoft.graph.drives.item.items.item.workbook.worksheets.item.charts.add.AddPostRequestBody();
