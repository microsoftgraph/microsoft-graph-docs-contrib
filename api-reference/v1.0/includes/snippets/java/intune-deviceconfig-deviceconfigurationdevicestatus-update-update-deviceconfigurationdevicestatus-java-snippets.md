...
graphClient.deviceManagement().deviceConfigurations("{deviceConfigurationId}").deviceStatuses("{deviceConfigurationDeviceStatusId}")
	.buildRequest()
	.patch(deviceConfigurationDeviceStatus);
