...
DeviceCompliancePolicyAssignment result = graphClient.deviceManagement().deviceCompliancePolicies().byDeviceCompliancePolicyId("{deviceCompliancePolicy-id}").assignments().post(deviceCompliancePolicyAssignment);
