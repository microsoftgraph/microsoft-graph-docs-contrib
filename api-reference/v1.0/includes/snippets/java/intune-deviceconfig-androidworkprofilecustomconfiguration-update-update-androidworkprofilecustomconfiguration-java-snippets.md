...
AndroidWorkProfileCustomConfiguration deviceConfiguration = new AndroidWorkProfileCustomConfiguration();
deviceConfiguration.setOdataType("#microsoft.graph.androidWorkProfileCustomConfiguration");
