...
var result = await graphClient.DeviceManagement.DeviceCompliancePolicies["{deviceCompliancePolicy-id}"].Assignments["{deviceCompliancePolicyAssignment-id}"].PatchAsync(requestBody);
