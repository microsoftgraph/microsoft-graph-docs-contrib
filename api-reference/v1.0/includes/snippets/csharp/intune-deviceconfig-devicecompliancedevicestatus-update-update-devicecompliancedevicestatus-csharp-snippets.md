...
var requestBody = new DeviceComplianceDeviceStatus
{
...
var result = await graphClient.DeviceManagement.DeviceCompliancePolicies["{deviceCompliancePolicy-id}"].DeviceStatuses["{deviceComplianceDeviceStatus-id}"].PatchAsync(requestBody);
