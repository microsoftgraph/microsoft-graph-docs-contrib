...
var result = await graphClient.DeviceManagement.DeviceCompliancePolicies["{deviceCompliancePolicy-id}"].UserStatuses["{deviceComplianceUserStatus-id}"].PatchAsync(requestBody);
