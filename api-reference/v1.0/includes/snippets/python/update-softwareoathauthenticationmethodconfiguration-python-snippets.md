...
request_body.@odata_type = '#microsoft.graph.softwareOathAuthenticationMethodConfiguration'

request_body.state(AuthenticationMethodState.Disabled('authenticationmethodstate.disabled'))
