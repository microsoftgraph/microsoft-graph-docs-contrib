...
result = await graph_client.identity_governance.entitlement_management.acce_packages.by_acce_package_id('accessPackage-id').resource_role_scopes.post(request_body = request_body)
