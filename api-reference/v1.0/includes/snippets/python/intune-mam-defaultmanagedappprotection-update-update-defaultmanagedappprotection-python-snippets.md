...
request_body.@odata_type = '#microsoft.graph.defaultManagedAppProtection'
...
result = await client.device_app_management.default_managed_app_protections.by_default_managed_app_protection_id('defaultManagedAppProtection-id').patch(request_body = request_body)
