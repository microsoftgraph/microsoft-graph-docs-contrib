...
request_body.@odata_type = '#microsoft.graph.microsoftStoreForBusinessApp'
...
request_body.licensetype(MicrosoftStoreForBusinessLicenseType.Online('microsoftstoreforbusinesslicensetype.online'))

request_body.package_identity_name = 'Package Identity Name value'
