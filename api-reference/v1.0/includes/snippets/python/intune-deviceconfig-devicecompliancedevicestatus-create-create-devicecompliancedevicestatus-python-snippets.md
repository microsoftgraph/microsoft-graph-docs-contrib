...
request_body.@odata_type = '#microsoft.graph.deviceComplianceDeviceStatus'
...
result = await client.device_management.device_compliance_policies.by_device_compliance_policie_id('deviceCompliancePolicy-id').device_statuses.post(request_body = request_body)
