...
result = await graph_client.identity_governance.app_consent.app_consent_requests.filter_by_current_user(on='{on}'.get(request_configuration = request_configuration)
