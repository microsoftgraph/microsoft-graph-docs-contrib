...
request_body.@odata_type = '#microsoft.graph.deviceConfigurationUserOverview'
...
result = await client.device_management.device_configurations.by_device_configuration_id('deviceConfiguration-id').user_statu_overview.patch(request_body = request_body)
