...
result = await graph_client.teams.by_team_id('team-id').schedule.offer_shift_requests.post(request_body = request_body, request_configuration = request_configuration)
