...
result = await client.device_management.device_management_partners.by_device_management_partner_id('deviceManagementPartner-id').patch(request_body = request_body)
