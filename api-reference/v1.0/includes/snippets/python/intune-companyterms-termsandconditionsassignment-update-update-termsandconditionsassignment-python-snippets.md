...
result = await graph_client.device_management.term_and_conditions.by_term_and_condition_id('termsAndConditions-id').assignments.by_assignment_id('termsAndConditionsAssignment-id').patch(request_body = request_body)
