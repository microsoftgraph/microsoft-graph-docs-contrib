...
result = await graph_client.teams.by_team_id('team-id').schedule.open_shift_change_requests.post(body = request_body, request_configuration = request_configuration)
