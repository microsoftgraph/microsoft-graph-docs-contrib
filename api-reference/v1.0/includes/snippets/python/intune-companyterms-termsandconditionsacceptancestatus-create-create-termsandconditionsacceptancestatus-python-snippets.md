...
result = await client.device_management.term_and_conditions.by_term_and_condition_id('termsAndConditions-id').acceptance_statuses.post(request_body = request_body)
