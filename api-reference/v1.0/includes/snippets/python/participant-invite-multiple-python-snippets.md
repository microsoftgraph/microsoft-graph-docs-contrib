...
participants_invitation_participant_info1identityuser.display_name = 'string'
...
participants_invitation_participant_info2.@odata_type = '#microsoft.graph.invitationParticipantInfo'

participants_invitation_participant_info2.replaces_call_id = 'a7ebfb2d-871e-419c-87af-27290b22e8db'

participants_invitation_participant_info2identity = IdentitySet()
participants_invitation_participant_info2identity.@odata_type = '#microsoft.graph.identitySet'

participants_invitation_participant_info2identityuser = Identity()
participants_invitation_participant_info2identityuser.@odata_type = '#microsoft.graph.identity'

participants_invitation_participant_info2identityuser.id = '1e126418-44a0-4a94-a6f8-0efe1ad71acb'

participants_invitation_participant_info2identityuser.display_name = 'string'


participants_invitation_participant_info2identity.user = participants_invitation_participant_info2identityuser

participants_invitation_participant_info2.identity = participants_invitation_participant_info2identity
