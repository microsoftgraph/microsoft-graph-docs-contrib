...
request_body.@odata_type = '#microsoft.graph.managedDeviceMobileAppConfigurationUserSummary'
...
result = await client.device_app_management.mobile_app_configurations.by_mobile_app_configuration_id('managedDeviceMobileAppConfiguration-id').user_statu_summary.patch(request_body = request_body)
