...
request_body.@odata_type = '#microsoft.graph.windowsMobileMSI'
...
request_body.command_line = 'Command Line value'

request_body.product_code = 'Product Code value'

request_body.product_version = 'Product Version value'
