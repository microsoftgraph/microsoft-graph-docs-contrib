...
result = await graph_client.planner.tasks.by_task_id('plannerTask-id').progres_task_board_format.patch(request_body = request_body, request_configuration = request_configuration)
