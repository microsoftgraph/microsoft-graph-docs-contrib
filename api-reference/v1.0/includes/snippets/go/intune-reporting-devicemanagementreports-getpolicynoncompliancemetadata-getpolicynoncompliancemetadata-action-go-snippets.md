...
requestBody := graphdevicemanagement.NewGetPolicyNonComplianceMetadataPostRequestBody()
name := "Name value"
...
graphClient.DeviceManagement().Reports().GetPolicyNonComplianceMetadata().Post(context.Background(), requestBody, nil)
