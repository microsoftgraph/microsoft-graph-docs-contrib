...
graphClient.DrivesById("drive-id").ItemsById("driveItem-id").Workbook().WorksheetsById("workbookWorksheet-id").Range(address='{address}')().Patch(context.Background(), requestBody, nil)
