...
result, err := graphClient.DeviceManagement().DeviceConfigurations().ByDeviceConfigurationId("deviceConfiguration-id").UserStatuses().ByUserStatuseId("deviceConfigurationUserStatus-id").Patch(context.Background(), requestBody, nil)
