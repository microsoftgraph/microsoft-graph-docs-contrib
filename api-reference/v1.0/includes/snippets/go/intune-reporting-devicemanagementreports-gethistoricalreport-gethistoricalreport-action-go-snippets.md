...
requestBody := graphdevicemanagement.NewGetHistoricalReportPostRequestBody()
name := "Name value"
...
graphClient.DeviceManagement().Reports().GetHistoricalReport().Post(context.Background(), requestBody, nil)
