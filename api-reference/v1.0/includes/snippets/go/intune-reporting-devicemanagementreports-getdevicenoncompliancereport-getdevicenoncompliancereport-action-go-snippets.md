...
requestBody := graphdevicemanagement.NewGetDeviceNonComplianceReportPostRequestBody()
name := "Name value"
...
graphClient.DeviceManagement().Reports().GetDeviceNonComplianceReport().Post(context.Background(), requestBody, nil)
