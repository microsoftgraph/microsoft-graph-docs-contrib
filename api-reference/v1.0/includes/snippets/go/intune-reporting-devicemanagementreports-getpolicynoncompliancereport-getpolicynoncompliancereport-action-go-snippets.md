...
requestBody := graphdevicemanagement.NewGetPolicyNonComplianceReportPostRequestBody()
name := "Name value"
...
graphClient.DeviceManagement().Reports().GetPolicyNonComplianceReport().Post(context.Background(), requestBody, nil)
