...
result, err := graphClient.Me().ContactFoldersById("contactFolder-id").Contacts().Delta()(contactFolder-id).GetWithRequestConfigurationAndResponseHandler(configuration, nil)
