...
graphClient.Security().Cases().EdiscoveryCasesById("ediscoveryCase-id").ReviewSetsById("ediscoveryReviewSet-id").AddToReviewSet(ediscoveryCase-id, ediscoveryReviewSet-id).Post(requestBody)
