...
requestBody := graphdevicemanagement.NewGetReportFiltersPostRequestBody()
name := "Name value"
...
graphClient.DeviceManagement().Reports().GetReportFilters().Post(context.Background(), requestBody, nil)
