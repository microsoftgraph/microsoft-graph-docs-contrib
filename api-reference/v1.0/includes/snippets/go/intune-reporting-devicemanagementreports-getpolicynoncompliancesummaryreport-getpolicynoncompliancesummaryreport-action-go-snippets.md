...
requestBody := graphdevicemanagement.NewGetPolicyNonComplianceSummaryReportPostRequestBody()
name := "Name value"
...
graphClient.DeviceManagement().Reports().GetPolicyNonComplianceSummaryReport().Post(context.Background(), requestBody, nil)
