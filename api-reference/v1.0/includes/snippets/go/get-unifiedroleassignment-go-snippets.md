...
result, err := graphClient.RoleManagement().Directory().RoleAssignmentsById("unifiedRoleAssignment-id").GetWithRequestConfigurationAndResponseHandler(configuration, nil)
