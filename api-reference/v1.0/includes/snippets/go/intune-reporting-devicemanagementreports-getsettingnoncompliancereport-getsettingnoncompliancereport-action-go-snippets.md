...
requestBody := graphdevicemanagement.NewGetSettingNonComplianceReportPostRequestBody()
name := "Name value"
...
graphClient.DeviceManagement().Reports().GetSettingNonComplianceReport().Post(context.Background(), requestBody, nil)
