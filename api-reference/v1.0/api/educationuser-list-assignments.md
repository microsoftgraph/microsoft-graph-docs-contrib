...
The following `$expand` options are available for this method: `categories`, `gradingCategory`, `resources`, `rubric`, `submissions`, and `*`, which includes all the previous options.
