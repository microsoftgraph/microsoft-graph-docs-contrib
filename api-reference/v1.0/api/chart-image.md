...
<!-- { "blockType": "samples" } -->
```http
GET /me/drive/root/workbook/worksheets/{id|name}/charts/{name}/image
GET /me/drive/root/workbook/worksheets/{id|name}/charts/{name}/image(width=640)
GET /me/drive/root/workbook/worksheets/{id|name}/charts/{name}/image(width=640,height=480)
GET /me/drive/root/workbook/worksheets/{id|name}/charts/{name}/image(width=640,height=480,fittingMode='fit')
```
## Request headers
| Name       | Description|
|:---------------|:----------|
