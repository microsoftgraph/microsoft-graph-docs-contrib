...
> [!IMPORTANT]
> Starting January 1, 2026, this API will no longer support application permissions. To approve a request with application permissions, use [/declineForUser](../../beta/api/schedulechangerequest-declineforuser.md) instead.
