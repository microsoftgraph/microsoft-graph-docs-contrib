...
<!-- { "blockType": "ignored" } -->
```http
PATCH /me/drive/root/workbook/names/{name}/range/format/protection
PATCH /me/drive/root/workbook/worksheets/{id|name}/range(<address>)/format/protection
PATCH /me/drive/root/workbook/tables/{id|name}/columns/{id|name}/range/format/protection
```
