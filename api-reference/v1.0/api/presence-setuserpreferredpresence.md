...
Preferred presence takes effect only when at least one [presence session](/graph/manage-presence-state#presence-sessions) exists for the user. Otherwise, the user's presence shows as `Offline`.
...
For more details, see [presence sessions](/graph/manage-presence-state#presence-sessions) and [time-out and expiration](/graph/manage-presence-state#timeout-expiration-and-keep-alive).
