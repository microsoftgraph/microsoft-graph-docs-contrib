...
> - You can create shared channels with one owner initially. Adding multiple owners results in a `400 Bad Request` error. After the initial request, you can add more owners using the [Add member to channel](/graph/api/channel-post-members) API.
