...
-->
``` http
GET https://graph.microsoft.com/v1.0/identity/riskPrevention/webApplicationFirewallProviders
```
...
[!INCLUDE [sample-code](../includes/snippets/powershell/list-webapplicationfirewallprovider-powershell-snippets.md)]
[!INCLUDE [sdk-documentation](../includes/snippets/snippets-sdk-documentation-link.md)]
...
{
    "@odata.context": "https://graph.microsoft.com/v1.0/$metadata#identity/riskPrevention/webApplicationFirewallProviders",
    "value": [
        {
