...
Provides the list of audit logs generated by Azure Active Directory. Includes audit logs generated by various services within Azure AD, including user, app, device and group Management, privileged identity management (PIM), access reviews, terms of use, identity protection, password management (SSPR and Admin password resets), and self service group management.
