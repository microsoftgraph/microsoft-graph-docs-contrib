...
(For details, see [get change notifications for messages in Teams channels and chats using Microsoft Graph] ((/graph/teams-changenotifications-chatmessage.md).))
