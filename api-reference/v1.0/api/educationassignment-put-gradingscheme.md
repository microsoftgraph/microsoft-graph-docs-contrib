...
Add an existing [educationGradingScheme](../resources/educationgradingscheme.md) to an existing [educationAssignment](../resources/educationassignment.md).
...
In the request body, supply the **@odata.id** of the existing [educationGradingScheme](../resources/educationgradingscheme.md) object to add to this assignment.
...
-->
``` http
PUT https://graph.microsoft.com/v1.0/education/classes/37d99af7-cfc5-4e3b-8566-f7d40e4a2070/assignments/e98aaae1-7c98-4e65-bb62-1994fe410552/gradingScheme/$ref
