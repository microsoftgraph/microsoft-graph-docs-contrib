...
While the [**SharedDriveItem**](../resources/shareddriveitem.md) contains some useful information, most apps want to directly access the shared [DriveItem](../resources/driveitem.md).
