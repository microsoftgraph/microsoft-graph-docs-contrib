...
-->
``` http
GET https://graph.microsoft.com/v1/reports/authenticationMethods/userRegistrationDetails
```
...
{
  "@odata.context": "https://graph.microsoft.com/v1/$metadata#reports/authenticationMethods/userRegistrationDetails",
  "value": [
    {
