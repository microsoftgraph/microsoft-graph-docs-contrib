...
<!-- { "blockType": "ignored" } -->
```http
GET /me/drive/root/workbook/names/{name}/range/format/borders
GET /me/drive/root/workbook/worksheets/{id|name}/range(address='<address>')/format/borders
GET /me/drive/root/workbook/tables/{id|name}/columns/{id|name}/range/format/borders
```
