...
When an event is created, the service sends invitations to all the attendees. This ensures consistency between the organizer and attendee views of the event and cannot be configured.
