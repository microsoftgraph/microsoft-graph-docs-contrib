...
> [!NOTE]
> This API returns a 401 error when a newly created tenant calls this method. For more information, see [Known issues](/graph/known-issues#list-team-members-api-fails-with-401-errors-in-newly-created-tenants).
