...
> **Note**: This API does not provide **email** and **moderationSettings** properties for a channel by default to improve the performance. To get these properties, use the `$select` query parameter.
