...
> **Note:** The use of "Prefer: deltashowsharingchanges" header requires to use "Prefer: deltashowremovedasdeleted" and "Prefer: deltatraversepermissiongaps". These header values can be joint together in a single header "Prefer: deltashowremovedasdeleted; deltatraversepermissiongaps; deltashowsharingchanges;"
