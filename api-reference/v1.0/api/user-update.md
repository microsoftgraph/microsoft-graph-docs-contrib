...
|mail|String|The SMTP address for the user, for example, "jeff@contoso.onmicrosoft.com". <br><br>Supports $filter. <br>This will internally update **proxyAddresses** user property with this value as SMTP address.|
