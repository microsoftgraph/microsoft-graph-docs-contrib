...
|transferee|[participant](../resources/participant.md)|The participant which is the transferee of the transfer. It is only needed when transfer from a group call.|
...

{
  ...
  "transferee": {
      ...
      "id": "909c6581-5130-43e9-88f3-fcb3582cde37"
    }
  }
}
```
