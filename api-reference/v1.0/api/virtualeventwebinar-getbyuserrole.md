...
<!-- {
  ...
  "name": "virtualeventwebinar-getbyuserrole-permissions"
}
-->
...
-->
``` http
GET /solutions/virtualEvents/webinars/getByUserRole
```
...
-->
``` http
GET https://graph.microsoft.com/v1.0/solutions/virtualEvents/webinars/getByUserRole(role='parameterValue')
```
