...
### Response
The following is an example of the response. Note that the **id**, **name**, and **description** properties in the response payload are generated by the system and are different from the ones that are in the connection that was created.
<!-- {
  "blockType": "response",
  "truncated": true,
