...
<!-- { "blockType": "permissions", "name": "identityverifiedidroot_delete_profiles" } -->
...
-->
``` http
DELETE https://graph.microsoft.com/v1.0/identity/verifiedId/profiles/ca15ec56-7adf-42ee-847b-00c3008264fb
```
...
[!INCLUDE [sample-code](../includes/snippets/powershell/delete-verifiedidprofile-powershell-snippets.md)]
[!INCLUDE [sdk-documentation](../includes/snippets/snippets-sdk-documentation-link.md)]
