...
```
<iframe src="//api.apiembed.com/?source=https://raw.githubusercontent.com/keyur32/keyur32Repo0115221027/master/keyur32Docset0115221027/get_current_user.json&targets=shell:curl,csharp:restsharp,node:request,node:unirest,java:unirest,python:requests,php:curl,ruby:native,objc:nsurlsession,javascript:xhr,swift:nsurlsession" frameborder="0" scrolling="no" width="100%" height="500px" seamless></iframe>
