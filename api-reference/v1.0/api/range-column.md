...
<!-- { "blockType": "ignored" } -->
```http
GET /me/drive/root/workbook/names/{name}/range/column
GET /me/drive/root/workbook/worksheets/{id|name}/range(address='<address>')/column
GET /me/drive/root/workbook/tables/{id|name}/columns/{id|name}/range/column
