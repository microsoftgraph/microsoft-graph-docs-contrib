...
Update the properties of an [educationRubric](../resources/educationrubric.md) object. This operation can only be performed if the role of the user in the class is teacher.
