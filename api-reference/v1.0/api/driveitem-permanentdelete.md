...
Permanently delete a [driveItem](../resources/driveitem.md) by using its ID. If you delete items using this method, they are permanently removed and won't be sent to the recycle bin, unlike the [Delete driveItem](../api/driveitem-delete.md) API which sends the item to the recycle bin. Therefore, they can't be restored afterward.
