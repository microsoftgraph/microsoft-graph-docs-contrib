...
Assign an app role to a [user](../resources/user.md),creating an [appRoleAssignment](../resources/approleassignments.md). To grant an app role assignment to a user, you need three identifiers:
