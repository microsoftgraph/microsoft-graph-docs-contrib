...
## Response
If successful, this method returns a `200 OK` response code and a collection of [managedDevice](../resources/intune_devices_manageddevice.md) objects in the response body.
