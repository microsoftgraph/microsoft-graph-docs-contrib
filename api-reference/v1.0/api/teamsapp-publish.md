...
|`ApiBasedComposeExtensionManifestCommandIdsNotIncludedInOperationIdsOnApiSpecficationFile`	| Command Ids on manifest are not included in Operation Ids on API specification file.	| The error which occurs when the `Command Ids` in the app manifest aren't included in `Operation Ids` on API specification file.|
|`ApiBasedComposeExtensionWithBotId`	| Api based compose extension cannot have botId defined.	| The error which occurs when an API-based compose extension have `botId` defined in the app manifest.|
|`ApiBasedComposeExtensionWithCanUpdateConfiguration`	 |Api based compose extension cannot have canUpdateConfiguration defined on manifest.	| The error which occurs when an API-based compose extension have `canUpdateConfiguration` defined in the app manifest.|
|`ApiBasedComposeExtensionWithNoParameter`|	 Api based compose extension must have command parameters defined on manifest.	| The error which occurs when an API-based compose extension doesn't have any command parameters defined in the app manifest.|
|`ApiBasedComposeExtensionApiResponseRenderingTemplateFileNullOrEmpty` |	 Api based compose extension must have apiResponseRenderingTemplateFile defined on manifest.	| The error which occurs when an API-based compose extension doesn't have the `apiResponseRenderingTemplateFile` defined in the app manifest.|
|`ApiBasedComposeExtensionApiSpecificationFileNullOrEmpty` 	| Api based compose extension must have apiSpecificationFile defined on manifest. | The error which occurs when an API-based compose extension doesn't have the `apiSpecificationFile` defined in the app manifest.|
...
|`ApiSpecificationFileRequiredParameterContainUnsupportedLocation` 	| Api based compose extension have unsuppported parameter location defined on apiSpecificationFile for {0}. Currently only path and query supported.|	 The message appears when an API-based compose extension have unsuppported parameter location defined on `apiSpecificationFile`.|
|`ApiSpecificationFileRequestBodyContainUnsupportedMediaType`	 |Api based compose extension have unsuppported media type defined in request body on apiSpecificationFile. Currently only application/json is supported.	| The message appears when an API-based compose extension have unsuppported `media` type defined in request body on `apiSpecificationFile`.|
|`ApiSpecificationFileRequestBodyContainUnsupportedSchemaType`	| Api based compose extension have unsuppported schema type defined in request body on apiSpecificationFile. Currently arrays are not supported.	| The message appears when an API-based compose extension have unsuppported schema type defined in request body on `apiSpecificationFile`.|
...
|`ApiSpecificationFileServerUrlsContainHttp`|	 Api based compose extension have server urls that have http protocal defined on apiSpecificationFile.	| The message appears when an API-based compose extension have server urls that contains `http` protocal on `apiSpecificationFile`.|
|`ApiSpecificationFileServerUrlsContainInvalidUrl`	| Api based compose extension have server urls that is invalid url defined on apiSpecificationFile.	| The message appears when an API-based compose extension have `invalid` url defined on `apiSpecificationFile`.|
|`ServerUrlsMissingOnApiSpecificationFile` 	| Api based compose extension have no server urls defined on apiSpecificationFile.	| The error which occurs when an API-based compose extension have no server urls defined on `apiSpecificationFile`.|
|`BotBasedComposeExtensionApiResponseRenderingTemplateFileExists` |	 Bot based compose extension cannot have apiResponseRenderingTemplateFile defined.	 |The error which occurs when the bot-based compose extension have `apiResponseRenderingTemplateFile` property defined in the app manifest.|
|`BotBasedComposeExtensionApiSpecificationFileExists` |	 Bot based compose extension cannot have apiSpecificationFile defined.|	 The error which occurs when the bot-based compose extension have API specification file defined in the app manifest.|
|`BotBasedComposeExtensionBotIdNotGuid` |	 Bot based compose extension must have GUID botId.	| The error which occurs when the bot-based compose extension have no GUID botId.|
...
|`DashboardCardEntityIdsAreNotUnique`	| Dashboard card entity ids should be unique.	| Entity Ids for dashboards card isn't unique.|
...
|`GroupChatForBotsLessThanV13`	| Please upgrade the version of manifest to V1.3 as group chat bot is supported in manifest v1.3 onwards.	| The error which occurs when the group chat exists in bots for app manifest version less than 1.3.|
|`GroupChatForConfigurableTabsLessThanV13`	| Please upgrade the version of manifest to V1.3 as group chat configurable tabs is supported in manifest v1.3 onwards.	 T|he error which occurs when the group chat exists in configurable tabs for the app manifest version less than 1.3.|
...
|`ApiSpecificationFileParameterContainUnsupportedSchemaType` |	Api based compose extension have unsuppported parameter schema type defined on apiSpecificationFile.Arrays are not supported.	|The message appears when an API-based compose extension have unsuppported parameter schema type defined in the apiSpecificationFile.|
