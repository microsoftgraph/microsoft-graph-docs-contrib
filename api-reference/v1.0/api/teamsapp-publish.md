...
| `LocalizationSchemaVersionIsNotTheSameAsTheManifestSchemaVersion` | Localization file schema version is different from app manifest schema version.| The schema version in the localization file does not match the version specified in the app manifest.|
