...
Retrieve an [educationCategory](../resources/educationcategory.md) object. This operation can be performed with both the roles in the class either teacher or student.
