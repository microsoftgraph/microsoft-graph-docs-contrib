...
> **Note**: `202 Accepted` response code indicates that the request has been accepted however, the processing is not yet completed. Delivery of  the message is applicable to [Exhange Online limitations and throttling](https://learn.microsoft.com/en-us/office365/servicedescriptions/exchange-online-service-description/exchange-online-limits).
