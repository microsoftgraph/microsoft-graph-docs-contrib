...
```http
DELETE https://graph.microsoft.com/v1.0/applications/{id}/microsoft.graph.agentIdentityBlueprint/owners/1511d5e7-c324-4362-ad4b-16c20076e5aa/$ref
```

# [JavaScript](#tab/javascript)
[!INCLUDE [sample-code](../includes/snippets/javascript/agentidentityblueprint-delete-owners-javascript-snippets.md)]
