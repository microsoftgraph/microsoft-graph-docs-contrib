...
Update an application [permission](../resources/permission.md) object on a site. Note that a user site [permission](../resources/permission.md) cannot be updated with this endpoint.
