...
<!-- { "blockType": "permissions", "name": "authentication-list-emailmethods-permissions", "requestUrls": ["GET /users/{id | userPrincipalName}/authentication/microsoftAuthenticatorMethods/{microsoftAuthenticatorAuthenticationMethodId}"] } -->
