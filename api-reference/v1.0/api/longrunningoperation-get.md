...
Retrieve the properties and relationships of an [operation](../resources/longrunningoperation.md) object. Currently these operations are generated by initiating a password reset using the [reset password](passwordauthenticationmethod-resetpassword.md) method. An operation object tells the caller about the current state of that password reset operation. Possible states include:
...
If successful, this method returns a `200 OK` response code and the requested [operation](../resources/longrunningoperationoperation.md) object in the response body.
