...
<!-- {
  ...
  "name": "virtualeventregistration-post-sessions-permissions"
}
-->
[!INCLUDE [permissions-table](../includes/permissions/virtualeventregistration-post-sessions-permissions.md)]
...
-->
``` http
POST /virtualEventRegistration/sessions/$ref
```
...
If successful, this method returns a `204 No Content` response code and a [virtualEventSession](../resources/virtualeventsession.md) object in the response body.
...
-->
``` http
POST https://graph.microsoft.com/v1.0/virtualEventRegistration/sessions/$ref
