...
All [properties](/graph/api/resources/educationsubmissionlistsubmittedresource#properties) are supported for the query parameters `$filter` and `$orderby`.
...
```http
GET https://graph.microsoft.com/v1.0/education/classes/2003c52e-807a-4186-9b49-60c573095461/assignments/03a893d4-f64b-47e4-9e0c-afac4b357007/submissions/be6280d6-cf92-d58e-6ca4-44babfcb2394/submittedResources?$orderby=id
```
