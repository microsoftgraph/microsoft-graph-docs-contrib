...
If successful, this method returns a `200 OK` response code and a new [passwordCredential](../resources/passwordcredential.md) object in the response body. The **secretText** property in the response object contains the strong passwords/secrets generated by Microsoft Entra ID that are 16-64 characters in length. There is no way to retrieve this password in the future.
