...
When deleted, both Microsoft 365 groups and security groups are moved to a temporary container and can be restored within 30 days. After that time, they're permanently deleted. This isn't applicable to Distribution groups which are permanently deleted immediately. To learn more, see [deletedItems](../resources/directory.md).
