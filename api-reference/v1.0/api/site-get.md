...
> [!NOTE]
> When a user from one geo location attempts to access a site located in another geo, the request may fail unless the calling user has at least "Limited Access" permission to the root site collection of the target geo. Ensure this access is granted to avoid authorization issues.
>
