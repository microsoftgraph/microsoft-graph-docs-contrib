...
> [!NOTE]
> The **publicKeyCredential** property is a write-only property and is not returned in GET requests.

Currently, only attestation formats of "packed" or "none" are supported.
...
-->
``` http
POST https://graph.microsoft.com/v1.0/users/65b7236a-8e88-4c6a-85dc-1d79ab74267c/authentication/fido2Methods
