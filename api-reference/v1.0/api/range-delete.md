...
<!-- { "blockType": "ignored" } -->
```http
POST /me/drive/root/workbook/names/{name}/range/delete
POST /me/drive/root/workbook/worksheets/{id|name}/range(address='<address>')/delete
POST /me/drive/root/workbook/tables/{id|name}/columns/{id|name}/range/delete
