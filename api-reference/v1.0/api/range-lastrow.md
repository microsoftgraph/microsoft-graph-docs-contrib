...
<!-- { "blockType": "ignored" } -->
```http
GET /me/drive/root/workbook/names/{name}/range/lastRow
GET /me/drive/root/workbook/worksheets/{id|name}/range(address='<address>')/lastRow
GET /me/drive/root/workbook/tables/{id|name}/columns/{id|name}/range/lastRow
