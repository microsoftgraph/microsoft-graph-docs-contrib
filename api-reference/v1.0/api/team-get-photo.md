...
```http
GET /v1.0/teams/{id}/photo/$value
GET /v1.0/teams/{id}/photo/{size}/$value
```
...
```http
GET https://graph.microsoft.com/v1.0/teams/{id}/photo
```
...
{
    "@odata.context": "https://graph.microsoft.com/v1.0/$metadata#teams('ddfcd489-628b-7d04-b48b-20075df800e5')/photo/$entity",
    "@odata.id": "https://graph.microsoft.com/v1.0/teams('ddfcd489-628b-7d04-b48b-20075df800e5')/photo",
...
```http
GET https://graph.microsoft.com/v1.0/teams/{id}/photo/240x240/$value
```
