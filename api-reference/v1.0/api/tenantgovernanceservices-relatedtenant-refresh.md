...
description: "Refresh the list of related tenants."
...
Refresh the list of [related tenants](../resources/tenantgovernanceservices-relatedtenant.md). The list is also automatically refreshed daily.
