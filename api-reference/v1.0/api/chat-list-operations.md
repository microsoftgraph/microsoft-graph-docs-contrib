...
-->
``` http
GET https://graph.microsoft.com/v1.0/chats/19:c253a29b5f694b55a6baad8e83510af7@thread.v2/operations
```
...
{
    "@odata.context": "https://graph.microsoft.com/v1.0/$metadata#chats('19%3Ac253a29b5f694b55a6baad8e83510af7%40thread.v2')/operations",
    "@odata.count": 1,
    "value": [
        {
