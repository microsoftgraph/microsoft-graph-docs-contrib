...
>[!NOTE]
>**federatedIdpMfaBehavior** is an evolved version of the **SupportsMfa** property of the [Set-EntraDomainFederationSettings PowerShell cmdlet](/powershell/module/microsoft.entra.directorymanagement/set-entradomainfederationsettings).
