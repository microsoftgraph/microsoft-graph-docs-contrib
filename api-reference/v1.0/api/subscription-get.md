...
|[callTranscript](../resources/calltranscript.md) <br /> `communications/onlineMeetings/getAllTranscripts` <br /> All transcript in an organization. | Not supported.  | Not supported.  | OnlineMeetingTranscript.Read.All |
