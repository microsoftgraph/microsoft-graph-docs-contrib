...
Creates a new [educationCategory](../resources/educationcategory.md) on an [educationClass](../resources/educationclass.md). This operation can only be performed if the role of the user in the class is teacher.
