...
Use this API to assign an app role to a security group. All direct members of the group will be considered assigned. Security groups with dynamic memberships are also supported. To grant an app role assignment to a group, you need three identifiers:
