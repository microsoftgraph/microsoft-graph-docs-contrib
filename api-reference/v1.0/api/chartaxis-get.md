...
<!-- { "blockType": "ignored" } -->
```http
GET /me/drive/root/workbook/worksheets/{id|name}/charts/{name}/axes/valueAxis
GET /me/drive/root/workbook/worksheets/{id|name}/charts/{name}/axes/seriesAxis
GET /me/drive/root/workbook/worksheets/{id|name}/charts/{name}/axes/categoryaxis
```
