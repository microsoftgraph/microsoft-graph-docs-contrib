...
<!-- { "blockType": "ignored" } -->
```http
POST /me/drive/root/workbook/names/{name}/range/merge
POST /me/drive/root/workbook/worksheets/{id|name}/range(address='<address>')/merge
POST /me/drive/root/workbook/tables/{id|name}/columns/{id|name}/range/merge
