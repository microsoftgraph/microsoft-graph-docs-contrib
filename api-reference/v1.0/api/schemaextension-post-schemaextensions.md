...
Schema extensions let you add strongly-typed custom data to a resource. The app that creates a schema extension is the owner app. Depending on the [state of the extension](/graph/api/resources/schemaextension#schema-extensions-lifecycle), the owner app, and only the owner app, may update or delete the extension.
