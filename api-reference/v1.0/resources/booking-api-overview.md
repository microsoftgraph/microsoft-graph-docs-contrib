...
<!IMPORTANT> Please note, all the below mentioned APIs apply to only Shared Bookings and are not applicable for Personal Bookings.
...
## Using the Shared Bookings REST API
