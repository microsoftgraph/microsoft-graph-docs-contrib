...
Errors in the Microsoft Graph Security API in Microsoft Graph are returned using standard HTTP 206 status codes and are delivered by way of a warning header.
