...
description: Represents the indicators that caused the email to be marked as compromised.
author: akgraph
...
Represents an indicator and its associated verdict that suggests whether an email is compromised. The resource combines specific indicators found in the email with categorized verdicts to help identify potential security threats like malware, phishing attempts, or spam. It is returned in the **compromiseIndicators** property of [detonationDetails](../resources/security-detonationdetails.md).
