...
| resourceProvisioningOptions   | String collection                                                        | Specifies the group resources provisioned as part of Microsoft 365 group creation that are not normally part of default group creation. The possible value is `Team`. For more information, see [Set Microsoft 365 group behaviors and provisioning options](/graph/group-set-options).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
