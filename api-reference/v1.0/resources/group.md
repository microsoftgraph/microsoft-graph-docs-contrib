...
Represents a Microsoft Entra group, which can be a Microsoft 365 group, or a security group. This resource is an open type that allows other properties to be passed in.
