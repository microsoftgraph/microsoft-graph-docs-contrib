...
> |isSubscribedByMail|Boolean|Default value is **true**. Indicates whether the signed-in user is subscribed to receive email conversations.| No 
...
> |unseenCount|Int32|Count of conversations that have received new posts since the signed-in user last visited the group.| No 
