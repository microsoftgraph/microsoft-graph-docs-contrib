...
You can use the [Azure AD v.2 endpoint](../permissions-reference.md) to authenticate Excel APIs. All APIs require the `Authorization: Bearer {access-token}` HTTP header.   
