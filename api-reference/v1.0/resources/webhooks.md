...
| Teams [chatMessage](/graph/api/resources/chatmessage?view=graph-rest-v1.0) | Changes to chat messages in all channels in all teams:<br>`/teams/getAllMessages`<br>Changes to chat messages in all chats:<br>`/chats/getAllMessages` | Yes |
