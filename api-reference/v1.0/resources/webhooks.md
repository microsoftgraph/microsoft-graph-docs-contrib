...
| Teams [chatMessage](chatmessage.md) | Changes to chat messages in all channels in all teams:<br>`/teams/getAllMessages`<br>Changes to chat messages in all chats:<br>`/chats/getAllMessages` | Yes |
