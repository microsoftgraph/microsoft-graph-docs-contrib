...
|riskEventType|String|The type of risk event detected. The possible values are: `adminConfirmedServicePrincipalCompromised`, `anomalousServicePrincipalActivity`,  `generic`, `investigationsThreatIntelligence`, `leakedCredentials`, `maliciousApplication`, `suspiciousAPITraffic` `suspiciousApplication`, `suspiciousSignins`.|
