...
The softwareOathAuthenticationMethod resource type is a derived type that inherits from the [authenticationMethod](authenticationmethod.md) resource type.
