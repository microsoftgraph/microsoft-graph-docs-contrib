...
Note: This field may be null for older SAML applications created before it was added to the Graph API. For OIDC applications, the field is not currently being set automatically at creation, so the expected value is null.
