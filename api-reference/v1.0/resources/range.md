...
|:---------------|:--------|:----------|
|[Get Range](../api/range-get.md) | [workbookRange](range.md) |Read properties and relationships of range object.|
|[Update](../api/range-update.md) | [workbookRange](range.md)	|Update Range object. |
|[Boundingrect](../api/range-boundingrect.md)|[workbookRange](range.md)|Gets the smallest range object that encompasses the given ranges. For example, the GetBoundingRect of "B2:C5" and "D10:E15" is "B2:E16".|
|[Cell](../api/range-cell.md)|[workbookRange](range.md)|Gets the range object containing the single cell based on row and column numbers. The cell can be outside the bounds of its parent range, so long as it's stays within the worksheet grid. The returned cell is located relative to the top left cell of the range.|
|[Column](../api/range-column.md)|[workbookRange](range.md)|Gets a column contained in the range.|
...
|[Entirecolumn](../api/range-entirecolumn.md)|[workbookRange](range.md)|Gets an object that represents the entire column of the range.|
|[Entirerow](../api/range-entirerow.md)|[workbookRange](range.md)|Gets an object that represents the entire row of the range.|
|[Intersection](../api/range-intersection.md)|[workbookRange](range.md)|Gets the range object that represents the rectangular intersection of the given ranges.|
|[Lastcell](../api/range-lastcell.md)|[workbookRange](range.md)|Gets the last cell within the range. For example, the last cell of "B2:D5" is "D5".|
|[Lastcolumn](../api/range-lastcolumn.md)|[workbookRange](range.md)|Gets the last column within the range. For example, the last column of "B2:D5" is "D2:D5".|
|[Lastrow](../api/range-lastrow.md)|[workbookRange](range.md)|Gets the last row within the range. For example, the last row of "B2:D5" is "B5:D5".|
|[Offsetrange](../api/range-offsetrange.md)|[workbookRange](range.md)|Gets an object that represents a range that's offset from the specified range. The dimension of the returned range matches this range. If the resulting range is forced outside the bounds of the worksheet grid, an exception is thrown.|
|[Row](../api/range-row.md)|[workbookRange](range.md)|Gets a row contained in the range.|
...
|[Usedrange](../api/range-usedrange.md)|[workbookRange](range.md)|Returns the used range of the given range object.|
...
|[Insert](../api/range-insert.md)|[workbookRange](range.md)|Inserts a cell or a range of cells into the worksheet in place of this range, and shifts the other cells to make space. Returns a new Range object at the now blank space.|
