...
|Software token | Allow users to perform multifactor authentication using an application which supports the OAUTH specification and provides a one-time code. | Get and delete a software token assigned to a user.|
