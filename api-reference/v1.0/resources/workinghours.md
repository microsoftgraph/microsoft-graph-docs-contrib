...
You can [get](../api/user-get-mailboxsettings.md#example-3-get-specifically-the-working-hour-settings-of-the-signed-in-users-mailbox) and [set](../api/user-update-mailboxsettings.md#example-2-get-specifically-the-automatic-replies-settings-of-the-signed-in-users-mailbox) the 
