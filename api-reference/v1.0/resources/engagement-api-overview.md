...
The Microsoft Graph API supports Viva Engage role management and enables apps to manage communities in Viva Engage. Viva Engage is a social fabric for the Microsoft Viva suite of apps that connects people across the organization to share and learn. It's a place where employees can connect with leaders, coworkers, and communities, share their knowledge and ideas, and find belonging at work.
...
- Use the Microsoft Graph API for role management and to manage communities in Viva Engage.
