...
|[externalauthenticationmethodconfiguration](externalauthenticationmethodconfiguration.md)|Define users who can use an external MFA to satisfy the second factor of Microsoft Entra ID multifactor authentication requirements.|
