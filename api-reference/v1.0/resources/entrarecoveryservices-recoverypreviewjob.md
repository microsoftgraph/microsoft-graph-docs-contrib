...
|id|String|The unique identifier for the job. Inherited from [recoveryJobBase](../resources/entrarecoveryservices-recoveryjobbase.md). Supports `$filter` (`eq`, `ne`).|
...
|status|[microsoft.graph.entraRecoveryServices.recoveryStatus](../resources/entrarecoveryservices-recoveryjobbase.md#recoverystatus-values)|The current status of the job. Inherited from [recoveryJobBase](../resources/entrarecoveryservices-recoveryjobbase.md). Supports `$filter` (`eq`, `ne`).|
