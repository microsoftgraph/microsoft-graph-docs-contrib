...
|:---------------|:--------|:----------|-----------|
|[Get chat between user and app](../api/userscopeteamsappinstallation-get-chat.md) | [userScopeTeamsAppInstallation](userScopeTeamsAppInstallation.md)| Get one-on-one chat between user and the app | Delegated and application* |
