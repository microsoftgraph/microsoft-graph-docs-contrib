...
|status| [accessReviewHistoryStatus](accessreviewhistorystatus.md) |Represents the status of the review history data collection. The possible values are: `done`, `inProgress`, `error`, `requested`, `unknownFutureValue`.|
