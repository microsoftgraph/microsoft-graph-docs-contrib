...
Represents settings that control the end user experience for access package suggestions and resource discovery in [Microsoft Entra entitlement management](../resources/entitlementmanagement-overview.md). These settings configure how suggestions are provided to end users and what level of related people insights are shown.
