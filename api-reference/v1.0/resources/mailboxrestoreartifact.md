...
|Member | Description |
|:------|:------------|
|new|Restoration will occur at a new location. For SharePoint and OneDrive, a new site will be created, and content is restored in the new site. For Exchange, a restored folder is created, and the content will be restored there.|
