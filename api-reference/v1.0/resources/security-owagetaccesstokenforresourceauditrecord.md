...
description: "Represents an audit record for Outlook Web App (OWA) get access token for resource events."
author: "imsandhya7-spec"
ms.subservice: security
ms.localizationpriority: medium
doc_type: resourcePageType
ms.date: 08/04/2026
toc.title: "Outlook Web App (OWA) get access token for resource audit record"
---
# owaGetAccessTokenForResourceAuditRecord resource type

Namespace: microsoft.graph.security

Represents an audit record for Outlook Web App (OWA) get access token for resource events. This resource captures information about these activities as part of the Microsoft 365 unified audit log.
