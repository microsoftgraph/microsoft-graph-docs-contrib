...
|:---|:---|:---|
|managedType|[microsoftManagedDesktopType](../resources/microsoftmanageddesktop.md#microsoftmanageddesktoptype-values)|Indicates the provisioning policy associated with Microsoft Managed Desktop settings. The possible values are: `notManaged`, `premiumManaged`, `standardManaged`, `starterManaged`, `unknownFutureValue`. The default is `notManaged`.|
