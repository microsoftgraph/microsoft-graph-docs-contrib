...
|locale|String |The locale is the location that a user has chosen within Microsoft Teams. The **locale** property refers to the locale setting specific to Teams, which doesn't follow the locale setting of Office. A user’s locale is represented by their preferred language and country or region. For example, `en-us`. The language component follows two letter codes as defined in [ISO 639-1](https://www.iso.org/iso/home/standards/language_codes.htm), and the country component follows two letter codes as defined in [ISO 3166-1 alpha-2](https://www.iso.org/iso/country_codes.htm). |  
