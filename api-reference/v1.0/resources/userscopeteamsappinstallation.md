...
|[Upgrade installed app for user](../api/userteamwork-teamsappinstallation-upgrade.md) | None | Upgrade to the latest version of the app installed in the personal scope of a user.|
