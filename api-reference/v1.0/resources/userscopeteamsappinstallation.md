...
|[Gets the installed app for user](../api/user-get-teamsappinstallation.md)| [userscopeteamappinstallation](userscopeteamsappinstallation.md) | List the specified app installed in the personal scope of a user. |
