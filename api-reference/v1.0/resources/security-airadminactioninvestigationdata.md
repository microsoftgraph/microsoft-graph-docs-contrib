...
ms.date: 08/04/2026
toc.title: "Automated Investigation and Response (AIR) admin action investigation audit record"
---
# airAdminActionInvestigationData resource type

Namespace: microsoft.graph.security

Represents an audit record for Automated Investigation and Response (AIR) admin action investigation events. This resource captures information about these activities as part of the Microsoft 365 unified audit log.
