...
description: "Represents an audit record for Project for the Web roadmap settings events."
...
Represents an audit record for Project for the Web roadmap settings events. This resource captures information about these activities as part of the Microsoft 365 unified audit log.
...
<!-- {
  "blockType": "resource",
  "@odata.type": "microsoft.graph.security.projectForTheWebRoadmapSettingsAuditRecord"
}
-->
``` json
{
