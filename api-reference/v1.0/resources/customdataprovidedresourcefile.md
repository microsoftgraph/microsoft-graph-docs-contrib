...
This resource doesn't have direct methods. Access files through the **files** navigation property on [customDataProvidedResourceUploadSession](../resources/customdataprovidedresourceuploadsession.md) using `$expand=files`.
