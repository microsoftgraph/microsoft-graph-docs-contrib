...
|Member|Description|
|:---|:---|
|hybridAzureADJoin|Indicates the Cloud PC devices are joined to on-premises Active Directory and registered with Microsoft Entra ID.|
|azureADJoin|Indicates the Cloud PC devices are joined only to Microsoft Entra ID.|
