...
ms.date: 08/04/2026
toc.title: "Azure Information Protection (AIP) heartbeat audit record"
---
# aipHeartBeat resource type

Namespace: microsoft.graph.security

Represents an audit record for Azure Information Protection (AIP) heartbeat events. This resource captures information about these activities as part of the Microsoft 365 unified audit log.
