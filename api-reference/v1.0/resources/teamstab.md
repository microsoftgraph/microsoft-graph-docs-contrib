...
|[Get tab](../api/channel-get-tabs.md) | [teamsTab](teamstab.md) | Reads a tab pinned to a channel.|
|[Add tab](../api/channel-post-tabs.md) | [teamsTab](teamstab.md) | Adds (pins) a tab to a channel.|
|[Update tab](../api/channel-patch-tabs.md) | [teamsTab](teamstab.md) | Updates the tab properties.|
|[Remove tab](../api/channel-delete-tabs.md) | None | Removes (unpins) a tab from a channel.|
