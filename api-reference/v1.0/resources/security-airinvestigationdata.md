...
ms.date: 08/04/2026
toc.title: "Automated Investigation and Response (AIR) investigation audit record"
---
# airInvestigationData resource type

Namespace: microsoft.graph.security

Represents an audit record for Automated Investigation and Response (AIR) investigation events. This resource captures information about these activities as part of the Microsoft 365 unified audit log.
