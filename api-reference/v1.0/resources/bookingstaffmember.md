...
|membershipStatus|bookingStaffMembershipStatus| The membership status of the staff in the business. Possible values are: `active`, `pendingAcceptance`, `rejectedByStaff`, `unknownFutureValue`. |
