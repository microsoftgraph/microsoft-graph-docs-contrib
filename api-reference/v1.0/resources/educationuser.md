...
description: "Represetns a user in the system. This is an education-specific variant of the user with the same `id` that Microsoft Graph will return from the non-education-specific `/users` endpoint."
author: "mlafleur"
...
| relatedContacts      | [relatedContact] collection                                        | Related records related to the user. Read-only.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
