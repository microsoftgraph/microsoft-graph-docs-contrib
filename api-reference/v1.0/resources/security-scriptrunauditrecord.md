...
description: "Represents an audit record for script run events."
...
Represents an audit record for script run events. This resource captures information about these activities as part of the Microsoft 365 unified audit log.
