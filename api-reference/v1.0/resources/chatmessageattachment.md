...
An entity of type `chatMessageAttachment` is returned as part of the [Get channel messages](../../beta/api/channel-list-messages.md) API, as a part of [chatMessage](./chatmessage.md) entity.
