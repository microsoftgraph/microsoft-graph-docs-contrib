...
|privilegedAccess|[privilegedAccess](privilegedaccessRoot.md)| Container for the base resources that expose the API and features related to Privileged Identity Management (PIM) for Groups.|