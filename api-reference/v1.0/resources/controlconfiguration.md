...
Defines the lifecycle and access policies of Entitlement Management within a tenant. Abstract type from which the [endUserSettings](../resources/endusersettings.md) resource is derived.
