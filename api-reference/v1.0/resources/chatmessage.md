...
Represents an individual chat message within a [channel](./channel.md) or [chat](/api-reference/beta/resources/chat.md). The chat message can be a root chat message or part of a reply thread that is defined by the **replyToId** property in the chat message.
...
|reactions| [chatMessageReaction](/api-reference/beta/resources/chatmessagereaction.md) collection | Reactions for this chat message (for example, Like).|
