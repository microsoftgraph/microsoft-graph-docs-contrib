...
| EmitSamlNameFormat | Boolean | If selected, Azure Active Directory will add an additional attribute called "NameFormat" that describes the format of the name to restricted, core, and optional claims for this application. [Learn more](https://docs.microsoft.com/azure/active-directory/develop/reference-claims-mapping-policy-type#claim-sets) |
