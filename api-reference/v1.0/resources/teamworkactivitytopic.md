...
|:---|:---|:---|
|source|[teamworkActivityTopicSource](teamworkactivitytopicsource.md)|Type of source. Possible values are: `entityUrl`, `text`. For supported Microsoft Graph URLs, use `entityUrl`. For custom text, use `text`.|
