...
|appAvailability|[managedAppAvailability](../resources/intune-apps-managedappavailability.md)|The Application's availability. This property is read-only. Possible values are: `global`, `lineOfBusiness`.|
