...
|membershipType|String|The type of the channel. Can be set during creation and cannot be changed. Values: standard, private, unknownFutureValue. Default: standard.|
