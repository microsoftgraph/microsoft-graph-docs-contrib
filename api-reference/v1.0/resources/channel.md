...
|[List all members](../api/channel-list-allmembers.md) | [conversationMember](conversationmember.md) collection | Get all members from a channel, including direct and indirect members for shared channel. |
