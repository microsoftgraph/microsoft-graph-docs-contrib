...
|isFavoriteByDefault|Boolean|Indicates whether the channel should be marked 'recommended' for all members of the team to show in their channel list. NOTE: All recommended channels will automatically show in channels list for EDU and FLW users. Can only be set programmatically with [Create team](../api/team-post.md). Default: `false`.|
