...
| businessPhones | String collection | Telephone number for the organization. <br/>NOTE: Although this is a string collection, only one number can be set for this property. |
