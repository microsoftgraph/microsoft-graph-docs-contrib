...
|values|String collection|A collection with one or many strings. One or more specified string are matched with the specified property using the specified operation. Required.|
