...
**For specific guidance and additional information, please check this document:** Tutorial: [Identify and remediate risks using Microsoft Graph APIs](https://docs.microsoft.com/en-us/graph/tutorial-riskdetection-api)
