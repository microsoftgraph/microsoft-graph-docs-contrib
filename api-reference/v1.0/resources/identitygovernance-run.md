...
|:---|:---|:---|
|activatedOnScope|microsoft.graph.identityGovernance.activationScope|The scope for which users the workflow runs. The possible values are: `allUsers`, `failedUsers`, `unknownFutureValue`.|
