...
|id|String|Read-only.|
|justification|String|The requestor's supplied justification. To retrieve the **justification** supplied by the *approver*, use [List approval stages](../api/approval-list-stages.md); the identifier of the [approval](approval.md) is the same as the identifier of the access package assignment request.|
