...
|[Reprovision](../api/cloudpc-reprovision.md)|None|Reprovision a specific [Cloud PC](../resources/cloudpc.md).|
...
|provisioningType|[cloudPcProvisioningType](#cloudpcprovisioningtype-values)| The type of licenses to be used when provisioning Cloud PCs using this policy. The possible values are: `dedicated`, `shared`, `unknownFutureValue`. The default value is `dedicated`.                                                                                                                                      |
