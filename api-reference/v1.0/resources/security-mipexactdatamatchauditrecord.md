...
description: "Represents an audit record for MIP exact data match events."
...
Represents an audit record for MIP exact data match events. This resource captures information about these activities as part of the Microsoft 365 unified audit log.
