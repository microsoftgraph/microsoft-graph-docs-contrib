...
After group onboarding, Ids of the PIM Policies and Policy Assignments of the specific group change. Call [List unifiedRoleManagementPolicyAssignments](../api/policyroot-list-rolemanagementpolicyassignments.md) to get the updated Ids.
