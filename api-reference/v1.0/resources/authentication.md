...
|platformCredentialMethods|microsoft.strongAuthentication.platformCredentialAuthenticationMethod| Represents a platform credential instance registered to a user on Mac OS. |
