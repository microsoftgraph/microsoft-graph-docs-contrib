...
|platformCredentialMethods| microsoft.strongAuthentication.authenticationMethod collection|Represents a platform credential instance registered to a user on Mac OS. |
