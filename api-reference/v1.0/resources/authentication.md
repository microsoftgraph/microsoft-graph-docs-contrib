...
|platformCredentialMethods|[microsoft.graph.strongAuthentication.platformCredentialAuthenticationMethod](platformCredentialAuthenticationMethod.md)| Represents a platform credential instance registered to a user on Mac OS. |
