...
|[Get](../api/user-list-messages.md#request) messages mentioning me | [message](../resources/message.md) collection | Get all the messages in the signed-in user's mailbox that contain a **mention** of this user.|
...
|[Delete](../api/message-delete.md#request) a mention | None |Deletes the specified mention in the specified message in the signed-in user's mailbox. |
