...
|:---|:---|:---|
|allowedWeakAlgorithms|weakAlgorithms|**TODO: Add Description**. The possible values are: `rsaSha1`, `unknownFutureValue`.|
|isSignedRequestRequired|Boolean|**TODO: Add Description**|
