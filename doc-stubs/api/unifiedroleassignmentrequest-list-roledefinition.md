...
-->
``` http
GET /unifiedRoleAssignmentRequests/{unifiedRoleAssignmentRequestsId}/roleDefinition
```
...
-->
``` http
GET https://graph.microsoft.com/beta/unifiedRoleAssignmentRequests/{unifiedRoleAssignmentRequestsId}/roleDefinition
```
