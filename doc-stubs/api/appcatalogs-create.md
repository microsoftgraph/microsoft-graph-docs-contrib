...
-->
``` http
POST ** Collection URI for Microsoft.Teams.GraphSvc.appCatalogs not found
```
...
-->
``` http
POST https://graph.microsoft.com/beta** Collection URI for Microsoft.Teams.GraphSvc.appCatalogs not found
...
{
  "@odata.type": "#Microsoft.Teams.GraphSvc.appCatalogs",
  "id": "98d444f7-44f7-98d4-f744-d498f744d498"
}
```
