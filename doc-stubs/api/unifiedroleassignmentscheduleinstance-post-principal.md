...
-->
``` http
POST /unifiedRoleAssignmentScheduleInstances/{unifiedRoleAssignmentScheduleInstancesId}/principal/$ref
```
...
-->
``` http
POST https://graph.microsoft.com/beta/unifiedRoleAssignmentScheduleInstances/{unifiedRoleAssignmentScheduleInstancesId}/principal/$ref
