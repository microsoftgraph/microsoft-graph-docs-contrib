...
-->
``` http
POST /unifiedRoleEligibilityScheduleInstances/{unifiedRoleEligibilityScheduleInstancesId}/appScope/$ref
```
...
-->
``` http
POST https://graph.microsoft.com/beta/unifiedRoleEligibilityScheduleInstances/{unifiedRoleEligibilityScheduleInstancesId}/appScope/$ref
