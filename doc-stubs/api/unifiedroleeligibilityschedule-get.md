...
-->
``` http
GET /unifiedRoleEligibilitySchedules/{unifiedRoleEligibilitySchedulesId}
```
...
-->
``` http
GET https://graph.microsoft.com/beta/unifiedRoleEligibilitySchedules/{unifiedRoleEligibilitySchedulesId}
```
