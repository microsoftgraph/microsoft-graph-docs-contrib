...
-->
``` http
GET /unifiedRoleEligibilityScheduleInstances/{unifiedRoleEligibilityScheduleInstancesId}/roleDefinition
```
...
-->
``` http
GET https://graph.microsoft.com/beta/unifiedRoleEligibilityScheduleInstances/{unifiedRoleEligibilityScheduleInstancesId}/roleDefinition
```
