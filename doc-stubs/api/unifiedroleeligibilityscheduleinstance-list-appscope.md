...
-->
``` http
GET /unifiedRoleEligibilityScheduleInstances/{unifiedRoleEligibilityScheduleInstancesId}/appScope
```
...
-->
``` http
GET https://graph.microsoft.com/beta/unifiedRoleEligibilityScheduleInstances/{unifiedRoleEligibilityScheduleInstancesId}/appScope
```
