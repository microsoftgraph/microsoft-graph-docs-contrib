...
-->
``` http
POST /unifiedRoleEligibilitySchedules/{unifiedRoleEligibilitySchedulesId}/appScope/$ref
```
...
-->
``` http
POST https://graph.microsoft.com/beta/unifiedRoleEligibilitySchedules/{unifiedRoleEligibilitySchedulesId}/appScope/$ref
