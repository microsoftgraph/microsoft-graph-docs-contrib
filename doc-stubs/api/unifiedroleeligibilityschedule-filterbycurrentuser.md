...
-->
``` http
GET /unifiedRoleEligibilitySchedules/filterByCurrentUser
```
...
-->
``` http
GET https://graph.microsoft.com/beta/unifiedRoleEligibilitySchedules/filterByCurrentUser(on='parameterValue')
```
