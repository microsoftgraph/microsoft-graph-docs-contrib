...
-->
``` http
GET /directory/administrativeUnits/{administrativeUnitId}/scopedRoleMembers
```
...
-->
``` http
GET https://graph.microsoft.com/v1.0/directory/administrativeUnits/{administrativeUnitId}/scopedRoleMembers
```
