...
-->
``` http
POST /print/printers/{printerId}/shares/{printerShareId}/allowedUsers/$ref
```
...
-->
``` http
POST https://graph.microsoft.com/v1.0/print/printers/{printerId}/shares/{printerShareId}/allowedUsers/$ref
