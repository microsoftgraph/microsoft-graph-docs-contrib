...
-->
``` http
GET /rbacApplication/roleSchedules
```
...
-->
``` http
GET https://graph.microsoft.com/beta/rbacApplication/roleSchedules(directoryScopeId='parameterValue',appScopeId='parameterValue',principalId='parameterValue',roleDefinitionId='parameterValue')
```
