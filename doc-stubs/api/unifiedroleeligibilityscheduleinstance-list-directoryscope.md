...
-->
``` http
GET /unifiedRoleEligibilityScheduleInstances/{unifiedRoleEligibilityScheduleInstancesId}/directoryScope
```
...
-->
``` http
GET https://graph.microsoft.com/beta/unifiedRoleEligibilityScheduleInstances/{unifiedRoleEligibilityScheduleInstancesId}/directoryScope
```
