...
-->
``` http
POST /unifiedRoleEligibilityRequests/{unifiedRoleEligibilityRequestsId}/roleDefinition/$ref
```
...
-->
``` http
POST https://graph.microsoft.com/beta/unifiedRoleEligibilityRequests/{unifiedRoleEligibilityRequestsId}/roleDefinition/$ref
