...
-->
``` http
GET /unifiedRoleEligibilityRequests/filterByCurrentUser
```
...
-->
``` http
GET https://graph.microsoft.com/beta/unifiedRoleEligibilityRequests/filterByCurrentUser(on='parameterValue')
```
