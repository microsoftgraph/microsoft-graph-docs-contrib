...
-->
``` http
POST /unifiedRoleAssignmentRequests/{unifiedRoleAssignmentRequestsId}/appScope/$ref
```
...
-->
``` http
POST https://graph.microsoft.com/beta/unifiedRoleAssignmentRequests/{unifiedRoleAssignmentRequestsId}/appScope/$ref
