...
-->
``` http
GET /unifiedRoleAssignmentSchedules/{unifiedRoleAssignmentSchedulesId}/appScope
```
...
-->
``` http
GET https://graph.microsoft.com/beta/unifiedRoleAssignmentSchedules/{unifiedRoleAssignmentSchedulesId}/appScope
```
