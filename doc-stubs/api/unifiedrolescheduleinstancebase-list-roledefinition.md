...
-->
``` http
GET /unifiedRoleAssignmentSchedules/{unifiedRoleAssignmentSchedulesId}/activeInstance/roleDefinition
```
...
-->
``` http
GET https://graph.microsoft.com/beta/unifiedRoleAssignmentSchedules/{unifiedRoleAssignmentSchedulesId}/activeInstance/roleDefinition
```
