...
-->
``` http
GET /unifiedRoleAssignmentScheduleInstances/{unifiedRoleAssignmentScheduleInstancesId}/activatedUsing
```
...
-->
``` http
GET https://graph.microsoft.com/beta/unifiedRoleAssignmentScheduleInstances/{unifiedRoleAssignmentScheduleInstancesId}/activatedUsing
```
