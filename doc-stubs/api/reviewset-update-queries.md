...
-->
``` http
PATCH /compliance/ediscovery/cases/{ediscoveryCaseId}/reviewSets/{reviewSetId}/queries
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/compliance/ediscovery/cases/{ediscoveryCaseId}/reviewSets/{reviewSetId}/queries
