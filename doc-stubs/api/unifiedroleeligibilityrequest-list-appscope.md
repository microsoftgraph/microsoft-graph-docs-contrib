...
-->
``` http
GET /unifiedRoleEligibilityRequests/{unifiedRoleEligibilityRequestsId}/appScope
```
...
-->
``` http
GET https://graph.microsoft.com/beta/unifiedRoleEligibilityRequests/{unifiedRoleEligibilityRequestsId}/appScope
```
