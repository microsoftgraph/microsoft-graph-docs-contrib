...
-->
``` http
POST ** Collection URI for Microsoft.AAD.MobilityService.policyRoot not found
```
...
-->
``` http
POST https://graph.microsoft.com/beta** Collection URI for Microsoft.AAD.MobilityService.policyRoot not found
