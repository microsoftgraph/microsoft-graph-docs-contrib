...
-->
``` http
DELETE /user/authentication/oathMethods/{softwareOathAuthenticationMethodId}
```
...
-->
``` http
DELETE https://graph.microsoft.com/beta/user/authentication/oathMethods/{softwareOathAuthenticationMethodId}
```
