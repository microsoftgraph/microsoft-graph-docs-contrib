...
-->
``` http
PATCH /directory/administrativeUnits/{administrativeUnitId}/scopedRoleMembers
```
...
-->
``` http
PATCH https://graph.microsoft.com/v1.0/directory/administrativeUnits/{administrativeUnitId}/scopedRoleMembers
