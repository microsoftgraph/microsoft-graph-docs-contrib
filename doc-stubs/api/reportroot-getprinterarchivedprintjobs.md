...
-->
``` http
GET /reportRoot/getPrinterArchivedPrintJobs
```
...
-->
``` http
GET https://graph.microsoft.com/v1.0/reportRoot/getPrinterArchivedPrintJobs(printerId='parameterValue',startDateTime=String (timestamp),endDateTime=String (timestamp))
```
