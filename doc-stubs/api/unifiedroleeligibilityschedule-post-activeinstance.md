...
-->
``` http
POST /unifiedRoleEligibilitySchedules/{unifiedRoleEligibilitySchedulesId}/activeInstance/$ref
```
...
-->
``` http
POST https://graph.microsoft.com/beta/unifiedRoleEligibilitySchedules/{unifiedRoleEligibilitySchedulesId}/activeInstance/$ref
