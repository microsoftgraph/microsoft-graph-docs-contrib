...
description: "Get a list of the trustFramework objects and their properties."
...
Get a list of the [trustFramework](../resources/trustframework.md) objects and their properties.
...
-->
``` http
GET https://graph.microsoft.com/beta** Collection URI for microsoft.graph.trustFramework not found
```
