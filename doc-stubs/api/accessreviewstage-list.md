...
Get a list of the [accessReviewStage](../resources/accessreviewstage.md) objects and their properties.
...
-->
``` http
GET /user/pendingAccessReviewInstances/{accessReviewInstanceId}/stages
```
...
-->
``` http
GET https://graph.microsoft.com/beta/user/pendingAccessReviewInstances/{accessReviewInstanceId}/stages
```
