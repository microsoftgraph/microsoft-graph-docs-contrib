...
-->
``` http
GET /unifiedRoleAssignmentSchedules/{unifiedRoleAssignmentSchedulesId}/roleDefinition
```
...
-->
``` http
GET https://graph.microsoft.com/beta/unifiedRoleAssignmentSchedules/{unifiedRoleAssignmentSchedulesId}/roleDefinition
```
