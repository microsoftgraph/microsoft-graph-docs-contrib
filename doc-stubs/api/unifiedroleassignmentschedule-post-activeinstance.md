...
-->
``` http
POST /unifiedRoleAssignmentSchedules/{unifiedRoleAssignmentSchedulesId}/activeInstance/$ref
```
...
-->
``` http
POST https://graph.microsoft.com/beta/unifiedRoleAssignmentSchedules/{unifiedRoleAssignmentSchedulesId}/activeInstance/$ref
