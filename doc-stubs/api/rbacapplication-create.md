...
-->
``` http
POST ** Collection URI for Microsoft.Identity.Governance.Common.Data.ExternalModels.V1.rbacApplication not found
```
...
-->
``` http
POST https://graph.microsoft.com/beta** Collection URI for Microsoft.Identity.Governance.Common.Data.ExternalModels.V1.rbacApplication not found
Content-Type: application/json
Content-length: 101

{
  "@odata.type": "#Microsoft.Identity.Governance.Common.Data.ExternalModels.V1.rbacApplication"
}
```
