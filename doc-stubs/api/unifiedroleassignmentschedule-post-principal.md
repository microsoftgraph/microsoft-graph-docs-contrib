...
-->
``` http
POST /unifiedRoleAssignmentSchedules/{unifiedRoleAssignmentSchedulesId}/principal/$ref
```
...
-->
``` http
POST https://graph.microsoft.com/beta/unifiedRoleAssignmentSchedules/{unifiedRoleAssignmentSchedulesId}/principal/$ref
