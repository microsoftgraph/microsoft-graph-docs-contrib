...
-->
``` http
POST ** Collection URI for microsoft.graph.passwordAuthenticationMethodConfiguration not found
```
...
-->
``` http
POST https://graph.microsoft.com/beta** Collection URI for microsoft.graph.passwordAuthenticationMethodConfiguration not found
