...
Create a new [richLongRunningOperation](../resources/richlongrunningoperation.md) object.
...
-->
``` http
POST https://graph.microsoft.com/beta/drive/list/operations
