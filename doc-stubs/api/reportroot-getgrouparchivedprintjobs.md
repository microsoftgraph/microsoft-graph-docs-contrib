...
-->
``` http
GET /reportRoot/getGroupArchivedPrintJobs
```
...
-->
``` http
GET https://graph.microsoft.com/v1.0/reportRoot/getGroupArchivedPrintJobs(groupId='parameterValue',startDateTime=String (timestamp),endDateTime=String (timestamp))
```
