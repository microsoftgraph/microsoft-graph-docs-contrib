...
-->
``` http
GET /unifiedRoleEligibilitySchedules/{unifiedRoleEligibilitySchedulesId}/appScope
```
...
-->
``` http
GET https://graph.microsoft.com/beta/unifiedRoleEligibilitySchedules/{unifiedRoleEligibilitySchedulesId}/appScope
```
