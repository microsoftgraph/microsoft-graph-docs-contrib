...
-->
``` http
GET /unifiedRoleAssignmentScheduleInstances/{unifiedRoleAssignmentScheduleInstancesId}/directoryScope
```
...
-->
``` http
GET https://graph.microsoft.com/beta/unifiedRoleAssignmentScheduleInstances/{unifiedRoleAssignmentScheduleInstancesId}/directoryScope
```
