...
-->
``` http
POST /unifiedRoleAssignmentSchedules/{unifiedRoleAssignmentSchedulesId}/activeInstance/principal/$ref
```
...
-->
``` http
POST https://graph.microsoft.com/beta/unifiedRoleAssignmentSchedules/{unifiedRoleAssignmentSchedulesId}/activeInstance/principal/$ref
