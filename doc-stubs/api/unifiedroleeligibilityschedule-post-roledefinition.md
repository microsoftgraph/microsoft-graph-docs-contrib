...
-->
``` http
POST /unifiedRoleEligibilitySchedules/{unifiedRoleEligibilitySchedulesId}/roleDefinition/$ref
```
...
-->
``` http
POST https://graph.microsoft.com/beta/unifiedRoleEligibilitySchedules/{unifiedRoleEligibilitySchedulesId}/roleDefinition/$ref
