...
-->
``` http
GET ** Collection URI for microsoft.graph.caseExportOperation not found
```
...
-->
``` http
GET https://graph.microsoft.com/beta** Collection URI for microsoft.graph.caseExportOperation not found
```
...
<!-- {
  "blockType": "response",
  "truncated": true,
  "@odata.type": "Collection(microsoft.graph.caseExportOperation)"
}
-->
``` http
HTTP/1.1 200 OK
