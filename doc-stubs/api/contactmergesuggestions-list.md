...
-->
``` http
GET ** Collection URI for Microsoft.Fast.PI.ViewGenerator.V2.Profile.Models.contactMergeSuggestions not found
```
...
-->
``` http
GET https://graph.microsoft.com/beta** Collection URI for Microsoft.Fast.PI.ViewGenerator.V2.Profile.Models.contactMergeSuggestions not found
```
