...
-->
``` http
POST ** Collection URI for BadUnresolvedEntityType:microsoft.graph.site not found
```
...
-->
``` http
POST https://graph.microsoft.com/beta** Collection URI for BadUnresolvedEntityType:microsoft.graph.site not found
