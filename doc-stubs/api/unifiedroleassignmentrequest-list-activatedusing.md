...
-->
``` http
GET /unifiedRoleAssignmentRequests/{unifiedRoleAssignmentRequestsId}/activatedUsing
```
...
-->
``` http
GET https://graph.microsoft.com/beta/unifiedRoleAssignmentRequests/{unifiedRoleAssignmentRequestsId}/activatedUsing
```
