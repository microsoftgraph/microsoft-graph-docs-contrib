...
-->
``` http
POST ** Collection URI for microsoft.substrateConnectors.external not found
```
...
-->
``` http
POST https://graph.microsoft.com/beta** Collection URI for microsoft.substrateConnectors.external not found
