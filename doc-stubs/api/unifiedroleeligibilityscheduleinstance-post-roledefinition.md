...
-->
``` http
POST /unifiedRoleEligibilityScheduleInstances/{unifiedRoleEligibilityScheduleInstancesId}/roleDefinition/$ref
```
...
-->
``` http
POST https://graph.microsoft.com/beta/unifiedRoleEligibilityScheduleInstances/{unifiedRoleEligibilityScheduleInstancesId}/roleDefinition/$ref
