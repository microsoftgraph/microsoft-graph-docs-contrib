...
-->
``` http
GET /print/printers/{printerId}/shares/{printerShareId}/allowedGroups
```
...
-->
``` http
GET https://graph.microsoft.com/v1.0/print/printers/{printerId}/shares/{printerShareId}/allowedGroups
```
