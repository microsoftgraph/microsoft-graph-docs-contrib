---
title: "List unifiedRoleScheduleInstanceBase"
description: "Get the unifiedRoleScheduleInstanceBase resources from the activeInstance navigation property."
...
# List unifiedRoleScheduleInstanceBase
Namespace: microsoft.graph

Get the unifiedRoleScheduleInstanceBase resources from the activeInstance navigation property.
...
-->
``` http
GET https://graph.microsoft.com/beta/unifiedRoleEligibilitySchedules/{unifiedRoleEligibilitySchedulesId}/activeInstance
```
