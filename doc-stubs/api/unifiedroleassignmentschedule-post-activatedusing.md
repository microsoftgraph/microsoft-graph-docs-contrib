...
-->
``` http
POST /unifiedRoleAssignmentSchedules/{unifiedRoleAssignmentSchedulesId}/activatedUsing/$ref
```
...
-->
``` http
POST https://graph.microsoft.com/beta/unifiedRoleAssignmentSchedules/{unifiedRoleAssignmentSchedulesId}/activatedUsing/$ref
