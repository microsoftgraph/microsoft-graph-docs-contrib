...
-->
``` http
GET /unifiedRoleAssignmentRequests/{unifiedRoleAssignmentRequestsId}/appScope
```
...
-->
``` http
GET https://graph.microsoft.com/beta/unifiedRoleAssignmentRequests/{unifiedRoleAssignmentRequestsId}/appScope
```
