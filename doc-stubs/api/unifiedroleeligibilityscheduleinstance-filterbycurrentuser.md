...
-->
``` http
GET /unifiedRoleEligibilityScheduleInstances/filterByCurrentUser
```
...
-->
``` http
GET https://graph.microsoft.com/beta/unifiedRoleEligibilityScheduleInstances/filterByCurrentUser(on='parameterValue')
```
