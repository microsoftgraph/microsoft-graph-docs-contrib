...
-->
``` http
POST /unifiedRoleEligibilitySchedules/{unifiedRoleEligibilitySchedulesId}/principal/$ref
```
...
-->
``` http
POST https://graph.microsoft.com/beta/unifiedRoleEligibilitySchedules/{unifiedRoleEligibilitySchedulesId}/principal/$ref
