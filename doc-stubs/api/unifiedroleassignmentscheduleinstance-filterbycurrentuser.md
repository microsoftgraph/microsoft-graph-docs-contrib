...
-->
``` http
GET /unifiedRoleAssignmentScheduleInstances/filterByCurrentUser
```
...
-->
``` http
GET https://graph.microsoft.com/beta/unifiedRoleAssignmentScheduleInstances/filterByCurrentUser(on='parameterValue')
```
