...
-->
``` http
GET /unifiedRoleEligibilityRequests/{unifiedRoleEligibilityRequestsId}/directoryScope
```
...
-->
``` http
GET https://graph.microsoft.com/beta/unifiedRoleEligibilityRequests/{unifiedRoleEligibilityRequestsId}/directoryScope
```
