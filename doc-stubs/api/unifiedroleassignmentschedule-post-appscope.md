...
-->
``` http
POST /unifiedRoleAssignmentSchedules/{unifiedRoleAssignmentSchedulesId}/appScope/$ref
```
...
-->
``` http
POST https://graph.microsoft.com/beta/unifiedRoleAssignmentSchedules/{unifiedRoleAssignmentSchedulesId}/appScope/$ref
