...
-->
``` http
GET /unifiedRoleAssignmentSchedules/{unifiedRoleAssignmentSchedulesId}/activatedUsing
```
...
-->
``` http
GET https://graph.microsoft.com/beta/unifiedRoleAssignmentSchedules/{unifiedRoleAssignmentSchedulesId}/activatedUsing
```
