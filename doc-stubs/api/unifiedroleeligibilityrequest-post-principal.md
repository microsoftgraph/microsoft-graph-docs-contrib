...
-->
``` http
POST /unifiedRoleEligibilityRequests/{unifiedRoleEligibilityRequestsId}/principal/$ref
```
...
-->
``` http
POST https://graph.microsoft.com/beta/unifiedRoleEligibilityRequests/{unifiedRoleEligibilityRequestsId}/principal/$ref
