...
-->
``` http
POST /unifiedRoleAssignmentRequests/{unifiedRoleAssignmentRequestsId}/roleDefinition/$ref
```
...
-->
``` http
POST https://graph.microsoft.com/beta/unifiedRoleAssignmentRequests/{unifiedRoleAssignmentRequestsId}/roleDefinition/$ref
