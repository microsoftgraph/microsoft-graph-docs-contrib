...
-->
``` http
DELETE /unifiedRoleEligibilitySchedules/{unifiedRoleEligibilitySchedulesId}
```
...
-->
``` http
DELETE https://graph.microsoft.com/beta/unifiedRoleEligibilitySchedules/{unifiedRoleEligibilitySchedulesId}
```
