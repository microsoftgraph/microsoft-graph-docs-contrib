...
>[!Note]
> *RequiredSearchAnnotations* marks the property annotations as mandatory and cannot be changed while setting up the connector. The example above sets all the properties as *searchable* and *retrievable* mandatorily, however you can skip assigning *RequiredSearchAnnotations* to properties.
> *DefaultSearchAnnotations* marks the property annotations as default and can be changed while setting up the connector.
