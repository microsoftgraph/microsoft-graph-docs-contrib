...
|_Chat.ManageDeletion.All_ |Delete and recover deleted chats. |Allows the app to read all one-to-one and group chats threads and messages in Microsoft Teams, without a signed-in user. | Yes | No |
