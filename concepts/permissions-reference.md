...
<!-- Autogenerated content starts here. Do not manually update. Manual updates are overwritten in weekly updates. If you see an error in this article, file a GitHub issue instead. See https://github.com/microsoftgraph/microsoft-graph-docs-contrib/blob/main/CONTRIBUTING.md#ways-to-contribute -->
...
| Description | Allows the app to read all workplace devices, without a signed-in user. | Allows the app to read all workplace devices, without a signed-in user. 
| AdminConsentRequired | Yes | Yes 
...
| DisplayText | Write telemetry for all workplace devices. | - 
| Description | Allows the app to write telemetry for all workplace devices, without a signed-in user. | - 
| AdminConsentRequired | Yes | - 
