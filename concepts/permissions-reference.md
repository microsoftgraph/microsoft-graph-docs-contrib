...
|   Permission    |  Display String   |  Description | Admin Consent Required | Microsoft Account supported |
|:----------------|:------------------|:-------------|:-----------------------|:--------------|
| _RoleAssignment.Read.Directory_ | Read all active role assignments for your company's directory | Allows the app to read the active role-based access control (RBAC) assignments for your company's directory, on behalf of the signed-in user. This includes reading directory role templates, and directory roles. | Yes |  |
| _RoleEligibility.Read.Directory_ | Read all eligible role assignments for your company's directory | Allows the app to read the eligible role-based access control (RBAC) assignments for your company's directory, on behalf of the signed-in user. This includes reading directory role templates, and directory roles. | Yes | |
...
| _RoleManagementPolicy.Read.Directory_ | Read all policies for privileged role assignments for your company's directory | Allows the app to read policies for privileged role-based access control (RBAC) assignments for your company's directory, on behalf of the signed-in user. | Yes | |
| _RoleAssignment.ReadWrite.Directory_ | Read, update, and delete all active role assignments for your company's directory | Allows the app to read and manage the active role-based access control (RBAC) assignments for your company's directory, on behalf of the signed-in user. This includes managing active directory role membership, and reading directory role templates, directory roles and active memberships. | Yes | |
| _RoleEligibility.ReadWrite.Directory_ | Read, update, and delete  all eligible role assignments for your company's directory | Allows the app to read and manage the eligible role-based access control (RBAC) assignments for your company's directory, on behalf of the signed-in user. This includes managing eligible directory role membership, and reading directory role templates, directory roles and eligible memberships. | Yes | |
...
| _RoleManagementPolicy.ReadWrite.Directory_ | Read, update, and delete all policies for privileged role assignments for your company's directory | Allows the app to read, update, and delete policies for privileged role-based access control (RBAC) assignments for your company's directory, on behalf of the signed-in user. | Yes | |

#### Application permissions

|   Permission    |  Display String   |  Description | Admin Consent Required |
|:----------------|:------------------|:-------------|:-----------------------|
| _RoleAssignment.Read.Directory_ | Read all active role assignments for your company's directory | Allows the app to read the active role-based access control (RBAC) assignments for your company's directory, without a signed-in user. This includes reading directory role templates, and directory roles. | Yes |
| _RoleEligibility.Read.Directory_ | Read all eligible role assignments for your company's directory | Allows the app to read the eligible role-based access control (RBAC) assignments for your company's directory, without a signed-in user. This includes reading directory role templates, and directory roles. | Yes |
...
| _RoleManagementPolicy.Read.Directory_ | Read all policies for privileged role assignments for your company's directory | Allows the app to read policies for privileged role-based access control (RBAC) assignments for your company's directory, without a signed-in user. | Yes |
| _RoleAssignment.ReadWrite.Directory_ | Read, update, and delete all active role assignments for your company's directory | Allows the app to read and manage the active role-based access control (RBAC) assignments for your company's directory, without a signed-in user. This includes managing active directory role membership, and reading directory role templates, directory roles and active memberships. | Yes |
| _RoleEligibility.ReadWrite.Directory_ | Read, update, and delete  all eligible role assignments for your company's directory | Allows the app to read and manage the eligible role-based access control (RBAC) assignments for your company's directory, without a signed-in user. This includes managing eligible directory role membership, and reading directory role templates, directory roles and eligible memberships. | Yes |
...
| _RoleManagementPolicy.ReadWrite.Directory_ | Read, update, and delete all policies for privileged role assignments for your company's directory | Allows the app to read, update, and delete policies for privileged role-based access control (RBAC) assignments for your company's directory, without a signed-in user. | Yes |
...
| _Sites.Selected_ | Access selected site collections (preview) | Allow the application to access a subset of site collections without a signed in user.  The specific site collections and the permissions granted will be configured in SharePoint Online. | Yes  |
