...
| _EduClasswork.Read_             | Read users' view of class modules and resources                  | Allows the app to read modules and resources on behalf of the user. | Yes                    | No                          |
| _EduClasswork.ReadWrite_        | Read and write users' view of class modules and resources        | Allows the app to read and write modules and resources on behalf of the user. | Yes                    | No                          |
...
| _EduClasswork.Read.All_             | Read all class modules and resources                | Allows the app to read all class modules and resources without a signed-in user.  | Yes |
| _EduClasswork.ReadWrite.All_        | Create, read, update and delete all class modules and resources | Allows the app to create, read, update and delete all class modules and resources without a signed-in user. | Yes |
