...
### DataClassificationSession.Create

| Category | Application | Delegated |
|--|--|--|
| Identifier | 50bbb34b-8df4-4148-8e59-239c00555340 | 2dd78a34-0a00-4157-82e2-2b614b875b3e 
| DisplayText | Create data classification sessions | Create data classification sessions 
| Description | Allow the app to create data classification sessions, without a signed-in user. | Allow the app to create data classification sessions, on behalf of the signed-in user. 
| AdminConsentRequired | Yes | Yes 
...
| DisplayText | - | Read your teamwork settings. 
