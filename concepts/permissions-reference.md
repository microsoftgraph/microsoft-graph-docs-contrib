...
For your app to access data in Microsoft Graph, it must be granted the permissions it needs. This topic lists the permissions associated with all Microsoft Graph APIs. For more guidance about how to use the permissions, see the [Overview of Microsoft Graph permissions](permissions-overview.md).
