...
| _Calendars.ReadBasic_ |Read basic details in a user's calendar |Allows the app to read events in the signed-in user’s calendar except for body, attachments, extensions etc. |No | No |
