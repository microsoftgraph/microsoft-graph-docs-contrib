...
|_OnlineMeetings.ReadWrite.All_|Read Online Meeting details from the app (preview)|Allows an app to create, read online meetings without a signed-in user.|Yes|
<br/>
