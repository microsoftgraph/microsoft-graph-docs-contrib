...
|   Permission    |  Display String   |  Description | Admin Consent Required |
|:-----------------------------|:-----------------------------------------|:-----------------|:-----------------|
| _Group.Read.All_ | Read all groups | Allows the app to read memberships for all groups without a signed-in user.<br/><br/>**Note:** Not all group APIs support access using app-only permissions. See [known issues](known-issues.md) for examples. | Yes |
| _Group.ReadWrite.All_ | Read and write all groups | Allows the app to create groups, read and update group memberships, and delete groups.<br/><br/>**Note:** Not all group APIs support access using app-only permissions. See [known issues](known-issues.md) for examples.| Yes |
...
| ChannelMessage.Delete                                   | Delegated   | 32ea53ac-4a89-4cde-bac4-727c6fb9ac29 |
...
| Place.Read                                              | Delegated   | 40f6bacc-b201-40da-90a5-09775cc4a863 |
...
| Place.Read.Shared                                       | Delegated   | 0b3f56bc-fecd-4036-8930-660fc672e342 |
| Place.ReadWrite                                         | Delegated   | 012ba4a5-ca82-4a76-95ba-6c27f44364c3 |
...
| TeamsApp.Read                                           | Delegated   | daef10fc-047a-48b0-b1a5-da4b5e72fabc |
