...
> [!NOTE]
> Guest users have the same access as members enabled under **External Identities** > **External Collaboration Settings** > **Guest user access**. The users API works with guest tokens as well.
