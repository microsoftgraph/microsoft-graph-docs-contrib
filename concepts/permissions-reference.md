...
| _Directory.Write.Restricted_ |Manage all restricted resources  | Allows an app to manage restricted resources as per existing permissions of the app, on behalf of the signed-in user. | Yes | No |
