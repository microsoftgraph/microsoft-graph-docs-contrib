...
You can create a [message](https://learn.microsoft.com/graph/api/resources/message?view=graph-rest-1.0) in JSON or MIME format. Specify the intended format in the request header:
