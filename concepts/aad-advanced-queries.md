...
| [User](/graph/api/resources/user)                                         | [Member Of](/graph/api/user-list-memberof), [Transitive Member Of](/graph/api/user-list-transitivememberof), Owned Objects, Registered Devices, Owned Devices, [Transitive Managers](/graph/api/user-list-manager), Direct Reports, [Transitive Reports](/graph/api/user-get-transitivereports), [AppRole Assignments](/graph/api/user-list-approleassignments), [Delegated Permission Grants](/graph/api/user-list-oauth2permissiongrants) |
