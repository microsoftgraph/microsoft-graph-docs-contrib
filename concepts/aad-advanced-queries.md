...
These advanced query capabilities are supported only on a subset of Azure AD objects and their relationships:

| Object                                                                    | Links                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| ------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [Administrative Units](/graph/api/resources/administrativeunit)           | [Members](/graph/api/administrativeunit-list-members)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| [Applications](/graph/api/resources/application)                          | [Owners](/graph/api/application-list-owners)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| [Contacts](/graph/api/resources/contact)                                  | Member Of, Transitive Member Of                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| [Delegated Permission Grants](/graph/api/resources/oauth2permissiongrant) |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| [Devices](/graph/api/resources/device)                                    | [Member Of](/graph/api/device-list-memberof), [Transitive Member Of](/graph/api/device-list-transitivememberof), [Registered Users](/graph/api/device-list-registeredusers), [Registered Owners](/graph/api/device-list-registeredowners)                                                                                                                                                                                                                                                                                                                                                             |
| [Groups](/graph/api/resources/group)                                      | [Members](/graph/api/group-list-members), [Transitive Members](/graph/api/group-list-transitivemembers), [Member Of](/graph/api/group-list-memberof), [Transitive Member Of](/graph/api/group-list-transitivememberof), [Owners](/graph/api/group-list-owners), [AppRole Assignments](/graph/api/group-list-approleassignments)                                                                                                                                                                                                                                                                       |
| [Service Principals](/graph/api/resources/serviceprincipal)               | [Member Of](/graph/api/serviceprincipal-list-memberof), [Transitive Member Of](/graph/api/serviceprincipal-list-transitivememberof), [AppRole Assignments](/graph/api/serviceprincipal-list-approleassignments), [AppRole Assignments To](/graph/api/serviceprincipal-list-approleassignedto), [Delegated Permission Grants](/graph/api/serviceprincipal-list-oauth2permissiongrants)                                                                                                                                                                                                                 |
| [User](/graph/api/resources/user)                                         | [Member Of](/graph/api/user-list-memberof), [Transitive Member Of](/graph/api/user-list-transitivememberof), [Owned Objects](/graph/api/user-list-ownedobjects), [Registered Devices](/graph/api/user-list-registereddevices), [Owned Devices](/graph/api/user-list-owneddevices), [Transitive Managers](/graph/api/user-list-manager), [Direct Reports](/graph/api/user-list-directreports), [Transitive Reports](/graph/api/user-get-transitivereports), [AppRole Assignments](/graph/api/user-list-approleassignments), [Delegated Permission Grants](/graph/api/user-list-oauth2permissiongrants) |
...
The following table summarizes support for `$filter` operators by properties of directory objects supported by the advanced query capabilities.
...
+ ![Not supported.](../concepts/images/advanced-query-parameters/notSupported.svg) The `$filter` operator is not supported on that property yet. Please [send us feedback](https://aka.ms/MsGraphAADSurveyDocs) if you need this property to enable your scenarios.
