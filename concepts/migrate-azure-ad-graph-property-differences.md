...
| **passwordProfile** | beta  &nbsp;-&nbsp; **passwordProfile** <br> v1.0 &nbsp;-&nbsp; **passwordProfile** | While the property name and type is still **passwordProfile**, the properties of the **passwordProfile** complex type have changed. See [passwordProfile property differences](#passwordprofile-property-differences). |
