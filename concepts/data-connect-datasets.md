...
| BasicDataSet_v0.Contact_v0         | Contains the available information from each user’s address book.                  | Coming soon!       |
...
| BasicDataSet_v0.Event_v0           | Contains the information from a user’s calendar events.                            | Coming soon!       |
...
| BasicDataSet_v0.Message_v0         | Contains the messages from a user’s mailbox.                                       | Coming soon!       |
...
| BasicDataSet_v0.SentItem_v0        | Contains the messages sent from each user's mailbox.                               | Coming soon!       |
...
| BasicDataSet_v0.User_v0            | Contains user information (DisplayName, UserPrincipalName, and other information). | Coming soon!       |
