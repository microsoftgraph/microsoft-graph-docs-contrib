...
| BasicDataSet_v0.GroupDetails_v0  | Contains the details of the group  | <ul><li> [Sample](https://github.com/microsoftgraph/dataconnect-solutions/blob/main/sampledatasets/BasicDataSet_v0.GroupDetails_v0.json)</li><li>[Schema](https://github.com/microsoftgraph/dataconnect-solutions/blob/main/datasetschemas/BasicDataSet_v0_GroupDetails_v0.md)</li></ul> | Free |
|BasicDataSet_v0.GroupMembers_v0  | Contains the members in the group   | <ul><li> [Sample](https://github.com/microsoftgraph/dataconnect-solutions/blob/main/sampledatasets/BasicDataSet_v0.GroupMembers_v0.json)</li><li>[Schema](https://github.com/microsoftgraph/dataconnect-solutions/blob/main/datasetschemas/BasicDataSet_v0.GroupMembers_v0.md)</li></ul> | Free |
|BasicDataSet_v0.GroupOwners_v0  | Contains the owners of the group  | <ul><li> [Sample](https://github.com/microsoftgraph/dataconnect-solutions/blob/main/sampledatasets/BasicDataSet_v0.GroupOwners_v0.json)</li><li>[Schema](https://github.com/microsoftgraph/dataconnect-solutions/blob/main/datasetschemas/BasicDataSet_v0.GroupOwners_v0.md)</li></ul> | Free |
