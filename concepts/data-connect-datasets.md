...
| BasicDataSet_v0.GroupDetails_v0  | Contains the details of the group  | <ul><li> [Sample](TBD)</li><li>[Schema](TBD)</li></ul> | Free |
|BasicDataSet_v0.GroupMembers_v0  | Contains the members in the group   | <ul><li> [Sample](TBD)</li><li>[Schema](TBD)</li></ul> | Free |
|BasicDataSet_v0.GroupOwners_v0  | Contains the owners of the group  | <ul><li> [Sample](TBD)</li><li>[Schema](TBD)</li></ul> | Free |
...
| BasicDataset_v0.OutlookGroupConversation | Contains the information from Outlook group conversations. | a | b |
...
| BasicDataSet_v0.OutlookGroupConversations_v0  | Contains the message sent from each user's mailbox. | <ul><li> [Sample](TBD)</li><li>[Schema]TBD</li></ul> | [Paid](https://azure.microsoft.com/pricing/details/graph-data-connect/) |
...
| BasicDataset_v0.TeamChannelDetails_v0 | Contains a Teams Channel details. | <ul><li> [Sample](https://github.com/microsoftgraph/dataconnect-solutions/blob/main/sampledatasets/TeamsChannelDetails_v0.json)</li><li>[Schema](https://github.com/microsoftgraph/dataconnect-solutions/blob/main/datasetschemas/TeamsChannelDetails_v0.md)</li></ul> | [Paid](https://azure.microsoft.com/pricing/details/graph-data-connect/) |
| BasicDataset_v0.TeamStandardChannelMessages_v0 | Contains a Teams standard channel messages details. | <ul><li> [Sample](<<NO SAMPLE YET>>)</li><li>[Schema](https://github.com/microsoftgraph/dataconnect-solutions/blob/main/datasetschemas/TeamsStandardChannelMessages_v0.md)</li></ul> | [Paid](https://azure.microsoft.com/pricing/details/graph-data-connect/) |
| BasicDataSet_v0.TeamsCallRecords_v1 | Contains activity records from Teams calls and meetings. | <ul><li> [Sample](TBD)</li><li>[Schema](TBD)</li></ul> | [Paid](https://azure.microsoft.com/pricing/details/graph-data-connect/) |
| BasicDataSet_v0.TeamsChannelDetails_v0  | Contains details about Channels in a team.  | <ul><li> [Sample](TBD)</li><li>[Schema](TBD)</li></ul> | [Paid](https://azure.microsoft.com/pricing/details/graph-data-connect/) |
| BasicDataSet_v0.TeamsTranscript_v1 | CContains transcripts from calls and meetings in Teams when the transcript is enabled for a meeting or a call.   | <ul><li> [Sample](TBD)</li><li>[Schema](TBD)</li></ul> | [Paid](https://azure.microsoft.com/pricing/details/graph-data-connect/) |
...
| SharePointSitesDataset_v0_Preview | Contains information about SharePoint sites. | <ul><li> [Sample](<<NO SAMPLE YET>>)</li><li>[Schema](<<NO SCHEMA YET>)</li></ul> | [Free (under preview only)](https://azure.microsoft.com/pricing/details/graph-data-connect/). These datasets will be available to those in Preview. You will need to join the Graph TAP program using the signup form at https://aka.ms/GraphTAPForm  and request to join the Preview.  |
|SharePointSitesDataset_v0_Preview  | Contains information about SharePoint sites. | <ul><li> [Sample](TBD)</li><li>[Schema](TBD)</li></ul> | [Free (under preview only)](https://azure.microsoft.com/pricing/details/graph-data-connect/). These datasets will be available to those in Preview. You will need to join the Graph TAP program using the signup form at https://aka.ms/GraphTAPForm  and request to join the Preview. |
