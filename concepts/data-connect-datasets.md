...
| BasicDataset_v0.TeamStandardChannelMessages_v0 | Contains a Teams standard channel message details. | <ul><li> [Sample](https://github.com/microsoftgraph/dataconnect-solutions/blob/main/sampledatasets/BasicDataSet_v0.TeamsStandardChannelMessages_v0.json)</li><li>[Schema](https://github.com/microsoftgraph/dataconnect-solutions/blob/main/datasetschemas/TeamsStandardChannelMessages_v0.md)</li></ul> | [Paid](https://azure.microsoft.com/pricing/details/graph-data-connect/) |
...
Please consider that these datasets are available after 48 hours (about two days). For instance, you can query data for 07/01 starting on 07/03.  
