...
|Feature     |Supporting services  |Description |More information |
|:-----------|:--------------------|:-----------|:----------------|
| Browser Management | Microsoft Edge Services | Microsoft Edge is one of the applications that administrators manage through the Microsoft 365 admin center. As an alternative to using the Microsoft 365 admin center, apps can use the Microsoft Graph API to manage the same Edge settings configured through the Microsoft 365 admin center. | [Edge API](browser-edge-concept-overview.md) |
