...
| Employee engagement | Viva Engage | Enables developers to integrate and automate community and role management in Viva Engage, fostering connections and knowledge sharing across the organization. For example, an app can manage communities and assign roles. | [Use the Microsoft Graph API to work with Viva Engage](/graph/api/resources/engagement-api-overview) |
