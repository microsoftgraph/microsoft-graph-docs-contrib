...
| Employee learning (preview) | Viva Learning | Empowers employees to make learning a natural part of the day by bringing learning into the flow of work within the tools and platforms of Microsoft 365 that they already use. Discover, share, and track learning across a variety of sources from a center of learning in Microsoft Teams.  | [Enable employee learning using the collaborative capabilities in Teams](teams-concept-overview.md#enable-employee-learning-using-the-collaborative-capabilities-in-teams-preview) |
