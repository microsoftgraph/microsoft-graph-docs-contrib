...
| Do I need to provide an Azure subscription if my application is not calling metered APIs? | No. If you need to call other APIs, please refer to the request form in [protected APIs](/graph/teams-protected-apis). |
