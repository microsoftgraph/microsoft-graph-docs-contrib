...
- Use TLS 1.2 to support all capabilities of Microsoft Graph. For more information about the Microsoft Graph TLS 1.0 and 1.1 deprecation, please refer to this [article](https://docs.microsoft.com/en-us/troubleshoot/azure/active-directory/enable-support-tls-environment).
