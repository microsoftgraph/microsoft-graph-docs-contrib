...
![Microsoft Graph exposes delegated and application permissions to your app but, also authorizes requests based on the app's effective permissions.](/graph/images/typesofpermissionsOriginal.png)
