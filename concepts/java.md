...
After you complete the application registration and [configuring the sample](https://github.com/microsoftgraph/console-java-connect-sample/blob/master/README.md#configure-your-app-using-constants.java) for the **Application Id** you get from the application registration, you can build and run the sample.
