...
- Any additional request headers, such as the **ConsistencyLevel** header for eventual consistency, are not included by default in subsequent page requests. If those headers need to be sent on subsequent requests, you must set them explicitly.
