...
The following example shows a task configuration to send the offboarding email to a user's manager after the user's last day of work. This task is identified by **taskDefinitionId** `6f22ddd4-b3a5-47a4-a846-0d7c201a49ce`.
...
The following example shows a task configuration to add a user to a Teams team. This task is identified by **taskDefinitionId** `e440ed8d-25a1-4618-84ce-091ed5be5594`.
