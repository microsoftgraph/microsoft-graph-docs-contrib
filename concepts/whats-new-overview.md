...
Create assignments with [Speaker Progress](/graph/api/resources/educationspeakerprogressresource?view=graph-rest-beta&preserve-view=true) resources at the start of a semester.
