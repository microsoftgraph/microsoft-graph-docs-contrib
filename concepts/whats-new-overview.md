...
- Use the new [cloudPcCloudApp](/graph/api/resources/cloudpccloudapp?view=graph-rest-beta&preserve-view=true) API to manage and publish app-only Cloud PC experiences for end users.
