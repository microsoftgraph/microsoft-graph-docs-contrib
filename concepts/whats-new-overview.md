...
The [Microsoft Graph PHP SDK v2.0](https://github.com/microsoftgraph/msgraph-sdk-php) is now generally available. In July 2022, we [announced](https://devblogs.microsoft.com/microsoft365dev/microsoft-graph-php-sdk-2-0-0-rc5-is-now-available/) the public preview of the first Kiota generated API client for PHP. Today, we are pleased to make this SDK generally available. The PHP SDK 2.0.0 offers best in class features to improve developer efficiency and code quality. By solving cross-cutting concerns like authentication, retry and batching, the SDK gives you time back to focus on the design and value of your application. To learn more about the new PHP SDK see [Write high quality code with the new Microsoft Graph PHP SDK v2](https://devblogs.microsoft.com/microsoft365dev/).
