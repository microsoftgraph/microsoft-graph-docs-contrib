...
- Deprecated the [cloudPcExternalPartnerSetting](/graph/api/resources/cloudpcexternalpartnersetting) resource.
- Added the [cloudPcExternalPartner](/graph/api/resources/cloudpcexternalpartner) resource
