...
Use the new Teams meeting AI insights APIs to get AI-generated insights for a meeting after it is over. For more information, see [callAiInsight](/graph/api/resources/callaiinsight.md).
