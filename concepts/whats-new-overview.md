...
An [Azure Communication Services](/azure/communication-services/overview) user can participate in a [team](/graph/api/resources/team), [channel](/graph/api/resources/channel), or [chat](/graph/api/resources/chat).
