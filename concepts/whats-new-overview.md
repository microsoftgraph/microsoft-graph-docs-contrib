...
|[shareSnapshot](/graph/api/cloudpc-createsnapshot)|None|Share a [cloudPcSnapshot](/graph/api/resources/cloudpcsnappshot?view=graph-rest-beta&preserve-view=true) for a specific Cloud PC to a storage account.|
