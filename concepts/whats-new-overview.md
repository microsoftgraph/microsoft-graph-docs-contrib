...
| User-Phone.ReadWrite.All | Least privileged permission to update **businessPhones** and **mobilePhone** properties. |
| User.EnableDisableAccount.All | Least privileged permission to update **accountEnabled** property. Requires *User.Read.All* permission as well. |
