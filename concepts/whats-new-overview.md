...
Retired the previously deprecated Microsoft Entra lifecycle announcements APIs that stopped returning data in Might 2025. Use the [Microsoft Entra release notes RSS feed instead](/entra/fundamentals/whats-new).
