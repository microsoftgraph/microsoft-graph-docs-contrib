...
4. Grant the policy to the user to allow the app IDs contained in the policy to access online meetings on behalf of the granted user. 
   ...
   ```
5. (Optional) Grant the policy to the whole tenant. This will apply to those who do have an application access policy assigned yet. For more details, refer to the cmdlet documentation in [see also](#see-also) section.
