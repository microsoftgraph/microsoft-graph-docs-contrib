...
| scope         | required    | A space-separated list of the Microsoft Graph permissions that you want the user to consent to. These may include resource permissions, such as *User.Read* and *Mail.Read*, and OIDC scopes, such as `offline_access` which indicates that your app needs a refresh token for long-lived access to resources.                                                                                                                                                                                                                                                                                                                                                                  |
