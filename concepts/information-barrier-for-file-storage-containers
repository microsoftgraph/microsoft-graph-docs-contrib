...
The [informationBarrier](/graph/api/resources/informationBarrier) property of the [fileStorageContainer](/graph/api/resources/filestoragecontainer) object lets you restrict two-way communication and collaboration between users.
