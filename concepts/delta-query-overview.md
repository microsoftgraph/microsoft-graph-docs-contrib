...
| Education Users (preview)                                      | [delta](/graph/api/educationuser-delta?view=graph-rest-beta) function of the [Education Cuser](/graph/api/resources/educationuser?view=graph-rest-beta) resource (preview)             |
