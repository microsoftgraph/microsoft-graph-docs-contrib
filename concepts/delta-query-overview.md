...
| Administrative units (preview)                                         | [delta](/graph/api/administrativeunit-delta?view=graph-rest-beta) function of the [administrativeUnit](/graph/api/resources/administrativeunit?view=graph-rest-beta) resource (preview)                     |
