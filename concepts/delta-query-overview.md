...
| Call recording (preview)                                    | [delta](/graph/api/callrecording-delta) function (preview) of the [callRecording](/graph/api/resources/callrecording) resource (through [getAllRecordings](/graph/api/onlinemeeting-getallrecordings) function)
| Call transcript (preview)                                    | [delta](/graph/api/calltranscript-delta) function (preview) of the [callTranscript](/graph/api/resources/calltranscript) resource (through [getAllTranscripts](/graph/api/onlinemeeting-getalltranscripts) function)
