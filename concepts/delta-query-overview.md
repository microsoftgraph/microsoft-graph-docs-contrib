...
| OAuth2PermissionGrant's (preview) | [delta](/graph/api/oauth2permissiongrant-delta?view=graph-rest-beta) function of the [oauth2permissiongrant](/graph/api/resources/oauth2permissiongrant?view=graph-rest-beta) resource (preview) |
