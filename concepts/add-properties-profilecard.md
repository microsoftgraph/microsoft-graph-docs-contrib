...
> [!NOTE]
> * Removing a custom attribute doesn't delete the property from Azure AD; instead, only the attribute from the users' profile cards for an organization is removed.
