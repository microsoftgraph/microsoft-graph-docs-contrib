...
You can use the Microsoft Graph API interact with the data of millions of users in the Microsoft cloud. Use Microsoft Graph to build apps for organizations and consumers that connect to a wealth of resources, relationships, and intelligence, all through a single endpoint. 
...
The graph is made up of resources connected by relationships. For example, a user can be connected to a group through a [memberOf](#) relationship, and to another user through a [manager](#) relationship. Your app can traverse these relationships to access these connected resources and perform actions on them through the API.
...
![An image showing the primary resources that are part of the graph](images/microsoft_graph.png)
