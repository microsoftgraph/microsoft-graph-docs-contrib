...
| Service principals | [delta](../api-reference/beta/api/serviceprincipal_delta.md) function of the [servicePrincipal](../api-reference/beta/resources/serviceprincipal.md) resource (preview) |
