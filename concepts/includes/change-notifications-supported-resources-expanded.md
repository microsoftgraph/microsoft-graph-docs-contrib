...
| Teams [chat][] | Changes to any chat in the tenant: `/chats`  <br><br> Changes to a specific chat: `/chats/{id}` <br> **Supported query parameter**: [notifyOnUserSpecificProperties](https://learn.microsoft.com/graph/teams-changenotifications-chat#notification-payloads-for-user-specific-properties) <br><br> Changes to all chats in an organization where a particular Teams app is installed: `/appCatalogs/teamsApps/{id}/installedToChats` <br><br> Changes to all chats that a particular user is part of: `/users/{id}/chats` <br> **Supported query parameter**: [notifyOnUserSpecificProperties](https://learn.microsoft.com/graph/teams-changenotifications-chat#notification-payloads-for-user-specific-properties)  | Maximum subscription quotas: <li> Per app and chat combination: 1 subscription. <li> Per organization: 10,000 total subscriptions. <li> Per user (for subscriptions tracking all chats that a particular user is part of): 10 subscriptions. |
