...
> [!NOTE]
> If you're subscribing to [lifecycle notifications](/graph/change-notifications-lifecycle-events) as well, the subscription service also validates the **lifecycleNotificationUrl**.
