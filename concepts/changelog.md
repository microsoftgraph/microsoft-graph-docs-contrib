...
| Addition | beta | Added support for the $top filter and the $skiptoken to support pagination on the [List provisioningObjectSummary method](/api-reference/beta/api/provisioningobjectsummary-list.md)
