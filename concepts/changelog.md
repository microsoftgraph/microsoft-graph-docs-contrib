...
| :-------------- | :------------ | :--------------------------------------- |
| Change | v1.0 <br/> beta | [Update alert](https://docs.microsoft.com/graph/api/alert-update?view=graph-rest-1.0&tabs=http) method can update the comments field with the following values only: <br/> `Closed in IPC` <br/> `Closed in MCAS`<br/>|
