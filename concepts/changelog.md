...
| Addition | beta | Added support for application permissions to [List messages in a chat](../api/chatmessage-list.md) and [Get message in chat](../api/chatmessage-get.md). |
