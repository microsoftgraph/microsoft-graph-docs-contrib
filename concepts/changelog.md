...
| Addition | beta | Added the following properties to [authorizationPolicy] resource type(/graph/api/resources/authorizationpolicy?view=graph-rest-beta):<ul><li>defaultUserRolePermissions</li><li>allowedToUseSSPR</li><li>allowedToSignUpEmailBasedSubscriptions</li><li>allowEmailVerifiedUsersToJoinOrganization</li></ul>|
