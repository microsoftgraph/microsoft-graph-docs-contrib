...
| Addition | beta | Added the following properties to [authorizationPolicy] resource type(https://docs.microsoft.com/graph/api/resources/authorizationpolicy?view=graph-rest-beta):<ul><li>defaultUserRolePermissions</li><li>allowedToUseSSPR</li><li>allowedToSignUpEmailBasedSubscriptions</li><li>allowEmailVerifiedUsersToJoinOrganization</li></ul>|
