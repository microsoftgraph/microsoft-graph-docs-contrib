...
|Addition |v1.0| Introduced new resource type [teamsAppDefinition](../api-reference/beta/resources/teamsappdefinition.md).|
|Addition |v1.0| Introduced new resource type [teamsAppInstallation](../api-reference/beta/resources/teamsappinstallation.md).|
|Addition |v1.0| Introduced new resource type [teamsAsyncOperation](../api-reference/beta/resources/teamsasyncoperation.md). |
|Addition |v1.0| Introduced new complex type [teamGuestSettings](../api-reference/beta/resources/teamguestsettings.md). |
|Addition |v1.0| Introduced new complex type [teamMemberSettings](../api-reference/beta/resources/teammembersettings.md). |
|Addition |v1.0| Introduced new complex type [teamMessagingSettings](../api-reference/beta/resources/teammessagingsettings.md). |
|Addition |v1.0| Introduced new complex type [teamFunSettings](../api-reference/beta/resources/teamfunsettings.md). |
|Addition |v1.0| Introduced new action [Clone team](../api-reference/beta/api/team_clone.md). |
|Addition |v1.0| Introduced new action [Archive team](../api-reference/beta/api/team_archive.md).|
|Addition |v1.0| Introduced new action [Unarchive team](../api-reference/beta/api/team_unarchive.md). |
