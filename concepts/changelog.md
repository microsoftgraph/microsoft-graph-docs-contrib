...
| Addition | v1.0 | Added new application permission [Group.Create](https://docs.microsoft.com/en-us/graph/permissions-reference#group-permissions) to create the [group API](https://docs.microsoft.com/en-us/graph/api/resources/group?view=graph-rest-1.0) resource.
