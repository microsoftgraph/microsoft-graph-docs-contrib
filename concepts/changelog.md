...
|Addition|beta|Added **validation**,  **contentApprovalStatus**, **hyperlinkOrPicture**, **isDeletable**, **isReorderable**, **isSealed**, **propagateChanges**, **term**, **thumbnail**, **type** properties to [columnDefinition](https://docs.microsoft.com/graph/api/resources/columnDefinition?view=graph-rest-beta) resource|
|Addition|beta|Added **sourceColumn** relationship to [columnDefinition](https://docs.microsoft.com/graph/api/resources/columnDefinition?view=graph-rest-beta) resource|
|Addition|beta|Added **associatedHubsUrls**, **documentSet**, **documentTemplate**, **isBuiltIn**, **propagateChanges** properties to [contentType](https://docs.microsoft.com/graph/api/resources/contentType?view=graph-rest-beta) resource|
|Addition|beta|Added **base**, **baseTypes**, **columns**, **columnPositions** relationships to [contentType](https://docs.microsoft.com/graph/api/resources/contentType?view=graph-rest-beta) resource|
