...
| Addition | beta | Added the **connectedOrganizationState** enumeration type and added the **state** property to [connectedOrganization](https://docs.microsoft.com/graph/api/resources/connectedOrganization?view=graph-rest-beta) resource|
