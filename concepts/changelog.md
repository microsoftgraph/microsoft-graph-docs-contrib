...
|Addition|beta|Added the [syncLicenseCounts](o:syncLicenseCounts:Collection(microsoft.graph.vppToken?view=graph-rest-beta)?view=graph-rest-beta) action on [vppToken](/graph/api/resources/intune-onboarding-vpptoken?view=graph-rest-beta) collection |
|Addition|beta|Added the [importOffice365DeviceConfigurationPolicies](o:importOffice365DeviceConfigurationPolicies:Collection(microsoft.graph.deviceManagementTemplate?view=graph-rest-beta)?view=graph-rest-beta) action on [deviceManagementTemplate](/graph/api/resources/intune-deviceintent-devicemanagementtemplate?view=graph-rest-beta) collection |
