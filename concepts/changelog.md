...
| Addition | v1.0 | Added the **licenseAssignmentStates** property to the [User](/graph/api/resources/users?view=graph-rest-1.0) entity for [Group Based Licensing](https://docs.microsoft.com/azure/active-directory/fundamentals/active-directory-licensing-whatis-azure-portal).|
