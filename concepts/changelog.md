...
| Addition | beta | Added support for the $top filter and the $skiptoken to support pagination on the [List provisioningObjectSummary method](/graph/api/provisioningobjectsummary-list?view=graph-rest-beta)
