...
|Addition|beta|Added the [import](o:import:Collection(microsoft.graph.importedWindowsAutopilotDeviceIdentity)) action on [importedWindowsAutopilotDeviceIdentity](/graph/api/resources/intune-enrollment-importedwindowsautopilotdeviceidentity?view=graph-rest-beta)<br/> collection |
