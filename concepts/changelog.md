...
|:------------|:--------|:-----------------------------------------|
| Change      | v1.0 and beta   | Alternative behavior to return changed properties only in JSON response for [users](../api-reference/v1.0/api/user_delta) and [groups](../api-reference/v1.0/api/group_delta). |
