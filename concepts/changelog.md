...
| Change | beta | The [targetResource](/graph/api/resources/targetresource?view=graph-rest-beta) type now represents property changes as [modifiedProperty](/graph/api/resources/user?view=graph-rest-beta) values. |
