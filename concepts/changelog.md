...
|Addition|Beta|Added [create](../api-reference/beta/api/team_create_teams.md), [get](../api-reference/beta/api/team_get.md), and [update](../api-reference/beta/api/team_update.md) operations on [team](../api-reference/beta/resources/team.md) entity.|
