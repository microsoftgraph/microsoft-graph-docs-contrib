...
| :-------------- | :------------ | :--------------------------------------- |
|Addition |v1.0|Introduced new resource type [identityProvider](../api-reference/v1.0/resources/identityprovider.md) entity and the [create](../api-reference/v1.0/api/identityprovider-post-identityproviders.md), [list](../api-reference/v1.0/api/identityprovider_list.md), [get](../api-reference/v1.0/api/identityprovider-get.md), [update](../api-reference/v1.0/api/identityprovider-update.md), and [delete](../api-reference/v1.0/api/identityprovider-delete.md) operations.|
