...
|:-------------|:-----------|:--------------|
| Addition | v1.0 | Added the [People APIs](../api-reference/v1.0/resources/social_overview.md) to v1.0. For details about the People API, see [Get relevant information about people](concepts/people_example.md).|
