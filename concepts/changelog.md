...
|Addition|beta|Added the [getRoleScopeTagsById](o:getRoleScopeTagsById:Collection(microsoft.graph.roleScopeTag)) action on [roleScopeTag](/graph/api/resources/intune-rbac-rolescopetag?view=graph-rest-beta) collection |
...
|Addition|beta|Added the [hasCustomRoleScopeTag](o:hasCustomRoleScopeTag:Collection(microsoft.graph.roleScopeTag)) function on [roleScopeTag](/graph/api/resources/intune-rbac-rolescopetag?view=graph-rest-beta) collection |
