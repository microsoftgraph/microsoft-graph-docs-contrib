...
https://github.com/elcarlosadrian/microsoft-graph-docs.git
...
|:----------------|:------------|:-----------------------------------------|
| Update | beta | Conditional Access APIs are moved to /identity/ segment. e.g. /beta/identity/conditionalAccess/policies.|
