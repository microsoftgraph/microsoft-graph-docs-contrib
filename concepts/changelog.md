...
| Addition | Beta |Added the [directoryDefinition: discover](/graph/api/resources/synchronization-synchronizationschema-DiscoverDirectoryDefinition?view=graph-rest-beta) method.|
