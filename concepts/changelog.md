...
| Addition | Beta | Added the [checkMemberObjects](/graph/api/administrativeunit-checkmemberobjects?view=graph-rest-beta) operation for the [administrativeUnit](/graph/api/resources/administrativeunit?view=graph-rest-beta) resource. |
