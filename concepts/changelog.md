...
| Change        | Beta        | Renamed IVR API Record to [RecordResponse] (/graph/api/call-record.md). | 
| Change        | Beta        | Removed [OnlineMeeting] (/api-reference/beta/resources/onlinemeeting.md) object properties isCanceled, canceledDateTime, entryExitAnnouncement. As well as renamed propery joinUrl to [joinWebUrl]. | 
