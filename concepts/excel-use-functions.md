...
The complete list of supported functions are listed [here](https://docs.microsoft.com/en-us/javascript/api/excel/excel.functions?view=excel-js-preview). Refer to the function signature for specific parameter names and data types.
