...
The permissions TeamworkAppSettings.Read.All and TeamworkAppSettings.ReadWrite.All might not be visible in the azure portal. To consent to these permissions, please use an authorize request as follows:
