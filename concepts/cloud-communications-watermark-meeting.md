...
When watermark is in use(either watermark option is turned on), applications use the [cloud communications calling APIs](/graph/api/application-post-calls) get restricted media experience(audio only).
