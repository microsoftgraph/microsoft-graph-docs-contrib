...
When a watermark is in use (either watermark option is turned on), applications use [cloud communications calling APIs](/graph/api/application-post-calls) get a restricted (audio only) media experience.
