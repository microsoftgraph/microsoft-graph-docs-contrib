...
The following set of articles show you how to use the [Microsoft Graph connectors SDK](/graph/custom-connector-sdk-overview)(preview) to create a custom connector in C# and use it to power Microsoft Search. This custom connector uses a sample data- appliance parts inventory in a CSV file for the Contoso Appliance Repair organization.
