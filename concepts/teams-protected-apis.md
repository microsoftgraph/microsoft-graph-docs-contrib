...
> [!CAUTION] 
> Starting May 18, 2023, the protected API approval process has been deprecated. You can now call APIs that were previously protected as long as the [requirements for accessing without a user](/graph/auth-v2-service) are met.
