...
Starting May 18th, 2023, the online form and the protected API approval process are no longer needed.  You can immediately call the protected APIs as long as the [requirements for accessing without a user](/auth-v2-service) are met.
