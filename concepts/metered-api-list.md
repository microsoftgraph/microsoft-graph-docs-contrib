...
Some metered Microsoft 365 APIs and services require additional validation beyond permissions and admin consent before you can use protected APIs, requiring to submit a protected API request.
