...
| SharePoint and OneDrive for Business [assignSensitivityLabel](/graph/api/driveitem-assignsensitivitylabel) | SharePoint Online premium API | [SharePoint preview enrollment form](https://aka.ms/PreviewSPOPremiumAPI) |
