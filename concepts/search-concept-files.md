...
Use the **includeHiddenContent** property to include normally hidden content, such as archived content and SharePoint Embedded (RaaS), in search results. By default, this property is set to `false` that prevents hidden content from being returned.
