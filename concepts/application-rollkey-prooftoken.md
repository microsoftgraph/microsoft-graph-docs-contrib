...
You can use the **addKey** and **removeKey** methods defined on the [application](/graph/api/resources/application?view=graph-rest-v1.0) and [servicePrincipal](/graph/api/resources/serviceprincipal?view=graph-rest-v1.0) resources to roll expiring keys programmatically.
