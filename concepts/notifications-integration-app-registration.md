...
For information about how to register your apps, see [Register an application with the Microsoft identity platform](auth-register-app-v2.md). When you register your app, be sure to keep the application ID/client ID somewhere handy. You'll need this ID later when you register your application for cross-device experiences in the [Microsoft Partner Center](https://partner.microsoft.com/) for Windows, Android or iOS clients.
...
>[!NOTE]
>If you're only targeting web endpoints, you can skip Partner Center registration and go to the next section to learn more about setting up your [App Service](notifications-integrating-app-server.md) to send notifications.
