...
description: "Provide remote access and single sign-on to on-premises applications by configuring Application Proxy using the Microsoft Graph APIs."
author: "FaithOmbongi"
ms.topic: "conceptual"
...
- [application](/graph/api/resources/application?view=graph-rest-1.0&preserve-view=true)
- [applicationTemplate: instantiate](/graph/api/applicationtemplate-instantiate?view=graph-rest-1.0&preserve-view=true)
- [appRoleAssignment](/graph/api/resources/approleassignment?view=graph-rest-1.0&preserve-view=true)
- [connector](/graph/api/resources/connector?view=graph-rest-beta&preserve-view=true)
- [connectorGroup](/graph/api/resources/connectorGroup?view=graph-rest-beta&preserve-view=true)
- [implicitGrantSettings](/graph/api/resources/implicitgrantsettings?view=graph-rest-1.0&preserve-view=true)
...
- [servicePrincipal](/graph/api/resources/serviceprincipal?view=graph-rest-1.0&preserve-view=true)
- [singleSignOnSettings](/graph/api/resources/onpremisespublishingsinglesignon?view=graph-rest-beta&preserve-view=true)
- [user](/graph/api/resources/user?view=graph-rest-1.0&preserve-view=true)
