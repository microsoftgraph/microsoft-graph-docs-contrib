...
- **Curated datasets:** Datasets generated for a custom use case or analytics scenario. This category can also include datasets from other Microsoft organizations, such as Viva Insights, SharePoint, and so on. These datasets enable extensibility of Microsoft 365 analytics applications.
...
- **Ensure security and governance:** Minimize compliance management overhead and provide access to secure data, empowering data and business users to make more informed and accurate data-driven decisions.
