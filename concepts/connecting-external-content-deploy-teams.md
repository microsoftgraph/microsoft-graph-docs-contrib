...
1. Select the **Manage apps** blade in the left rail.
    ...
    > [!NOTE]
    > The **Manage apps** in the Teams admin center will be deprecated soon. You can use the [Microsoft 365 admin center](https://admin.microsoft.com) to enable the Microsoft Graph connector.
