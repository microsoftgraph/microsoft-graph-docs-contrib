...
> [!NOTE]
> There's a [known issue](https://developer.microsoft.com/en-us/graph/known-issues/?search=18101) relating to `$search` on directory objects for values that contain an ampersand (&) symbol.
