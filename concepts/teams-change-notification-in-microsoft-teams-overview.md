...
| Teams [callTranscript](/graph/api/resources/calltranscript) | <li> All transcript in an organization: `communications/onlineMeetings/getAllTranscripts` <li> All transcripts for a specific meeting: `communications/onlineMeetings/{onlineMeetingId}/transcripts` | Yes |
