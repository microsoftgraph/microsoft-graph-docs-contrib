...
|:----------------|:------------|:-----------------------------------------|
| Teams [callRecording](/graph/api/resources/callrecording) | **For online meetings:** <br> <ul><li> All recordings in an organization: `communications/onlineMeetings/getAllRecordings`  <li> All recordings for a specific meeting: `communications/onlineMeetings/{onlineMeetingId}/recordings` <li> A call recording that becomes available in a meeting organized by a specific user: `users/{userId}/onlineMeetings/getAllRecordings` <li> A call recording that becomes available in a meeting where a particular Teams app is installed: `appCatalogs/teamsApps/{id}/installedToOnlineMeetings/getAllRecordings`</ul> <br>**For ad hoc calls:** <br> <ul><li> A call recording that beomes available in a call done by a specific user: `users/{userId}/adhocCalls/{callId}/recordings`</ul>| Yes |
| Teams [callTranscript](/graph/api/resources/calltranscript) | **For online meetings:** <br><ul><li> All transcripts in an organization: `communications/onlineMeetings/getAllTranscripts` <li> All transcripts for a specific meeting: `communications/onlineMeetings/{onlineMeetingId}/transcripts` <li> A call transcript that becomes available in a meeting organized by a specific user: `users/{userId}/onlineMeetings/getAllTranscripts` <li> A call transcript that becomes available in a meeting where a particular Teams app is installed: `appCatalogs/teamsApps/{teams-app-id}/installedToChats/getAlltranscripts`</ul> **For ad hoc calls:** <br><ul><li> A call transcript that beomes available in a call done by a specific user: `users/{userId}/adhocCalls/{callid}/transcripts` </li>| Yes |
