...
| Teams [chat](/graph/api/resources/chat) | <li> Changes to any chat in the tenant:<br>`/chats` <br>Changes to a specific chat:<br>`/chats/{id}`<br/> <li> Changes to any chat in the tenant where a particular Teams app is installed:<br/>`/appCatalogs/teamsApps/{id}/installedToChats` | Yes |
...
| Teams [conversationMember](/graph/api/resources/conversationMember) | <li> Changes to membership in a specific team:<br>`/teams/{id}/members` <br> <li> Changes to membership in a specific chat:<br>`/chats/{id}/members` <br> <li> Changes to membership in all chats:<br>`/chats/getAllMembers` <br>  Changes to membership in all channels under a specific team:<br>`teams/{id}/channels/getAllMembers`<br/><li> Changes to membership in all the chats in the tenant where a particular Teams app is installed:<br/>`/appCatalogs/teamsApps/{id}/installedToChats/getAllMembers` <br> <li> Changes to membership in all channels across the tenant:<br> `teams/getAllChannels/getAllMembers` | Yes |
