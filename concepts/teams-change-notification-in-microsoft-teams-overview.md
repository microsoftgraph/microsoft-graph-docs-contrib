...
| Teams [teamsAppInstallation](/graph/api/resources/teamsappinstallation) | Changes when a particular Teams app is installed:<br>`/appCatalogs/teamsApps/{teams-app-id}/installations` | Yes |
