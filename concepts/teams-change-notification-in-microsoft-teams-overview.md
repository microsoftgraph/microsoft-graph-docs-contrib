...
| Teams [teamsAppInstallation](/graph/api/resources/teamsappinstallation) | Changes to a specific team:<br>`/appCatalogs/teamsApps/{teams-app-id}/installations` | Yes |
