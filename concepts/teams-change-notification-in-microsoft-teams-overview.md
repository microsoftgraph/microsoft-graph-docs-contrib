...
| Teams [callTranscript](/graph/api/resources/calltranscript) | <li> Any transcript becomes available in the tenant: `communications/onlineMeetings/getAllTranscripts` <li> Any transcript becomes available for a specific meeting: `communications/onlineMeetings/{onlineMeetingId}/transcripts` | Yes |
