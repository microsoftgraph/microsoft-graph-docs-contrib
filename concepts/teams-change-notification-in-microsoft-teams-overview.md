...
| Teams [chat](/graph/api/resources/chat) | <li>Changes to any chat in the tenant:<br>`/chats` <li>Changes to a specific chat:<br>`/chats/{id}`<li>Changes to any chat in the tenant where a particular Teams app is installed:<br/>`/appCatalogs/teamsApps/{id}/installedToChats` | Yes |
