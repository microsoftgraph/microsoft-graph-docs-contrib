...
When you perform a [GET operation to retrieve a chart image](https://docs.microsoft.com/en-us/graph/api/chart-image), the Excel API returns the image as a base-64 string.
