...
For [sessionful requests](excel-manage-sessions.md#request-types), we recommend that you recreate the session if you encounter a `503/serviceUnavailable` or `502/badGateway` error.
<!-- {
