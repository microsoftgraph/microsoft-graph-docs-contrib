...
The following table lists examples of other second-level error codes, including the corresponding handling instructions for each error code. The service might add new error codes at any time.
