...
- [Send an activity feed notification in a chat](../api-reference/beta/api/chat-sendactivitynotification.md)
- [Send an activity feed notification in a team](../api-reference/beta/api/team-sendactivitynotification.md)
- [Send an activity feed notification to a user](../api-reference/beta/api/userteamwork-sendactivitynotification)
- [Send activity feed notifications to multiple users in bulk](../api-reference/beta/api/teamwork-sendactivitynotificationtorecipients)