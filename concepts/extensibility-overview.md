...
In the following request, `30a5435a-1871-485c-8c7b-65f69e287e7b` is the object ID of the application that owns the directory extension. On the graph endpoint, you can create directory extensions that store a collection of values.
