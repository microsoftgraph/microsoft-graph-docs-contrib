...
| application | 150,000 per 20 seconds  | 70,000 per 5 minutes where **signInAudience** is `AzureADMyOrg` or `AzureADMultipleOrgs` <br/><br/>60 requests per minute where **signInAudience** is `AzureADandPersonalMicrosoftAccount` or `PersonalMicrosoftAccount`|
