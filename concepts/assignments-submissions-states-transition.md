...
The caller must use the [GET assignment](/graph/api-reference/beta/api/educationassignment-get.md) operation to check the current assignment status and verify that the publishing process succeeded.
