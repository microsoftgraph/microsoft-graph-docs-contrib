...
The caller must use the [GET assignment](../api/educationassignment-get.md) operation to check the current assignment status and verify that the publishing process succeeded.
