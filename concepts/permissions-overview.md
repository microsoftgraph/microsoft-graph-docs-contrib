...
> [!VIDEO https://learn.microsoft.com/en-us/shows/one-dev-minute/how-do-delegated-permissions-work]
...
When a user signs in to an app they, or, in some cases, an administrator, are given a chance to consent to the delegated permissions. If they grant consent, the app can access the resources, and APIs that it has requested, within the boundaries of the permissions the user has.
