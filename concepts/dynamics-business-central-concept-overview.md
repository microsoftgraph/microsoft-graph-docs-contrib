...
# Dynamics 365 Business Central API Overview
...
Microsoft Graph provides access to your financial reports. Connect BI tools and apps to your balance sheet, cash flow statement, payables and receivables aging reports, and trial balance reports to create BI dashboards and ensure users have access to the information they need.
