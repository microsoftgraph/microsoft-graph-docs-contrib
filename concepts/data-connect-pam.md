...
* If the Azure Synapse or Azure Data Factory pipeline or copy activity's name change, a new approval request is triggered if the Azure Synapse or Azure Data Factory pipeline or copy activity's name change. For example, a new approval is required if the data table or set of columns that the copy activity is accessing changes.
