...
| _PrivilegedAccess.ReadWrite.AzureAD_ |Read and write Privileged Identity Management data  | Allows the app to have read and write access to Privileged Identity Management Apis. | Yes | No |
