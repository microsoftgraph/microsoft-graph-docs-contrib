...
|   Permission    |  Display String   |  Description | Admin Consent Required |
|:----------------|:------------------|:-------------|:-----------------------|
| _Notes.Read_ |    Read user OneNote notebooks | Allows the app to read the titles of OneNote notebooks, sections, and pages on behalf of the signed-in user.| No |
| _Notes.Create_ |    Create user OneNote notebooks | Allows the app to create new notebooks, sections, and pages on behalf of the signed-in user.| No |
