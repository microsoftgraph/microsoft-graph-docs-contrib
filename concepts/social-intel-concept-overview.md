...
- [Profile property setting (preview)](/graph/api/resources/profilepropertysetting) resource
...
- See how to [manage profile source precedence settings for an organization](/graph/profilepriority-configure-profilepropertysetting).
