...
- [Get all classes in a school](../api-reference/v1.0/api/educationschool_list_classes)
- [Get all users in a class](../api-reference/v1.0/api/educationclass_list_members)
- [Get all the classes I teach](../api-reference/v1.0/api/educationuser_list_classes)
...
- [Add an assignment that links to your application](../api-reference/beta/api/educationclass_post_assignments) 
- [Assign grades to individual students for assignments linked to your application](../api-reference/beta/api/educationsubmission_update)
- [Create a student dashboard to show which assignments are due by when](../api-reference/beta/api/educationclass_list_assignments)
...
- [Create a synchronization profile that automatically starts a sync](../api-reference/beta/api/educationsynchronizationprofile_post)
- Manage sync lifecycle with [pause](../api-reference/beta/api/educationsynchronizationprofile_pause), [resume](../api-reference/beta/api/educationsynchronizationprofile_resume) and [reset](../api-reference/beta/api/educationsynchronizationprofile_reset) operations
...
- To start using the education APIs, see:
    - [Use the roster APIs](../api-reference/v1.0/resources/education-overview)
    - [Use the assignment APIs](../api-reference/beta/resources/educationassignment)
    - [Use the SDS management APIs](../api-reference/beta/resources/educationsynchronizationprofile)
