The Microsoft Graph SDK for Java allows you to capture, inspect, modify, and export properties not captured by the SDK's built-in native entity definitions.
...
Using the earlier example, we query our vehicle entity for the undeclared `licensePlate` property:
...
### Initializing undeclared properties
