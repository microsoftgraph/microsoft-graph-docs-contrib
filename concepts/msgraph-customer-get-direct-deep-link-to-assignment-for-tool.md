...
Assignments APIs support both delegated and application permissions. We recommend using application permissions as it only permits your app to retrieve data.