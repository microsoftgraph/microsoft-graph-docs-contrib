...
> **Note:** If you are setting up [change notifications delivered through Azure Event Hubs](change-notifications-delivery.md), Microsoft Graph will not send the Validation Tokens. Microsoft Graph does not need to validate the notificationUrl.
