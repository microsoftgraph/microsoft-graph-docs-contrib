...
> **Note:** If you are setting up [change notifications delivered through Azure Event Hubs](https://docs.microsoft.com/en-us/graph/change-notifications-delivery?view=graph-rest-1.0), Microsoft Graph will not send the Validation Tokens. Microsoft Graph does not need to validate the notificationUrl.
