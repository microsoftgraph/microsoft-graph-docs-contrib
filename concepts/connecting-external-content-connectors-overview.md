...
To get started, see Build your first custom Microsoft Graph connector using [APIs](connecting-external-content-build-quickstart.yml) or [connectors SDK](/graph/custom-connector-sdk-sample-overview).
