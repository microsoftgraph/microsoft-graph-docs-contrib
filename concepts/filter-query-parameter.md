...
| --------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------ |
| Equality operators    | <ul><li> Equals (`eq`) </li><li> Not equals (`ne`)</li><li> Logical negation (`not`)</li><li> In (`in`)</li><li> Has (`has`)</li></ul> <br/><br/> The maximum number of expressions in a filter clause when using the `in` operator is 15 items by default and 2048 characters when using [advanced queries](./aad-advanced-queries.md).                               |
...
| `in`                   | `~/users?$filter=mail in ('mail1@domain.com', 'mail2@domain.com')`  <br/><br/> The maximum number of expressions in a filter clause when using the `in` operator is 15 items by default and 2048 characters when using [advanced queries](./aad-advanced-queries.md).                                                                                          |
