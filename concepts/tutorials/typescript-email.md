...
description: Learn how to use Microsoft Graph to read and send email in TypeScript apps
author: jasonjoh
ms.author: jasonjoh
ms.topic: how-to
ms.date: 05/30/2025
...
In this article, you extend the application you created in [Build TypeScript apps with Microsoft Graph](typescript.md) with Microsoft Graph mail APIs. You use Microsoft Graph to list the user's inbox and send an email.
