...
In this article, you'll add app-only authentication to the application you created in [Build Python apps with Microsoft Graph and app-only authentication](python-app-only.md).
