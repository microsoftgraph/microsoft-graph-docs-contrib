...
| **IdentifierUris** | Write | StringArray[] | User-defined URIs that uniquely identify a Web application within its Azure AD tenant, or within a verified custom domain. | |
...
| **Permissions** | Write | ApplicationPermission[] | API permissions for the Azure Active Directory Application. | |
