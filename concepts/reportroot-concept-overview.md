...
### Understand usage of Microsoft Graph APIs by applications

You can use the Microsoft Graph API usage report to gain insight into how frequently applications access Microsoft Graph APIs. Use this data to identify applications that may be optimized for data access efficiency.
...
| Microsoft Graph | [API usage](/graph/api/resources/reportroot#microsoft-graph-api-usage?view=graph-rest-beta&preserve-view=true) |
