...
| Microsoft Teams | [Device usage](/graph/api/resources/microsoft-teams-device-usage)<br/>[Team activity (preview)](/graph/api/resources/microsoft-teams-team-usage)<br/>[User activity](/graph/api/resources/microsoft-teams-user-activity)|
| Microsoft 365 (general) | [Activations](/graph/api/resources/microsoft-365-activations)<br/>[Active users](/graph/api/resources/microsoft-365-active-users)<br/>[Apps usage](/graph/api/resources/microsoft-365-apps-usage-report)<br/>[Browser usage (preview)](/graph/api/resources/microsoft-365-browser-usage-report)<br/>[Groups activity](/graph/api/resources/microsoft-365-groups-activity) |
| OneDrive | [Activity](/graph/api/resources/onedrive-activity)<br/>[Usage](/graph/api/resources/onedrive-usage) |
| Outlook | [Activity](/graph/api/resources/outlook-activity)<br/>[App usage](/graph/api/resources/outlook-app-usage)<br/>[Mailbox usage](/graph/api/resources/outlook-mailbox-usage) |
...
| SharePoint | [Activity](/graph/api/resources/sharepoint-activity)<br/>[Site usage](/graph/api/resources/sharepoint-site-usage) |
| Skype for Business | [Activity](/graph/api/resources/skype-for-business-activity)<br/>[Device usage](/graph/api/resources/skype-for-business-device-usage)<br/>[Organizer activity](/graph/api/resources/skype-for-business-organizer-activity)<br/>[Participant activity](/graph/api/resources/skype-for-business-participant-activity)<br/>[Peer to peer activity](/graph/api/resources/skype-for-business-peer-to-peer-activity) |
| Viva Engage | [Activity](/graph/api/resources/viva-engage-activity)<br/>[Device usage](/graph/api/resources/viva-engage-device-usage)<br/>[Groups activity](/graph/api/resources/viva-engage-groups-activity) |
