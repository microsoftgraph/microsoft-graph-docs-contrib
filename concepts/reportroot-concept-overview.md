...
| Microsoft Teams | [Device usage](/graph/api/resources/reportroot#microsoft-teams-device-usage)<br/>[Team activity (preview)](/graph/api/resources/reportroot#microsoft-teams-team-activity)<br/>[User activity](/graph/api/resources/reportroot#microsoft-teams-user-activity)|
| Microsoft 365 (general) | [Activations](/graph/api/resources/reportroot#microsoft-365-activations)<br/>[Active users](/graph/api/resources/reportroot#microsoft-365-active-users)<br/>[Apps usage](/graph/api/resources/reportroot#microsoft-365-apps-usage-report)<br/>[Browser usage (preview)](/graph/api/resources/reportroot#microsoft-365-browser-usage-report)<br/>[Groups activity](/graph/api/resources/reportroot#microsoft-365-groups-activity) |
...
| Partner billing |  [Billed usage](/graph/api/resources/reportroot#partners-billing-billedusage)<br/>[Unbilled usage](/graph/api/resources/reportroot#partners-billing-unbilledusage) |
