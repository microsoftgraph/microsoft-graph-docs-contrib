...
| Microsoft Teams | [Device usage](/graph/api/resources/reportroot#microsoft-teams-device-usage)<br/>[Team activity (preview)](/graph/api/resources/reportroot#microsoft-teams-team-usage)<br/>[User activity](/graph/api/resources/reportroot#microsoft-teams-user-activity)|
