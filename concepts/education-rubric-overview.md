...
To begin using rubrics, start with the [educationRubric resource in Microsoft Graph beta](../api-reference/beta/resources/educationrubric.md) and associated methods.
