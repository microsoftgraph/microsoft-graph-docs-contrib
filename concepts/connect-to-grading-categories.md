...
If you want to use Generative AI for your assignments, you need a class. A class is a group of students and teachers who share assignments and feedback in different languages. You can join an existing class or create your own. Get the list of classes from your education tenant and locate the class where you want to set grading categories.
...
Grading categories are an essential feature of Generative AI that allow you to assess the quality and relevance of the content generated by your assignments. Whether you want to grade the creativity, accuracy, style, or tone of your output, you can create custom grading categories that suit your needs. In this section, we will explain how to create, update, and delete grading categories for your assignments. 
