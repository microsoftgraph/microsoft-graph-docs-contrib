...
description: "Follow these steps to deploy expedited Windows security updates to devices in a Microsoft Entra tenant in an emergency by using the Windows Update for Business deployment service."
