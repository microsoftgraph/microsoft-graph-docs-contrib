...
|[Channel picker](./components/teams-channel-picker.md)|Provides the ability to search for Microsoft Teams and Channels to select a Channel from a rendered list of results.|
