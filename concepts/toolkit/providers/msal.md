---
title: "Msal provider"
description: "The MsalProvider uses msal.js to sign in users and acquire tokens to use with the Microsoft Graph"
...
All new applications should use Msal2Provider whenever possible. See [Msal2Provider](./msal2.md) for migration documentation.
