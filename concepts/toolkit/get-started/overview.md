...
For a step-by-step tutorial of how to get started with the Toolkit, check out the [Get started with Microsot Graph Toolkit module](https://docs.microsoft.com/learn/modules/msgraph-toolkit-intro/). 
