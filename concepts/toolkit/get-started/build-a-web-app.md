...
> **Note**: If you are currently using MsalProvider and would like to update to Msal2Provider, follow the steps listed [here](../providers/msal2.md#migrating-from-msalprovider-to-msal2provider).
If you would like to use your own backend authentication, use the [Proxy Provider](../providers/proxy.md) in place of the Msal2Provider.
