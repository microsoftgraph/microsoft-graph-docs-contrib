...
>[!NOTE] 
>If you are currently using MsalProvider and would like to update to the Msal2Provider, follow the steps in the [Msal2Provider](../providers/msal2.md#migrating-from-msalprovider-to-msal2provider) article.
