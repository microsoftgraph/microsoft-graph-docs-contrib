...
In addition to the core components, it's also possible to use both `mgt-chat` and `mgt-new-chat` components in React applications. Using the chat components requires a separate package installation.
