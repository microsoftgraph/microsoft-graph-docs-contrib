...
| disable-image-fetch | disableImageFetch | Sets whether to disable fetching of person image. Can be used to avoid unnecessary fetching from Microsoft Graph when specifying `personImage` property.
