...
| avatar-size     | avatarSize     | Set to `small`, `large` or `auto` to  determine the size of avatar. This helps to choose the correct size for the presence badge - default is auto. |
