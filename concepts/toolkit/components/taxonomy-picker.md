...
| ------------- | ------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| default       | TermStore.Read.All | [/termStore/sets/{setId}/children](/graph/api/termstore-term-list-children?view=graph-rest-beta&tabs=http#http-request),<br> [/termStore/sets/{setId}/terms/{termId}/children](/graph/api/termstore-term-list-children?view=graph-rest-beta&tabs=http#http-request),<br> [sites/{site-id}/termStore/sets/{set-id}/children](/graph/api/termstore-term-list-children?tabs=http#http-request),<br> [sites/{site-id}/termStore/sets/{set-id}/terms/{term-id}/children](/graph/api/termstore-term-list-children?tabs=http#http-request) |
