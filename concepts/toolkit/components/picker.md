...
| selected-value | selectedValue | Optional, the value to be set as the currently selected option in the picker, must be present in the options provided from the graph query. |
