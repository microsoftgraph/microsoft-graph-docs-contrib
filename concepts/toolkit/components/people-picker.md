...
| selection-mode | selectionMode | Whether to allow selecting multiple users or just a single user. Available options are: `single`, `multiple`. Default value is `multiple`.
