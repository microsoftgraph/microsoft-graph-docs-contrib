...
| default-selected-user-ids | defaultSelectedUserIds | Provided a string of comma separated Graph userIds, the component will render the respective users as selected upon initialization.
