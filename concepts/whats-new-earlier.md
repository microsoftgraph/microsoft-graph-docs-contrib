...
### Reports | Identity and access reports
[List](/graph/api/relyingpartydetailedsummary-list?view=graph-rest-beta&preserve-view=true) **relying parties** configured in Active Directory Federation Services.
