...
String activityType = "systemDefault";

ItemBody previewText = new ItemBody();
previewText.content = "Take a break";
...
templateParameters.name = "systemDefaultText";
templateParameters.value = "You need to take a short break";
