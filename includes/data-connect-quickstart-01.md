...
Microsoft Graph Data Connect (Data Connect) augments our transactional APIs with an intelligent way to access rich data at scale. The data covers how workers communicate, collaborate, and manage their time across all the applications and services from Microsoft 365.
...
To complete this lab, you'll need the following subscriptions or licenses.
...
1. **Microsoft 365 tenancy**
   ...
   - If you don't have one, you get one (for free) by signing up to the [Microsoft 365 Developer Program](https://developer.microsoft.com/microsoft-365/dev-program).
...
2. **Microsoft Azure subscription**
   ...
   - Ensure your Azure subscription is in the same tenant as your Microsoft 365 tenant and both must be in the same Azure AD tenancy.
