...
| <li> [iosManagedAppProtection](/graph/api/resources/iosManagedAppProtection)                     | <li> [targetedManagedAppConfiguration](/graph/api/resources/targetedManagedAppConfiguration)                               |
| <li> [iosManagedAppRegistration](/graph/api/resources/iosManagedAppRegistration)                 | <li> [targetedManagedAppPolicyAssignment](/graph/api/resources/targetedManagedAppPolicyAssignment)                         |
| <li> [managedAppConfiguration](/graph/api/resources/managedAppConfiguration)                     | <li> [targetedManagedAppProtection](/graph/api/resources/targetedManagedAppProtection)                                     |
| <li> [managedAppOperation](/graph/api/resources/managedAppOperation)                             | <li> [windowsInformationProtection](/graph/api/resources/windowsInformationProtection)                                     |
| <li> [managedAppPolicy](/graph/api/resources/managedAppPolicy)                                   | <li> [windowsInformationProtectionAppLockerFile](/graph/api/resources/windowsInformationProtectionAppLockerFile)           |
