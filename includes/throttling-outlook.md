...
| Mailbox import and export API | <li>[mailbox](/graph/api/resources/mailbox) <li>[mailboxItem](/graph/api/resources/mailboxitem) <li>[mailboxFolder](/graph/api/resources/mailboxfolder) <li>[exchangeSettings](/graph/api/resources/exchangeSettings) |
